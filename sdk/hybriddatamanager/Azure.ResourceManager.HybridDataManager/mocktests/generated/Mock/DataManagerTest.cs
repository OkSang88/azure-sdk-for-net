...
namespace HybridDataManagementClient.Tests.Mock
{
    ...
    public partial class DataManagerMockTests : MockTestBase
    {
        ...
        public async Task Update()
        {
            ...
            var dataManagerId = HybridDataManagementClient.DataManager.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "ResourceGroupForSDKTest", "TestAzureSDKOperations");
            var dataManager = GetArmClient().GetDataManager(dataManagerId);
            HybridDataManagementClient.Models.DataManagerUpdateParameter dataManagerUpdateParameter = new HybridDataManagementClient.Models.DataManagerUpdateParameter()
            {
                Sku = new HybridDataManagementClient.Models.Sku()
                {
                    Name = "DS0",
                    Tier = "Standard",
                },
