...
namespace Azure.ResourceManager.PrivateDns
{
    ...
    public partial class PrivateDnsZoneMXCollection : ArmCollection, IEnumerable<PrivateDnsZoneMX>, IAsyncEnumerable<PrivateDnsZoneMX>
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly RecordSetsRestOperations _recordSetsRestClient;

        /// <summary> Initializes a new instance of the <see cref="PrivateDnsZoneMXCollection"/> class for mocking. </summary>
        protected PrivateDnsZoneMXCollection()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="PrivateDnsZoneMXCollection"/> class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal PrivateDnsZoneMXCollection(ArmResource parent) : base(parent)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            ClientOptions.TryGetApiVersion(PrivateDnsZoneMX.ResourceType, out string apiVersion);
        ...
        public virtual PrivateDnsZoneMXCreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, string relativeRecordSetName, RecordSetData parameters, string ifMatch = null, string ifNoneMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("PrivateDnsZoneMXCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                var operation = new PrivateDnsZoneMXCreateOrUpdateOperation(this, response);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="relativeRecordSetName"/> or <paramref name="parameters"/> is null. </exception>
        public async virtual Task<PrivateDnsZoneMXCreateOrUpdateOperation> CreateOrUpdateAsync(bool waitForCompletion, string relativeRecordSetName, RecordSetData parameters, string ifMatch = null, string ifNoneMatch = null, CancellationToken cancellationToken = default)
        {
            if (relativeRecordSetName == null)
            {
                throw new ArgumentNullException(nameof(relativeRecordSetName));
        ...
        public virtual Response<PrivateDnsZoneMX> Get(string relativeRecordSetName, CancellationToken cancellationToken = default)
        {
            if (relativeRecordSetName == null)
            {
                throw new ArgumentNullException(nameof(relativeRecordSetName));
            ...
            using var scope = _clientDiagnostics.CreateScope("PrivateDnsZoneMXCollection.Get");
            scope.Start();
            try
            {
                ...
                return Response.FromValue(new PrivateDnsZoneMX(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="relativeRecordSetName"/> is null. </exception>
        public async virtual Task<Response<PrivateDnsZoneMX>> GetAsync(string relativeRecordSetName, CancellationToken cancellationToken = default)
        {
            if (relativeRecordSetName == null)
            {
                throw new ArgumentNullException(nameof(relativeRecordSetName));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="relativeRecordSetName"/> is null. </exception>
        public virtual Response<PrivateDnsZoneMX> GetIfExists(string relativeRecordSetName, CancellationToken cancellationToken = default)
        {
            if (relativeRecordSetName == null)
            {
                throw new ArgumentNullException(nameof(relativeRecordSetName));
            ...
            using var scope = _clientDiagnostics.CreateScope("PrivateDnsZoneMXCollection.GetIfExists");
            scope.Start();
            try
            {
                ...
                if (response.Value == null)
                    return Response.FromValue<PrivateDnsZoneMX>(null, response.GetRawResponse());
                return Response.FromValue(new PrivateDnsZoneMX(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="relativeRecordSetName"/> is null. </exception>
        public async virtual Task<Response<PrivateDnsZoneMX>> GetIfExistsAsync(string relativeRecordSetName, CancellationToken cancellationToken = default)
        {
            if (relativeRecordSetName == null)
            {
                throw new ArgumentNullException(nameof(relativeRecordSetName));
        ...
        public virtual Response<bool> Exists(string relativeRecordSetName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("PrivateDnsZoneMXCollection.Exists");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="PrivateDnsZoneMX" /> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<PrivateDnsZoneMX> GetAll(int? top = null, string recordsetnamesuffix = null, CancellationToken cancellationToken = default)
        {
            Page<PrivateDnsZoneMX> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _clientDiagnostics.CreateScope("PrivateDnsZoneMXCollection.GetAll");
                scope.Start();
                try
                {
                    ...
                    return Page.FromValues(response.Value.Value.Select(value => new PrivateDnsZoneMX(this, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
            ...
            Page<PrivateDnsZoneMX> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _clientDiagnostics.CreateScope("PrivateDnsZoneMXCollection.GetAll");
                scope.Start();
                try
        ...
        /// <param name="recordsetnamesuffix"> The suffix label of the record set name to be used to filter the record set enumeration. If this parameter is specified, the returned enumeration will only contain records that end with &quot;.&lt;recordsetnamesuffix&gt;&quot;. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> An async collection of <see cref="PrivateDnsZoneMX" /> that may take multiple service requests to iterate over. </returns>
        public virtual AsyncPageable<PrivateDnsZoneMX> GetAllAsync(int? top = null, string recordsetnamesuffix = null, CancellationToken cancellationToken = default)
        {
            async Task<Page<PrivateDnsZoneMX>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _clientDiagnostics.CreateScope("PrivateDnsZoneMXCollection.GetAll");
                scope.Start();
                try
            ...
            async Task<Page<PrivateDnsZoneMX>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _clientDiagnostics.CreateScope("PrivateDnsZoneMXCollection.GetAll");
                scope.Start();
                try
        ...
        IEnumerator<PrivateDnsZoneMX> IEnumerable<PrivateDnsZoneMX>.GetEnumerator()
        {
        ...
        IAsyncEnumerator<PrivateDnsZoneMX> IAsyncEnumerable<PrivateDnsZoneMX>.GetAsyncEnumerator(CancellationToken cancellationToken)
        {
            return GetAllAsync(cancellationToken: cancellationToken).GetAsyncEnumerator(cancellationToken);
        }

        // Builders.
        // public ArmBuilder<Azure.Core.ResourceIdentifier, PrivateDnsZoneMX, RecordSetData> Construct() { }
    }
}
