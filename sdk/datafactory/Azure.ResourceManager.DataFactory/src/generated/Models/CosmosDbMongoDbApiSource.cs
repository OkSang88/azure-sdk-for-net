...
namespace DataFactoryManagementClient.Models
{
    ...
    public partial class CosmosDbMongoDbApiSource : CopySource
    {
        ...
        internal CosmosDbMongoDbApiSource(string type, object sourceRetryCount, object sourceRetryWait, object maxConcurrentConnections, object disableMetricsCollection, IDictionary<string, object> additionalProperties, object filter, MongoDbCursorMethodsProperties cursorMethods, object batchSize, object queryTimeout, object additionalColumns) : base(type, sourceRetryCount, sourceRetryWait, maxConcurrentConnections, disableMetricsCollection, additionalProperties)
        {
            Filter = filter;
