...
{
    public partial class Backend : IUtf8JsonSerializable
    {
        ...
        internal static Backend DeserializeBackend(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("privateEndpointStatus"))
                {
                    ...
                    privateEndpointStatus = new PrivateEndpointStatus(property.Value.GetString());
                    continue;
                }
            ...
            return new Backend(address.Value, privateLinkAlias.Value, privateLinkResourceId.Value, privateLinkLocation.Value, Optional.ToNullable(privateEndpointStatus), privateLinkApprovalMessage.Value, Optional.ToNullable(httpPort), Optional.ToNullable(httpsPort), Optional.ToNullable(enabledState), Optional.ToNullable(priority), Optional.ToNullable(weight), backendHostHeader.Value);
        }
    }
}
