    ...
    public partial class ExperimentCollection : ArmCollection, IEnumerable<Experiment>, IAsyncEnumerable<Experiment>
    {
        ...
        public virtual ExperimentCreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, string experimentName, ExperimentData parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ExperimentCreateOrUpdateOperation(this, _clientDiagnostics, Pipeline, _experimentsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, experimentName, parameters).Request, response);
