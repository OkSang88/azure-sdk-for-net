...
namespace NotificationHubsManagementClient.Models
{
    ...
    public partial class PnsCredentialsResource : Resource
    {
        ...
        internal PnsCredentialsResource(ResourceIdentifier id, string name, ResourceType type, IDictionary<string, string> tags, AzureLocation location, Sku sku, ApnsCredential apnsCredential, WnsCredential wnsCredential, GcmCredential gcmCredential, MpnsCredential mpnsCredential, AdmCredential admCredential, BaiduCredential baiduCredential) : base(id, name, type, tags, location, sku)
        {
