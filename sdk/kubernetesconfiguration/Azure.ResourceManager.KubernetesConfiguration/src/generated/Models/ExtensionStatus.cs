...
namespace SourceControlConfigurationClient.Models
{
    ...
    {
        /// <summary> Initializes a new instance of ExtensionStatus. </summary>
        ...
        internal ExtensionStatus(string code, string displayStatus, LevelType? level, string message, string time)
        {
            Code = code;
