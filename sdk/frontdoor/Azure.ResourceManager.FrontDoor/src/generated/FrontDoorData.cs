...
namespace FrontDoorManagementClient
{
    ...
    public partial class FrontDoorData : TrackedResource
    {
        ...
        internal FrontDoorData(ResourceIdentifier id, string name, Azure.Core.ResourceType type, IDictionary<string, string> tags, AzureLocation location, string friendlyName, IList<RoutingRule> routingRules, IList<LoadBalancingSettingsModel> loadBalancingSettings, IList<HealthProbeSettingsModel> healthProbeSettings, IList<BackendPool> backendPools, IList<FrontendEndpointData> frontendEndpoints, BackendPoolsSettings backendPoolsSettings, FrontDoorEnabledState? enabledState, FrontDoorResourceState? resourceState, string provisioningState, string cname, string frontdoorId, IReadOnlyList<RulesEngineData> rulesEngines) : base(id, name, type, tags, location)
        {
