...
namespace Azure.ResourceManager.LabServices
{
    ...
    public partial class LabPlanData : TrackedResource
    {
        ...
        /// <param name="location"> The location. </param>
        /// <param name="systemData"> Metadata pertaining to creation and last modification of the lab plan. </param>
        ...
        internal LabPlanData(ResourceIdentifier id, string name, ResourceType type, IDictionary<string, string> tags, AzureLocation location, SystemData systemData, ConnectionProfile defaultConnectionProfile, AutoShutdownProfile defaultAutoShutdownProfile, LabPlanNetworkProfile defaultNetworkProfile, IList<string> allowedRegions, string sharedGalleryId, SupportInfo supportInfo, string linkedLmsInstance, ProvisioningState? provisioningState) : base(id, name, type, tags, location)
        {
            SystemData = systemData;
