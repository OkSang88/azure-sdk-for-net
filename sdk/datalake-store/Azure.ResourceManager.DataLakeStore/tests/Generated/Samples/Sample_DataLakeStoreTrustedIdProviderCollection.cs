...
namespace Azure.ResourceManager.DataLakeStore.Samples
{
    public partial class Sample_DataLakeStoreTrustedIdProviderCollection
    {
        ...
        public async Task GetAll_ListsTheDataLakeStoreTrustedIdentityProvidersWithinTheSpecifiedDataLakeStoreAccount()
        {
            ...
            // get the collection of this DataLakeStoreTrustedIdProviderResource
            DataLakeStoreTrustedIdProviderCollection collection = dataLakeStoreAccount.GetDataLakeStoreTrustedIdProviders();

            // invoke the operation and iterate over the result
            await foreach (DataLakeStoreTrustedIdProviderResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                DataLakeStoreTrustedIdProviderData resourceData = item.Data;
        ...
        public async Task CreateOrUpdate_CreatesOrUpdatesTheSpecifiedTrustedIdentityProviderDuringUpdateTheTrustedIdentityProviderWithTheSpecifiedNameWillBeReplacedWithThisNewProvider()
        {
            ...
            DataLakeStoreTrustedIdProviderCreateOrUpdateContent content = new DataLakeStoreTrustedIdProviderCreateOrUpdateContent(new Uri("https://sts.windows.net/ea9ec534-a3e3-4e45-ad36-3afc5bb291c1"));
            ArmOperation<DataLakeStoreTrustedIdProviderResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, trustedIdProviderName, content);
            DataLakeStoreTrustedIdProviderResource result = lro.Value;
        ...
        public async Task Get_GetsTheSpecifiedDataLakeStoreTrustedIdentityProvider()
        {
            ...
            // invoke the operation
            string trustedIdProviderName = "test_trusted_id_provider_name";
            DataLakeStoreTrustedIdProviderResource result = await collection.GetAsync(trustedIdProviderName);
