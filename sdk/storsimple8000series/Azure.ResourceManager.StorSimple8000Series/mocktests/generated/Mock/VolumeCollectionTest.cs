...
namespace StorSimple8000SeriesManagementClient.Tests.Mock
{
    ...
    public partial class VolumeCollectionMockTests : MockTestBase
    {
        ...
        public async Task CreateOrUpdate()
        {
            ...
            StorSimple8000SeriesManagementClient.VolumeData parameters = new StorSimple8000SeriesManagementClient.VolumeData(sizeInBytes: 5368709120, volumeType: StorSimple8000SeriesManagementClient.Models.VolumeType.Tiered, accessControlRecordIds: new List<string>()
{
"/subscriptions/4385cf00-2d3a-425a-832f-f4285b1c9dce/resourceGroups/ResourceGroupForSDKTest/providers/Microsoft.StorSimple/managers/ManagerForSDKTest1/accessControlRecords/ACR2",}, volumeStatus: StorSimple8000SeriesManagementClient.Models.VolumeStatus.Offline, monitoringStatus: StorSimple8000SeriesManagementClient.Models.MonitoringStatus.Enabled);

            var volumeContainerId = StorSimple8000SeriesManagementClient.VolumeContainer.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "ResourceGroupForSDKTest", "ManagerForSDKTest1", "Device05ForSDKTest", "VolumeContainerForSDKTest");
