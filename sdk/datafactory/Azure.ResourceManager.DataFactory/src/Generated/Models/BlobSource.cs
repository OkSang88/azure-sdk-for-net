...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class BlobSource : CopySource
    {
        ...
        internal BlobSource(string type, object sourceRetryCount, object sourceRetryWait, object maxConcurrentConnections, object disableMetricsCollection, IDictionary<string, object> additionalProperties, object treatEmptyAsNull, object skipHeaderLineCount, object recursive) : base(type, sourceRetryCount, sourceRetryWait, maxConcurrentConnections, disableMetricsCollection, additionalProperties)
        {
