...
namespace Azure.ResourceManager.Search.Models
{
    ...
    public partial class PrivateLinkResourceProperties
    {
        ...
        internal PrivateLinkResourceProperties(string groupId, IReadOnlyList<string> requiredMembers, IReadOnlyList<string> requiredZoneNames, IReadOnlyList<ShareablePrivateLinkResourceType> shareablePrivateLinkResourceTypes)
        {
            GroupId = groupId;
