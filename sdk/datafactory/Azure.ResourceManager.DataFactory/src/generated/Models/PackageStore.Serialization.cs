...
{
    public partial class PackageStore : IUtf8JsonSerializable
    {
        ...
        internal static PackageStore DeserializePackageStore(JsonElement element)
        {
            string name = default;
            ...
            return new PackageStore(name, packageStoreLinkedService);
        }
    }
}
