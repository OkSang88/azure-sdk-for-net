# Azure StorageCache Management client library for .NET
...
Install the Azure StorageCache management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.StorageCache -Version 1.0.0-preview.1 
```
