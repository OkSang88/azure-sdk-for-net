...
namespace DataFactoryManagementClient.Models
{
    ...
    public partial class AzureDataLakeStoreSink : CopySink
    {
        ...
        internal AzureDataLakeStoreSink(string type, object writeBatchSize, object writeBatchTimeout, object sinkRetryCount, object sinkRetryWait, object maxConcurrentConnections, object disableMetricsCollection, IDictionary<string, object> additionalProperties, object copyBehavior, object enableAdlsSingleFileParallel) : base(type, writeBatchSize, writeBatchTimeout, sinkRetryCount, sinkRetryWait, maxConcurrentConnections, disableMetricsCollection, additionalProperties)
        {
