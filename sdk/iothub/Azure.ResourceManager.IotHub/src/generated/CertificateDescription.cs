...
namespace IotHubClient
{
    ...
    public partial class CertificateDescription : ArmResource
    {
        ...
        public async virtual Task<CertificateDeleteOperation> DeleteAsync(bool waitForCompletion, string ifMatch, CancellationToken cancellationToken = default)
        {
            if (ifMatch == null)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="ifMatch"/> is null. </exception>
        public virtual CertificateDeleteOperation Delete(bool waitForCompletion, string ifMatch, CancellationToken cancellationToken = default)
        {
            if (ifMatch == null)
            {
                throw new ArgumentNullException(nameof(ifMatch));
