...
namespace IotHubClient
{
    ...
    public partial class IotHubDescriptionData : TrackedResource
    {
        ...
        internal IotHubDescriptionData(ResourceIdentifier id, string name, ResourceType type, IDictionary<string, string> tags, AzureLocation location, string etag, IotHubProperties properties, IotHubSkuInfo sku, ResourceIdentity identity) : base(id, name, type, tags, location)
        {
            Etag = etag;
