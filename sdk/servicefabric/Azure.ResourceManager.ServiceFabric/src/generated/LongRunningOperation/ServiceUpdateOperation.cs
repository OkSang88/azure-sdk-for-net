...
namespace ServiceFabricManagementClient.Models
{
    ...
    public partial class ServiceUpdateOperation : Operation<ServiceResource>, IOperationSource<ServiceResource>
    {
        ...
        {
            _operation = new OperationInternals<ServiceResource>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "ServiceUpdateOperation");
