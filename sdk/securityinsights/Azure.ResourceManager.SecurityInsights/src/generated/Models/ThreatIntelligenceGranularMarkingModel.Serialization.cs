...
{
    public partial class ThreatIntelligenceGranularMarkingModel : IUtf8JsonSerializable
    {
        ...
        internal static ThreatIntelligenceGranularMarkingModel DeserializeThreatIntelligenceGranularMarkingModel(JsonElement element)
        {
            ...
            return new ThreatIntelligenceGranularMarkingModel(language.Value, Optional.ToNullable(markingRef), Optional.ToList(selectors));
        }
    }
}
