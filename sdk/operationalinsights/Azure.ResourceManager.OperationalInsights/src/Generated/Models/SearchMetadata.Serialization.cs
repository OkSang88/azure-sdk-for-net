...
namespace Azure.ResourceManager.OperationalInsights.Models
{
    public partial class SearchMetadata
    {
        internal static SearchMetadata DeserializeSearchMetadata(JsonElement element)
        {
            ...
            return new SearchMetadata(requestId.Value, resultType.Value, Optional.ToNullable(total), Optional.ToNullable(top), id.Value, Optional.ToList(coreSummaries), status.Value, Optional.ToNullable(startTime), Optional.ToNullable(lastUpdated), eTag.Value, Optional.ToList(sort), Optional.ToNullable(requestTime), aggregatedValueField.Value, aggregatedGroupingFields.Value, Optional.ToNullable(sum), Optional.ToNullable(max), schema.Value);
        }
    }
}
