...
namespace DataFactoryManagementClient
{
    ...
    {
        private static FactoriesRestOperations GetFactoriesRestOperations(ClientDiagnostics clientDiagnostics, TokenCredential credential, ArmClientOptions clientOptions, HttpPipeline pipeline, Uri endpoint = null)
        {
            return new FactoriesRestOperations(clientDiagnostics, pipeline, clientOptions, endpoint);
        }

        private static ExposureControlRestOperations GetExposureControlRestOperations(ClientDiagnostics clientDiagnostics, TokenCredential credential, ArmClientOptions clientOptions, HttpPipeline pipeline, Uri endpoint = null)
        {
            return new ExposureControlRestOperations(clientDiagnostics, pipeline, clientOptions, endpoint);
        }
        ...
        public static AsyncPageable<Factory> GetFactoriesAsync(this Subscription subscription, CancellationToken cancellationToken = default)
        {
            return subscription.UseClientContext((baseUri, credential, options, pipeline) =>
            {
                ...
                var restOperations = GetFactoriesRestOperations(clientDiagnostics, credential, options, pipeline, baseUri);
        ...
        public static async Task<Response<ExposureControlResponse>> GetFeatureValueExposureControlAsync(this Subscription subscription, string locationId, ExposureControlRequest exposureControlRequest, CancellationToken cancellationToken = default)
        {
            ...
            return await subscription.UseClientContext(async (baseUri, credential, options, pipeline) =>
            {
                ...
                try
                {
                    var restOperations = GetExposureControlRestOperations(clientDiagnostics, credential, options, pipeline, baseUri);
