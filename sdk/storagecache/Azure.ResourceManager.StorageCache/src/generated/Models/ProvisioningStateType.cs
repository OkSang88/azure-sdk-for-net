...
namespace StorageCacheManagementClient.Models
{
    ...
    public readonly partial struct ProvisioningStateType : IEquatable<ProvisioningStateType>
    {
        ...
        public static ProvisioningStateType Cancelled { get; } = new ProvisioningStateType(CancelledValue);
        /// <summary> Creating. </summary>
        public static ProvisioningStateType Creating { get; } = new ProvisioningStateType(CreatingValue);
        /// <summary> Deleting. </summary>
        public static ProvisioningStateType Deleting { get; } = new ProvisioningStateType(DeletingValue);
        /// <summary> Updating. </summary>
        public static ProvisioningStateType Updating { get; } = new ProvisioningStateType(UpdatingValue);
