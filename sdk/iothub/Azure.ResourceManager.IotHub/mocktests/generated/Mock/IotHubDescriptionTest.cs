...
namespace Azure.ResourceManager.IotHub.Tests.Mock
{
    ...
    public partial class IotHubDescriptionMockTests : MockTestBase
    {
        ...
        public async Task Update()
        {
            ...
            var iotHubDescriptionId = IotHub.IotHubDescription.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "myResourceGroup", "myHub");
            var iotHubDescription = GetArmClient().GetIotHubDescription(iotHubDescriptionId);
            IotHub.Models.TagsResource iotHubTags = new IotHub.Models.TagsResource();
        ...
        public async Task GetEndpointHealth()
        {
            ...
            var iotHubDescriptionId = IotHub.IotHubDescription.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "myResourceGroup", "default");
            var iotHubDescription = GetArmClient().GetIotHubDescription(iotHubDescriptionId);
        ...
        public async Task TestAllRoutes()
        {
            ...
            var iotHubDescriptionId = IotHub.IotHubDescription.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "myResourceGroup", "default");
            var iotHubDescription = GetArmClient().GetIotHubDescription(iotHubDescriptionId);
            IotHub.Models.TestAllRoutesInput input = new IotHub.Models.TestAllRoutesInput()
            {
                RoutingSource = new IotHub.Models.RoutingSource("DeviceMessages"),
                Message = new IotHub.Models.RoutingMessage()
                {
        ...
        public async Task TestRoute()
        {
            ...
            var iotHubDescriptionId = IotHub.IotHubDescription.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "myResourceGroup", "default");
            var iotHubDescription = GetArmClient().GetIotHubDescription(iotHubDescriptionId);
            IotHub.Models.TestRouteInput input = new IotHub.Models.TestRouteInput(route: new IotHub.Models.RouteProperties(name: "Routeid", source: new IotHub.Models.RoutingSource("DeviceMessages"), endpointNames: new List<string>()
{
"id1",}, isEnabled: true))
            {
                Message = new IotHub.Models.RoutingMessage()
        ...
        public async Task ExportDevices()
        {
            ...
            var iotHubDescriptionId = IotHub.IotHubDescription.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "myResourceGroup", "testHub");
            var iotHubDescription = GetArmClient().GetIotHubDescription(iotHubDescriptionId);
            IotHub.Models.ExportDevicesRequest exportDevicesParameters = new IotHub.Models.ExportDevicesRequest(exportBlobContainerUri: "testBlob", excludeKeys: true)
            {
                AuthenticationType = new IotHub.Models.AuthenticationType("identityBased"),
                Identity = new IotHub.Models.ManagedIdentity()
                {
        ...
        public async Task ImportDevices()
        {
            ...
            var iotHubDescriptionId = IotHub.IotHubDescription.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "myResourceGroup", "testHub");
            var iotHubDescription = GetArmClient().GetIotHubDescription(iotHubDescriptionId);
            IotHub.Models.ImportDevicesRequest importDevicesParameters = new IotHub.Models.ImportDevicesRequest(inputBlobContainerUri: "testBlob", outputBlobContainerUri: "testBlob");
        ...
        public async Task ManualFailoverIotHub()
        {
            ...
            var iotHubDescriptionId = IotHub.IotHubDescription.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "myResourceGroup", "default");
            var iotHubDescription = GetArmClient().GetIotHubDescription(iotHubDescriptionId);
            IotHub.Models.FailoverInput failoverInput = new IotHub.Models.FailoverInput(failoverRegion: "testHub");
