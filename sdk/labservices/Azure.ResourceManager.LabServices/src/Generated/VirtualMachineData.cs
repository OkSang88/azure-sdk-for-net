...
namespace Azure.ResourceManager.LabServices
{
    ...
    public partial class VirtualMachineData : Resource
    {
        ...
        /// <param name="systemData"> System data of the Lab virtual machine. </param>
        ...
        internal VirtualMachineData(ResourceIdentifier id, string name, ResourceType type, SystemData systemData, ProvisioningState? provisioningState, VirtualMachineState? state, VirtualMachineConnectionProfile connectionProfile, string claimedByUserId, VirtualMachineType? vmType) : base(id, name, type)
        {
