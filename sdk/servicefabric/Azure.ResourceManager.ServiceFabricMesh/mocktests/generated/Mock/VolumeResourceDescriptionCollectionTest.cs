...
namespace Azure.ResourceManager.ServiceFabricMesh.Tests.Mock
{
    ...
    public partial class VolumeResourceDescriptionCollectionMockTests : MockTestBase
    {
        ...
        public async Task CreateOrUpdate()
        {
            ...
            ServiceFabricMesh.VolumeResourceDescriptionData volumeResourceDescription = new ServiceFabricMesh.VolumeResourceDescriptionData(location: "EastUS", provider: new ServiceFabricMesh.Models.VolumeProvider("SFAzureFile"))
            {
                Description = "Service Fabric Mesh sample volume.",
                AzureFileParameters = new ServiceFabricMesh.Models.VolumeProviderParametersAzureFile(accountName: "sbzdemoaccount", shareName: "sharel")
                {
