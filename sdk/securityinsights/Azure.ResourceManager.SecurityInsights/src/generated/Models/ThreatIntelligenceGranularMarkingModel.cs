...
namespace SecurityInsights.Models
{
    ...
    {
        /// <summary> Initializes a new instance of ThreatIntelligenceGranularMarkingModel. </summary>
        ...
        internal ThreatIntelligenceGranularMarkingModel(string language, int? markingRef, IList<string> selectors)
        {
            Language = language;
