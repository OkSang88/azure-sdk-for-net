        ...
        internal static CustomDomainResourceData DeserializeCustomDomainResourceData(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("properties"))
                {
                    ...
                    properties = CustomDomainProperties.DeserializeCustomDomainProperties(property.Value);
                    continue;
                }
            ...
            return new CustomDomainResourceData(id, name, type, systemData.Value, properties.Value);
        }
    }
}
