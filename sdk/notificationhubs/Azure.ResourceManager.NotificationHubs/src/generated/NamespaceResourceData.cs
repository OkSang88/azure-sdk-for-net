...
{
    /// <summary> A class representing the NamespaceResource data model. </summary>
    public partial class NamespaceResourceData : Resource
    {
        /// <summary> Initializes a new instance of NamespaceResourceData. </summary>
        /// <param name="location"> The location. </param>
        public NamespaceResourceData(AzureLocation location) : base(location)
        {
        }
