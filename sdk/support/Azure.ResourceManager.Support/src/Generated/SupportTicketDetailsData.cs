...
{
    /// <summary> A class representing the SupportTicketDetails data model. </summary>
    public partial class SupportTicketDetailsData : Resource
    {
        /// <summary> Initializes a new instance of SupportTicketDetailsData. </summary>
        public SupportTicketDetailsData()
        {
        }
        ...
        /// <param name="problemStartTime"> Time in UTC (ISO 8601 format) when the problem started. </param>
        ...
        /// <param name="createdDate"> Time in UTC (ISO 8601 format) when the support ticket was created. </param>
        /// <param name="modifiedDate"> Time in UTC (ISO 8601 format) when the support ticket was last modified. </param>
        ...
        internal SupportTicketDetailsData(ResourceIdentifier id, string name, ResourceType type, string supportTicketId, string description, string problemClassificationId, string problemClassificationDisplayName, SeverityLevel? severity, string enrollmentId, bool? require24X7Response, ContactProfile contactDetails, ServiceLevelAgreement serviceLevelAgreement, SupportEngineer supportEngineer, string supportPlanType, string title, DateTimeOffset? problemStartTime, string serviceId, string serviceDisplayName, string status, DateTimeOffset? createdDate, DateTimeOffset? modifiedDate, TechnicalTicketDetails technicalTicketDetails, QuotaTicketDetails quotaTicketDetails) : base(id, name, type)
        {
        ...
        public DateTimeOffset? ProblemStartTime { get; set; }
