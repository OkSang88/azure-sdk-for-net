...
namespace ServiceFabricMeshManagementClient
{
    ...
    public partial class ServiceResourceDescription : ArmResource
    {
        ...
        internal ServiceResourceDescription(ArmResource options, ServiceResourceDescriptionData data) : base(options, new ResourceIdentifier(data.Id))
        {
            ...
            _serviceReplicaRestClient = new ServiceReplicaRestOperations(_clientDiagnostics, Pipeline, ClientOptions, BaseUri);
            _codePackageRestClient = new CodePackageRestOperations(_clientDiagnostics, Pipeline, ClientOptions, BaseUri);
#if DEBUG
