...
namespace Azure.ResourceManager.Search.Models
{
    public partial class PrivateEndpointConnectionProperties : IUtf8JsonSerializable
    {
        ...
        internal static PrivateEndpointConnectionProperties DeserializePrivateEndpointConnectionProperties(JsonElement element)
        {
            ...
            Optional<PrivateEndpointConnectionPropertiesPrivateLinkServiceConnectionState> privateLinkServiceConnectionState = default;
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("privateLinkServiceConnectionState"))
                {
                    ...
                    privateLinkServiceConnectionState = PrivateEndpointConnectionPropertiesPrivateLinkServiceConnectionState.DeserializePrivateEndpointConnectionPropertiesPrivateLinkServiceConnectionState(property.Value);
                    continue;
                }
            }
            return new PrivateEndpointConnectionProperties(privateEndpoint, privateLinkServiceConnectionState.Value);
        }
    }
}
