...
namespace AppPlatformManagementClient.Models
{
    ...
    public partial class CertificateProperties
    {
        ...
        internal CertificateProperties(string type, string thumbprint, string issuer, string issuedDate, string expirationDate, string activateDate, string subjectName, IReadOnlyList<string> dnsNames)
        {
            Type = type;
