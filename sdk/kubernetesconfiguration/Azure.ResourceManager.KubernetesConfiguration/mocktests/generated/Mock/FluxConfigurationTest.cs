...
namespace SourceControlConfigurationClient.Tests.Mock
{
    ...
    public partial class FluxConfigurationMockTests : MockTestBase
    {
        ...
        public async Task Get()
        {
            ...
            var fluxConfigurationId = SourceControlConfigurationClient.FluxConfiguration.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "rg1", "Microsoft.Kubernetes", "connectedClusters", "clusterName1", "srs-fluxconfig");
        ...
        public async Task Update()
        {
            ...
            var fluxConfigurationId = SourceControlConfigurationClient.FluxConfiguration.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "rg1", "Microsoft.Kubernetes", "connectedClusters", "clusterName1", "srs-fluxconfig");
            var fluxConfiguration = GetArmClient().GetFluxConfiguration(fluxConfigurationId);
            SourceControlConfigurationClient.Models.FluxConfigurationPatch fluxConfigurationPatch = new SourceControlConfigurationClient.Models.FluxConfigurationPatch()
            {
                Suspend = true,
                GitRepository = new SourceControlConfigurationClient.Models.GitRepositoryPatchDefinition()
                {
                    Url = "https://github.com/jonathan-innis/flux2-kustomize-helm-example.git",
                },
                Kustomizations = new Dictionary<string, SourceControlConfigurationClient.Models.KustomizationPatchDefinition>()
                {
                    ["srs-kustomization1"] = new SourceControlConfigurationClient.Models.KustomizationPatchDefinition(),
                    ["srs-kustomization2"] = new SourceControlConfigurationClient.Models.KustomizationPatchDefinition()
                    {
                        Path = "./test/alt-path",
                    ...
                    ["srs-kustomization3"] = new SourceControlConfigurationClient.Models.KustomizationPatchDefinition()
                    {
