...
namespace SearchManagementClient.Models
{
    ...
    public partial class SharedPrivateLinkResourceProperties
    {
        ...
        internal SharedPrivateLinkResourceProperties(string privateLinkResourceId, string groupId, string requestMessage, string resourceRegion, SharedPrivateLinkResourceStatus? status, SharedPrivateLinkResourceProvisioningState? provisioningState)
        {
