...
namespace SourceControlConfigurationClient.Tests.Mock
{
    ...
    public partial class ExtensionMockTests : MockTestBase
    {
        ...
        public async Task Get()
        {
            ...
            var extensionId = SourceControlConfigurationClient.Extension.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "rg1", "Microsoft.Kubernetes", "connectedClusters", "clusterName1", "ClusterMonitor");
        ...
        public async Task Update()
        {
            ...
            var extensionId = SourceControlConfigurationClient.Extension.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "rg1", "Microsoft.Kubernetes", "connectedClusters", "clusterName1", "ClusterMonitor");
            var extension = GetArmClient().GetExtension(extensionId);
            SourceControlConfigurationClient.Models.PatchExtension patchExtension = new SourceControlConfigurationClient.Models.PatchExtension()
            {
