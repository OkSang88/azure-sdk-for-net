...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class ProcessEntity : EntityData
    {
        ...
        internal ProcessEntity(ResourceIdentifier id, string name, ResourceType type, SystemData systemData, EntityKind kind, IReadOnlyDictionary<string, object> additionalData, string friendlyName, string accountEntityId, string commandLine, DateTimeOffset? creationTimeUtc, ElevationToken? elevationToken, string hostEntityId, string hostLogonSessionEntityId, string imageFileEntityId, string parentProcessEntityId, string processId) : base(id, name, type, systemData, kind)
        {
