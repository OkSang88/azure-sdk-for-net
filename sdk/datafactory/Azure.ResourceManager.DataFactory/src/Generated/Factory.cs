...
namespace Azure.ResourceManager.DataFactory
{
    ...
    public partial class Factory : ArmResource
    {
        ...
        internal Factory(ArmResource options, FactoryData data) : base(options, data.Id)
        {
            ...
            _exposureControlRestClient = new ExposureControlRestOperations(_clientDiagnostics, Pipeline, ClientOptions, BaseUri);
            _pipelineRunsRestClient = new PipelineRunsRestOperations(_clientDiagnostics, Pipeline, ClientOptions, BaseUri);
            _activityRunsRestClient = new ActivityRunsRestOperations(_clientDiagnostics, Pipeline, ClientOptions, BaseUri);
            ...
            _dataFlowDebugSessionRestClient = new DataFlowDebugSessionRestOperations(_clientDiagnostics, Pipeline, ClientOptions, BaseUri);
        ...
        public async virtual Task<DataFlowDebugSessionCreateOperation> CreateDataFlowDebugSessionAsync(bool waitForCompletion, CreateDataFlowDebugSessionRequest request, CancellationToken cancellationToken = default)
        {
            if (request == null)
            {
            ...
            try
            {
                ...
                var operation = new DataFlowDebugSessionCreateOperation(_clientDiagnostics, Pipeline, _dataFlowDebugSessionRestClient.CreateCreateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, request).Request, response);
                if (waitForCompletion)
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="request"/> is null. </exception>
        public virtual DataFlowDebugSessionCreateOperation CreateDataFlowDebugSession(bool waitForCompletion, CreateDataFlowDebugSessionRequest request, CancellationToken cancellationToken = default)
        {
            if (request == null)
            {
                throw new ArgumentNullException(nameof(request));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="request"/> is null. </exception>
        public async virtual Task<DataFlowDebugSessionExecuteCommandOperation> ExecuteCommandDataFlowDebugSessionAsync(bool waitForCompletion, DataFlowDebugCommandRequest request, CancellationToken cancellationToken = default)
        {
            if (request == null)
            {
                throw new ArgumentNullException(nameof(request));
            ...
            try
            {
                ...
                var operation = new DataFlowDebugSessionExecuteCommandOperation(_clientDiagnostics, Pipeline, _dataFlowDebugSessionRestClient.CreateExecuteCommandRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, request).Request, response);
                if (waitForCompletion)
                    await operation.WaitForCompletionAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="request"/> is null. </exception>
        public virtual DataFlowDebugSessionExecuteCommandOperation ExecuteCommandDataFlowDebugSession(bool waitForCompletion, DataFlowDebugCommandRequest request, CancellationToken cancellationToken = default)
        {
            if (request == null)
            {
                throw new ArgumentNullException(nameof(request));
