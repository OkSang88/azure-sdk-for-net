...
{
    public partial class MLBehaviorAnalyticsAlertRule : IUtf8JsonSerializable
    {
        ...
        internal static MLBehaviorAnalyticsAlertRule DeserializeMLBehaviorAnalyticsAlertRule(JsonElement element)
        {
            ...
            return new MLBehaviorAnalyticsAlertRule(id, name, type, systemData, etag.Value, kind, alertRuleTemplateName.Value, description.Value, displayName.Value, Optional.ToNullable(enabled), Optional.ToNullable(lastModifiedUtc), Optional.ToNullable(severity), Optional.ToList(tactics));
        }
    }
}
