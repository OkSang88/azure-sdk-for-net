...
namespace Azure.ResourceManager.Sql.Tests.Mock
{
    ...
    public partial class ServerSecurityAlertPolicyMockTests : MockTestBase
    {
        ...
        public async Task Get()
        {
            ...
            var serverSecurityAlertPolicyId = Sql.ServerSecurityAlertPolicy.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "securityalert-4799", "securityalert-6440", "Default");
            var serverSecurityAlertPolicy = GetArmClient().GetServerSecurityAlertPolicy(serverSecurityAlertPolicyId);
