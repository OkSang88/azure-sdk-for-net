...
namespace AppPlatformManagementClient.Models
{
    ...
    public partial class ServiceUpdateOperation : Operation<ServiceResource>, IOperationSource<ServiceResource>
    {
        ...
        internal ServiceUpdateOperation(ArmResource operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<ServiceResource>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.AzureAsyncOperation, "ServiceUpdateOperation");
