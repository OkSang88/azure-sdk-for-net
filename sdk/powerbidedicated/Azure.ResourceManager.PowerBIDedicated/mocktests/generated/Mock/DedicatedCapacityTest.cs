...
namespace PowerBIDedicated.Tests.Mock
{
    ...
    public partial class DedicatedCapacityMockTests : MockTestBase
    {
        ...
        public async Task Get()
        {
            ...
            var dedicatedCapacityId = PowerBIDedicated.DedicatedCapacity.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "TestRG", "azsdktest");
        ...
        public async Task Update()
        {
            ...
            var dedicatedCapacityId = PowerBIDedicated.DedicatedCapacity.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "TestRG", "azsdktest");
            var dedicatedCapacity = GetArmClient().GetDedicatedCapacity(dedicatedCapacityId);
            PowerBIDedicated.Models.DedicatedCapacityUpdateParameters capacityUpdateParameters = new PowerBIDedicated.Models.DedicatedCapacityUpdateParameters()
            {
                Sku = new PowerBIDedicated.Models.CapacitySku(name: "A1")
                {
        ...
        public async Task Update2()
        {
            ...
            PowerBIDedicated.Models.DedicatedCapacityUpdateParameters capacityUpdateParameters = new PowerBIDedicated.Models.DedicatedCapacityUpdateParameters()
            {
                ...
                Mode = new PowerBIDedicated.Models.Mode("Gen2"),
            };
