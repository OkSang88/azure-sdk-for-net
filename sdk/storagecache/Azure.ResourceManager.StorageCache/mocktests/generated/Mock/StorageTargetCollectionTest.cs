...
namespace StorageCacheManagementClient.Tests.Mock
{
    ...
    public partial class StorageTargetCollectionMockTests : MockTestBase
    {
        ...
        public async Task CreateOrUpdate()
        {
            ...
            StorageCacheManagementClient.StorageTargetData storagetarget = new StorageCacheManagementClient.StorageTargetData()
            {
                TargetType = new StorageCacheManagementClient.Models.StorageTargetType("nfs3"),
                Nfs3 = new StorageCacheManagementClient.Models.Nfs3Target()
                {
                    Target = "10.0.44.44",
        ...
        public async Task CreateOrUpdate2()
        {
            ...
            StorageCacheManagementClient.StorageTargetData storagetarget = new StorageCacheManagementClient.StorageTargetData()
            {
                TargetType = new StorageCacheManagementClient.Models.StorageTargetType("blobNfs"),
                BlobNfs = new StorageCacheManagementClient.Models.BlobNfsTarget()
                {
