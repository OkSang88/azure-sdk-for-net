...
namespace Azure.ResourceManager.MachineLearning
{
    public partial class Sample_MachineLearningScheduleResource
    {
        ...
        {
            // Generated from example definition: specification/machinelearningservices/resource-manager/Microsoft.MachineLearningServices/stable/2022-10-01/examples/Schedule/delete.json
        ...
        {
            // Generated from example definition: specification/machinelearningservices/resource-manager/Microsoft.MachineLearningServices/stable/2022-10-01/examples/Schedule/get.json
        ...
        public async Task Update_CreateOrUpdateSchedule()
        {
            ...
            // invoke the operation
            MachineLearningScheduleData data = new MachineLearningScheduleData(new MachineLearningScheduleProperties(new MachineLearningScheduleAction()
            {
                ActionType = ScheduleActionType.InvokeBatchEndpoint,
            }, new MachineLearningTriggerBase()
            {
                EndTime = "string",
                StartTime = "string",
                TimeZone = "string",
