...
namespace AppPlatformManagementClient.Models
{
    ...
    public partial class MonitoringSettingUpdatePatchOperation : Operation<MonitoringSettingResource>, IOperationSource<MonitoringSettingResource>
    {
        private readonly OperationInternals<MonitoringSettingResource> _operation;

        private readonly ArmResource _operationBase;

        /// <summary> Initializes a new instance of MonitoringSettingUpdatePatchOperation for mocking. </summary>
        protected MonitoringSettingUpdatePatchOperation()
        {
        }

        internal MonitoringSettingUpdatePatchOperation(ArmResource operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<MonitoringSettingResource>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.AzureAsyncOperation, "MonitoringSettingUpdatePatchOperation");
