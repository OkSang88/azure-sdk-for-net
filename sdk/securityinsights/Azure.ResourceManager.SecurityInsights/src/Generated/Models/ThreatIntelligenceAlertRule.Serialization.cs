...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    public partial class ThreatIntelligenceAlertRule : IUtf8JsonSerializable
    {
        ...
        internal static ThreatIntelligenceAlertRule DeserializeThreatIntelligenceAlertRule(JsonElement element)
        {
            ...
            return new ThreatIntelligenceAlertRule(id, name, type, systemData, etag.Value, kind, alertRuleTemplateName.Value, description.Value, displayName.Value, Optional.ToNullable(enabled), Optional.ToNullable(lastModifiedUtc), Optional.ToNullable(severity), Optional.ToList(tactics));
        }
    }
}
