...
namespace DataFactoryManagementClient.Models
{
    ...
    public partial class AzureDatabricksDeltaLakeSink : CopySink
    {
        ...
        internal AzureDatabricksDeltaLakeSink(string type, object writeBatchSize, object writeBatchTimeout, object sinkRetryCount, object sinkRetryWait, object maxConcurrentConnections, object disableMetricsCollection, IDictionary<string, object> additionalProperties, object preCopyScript, AzureDatabricksDeltaLakeImportCommand importSettings) : base(type, writeBatchSize, writeBatchTimeout, sinkRetryCount, sinkRetryWait, maxConcurrentConnections, disableMetricsCollection, additionalProperties)
        {
