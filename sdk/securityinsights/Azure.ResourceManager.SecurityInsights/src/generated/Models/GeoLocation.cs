...
namespace SecurityInsights.Models
{
    ...
    {
        /// <summary> Initializes a new instance of GeoLocation. </summary>
        ...
        internal GeoLocation(int? asn, string city, string countryCode, string countryName, double? latitude, double? longitude, string state)
        {
            Asn = asn;
            City = city;
