...
namespace Azure.ResourceManager.Network.Tests.Mock
{
    ...
    public partial class VpnConnectionCollectionMockTests : MockTestBase
    {
        ...
        public async Task CreateOrUpdateAsync()
        {
            ...
            var collection = GetArmClient().GetVpnGateway(new ResourceIdentifier("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.Network/vpnGateways/gateway1")).GetVpnConnections();
