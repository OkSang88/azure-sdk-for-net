...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class OracleCloudStorageLocation : DatasetLocation
    {
        ...
        internal OracleCloudStorageLocation(string type, object folderPath, object fileName, IDictionary<string, object> additionalProperties, object bucketName, object version) : base(type, folderPath, fileName, additionalProperties)
        {
            BucketName = bucketName;
            Version = version;
            Type = type ?? "OracleCloudStorageLocation";
        }
