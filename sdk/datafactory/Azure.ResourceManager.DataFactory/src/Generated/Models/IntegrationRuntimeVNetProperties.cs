...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class IntegrationRuntimeVNetProperties
    {
        ...
        internal IntegrationRuntimeVNetProperties(string vNetId, string subnet, IList<string> publicIPs, string subnetId, IDictionary<string, object> additionalProperties)
        {
            VNetId = vNetId;
            Subnet = subnet;
            PublicIPs = publicIPs;
