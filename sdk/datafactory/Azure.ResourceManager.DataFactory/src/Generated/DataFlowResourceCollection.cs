...
namespace Azure.ResourceManager.DataFactory
{
    ...
    public partial class DataFlowResourceCollection : ArmCollection, IEnumerable<DataFlowResource>, IAsyncEnumerable<DataFlowResource>
    {
        ...
        internal DataFlowResourceCollection(ArmResource parent) : base(parent)
        {
            ...
            ClientOptions.TryGetApiVersion(DataFlowResource.ResourceType, out string apiVersion);
        ...
        public virtual DataFlowResourceCreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, string dataFlowName, DataFlowResourceData dataFlow, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new DataFlowResourceCreateOrUpdateOperation(this, response);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="dataFlowName"/> or <paramref name="dataFlow"/> is null. </exception>
        public async virtual Task<DataFlowResourceCreateOrUpdateOperation> CreateOrUpdateAsync(bool waitForCompletion, string dataFlowName, DataFlowResourceData dataFlow, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            if (dataFlowName == null)
            {
                throw new ArgumentNullException(nameof(dataFlowName));
        ...
        public virtual Pageable<DataFlowResource> GetAll(CancellationToken cancellationToken = default)
        {
            Page<DataFlowResource> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    ...
                    return Page.FromValues(response.Value.Value.Select(value => new DataFlowResource(this, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
