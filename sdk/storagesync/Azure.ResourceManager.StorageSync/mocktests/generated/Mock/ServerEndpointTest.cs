...
namespace Azure.ResourceManager.StorageSync.Tests.Mock.Tests.Mock
{
    ...
    public partial class ServerEndpointMockTests : MockTestBase
    {
        ...
        public async Task Get()
        {
            ...
            var serverEndpointId = StorageSync.Tests.Mock.ServerEndpoint.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "SampleResourceGroup_1", "SampleStorageSyncService_1", "SampleSyncGroup_1", "SampleServerEndpoint_1");
        ...
        public async Task Update()
        {
            ...
            var serverEndpointId = StorageSync.Tests.Mock.ServerEndpoint.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "SampleResourceGroup_1", "SampleStorageSyncService_1", "SampleSyncGroup_1", "SampleServerEndpoint_1");
            var serverEndpoint = GetArmClient().GetServerEndpoint(serverEndpointId);
            StorageSync.Tests.Mock.Models.ServerEndpointUpdateParameters parameters = new StorageSync.Tests.Mock.Models.ServerEndpointUpdateParameters()
            {
                CloudTiering = new StorageSync.Tests.Mock.Models.FeatureStatus("off"),
                VolumeFreeSpacePercent = 100,
                TierFilesOlderThanDays = 0,
                OfflineDataTransfer = new StorageSync.Tests.Mock.Models.FeatureStatus("off"),
        ...
        public async Task RecallAction()
        {
            ...
            var serverEndpointId = StorageSync.Tests.Mock.ServerEndpoint.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "SampleResourceGroup_1", "SampleStorageSyncService_1", "SampleSyncGroup_1", "SampleServerEndpoint_1");
            var serverEndpoint = GetArmClient().GetServerEndpoint(serverEndpointId);
            StorageSync.Tests.Mock.Models.RecallActionParameters parameters = new StorageSync.Tests.Mock.Models.RecallActionParameters()
            {
                Pattern = "",
                RecallPath = "",
            };
