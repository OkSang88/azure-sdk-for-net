# Azure RedisEnterpriseCache Management client library for .NET
...
Install the Azure RedisEnterpriseCache management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.RedisEnterpriseCache -Version 1.0.0-preview.1 
```
