...
namespace Azure.ResourceManager.CosmosDB.Tests.Mock
{
    ...
    public partial class PrivateLinkResourceCollectionMockTests : MockTestBase
    {
        ...
        public async Task GetAsync()
        {
            ...
            var collection = GetArmClient().GetDatabaseAccount(new ResourceIdentifier("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.DocumentDB/databaseAccounts/ddb1")).GetPrivateLinkResources();
