...
namespace Azure.ResourceManager.OperationalInsights.Models
{
    ...
    {
        /// <summary> Initializes a new instance of SearchSchemaValue. </summary>
        ...
        internal SearchSchemaValue(bool indexed, bool stored, bool facet)
        {
            Indexed = indexed;
            Stored = stored;
            Facet = facet;
        ...
        internal SearchSchemaValue(string name, string displayName, string type, bool indexed, bool stored, bool facet, IReadOnlyList<string> ownerType)
        {
            Name = name;
