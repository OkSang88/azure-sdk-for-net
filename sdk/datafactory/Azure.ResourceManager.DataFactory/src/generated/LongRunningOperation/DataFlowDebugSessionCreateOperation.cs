...
namespace DataFactoryManagementClient.Models
{
    ...
    public partial class DataFlowDebugSessionCreateOperation : Operation<CreateDataFlowDebugSessionResponse>, IOperationSource<CreateDataFlowDebugSessionResponse>
    {
        private readonly OperationInternals<CreateDataFlowDebugSessionResponse> _operation;

        /// <summary> Initializes a new instance of DataFlowDebugSessionCreateOperation for mocking. </summary>
        protected DataFlowDebugSessionCreateOperation()
        {
        }

        internal DataFlowDebugSessionCreateOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<CreateDataFlowDebugSessionResponse>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "DataFlowDebugSessionCreateOperation");
        }
