...
namespace Azure.ResourceManager.ServiceFabric.Tests.Mock
{
    ...
    public partial class ServiceResourceMockTests : MockTestBase
    {
        ...
        public async Task Get()
        {
            ...
            var serviceResourceId = ServiceFabric.ServiceResource.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "resRg", "myCluster", "myApp", "myService");
        ...
        public async Task Update()
        {
            ...
            var serviceResourceId = ServiceFabric.ServiceResource.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "resRg", "myCluster", "myApp", "myService");
            var serviceResource = GetArmClient().GetServiceResource(serviceResourceId);
            ServiceFabric.Models.ServiceResourceUpdate parameters = new ServiceFabric.Models.ServiceResourceUpdate(location: AzureLocation.WestUS)
            {
