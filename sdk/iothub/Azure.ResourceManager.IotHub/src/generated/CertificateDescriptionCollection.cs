...
namespace IotHubClient
{
    ...
    public partial class CertificateDescriptionCollection : ArmCollection, IEnumerable<CertificateDescription>, IAsyncEnumerable<CertificateDescription>
    {
        ...
        public virtual CertificateCreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, string certificateName, CertificateDescriptionData certificateDescription, string ifMatch = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="certificateName"/> or <paramref name="certificateDescription"/> is null. </exception>
        public async virtual Task<CertificateCreateOrUpdateOperation> CreateOrUpdateAsync(bool waitForCompletion, string certificateName, CertificateDescriptionData certificateDescription, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            if (certificateName == null)
            {
                throw new ArgumentNullException(nameof(certificateName));
        ...
        public virtual Response<CertificateDescription> Get(string certificateName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new CertificateDescription(Parent, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual Pageable<CertificateDescription> GetAll(CancellationToken cancellationToken = default)
        {
            Page<CertificateDescription> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    ...
                    return Page.FromValues(response.Value.Value.Select(value => new CertificateDescription(Parent, value)), null, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
