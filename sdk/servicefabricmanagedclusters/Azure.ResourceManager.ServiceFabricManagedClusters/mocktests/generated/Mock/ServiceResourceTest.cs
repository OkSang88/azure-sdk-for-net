...
namespace ServiceFabricManagedClustersManagementClient.Tests.Mock
{
    ...
    public partial class ServiceResourceMockTests : MockTestBase
    {
        ...
        public async Task Get()
        {
            ...
            var serviceResourceId = ServiceFabricManagedClustersManagementClient.ServiceResource.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "resRg", "myCluster", "myApp", "myService");
        ...
        public async Task Update()
        {
            ...
            var serviceResourceId = ServiceFabricManagedClustersManagementClient.ServiceResource.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "resRg", "myCluster", "myApp", "myService");
            var serviceResource = GetArmClient().GetServiceResource(serviceResourceId);
            ServiceFabricManagedClustersManagementClient.Models.ServiceUpdateParameters parameters = new ServiceFabricManagedClustersManagementClient.Models.ServiceUpdateParameters();
