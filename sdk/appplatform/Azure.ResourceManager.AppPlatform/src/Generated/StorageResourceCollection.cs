...
namespace Azure.ResourceManager.AppPlatform
{
    ...
    public partial class StorageResourceCollection : ArmCollection, IEnumerable<StorageResource>, IAsyncEnumerable<StorageResource>
    {
        ...
        internal StorageResourceCollection(ArmResource parent) : base(parent)
        {
            ...
            ClientOptions.TryGetApiVersion(StorageResource.ResourceType, out string apiVersion);
        ...
        public virtual StorageResourceCreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, string storageName, StorageResourceData storageResource, CancellationToken cancellationToken = default)
        {
            if (storageName == null)
            {
            ...
            try
            {
                ...
                var operation = new StorageResourceCreateOrUpdateOperation(this, _clientDiagnostics, Pipeline, _storagesRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, storageName, storageResource).Request, response);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="storageName"/> or <paramref name="storageResource"/> is null. </exception>
        public async virtual Task<StorageResourceCreateOrUpdateOperation> CreateOrUpdateAsync(bool waitForCompletion, string storageName, StorageResourceData storageResource, CancellationToken cancellationToken = default)
        {
            if (storageName == null)
            {
                throw new ArgumentNullException(nameof(storageName));
        ...
        public virtual Response<StorageResource> GetIfExists(string storageName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                if (response.Value == null)
                    return Response.FromValue<StorageResource>(null, response.GetRawResponse());
                return Response.FromValue(new StorageResource(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual Response<bool> Exists(string storageName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("StorageResourceCollection.Exists");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="storageName"/> is null. </exception>
        public async virtual Task<Response<bool>> ExistsAsync(string storageName, CancellationToken cancellationToken = default)
        {
            if (storageName == null)
            {
                throw new ArgumentNullException(nameof(storageName));
        ...
        public virtual Pageable<StorageResource> GetAll(CancellationToken cancellationToken = default)
        {
            Page<StorageResource> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    ...
                    return Page.FromValues(response.Value.Value.Select(value => new StorageResource(this, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
        ...
        // Builders.
        // public ArmBuilder<Azure.Core.ResourceIdentifier, StorageResource, StorageResourceData> Construct() { }
    }
}
