...
namespace ServiceFabricManagedClustersManagementClient.Models
{
    ...
    public partial class LoadBalancingRule
    {
        ...
        public LoadBalancingRule(int frontendPort, int backendPort, Protocol protocol, ProbeProtocol probeProtocol)
        {
        ...
        internal LoadBalancingRule(int frontendPort, int backendPort, Protocol protocol, int? probePort, ProbeProtocol probeProtocol, string probeRequestPath)
        {
            FrontendPort = frontendPort;
            BackendPort = backendPort;
            Protocol = protocol;
