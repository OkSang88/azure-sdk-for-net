...
namespace SourceControlConfigurationClient.Models
{
    ...
    {
        /// <summary> Initializes a new instance of GitRepositoryDefinition. </summary>
        public GitRepositoryDefinition()
        {
        }

        /// <summary> Initializes a new instance of GitRepositoryDefinition. </summary>
        /// <param name="url"> The URL to sync for the flux configuration git repository. </param>
        ...
        internal GitRepositoryDefinition(string url, long? timeoutInSeconds, long? syncIntervalInSeconds, RepositoryRefDefinition repositoryRef, string sshKnownHosts, string httpsUser, string httpsCACert, string localAuthRef)
        {
            Url = url;
