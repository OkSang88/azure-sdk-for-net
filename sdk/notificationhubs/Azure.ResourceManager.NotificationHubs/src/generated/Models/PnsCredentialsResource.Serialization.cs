...
{
    public partial class PnsCredentialsResource : IUtf8JsonSerializable
    {
        ...
        internal static PnsCredentialsResource DeserializePnsCredentialsResource(JsonElement element)
        {
            ...
            return new PnsCredentialsResource(id, name, type, tags, location, sku.Value, apnsCredential.Value, wnsCredential.Value, gcmCredential.Value, mpnsCredential.Value, admCredential.Value, baiduCredential.Value);
        }
    }
}
