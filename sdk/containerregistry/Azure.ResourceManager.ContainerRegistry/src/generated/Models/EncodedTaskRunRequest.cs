...
namespace ContainerRegistryManagementClient.Models
{
    ...
    public partial class EncodedTaskRunRequest : RunRequest
    {
        ...
        internal EncodedTaskRunRequest(string type, bool? isArchiveEnabled, string agentPoolName, string logTemplate, string encodedTaskContent, string encodedValuesContent, IList<SetValue> values, int? timeout, PlatformProperties platform, AgentProperties agentConfiguration, string sourceLocation, Credentials credentials) : base(type, isArchiveEnabled, agentPoolName, logTemplate)
        {
            EncodedTaskContent = encodedTaskContent;
