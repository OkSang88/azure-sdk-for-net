    ...
    public partial class ClusterCollection : ArmCollection, IEnumerable<Cluster>, IAsyncEnumerable<Cluster>
    {
        ...
        public virtual ClusterCreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, string clusterName, ClusterData parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ClusterCreateOrUpdateOperation(Parent, _clientDiagnostics, Pipeline, _clustersRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, clusterName, parameters).Request, response);
        ...
        public virtual Pageable<Cluster> GetAll(CancellationToken cancellationToken = default)
        {
            Page<Cluster> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    ...
                    return Page.FromValues(response.Value.Value.Select(value => new Cluster(Parent, value)), null, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
