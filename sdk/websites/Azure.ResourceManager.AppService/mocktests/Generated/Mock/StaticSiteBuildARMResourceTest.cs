...
namespace Azure.ResourceManager.AppService.Tests.Mock
{
    ...
    public partial class StaticSiteBuildARMResourceMockTests : MockTestBase
    {
        ...
        [RecordedTest]
        public async Task CreateOrUpdateStaticSiteBuildAppSettings()
        {
        ...
        [RecordedTest]
        public async Task CreateOrUpdateStaticSiteBuildFunctionAppSettings()
        {
            // Example: Creates or updates the function app settings of a static site build.
            var staticSiteBuildARMResourceId = AppService.StaticSiteBuildARMResource.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "rg", "testStaticSite0", "12");
            var staticSiteBuildARMResource = GetArmClient().GetStaticSiteBuildARMResource(staticSiteBuildARMResourceId);
        ...
        [RecordedTest]
        public async Task GetStaticSiteBuildFunctions()
        {
            ...
            await foreach (var _ in staticSiteBuildARMResource.GetStaticSiteBuildFunctionsAsync())
            {
            }
        }

        [RecordedTest]
        public async Task GetStaticSiteBuildAppSettings()
        {
        ...
        [RecordedTest]
        public async Task GetStaticSiteBuildFunctionAppSettings()
        {
        ...
        [RecordedTest]
        public async Task CreateZipDeploymentForStaticSiteBuild()
        {
