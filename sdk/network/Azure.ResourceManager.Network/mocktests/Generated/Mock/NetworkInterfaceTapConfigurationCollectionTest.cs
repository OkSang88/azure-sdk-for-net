...
namespace Azure.ResourceManager.Network.Tests.Mock
{
    ...
    public partial class NetworkInterfaceTapConfigurationCollectionMockTests : MockTestBase
    {
        ...
        public async Task CreateOrUpdateAsync()
        {
            ...
            var collection = GetArmClient().GetNetworkInterface(new ResourceIdentifier("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/testrg/providers/Microsoft.Network/networkInterfaces/mynic")).GetNetworkInterfaceTapConfigurations();
        ...
        public void GetAllAsync()
        {
            ...
            var collection = GetArmClient().GetNetworkInterface(new ResourceIdentifier("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.Network/networkInterfaces/mynic")).GetNetworkInterfaceTapConfigurations();
