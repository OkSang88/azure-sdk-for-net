...
namespace AppPlatformManagementClient.Models
{
    ...
    public partial class BindingUpdateOperation : Operation<BindingResource>, IOperationSource<BindingResource>
    {
        private readonly OperationInternals<BindingResource> _operation;

        private readonly ArmResource _operationBase;

        /// <summary> Initializes a new instance of BindingUpdateOperation for mocking. </summary>
        protected BindingUpdateOperation()
        {
        }

        internal BindingUpdateOperation(ArmResource operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<BindingResource>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.AzureAsyncOperation, "BindingUpdateOperation");
