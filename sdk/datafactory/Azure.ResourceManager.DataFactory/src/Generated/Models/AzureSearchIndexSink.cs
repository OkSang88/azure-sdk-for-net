...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AzureSearchIndexSink : CopySink
    {
        ...
        internal AzureSearchIndexSink(string type, object writeBatchSize, object writeBatchTimeout, object sinkRetryCount, object sinkRetryWait, object maxConcurrentConnections, object disableMetricsCollection, IDictionary<string, object> additionalProperties, AzureSearchIndexWriteBehaviorType? writeBehavior) : base(type, writeBatchSize, writeBatchTimeout, sinkRetryCount, sinkRetryWait, maxConcurrentConnections, disableMetricsCollection, additionalProperties)
        {
