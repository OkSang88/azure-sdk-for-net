...
namespace Azure.ResourceManager.ChangeAnalysis
{
    ...
    {
        private static ResourceChangesRestOperations GetResourceChangesRestOperations(ClientDiagnostics clientDiagnostics, TokenCredential credential, ArmClientOptions clientOptions, HttpPipeline pipeline, Uri endpoint = null)
        {
            return new ResourceChangesRestOperations(clientDiagnostics, pipeline, clientOptions, endpoint);
        }
        ...
        public static AsyncPageable<Change> GetResourceChangesAsync(this Tenant tenant, string resourceId, DateTimeOffset startTime, DateTimeOffset endTime, string skipToken = null, CancellationToken cancellationToken = default)
        {
            ...
            return tenant.UseClientContext((baseUri, credential, options, pipeline) =>
            {
                ...
                var restOperations = GetResourceChangesRestOperations(clientDiagnostics, credential, options, pipeline, baseUri);
