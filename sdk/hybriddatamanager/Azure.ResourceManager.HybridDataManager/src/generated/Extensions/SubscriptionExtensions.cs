...
namespace HybridDataManagementClient
{
    ...
    {
        private static DataManagersRestOperations GetDataManagersRestOperations(ClientDiagnostics clientDiagnostics, TokenCredential credential, ArmClientOptions clientOptions, HttpPipeline pipeline, Uri endpoint = null)
        {
            return new DataManagersRestOperations(clientDiagnostics, pipeline, clientOptions, endpoint);
        }
        ...
        public static AsyncPageable<DataManager> GetDataManagersAsync(this Subscription subscription, CancellationToken cancellationToken = default)
        {
            return subscription.UseClientContext((baseUri, credential, options, pipeline) =>
            {
                ...
                var restOperations = GetDataManagersRestOperations(clientDiagnostics, credential, options, pipeline, baseUri);
