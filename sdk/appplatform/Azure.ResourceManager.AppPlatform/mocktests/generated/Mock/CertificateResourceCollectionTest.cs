...
namespace AppPlatformManagementClient.Tests.Mock
{
    ...
    public partial class CertificateResourceCollectionMockTests : MockTestBase
    {
        ...
        public async Task CreateOrUpdate()
        {
            ...
            AppPlatformManagementClient.CertificateResourceData certificateResource = new AppPlatformManagementClient.CertificateResourceData()
            {
                Properties = new AppPlatformManagementClient.Models.KeyVaultCertificateProperties(vaultUri: "https://myvault.vault.azure.net", keyVaultCertName: "mycert")
                {
