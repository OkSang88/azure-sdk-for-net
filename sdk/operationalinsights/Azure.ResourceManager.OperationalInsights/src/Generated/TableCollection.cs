...
namespace Azure.ResourceManager.OperationalInsights
{
    ...
    public partial class TableCollection : ArmCollection, IEnumerable<Table>, IAsyncEnumerable<Table>
    {
        ...
        internal TableCollection(ArmResource parent) : base(parent)
        {
            ...
            _tablesRestClient = new TablesRestOperations(_clientDiagnostics, Pipeline, ClientOptions, BaseUri, apiVersion);
#if DEBUG
        ...
        public virtual TableCreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, string tableName, TableData parameters, CancellationToken cancellationToken = default)
        {
            if (tableName == null)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="tableName"/> or <paramref name="parameters"/> is null. </exception>
        public async virtual Task<TableCreateOrUpdateOperation> CreateOrUpdateAsync(bool waitForCompletion, string tableName, TableData parameters, CancellationToken cancellationToken = default)
        {
            if (tableName == null)
            {
                throw new ArgumentNullException(nameof(tableName));
        ...
        public virtual Pageable<Table> GetAll(CancellationToken cancellationToken = default)
        {
            Page<Table> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    ...
                    return Page.FromValues(response.Value.Value.Select(value => new Table(this, value)), null, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
