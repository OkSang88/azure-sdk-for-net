# Azure CustomerInsights Management client library for .NET
...
Install the Azure CustomerInsights management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.CustomerInsights -Version 1.0.0-preview.1 
```
