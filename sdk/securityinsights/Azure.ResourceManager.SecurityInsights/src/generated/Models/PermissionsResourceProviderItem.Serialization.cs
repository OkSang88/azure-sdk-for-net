...
{
    public partial class PermissionsResourceProviderItem : IUtf8JsonSerializable
    {
        ...
        internal static PermissionsResourceProviderItem DeserializePermissionsResourceProviderItem(JsonElement element)
        {
            ...
            return new PermissionsResourceProviderItem(Optional.ToNullable(provider), permissionsDisplayText.Value, providerDisplayName.Value, Optional.ToNullable(scope), requiredPermissions.Value);
        }
    }
}
