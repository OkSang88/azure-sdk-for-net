...
namespace SearchManagementClient.Models
{
    public partial class CheckNameAvailabilityOutput
    {
        internal static CheckNameAvailabilityOutput DeserializeCheckNameAvailabilityOutput(JsonElement element)
        {
            ...
            Optional<UnavailableNameReason> reason = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("reason"))
                {
                    ...
                    reason = new UnavailableNameReason(property.Value.GetString());
                    continue;
                }
            ...
            return new CheckNameAvailabilityOutput(Optional.ToNullable(nameAvailable), Optional.ToNullable(reason), message.Value);
        }
    }
}
