...
namespace Azure.ResourceManager.HybridDataManager
{
    internal partial class DataServicesRestOperations
    {
        ...
        public DataServicesRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, Uri endpoint = null, string apiVersion = default)
        {
