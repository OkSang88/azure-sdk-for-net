...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class SsisPackage : SsisObjectMetadata
    {
        ...
        internal SsisPackage()
        {
            ...
            Type = SsisObjectMetadataType.Package;
        }
        ...
        internal SsisPackage(SsisObjectMetadataType type, long? id, string name, string description, long? folderId, long? projectVersion, long? projectId, IReadOnlyList<SsisParameter> parameters) : base(type, id, name, description)
        {
            FolderId = folderId;
