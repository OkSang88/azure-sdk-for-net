...
namespace Azure.ResourceManager.FrontDoor.Models
{
    public partial class ManagedRuleSetDefinition : IUtf8JsonSerializable
    {
        ...
        internal static ManagedRuleSetDefinition DeserializeManagedRuleSetDefinition(JsonElement element)
        {
            ...
            return new ManagedRuleSetDefinition(id, name, type, tags, location, provisioningState.Value, ruleSetId.Value, ruleSetType.Value, ruleSetVersion.Value, Optional.ToList(ruleGroups));
        }
    }
}
