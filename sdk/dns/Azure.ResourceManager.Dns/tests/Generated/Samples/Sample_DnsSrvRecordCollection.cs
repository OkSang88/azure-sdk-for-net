...
{
    public partial class Sample_DnsSrvRecordCollection
    {
        // Create A recordset
        ...
        public async Task CreateOrUpdate_CreateARecordset()
        {
            ...
            // get the collection of this DnsSrvRecordResource
            DnsSrvRecordCollection collection = dnsZone.GetDnsSrvRecords();
...
IPv4Address = "127.0.0.1",
            ...
            ArmOperation<DnsSrvRecordResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, relativeRecordSetName, data);
            DnsSrvRecordResource result = lro.Value;
...
"string1","string2"
        ...
        public async Task Get_GetARecordset()
        {
            ...
            // invoke the operation
            string relativeRecordSetName = "record1";
            DnsSrvRecordResource result = await collection.GetAsync(relativeRecordSetName);
        ...
        public async Task GetAll_ListARecordsets()
        {
            ...
            await foreach (DnsSrvRecordResource item in collection.GetAllAsync())
            {
