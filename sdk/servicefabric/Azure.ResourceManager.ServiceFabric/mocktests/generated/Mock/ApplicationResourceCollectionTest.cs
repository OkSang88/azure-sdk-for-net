...
namespace Azure.ResourceManager.ServiceFabric.Tests.Mock
{
    ...
    public partial class ApplicationResourceCollectionMockTests : MockTestBase
    {
        ...
        public async Task CreateOrUpdate()
        {
            ...
            ServiceFabric.ApplicationResourceData parameters = new ServiceFabric.ApplicationResourceData(location: AzureLocation.WestUS)
            {
                TypeVersion = "1.0",
                UpgradePolicy = new ServiceFabric.Models.ApplicationUpgradePolicy()
                {
                    UpgradeReplicaSetCheckTimeout = "01:00:00",
                    ForceRestart = false,
                    RollingUpgradeMonitoringPolicy = new ServiceFabric.Models.ArmRollingUpgradeMonitoringPolicy()
                    {
                        FailureAction = new ServiceFabric.Models.ArmUpgradeFailureAction("Rollback"),
                    ...
                    ApplicationHealthPolicy = new ServiceFabric.Models.ArmApplicationHealthPolicy()
                    {
                        ConsiderWarningAsError = true,
                        MaxPercentUnhealthyDeployedApplications = 0,
                        DefaultServiceTypeHealthPolicy = new ServiceFabric.Models.ArmServiceTypeHealthPolicy()
                        {
                    ...
                    UpgradeMode = new ServiceFabric.Models.RollingUpgradeMode("Monitored"),
                },
                MinimumNodes = 1,
                MaximumNodes = 3,
        ...
        public async Task CreateOrUpdate2()
        {
            ...
            string applicationName = "myApp";
            ServiceFabric.ApplicationResourceData parameters = new ServiceFabric.ApplicationResourceData(location: "eastus")
            {
                TypeVersion = "1.0",
                RemoveApplicationCapacity = false,
                TypeName = "myAppType",
