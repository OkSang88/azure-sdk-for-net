# Azure OperationalInsights Management client library for .NET
...
Install the Azure OperationalInsights management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.OperationalInsights -Version 1.0.0-preview.1 
```
