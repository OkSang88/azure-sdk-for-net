...
namespace FrontDoorManagementClient
{
    ...
    public partial class ProfileCollection : ArmCollection, IEnumerable<Profile>, IAsyncEnumerable<Profile>
    {
        ...
        public virtual NetworkExperimentProfileCreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, string profileName, ProfileData parameters, CancellationToken cancellationToken = default)
        {
            if (profileName == null)
            {
            ...
            try
            {
                ...
                var operation = new NetworkExperimentProfileCreateOrUpdateOperation(Parent, _clientDiagnostics, Pipeline, _networkExperimentProfilesRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, profileName, parameters).Request, response);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="profileName"/> or <paramref name="parameters"/> is null. </exception>
        public async virtual Task<NetworkExperimentProfileCreateOrUpdateOperation> CreateOrUpdateAsync(bool waitForCompletion, string profileName, ProfileData parameters, CancellationToken cancellationToken = default)
        {
            if (profileName == null)
            {
                throw new ArgumentNullException(nameof(profileName));
