...
namespace Insights
{
    public partial class MetricAlertResourceData : IUtf8JsonSerializable
    {
        ...
        internal static MetricAlertResourceData DeserializeMetricAlertResourceData(JsonElement element)
        {
            ...
            return new MetricAlertResourceData(id, name, type, tags, location, description, severity, enabled, Optional.ToList(scopes), evaluationFrequency, windowSize, targetResourceType.Value, targetResourceRegion.Value, criteria, Optional.ToNullable(autoMitigate), Optional.ToList(actions), Optional.ToNullable(lastUpdatedTime));
        }
    }
}
