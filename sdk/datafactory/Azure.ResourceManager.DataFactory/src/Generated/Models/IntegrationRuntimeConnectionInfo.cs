...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class IntegrationRuntimeConnectionInfo
    {
        ...
        internal IntegrationRuntimeConnectionInfo(string serviceToken, string identityCertThumbprint, string hostServiceUri, string version, string publicKey, bool? isIdentityCertExprired, IReadOnlyDictionary<string, object> additionalProperties)
        {
