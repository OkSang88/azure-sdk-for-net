...
{
    public partial class Sample_PrivateDnsCnameRecordCollection
    {
        ...
        public async Task CreateOrUpdate_PUTPrivateDNSZoneARecordSet()
        {
            ...
            // get the collection of this PrivateDnsCnameRecordResource
            PrivateDnsCnameRecordCollection collection = privateDnsZone.GetPrivateDnsCnameRecords();
...
IPv4Address = "1.2.3.4",
            ...
            ArmOperation<PrivateDnsCnameRecordResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, relativeRecordSetName, data);
            PrivateDnsCnameRecordResource result = lro.Value;
...
"string1","string2"
        ...
        public async Task Get_GETPrivateDNSZoneARecordSet()
        {
            ...
            // invoke the operation
            string relativeRecordSetName = "recordA";
            PrivateDnsCnameRecordResource result = await collection.GetAsync(relativeRecordSetName);
        ...
        public async Task GetAll_GETPrivateDNSZoneARecordSets()
        {
            ...
            await foreach (PrivateDnsCnameRecordResource item in collection.GetAllAsync())
            {
