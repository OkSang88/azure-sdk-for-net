...
namespace Azure.ResourceManager.ContainerRegistry
{
    ...
    public partial class AgentPoolCollection : ArmCollection, IEnumerable<AgentPool>, IAsyncEnumerable<AgentPool>
    {
        ...
        internal AgentPoolCollection(ArmResource parent) : base(parent)
        {
            ...
            ClientOptions.TryGetApiVersion(AgentPool.ResourceType, out string apiVersion);
        ...
        public virtual AgentPoolCreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, string agentPoolName, AgentPoolData agentPool, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new AgentPoolCreateOrUpdateOperation(this, _clientDiagnostics, Pipeline, _agentPoolsRestClient.CreateCreateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, agentPoolName, agentPool).Request, response);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="agentPoolName"/> or <paramref name="agentPool"/> is null. </exception>
        public async virtual Task<AgentPoolCreateOrUpdateOperation> CreateOrUpdateAsync(bool waitForCompletion, string agentPoolName, AgentPoolData agentPool, CancellationToken cancellationToken = default)
        {
            if (agentPoolName == null)
            {
                throw new ArgumentNullException(nameof(agentPoolName));
        ...
        public virtual Pageable<AgentPool> GetAll(CancellationToken cancellationToken = default)
        {
            Page<AgentPool> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    ...
                    return Page.FromValues(response.Value.Value.Select(value => new AgentPool(this, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
