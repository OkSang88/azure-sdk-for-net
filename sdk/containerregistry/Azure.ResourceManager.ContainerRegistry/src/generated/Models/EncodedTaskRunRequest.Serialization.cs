...
{
    public partial class EncodedTaskRunRequest : IUtf8JsonSerializable
    {
        ...
        internal static EncodedTaskRunRequest DeserializeEncodedTaskRunRequest(JsonElement element)
        {
            ...
            return new EncodedTaskRunRequest(type, Optional.ToNullable(isArchiveEnabled), agentPoolName.Value, logTemplate.Value, encodedTaskContent, encodedValuesContent.Value, Optional.ToList(values), Optional.ToNullable(timeout), platform, agentConfiguration.Value, sourceLocation.Value, credentials.Value);
        }
    }
}
