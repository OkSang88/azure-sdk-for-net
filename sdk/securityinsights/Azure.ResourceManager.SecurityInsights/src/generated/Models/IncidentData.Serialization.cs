...
namespace SecurityInsights
{
    public partial class IncidentData : IUtf8JsonSerializable
    {
        ...
        internal static IncidentData DeserializeIncidentData(JsonElement element)
        {
            ...
            Optional<string> incidentUrl = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        {
                            incidentUrl = property0.Value.GetString();
                            continue;
                        }
            ...
            return new IncidentData(id, name, type, systemData, etag.Value, additionalData.Value, Optional.ToNullable(classification), classificationComment.Value, Optional.ToNullable(classificationReason), Optional.ToNullable(createdTimeUtc), description.Value, Optional.ToNullable(firstActivityTimeUtc), incidentUrl.Value, Optional.ToNullable(incidentNumber), Optional.ToList(labels), providerName.Value, providerIncidentId.Value, Optional.ToNullable(lastActivityTimeUtc), Optional.ToNullable(lastModifiedTimeUtc), owner.Value, Optional.ToList(relatedAnalyticRuleIds), Optional.ToNullable(severity), Optional.ToNullable(status), teamInformation.Value, title.Value);
        }
    }
}
