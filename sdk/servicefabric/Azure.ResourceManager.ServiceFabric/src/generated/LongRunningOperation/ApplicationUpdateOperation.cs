...
namespace ServiceFabricManagementClient.Models
{
    ...
    public partial class ApplicationUpdateOperation : Operation<ApplicationResource>, IOperationSource<ApplicationResource>
    {
        ...
        internal ApplicationUpdateOperation(ArmResource operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<ApplicationResource>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "ApplicationUpdateOperation");
