...
namespace Azure.ResourceManager.DataFactory
{
    ...
    public partial class DatasetResourceCollection : ArmCollection, IEnumerable<DatasetResource>, IAsyncEnumerable<DatasetResource>
    {
        ...
        public virtual DatasetCreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, string datasetName, DatasetResourceData dataset, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            if (datasetName == null)
            {
            ...
            try
            {
                ...
                var operation = new DatasetCreateOrUpdateOperation(Parent, response);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="datasetName"/> or <paramref name="dataset"/> is null. </exception>
        public async virtual Task<DatasetCreateOrUpdateOperation> CreateOrUpdateAsync(bool waitForCompletion, string datasetName, DatasetResourceData dataset, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            if (datasetName == null)
            {
                throw new ArgumentNullException(nameof(datasetName));
        ...
        public virtual Response<DatasetResource> Get(string datasetName, string ifNoneMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new DatasetResource(Parent, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual Pageable<DatasetResource> GetAll(CancellationToken cancellationToken = default)
        {
            Page<DatasetResource> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    ...
                    return Page.FromValues(response.Value.Value.Select(value => new DatasetResource(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
