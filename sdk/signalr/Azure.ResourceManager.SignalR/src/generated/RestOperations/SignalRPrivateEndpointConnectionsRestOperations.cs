...
namespace SignalRManagementClient
{
    internal partial class SignalRPrivateEndpointConnectionsRestOperations
    {
        ...
        public SignalRPrivateEndpointConnectionsRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ClientOptions options, Uri endpoint = null, string apiVersion = "2021-10-01")
        {
