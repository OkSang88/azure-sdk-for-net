...
{
    public partial class ServiceReplicaProperties : IUtf8JsonSerializable
    {
        ...
        internal static ServiceReplicaProperties DeserializeServiceReplicaProperties(JsonElement element)
        {
            ...
            return new ServiceReplicaProperties(osType, codePackages, Optional.ToList(networkRefs), diagnostics.Value);
        }
    }
}
