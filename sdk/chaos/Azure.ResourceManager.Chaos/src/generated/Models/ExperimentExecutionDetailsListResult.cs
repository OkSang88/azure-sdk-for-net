...
namespace ChaosManagementClient.Models
{
    ...
    internal partial class ExperimentExecutionDetailsListResult
    {
        ...
        {
            Value = new ChangeTrackingList<ExperimentExecutionDetailsData>();
        }
        ...
        internal ExperimentExecutionDetailsListResult(IReadOnlyList<ExperimentExecutionDetailsData> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
        ...
        public IReadOnlyList<ExperimentExecutionDetailsData> Value { get; }
