...
namespace SearchManagementClient
{
    internal partial class QueryKeysRestOperations
    {
        ...
        public QueryKeysRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ClientOptions options, Uri endpoint = null, string apiVersion = "2020-08-01")
        {
