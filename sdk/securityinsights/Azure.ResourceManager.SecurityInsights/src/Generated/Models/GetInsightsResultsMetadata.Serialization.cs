...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    public partial class GetInsightsResultsMetadata
    {
        internal static GetInsightsResultsMetadata DeserializeGetInsightsResultsMetadata(JsonElement element)
        {
            ...
            Optional<IReadOnlyList<GetInsightsError>> errors = default;
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("errors"))
                {
                    ...
                    List<GetInsightsError> array = new List<GetInsightsError>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(GetInsightsError.DeserializeGetInsightsError(item));
                    }
                    errors = array;
                    continue;
                }
