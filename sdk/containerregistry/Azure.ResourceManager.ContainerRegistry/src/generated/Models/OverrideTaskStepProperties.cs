...
namespace ContainerRegistryManagementClient.Models
{
    ...
    {
        /// <summary> Initializes a new instance of OverrideTaskStepProperties. </summary>
        ...
        internal OverrideTaskStepProperties(string contextPath, string file, IList<Argument> arguments, string target, IList<SetValue> values, string updateTriggerToken)
        {
