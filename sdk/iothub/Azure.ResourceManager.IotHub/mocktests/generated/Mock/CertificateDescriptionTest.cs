...
namespace Azure.ResourceManager.IotHub.Tests.Mock.Tests.Mock
{
    ...
    public partial class CertificateDescriptionMockTests : MockTestBase
    {
        ...
        public async Task Get()
        {
            ...
            var certificateDescriptionId = IotHub.Tests.Mock.CertificateDescription.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "myResourceGroup", "testhub", "cert");
        ...
        public async Task Delete()
        {
            ...
            var certificateDescriptionId = IotHub.Tests.Mock.CertificateDescription.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "myResourceGroup", "myhub", "cert");
            var certificateDescription = GetArmClient().GetCertificateDescription(certificateDescriptionId);
        ...
        public async Task Verify()
        {
            ...
            var certificateDescriptionId = IotHub.Tests.Mock.CertificateDescription.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "myResourceGroup", "myFirstProvisioningService", "cert");
            var certificateDescription = GetArmClient().GetCertificateDescription(certificateDescriptionId);
            string ifMatch = "AAAAAAAADGk=";
            IotHub.Tests.Mock.Models.CertificateVerificationDescription certificateVerificationBody = new IotHub.Tests.Mock.Models.CertificateVerificationDescription()
            {
                Certificate = "#####################################",
            };
