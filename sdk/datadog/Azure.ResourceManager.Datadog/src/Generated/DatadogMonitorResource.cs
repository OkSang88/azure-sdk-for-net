...
namespace Azure.ResourceManager.Datadog
{
    ...
    public partial class DatadogMonitorResource : ArmResource
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async virtual Task<DatadogMonitorResourceDeleteOperation> DeleteAsync(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new DatadogMonitorResourceDeleteOperation(_clientDiagnostics, Pipeline, _monitorsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name).Request, response);
        ...
        /// <param name="waitForCompletion"> Waits for the completion of the long running operations. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual DatadogMonitorResourceDeleteOperation Delete(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("DatadogMonitorResource.Delete");
            scope.Start();
            try
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async virtual Task<DatadogMonitorResourceUpdateOperation> UpdateAsync(bool waitForCompletion, DatadogMonitorResourceUpdateParameters body = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new DatadogMonitorResourceUpdateOperation(this, _clientDiagnostics, Pipeline, _monitorsRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, body).Request, response);
                if (waitForCompletion)
        ...
        /// <param name="body"> The DatadogMonitorResourceUpdateParameters to use. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual DatadogMonitorResourceUpdateOperation Update(bool waitForCompletion, DatadogMonitorResourceUpdateParameters body = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("DatadogMonitorResource.Update");
            scope.Start();
            try
