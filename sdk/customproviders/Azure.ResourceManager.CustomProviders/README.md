# Azure CustomProviders Management client library for .NET
...
Install the Azure CustomProviders management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.CustomProviders -Version 1.0.0-preview.1 
```
