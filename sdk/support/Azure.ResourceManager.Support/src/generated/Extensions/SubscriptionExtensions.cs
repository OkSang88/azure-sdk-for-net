...
namespace MicrosoftSupport
{
    ...
    public static partial class SubscriptionExtensions
    {
        ...
        private static SupportTicketsRestOperations GetSupportTicketsRestOperations(ClientDiagnostics clientDiagnostics, TokenCredential credential, ArmClientOptions clientOptions, HttpPipeline pipeline, Uri endpoint = null)
        {
            return new SupportTicketsRestOperations(clientDiagnostics, pipeline, clientOptions, endpoint);
        }
        ...
        public static async Task<Response<CheckNameAvailabilityOutput>> CheckNameAvailabilitySupportTicketAsync(this Subscription subscription, CheckNameAvailabilityInput checkNameAvailabilityInput, CancellationToken cancellationToken = default)
        {
            ...
            return await subscription.UseClientContext(async (baseUri, credential, options, pipeline) =>
            {
                ...
                try
                {
                    var restOperations = GetSupportTicketsRestOperations(clientDiagnostics, credential, options, pipeline, baseUri);
