...
namespace Azure.ResourceManager.Search
{
    ...
    public partial class SearchServiceCollection : ArmCollection, IEnumerable<SearchService>, IAsyncEnumerable<SearchService>
    {
        ...
        internal SearchServiceCollection(ArmResource parent) : base(parent)
        {
            ...
            ClientOptions.TryGetApiVersion(SearchService.ResourceType, out string apiVersion);
        ...
        public virtual SearchServiceCreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, string searchServiceName, SearchServiceData service, SearchManagementRequestOptions searchManagementRequestOptions = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new SearchServiceCreateOrUpdateOperation(this, _clientDiagnostics, Pipeline, _servicesRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, searchServiceName, service, searchManagementRequestOptions).Request, response);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="searchServiceName"/> or <paramref name="service"/> is null. </exception>
        public async virtual Task<SearchServiceCreateOrUpdateOperation> CreateOrUpdateAsync(bool waitForCompletion, string searchServiceName, SearchServiceData service, SearchManagementRequestOptions searchManagementRequestOptions = null, CancellationToken cancellationToken = default)
        {
            if (searchServiceName == null)
            {
                throw new ArgumentNullException(nameof(searchServiceName));
        ...
        public virtual Pageable<SearchService> GetAll(SearchManagementRequestOptions searchManagementRequestOptions = null, CancellationToken cancellationToken = default)
        {
            Page<SearchService> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    ...
                    return Page.FromValues(response.Value.Value.Select(value => new SearchService(this, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
