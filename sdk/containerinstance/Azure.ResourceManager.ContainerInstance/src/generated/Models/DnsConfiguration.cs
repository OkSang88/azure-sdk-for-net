...
namespace ContainerInstanceManagementClient.Models
{
    ...
    {
        /// <summary> Initializes a new instance of DnsConfiguration. </summary>
        ...
        public DnsConfiguration(IEnumerable<string> nameServers)
        {
            if (nameServers == null)
            {
        ...
        internal DnsConfiguration(IList<string> nameServers, string searchDomains, string options)
        {
