# Azure DevTestLabs Management client library for .NET
...
Install the Azure DevTestLabs management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.DevTestLabs -Version 1.0.0-preview.1 
```
