...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class SsisProject : SsisObjectMetadata
    {
        ...
        internal SsisProject()
        {
            ...
            Type = SsisObjectMetadataType.Project;
        }
        ...
        internal SsisProject(SsisObjectMetadataType type, long? id, string name, string description, long? folderId, long? version, IReadOnlyList<SsisEnvironmentReference> environmentRefs, IReadOnlyList<SsisParameter> parameters) : base(type, id, name, description)
        {
            FolderId = folderId;
            Version = version;
