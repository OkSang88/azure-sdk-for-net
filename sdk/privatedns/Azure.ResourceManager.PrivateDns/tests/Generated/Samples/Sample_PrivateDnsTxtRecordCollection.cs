...
{
    public partial class Sample_PrivateDnsTxtRecordCollection
    {
        ...
        public async Task CreateOrUpdate_PUTPrivateDNSZoneARecordSet()
        {
            ...
            // get the collection of this PrivateDnsTxtRecordResource
            PrivateDnsTxtRecordCollection collection = privateDnsZone.GetPrivateDnsTxtRecords();
...
IPv4Address = "1.2.3.4",
            ...
            ArmOperation<PrivateDnsTxtRecordResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, relativeRecordSetName, data);
            PrivateDnsTxtRecordResource result = lro.Value;
...
"string1","string2"
        ...
        public async Task Get_GETPrivateDNSZoneARecordSet()
        {
            ...
            // invoke the operation
            string relativeRecordSetName = "recordA";
            PrivateDnsTxtRecordResource result = await collection.GetAsync(relativeRecordSetName);
        ...
        public async Task GetAll_GETPrivateDNSZoneARecordSets()
        {
            ...
            await foreach (PrivateDnsTxtRecordResource item in collection.GetAllAsync())
            {
