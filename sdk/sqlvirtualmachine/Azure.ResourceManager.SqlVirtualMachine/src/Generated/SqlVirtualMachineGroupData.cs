...
namespace Azure.ResourceManager.SqlVirtualMachine
{
    ...
    public partial class SqlVirtualMachineGroupData : TrackedResource
    {
        ...
        internal SqlVirtualMachineGroupData(ResourceIdentifier id, string name, ResourceType type, IDictionary<string, string> tags, AzureLocation location, string provisioningState, string sqlImageOffer, SqlVmGroupImageSku? sqlImageSku, ScaleType? scaleType, ClusterManagerType? clusterManagerType, ClusterConfiguration? clusterConfiguration, WsfcDomainProfile wsfcDomainProfile) : base(id, name, type, tags, location)
        {
