...
namespace BatchManagementClient.Models
{
    internal static partial class ProvisioningStateExtensions
    {
        ...
        {
            if (string.Equals(value, "Invalid", StringComparison.InvariantCultureIgnoreCase)) return ProvisioningState.Invalid;
            ...
            if (string.Equals(value, "Cancelled", StringComparison.InvariantCultureIgnoreCase)) return ProvisioningState.Cancelled;
