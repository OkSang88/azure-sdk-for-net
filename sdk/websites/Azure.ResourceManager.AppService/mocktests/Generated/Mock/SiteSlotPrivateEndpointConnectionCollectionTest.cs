...
namespace Azure.ResourceManager.AppService.Tests.Mock
{
    ...
    public partial class SiteSlotPrivateEndpointConnectionCollectionMockTests : MockTestBase
    {
        public SiteSlotPrivateEndpointConnectionCollectionMockTests(bool isAsync) : base(isAsync, RecordedTestMode.Record)
        {
        ...
        public async Task CreateOrUpdateAsync()
        {
            ...
            var collection = GetArmClient().GetSiteSlot(new ResourceIdentifier("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg/providers/Microsoft.Web/sites/testSite/slots/stage")).GetSiteSlotPrivateEndpointConnections();
