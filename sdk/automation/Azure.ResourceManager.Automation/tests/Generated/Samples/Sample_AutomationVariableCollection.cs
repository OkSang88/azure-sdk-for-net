...
{
    public partial class Sample_AutomationVariableCollection
    {
        ...
        public async Task Get_GetAVariable()
        {
            ...
            // invoke the operation
            string variableName = "sampleVariable";
            AutomationVariableResource result = await collection.GetAsync(variableName);
        ...
        public async Task GetAll_ListVariablesFirst100()
        {
            ...
            await foreach (AutomationVariableResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                AutomationVariableData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
