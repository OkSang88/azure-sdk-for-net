...
{
    public partial class Sample_DnsAaaaRecordResource
    {
        // Patch A recordset
        ...
        public async Task Update_PatchARecordset()
        {
            ...
            // this example assumes you already have this DnsAaaaRecordResource created on azure
            // for more information of creating DnsAaaaRecordResource, please refer to the document of DnsAaaaRecordResource
            string subscriptionId = "subid";
            string resourceGroupName = "rg1";
            string zoneName = "zone1";
            string relativeRecordSetName = "record1";
            ResourceIdentifier dnsDnsAaaaRecordInfoResourceId = DnsAaaaRecordResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, zoneName, relativeRecordSetName);
            DnsAaaaRecordResource dnsDnsAaaaRecordInfo = client.GetDnsAaaaRecordResource(dnsDnsAaaaRecordInfoResourceId);
...
["key2"] = "value2",
            ...
            DnsAaaaRecordResource result = await dnsDnsAaaaRecordInfo.UpdateAsync(data);
...
["key2"] = "value2",
        ...
        public async Task Delete_DeleteARecordset()
        {
            ...
            // invoke the operation
            await dnsDnsAaaaRecordInfo.DeleteAsync(WaitUntil.Completed);
        ...
        public async Task Get_GetARecordset()
        {
            ...
            // invoke the operation
            DnsAaaaRecordResource result = await dnsDnsAaaaRecordInfo.GetAsync();
