...
{
    public partial class IncidentOwnerInfo : IUtf8JsonSerializable
    {
        ...
        internal static IncidentOwnerInfo DeserializeIncidentOwnerInfo(JsonElement element)
        {
            Optional<string> email = default;
            Optional<string> assignedTo = default;
            Optional<Guid> objectId = default;
            Optional<string> userPrincipalName = default;
            Optional<OwnerType> ownerType = default;
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("ownerType"))
                {
                    ...
                    ownerType = new OwnerType(property.Value.GetString());
                    continue;
                }
            }
            return new IncidentOwnerInfo(email.Value, assignedTo.Value, Optional.ToNullable(objectId), userPrincipalName.Value, Optional.ToNullable(ownerType));
        }
    }
}
