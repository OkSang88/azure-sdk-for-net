...
namespace ResourceGraphClient.Models
{
    ...
    public partial class FacetResult : Facet
    {
        ...
        internal FacetResult(string expression, long totalRecords, int count, object data) : base(expression)
        {
            if (expression == null)
            {
        ...
        /// <param name="count"> Number of records returned in the facet response. </param>
        /// <param name="data"> A JObject array or Table containing the desired facets. Only present if the facet is valid. </param>
        internal FacetResult(string expression, string resultType, long totalRecords, int count, object data) : base(expression, resultType)
        {
            TotalRecords = totalRecords;
            Count = count;
            Data = data;
        ...
        /// <summary> A JObject array or Table containing the desired facets. Only present if the facet is valid. </summary>
