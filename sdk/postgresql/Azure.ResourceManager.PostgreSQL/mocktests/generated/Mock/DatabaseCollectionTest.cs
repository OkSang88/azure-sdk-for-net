...
namespace Azure.ResourceManager.PostgreSQL.Tests.Mock
{
    ...
    public partial class DatabaseCollectionMockTests : MockTestBase
    {
        ...
        public async Task CreateOrUpdate()
        {
            ...
            PostgreSQL.DatabaseData parameters = new PostgreSQL.DatabaseData()
            {
                Charset = "utf8",
                Collation = "en_US.utf8",
            };

            var serverId = PostgreSQL.Server.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "TestGroup", "testserver");
