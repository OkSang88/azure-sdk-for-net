...
namespace AzureAgriFoodRPService.Models
{
    ...
    internal partial class FarmBeatsListResponse
    {
        ...
        {
            Value = new ChangeTrackingList<FarmBeatsData>();
        }
        ...
        internal FarmBeatsListResponse(IReadOnlyList<FarmBeatsData> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
        ...
        public IReadOnlyList<FarmBeatsData> Value { get; }
