...
namespace DataFactoryManagementClient.Models
{
    ...
    public partial class CosmosDbLinkedService : LinkedService
    {
        ...
        internal CosmosDbLinkedService(string type, IntegrationRuntimeReference connectVia, string description, IDictionary<string, ParameterSpecification> parameters, IList<object> annotations, IDictionary<string, object> additionalProperties, object connectionString, object accountEndpoint, object database, SecretBase accountKey, object servicePrincipalId, CosmosDbServicePrincipalCredentialType? servicePrincipalCredentialType, SecretBase servicePrincipalCredential, object tenant, object azureCloudType, CosmosDbConnectionMode? connectionMode, object encryptedCredential, CredentialReference credential) : base(type, connectVia, description, parameters, annotations, additionalProperties)
        {
