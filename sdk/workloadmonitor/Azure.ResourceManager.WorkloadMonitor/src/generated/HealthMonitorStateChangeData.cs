...
namespace WorkloadMonitorAPI
{
    ...
    public partial class HealthMonitorStateChangeData : Resource
    {
        ...
        internal HealthMonitorStateChangeData(ResourceIdentifier id, string name, ResourceType type, string monitorName, string monitorType, string monitoredObject, string evaluationTimestamp, string currentStateFirstObservedTimestamp, HealthState? previousMonitorState, HealthState? currentMonitorState, object evidence, object monitorConfiguration) : base(id, name, type)
        {
        ...
        public object MonitorConfiguration { get; }
    }
}
