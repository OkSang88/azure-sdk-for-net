...
namespace SecurityInsights.Models
{
    ...
    public partial class HuntingBookmark : EntityData
    {
        ...
        internal HuntingBookmark(ResourceIdentifier id, string name, ResourceType type, SystemData systemData, EntityKind kind, IReadOnlyDictionary<string, object> additionalData, string friendlyName, DateTimeOffset? created, UserInfo createdBy, string displayName, DateTimeOffset? eventTime, IList<string> labels, string notes, string query, string queryResult, DateTimeOffset? updated, UserInfo updatedBy, IncidentInfo incidentInfo) : base(id, name, type, systemData, kind)
        {
