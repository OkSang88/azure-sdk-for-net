...
namespace DataFactoryManagementClient
{
    internal partial class IntegrationRuntimeObjectMetadataRestOperations
    {
        ...
        public IntegrationRuntimeObjectMetadataRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ClientOptions options, Uri endpoint = null, string apiVersion = "2018-06-01")
        {
