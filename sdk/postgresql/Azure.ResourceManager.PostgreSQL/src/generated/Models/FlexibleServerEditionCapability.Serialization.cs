...
namespace PostgreSQLManagementClient.Models
{
    ...
    {
        internal static FlexibleServerEditionCapability DeserializeFlexibleServerEditionCapability(JsonElement element)
        {
            ...
            return new FlexibleServerEditionCapability(name.Value, Optional.ToList(supportedStorageEditions), Optional.ToList(supportedServerVersions), status.Value);
        }
    }
}
