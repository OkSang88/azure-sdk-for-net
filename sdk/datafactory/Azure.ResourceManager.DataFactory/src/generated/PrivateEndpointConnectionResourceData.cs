...
namespace DataFactoryManagementClient
{
    ...
    public partial class PrivateEndpointConnectionResourceData : SubResource
    {
        ...
        internal PrivateEndpointConnectionResourceData(ResourceIdentifier id, string name, ResourceType type, string etag, RemotePrivateEndpointConnection properties) : base(id, name, type, etag)
        {
