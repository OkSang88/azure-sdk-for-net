...
namespace Azure.ResourceManager.Quota.Models
{
    ...
    /// </summary>
    public partial class CurrentQuotaLimitBaseUpdateOperation : Operation<CurrentQuotaLimitBase>, IOperationSource<CurrentQuotaLimitBase>
    {
        private readonly OperationInternals<CurrentQuotaLimitBase> _operation;

        private readonly ArmResource _operationBase;

        /// <summary> Initializes a new instance of CurrentQuotaLimitBaseUpdateOperation for mocking. </summary>
        protected CurrentQuotaLimitBaseUpdateOperation()
        {
        }

        internal CurrentQuotaLimitBaseUpdateOperation(ArmResource operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<CurrentQuotaLimitBase>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "CurrentQuotaLimitBaseUpdateOperation");
