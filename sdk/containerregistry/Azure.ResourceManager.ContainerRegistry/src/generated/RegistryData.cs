...
namespace ContainerRegistryManagementClient
{
    ...
    public partial class RegistryData : Resource
    {
        ...
        public RegistryData(AzureLocation location, Models.Sku sku) : base(location)
        {
            if (sku == null)
            {
        ...
        /// <param name="creationDate"> The creation date of the container registry in ISO8601 format. </param>
        ...
        internal RegistryData(ResourceIdentifier id, string name, ResourceType type, IDictionary<string, string> tags, AzureLocation location, SystemData systemData, Models.Sku sku, ResourceIdentity identity, string loginServer, DateTimeOffset? creationDate, ProvisioningState? provisioningState, Status status, bool? adminUserEnabled, NetworkRuleSet networkRuleSet, Policies policies, EncryptionProperty encryption, bool? dataEndpointEnabled, IReadOnlyList<string> dataEndpointHostNames, IReadOnlyList<PrivateEndpointConnectionData> privateEndpointConnections, PublicNetworkAccess? publicNetworkAccess, NetworkRuleBypassOptions? networkRuleBypassOptions, ZoneRedundancy? zoneRedundancy) : base(id, name, type, tags, location, systemData)
        {
            Sku = sku;
            Identity = identity;
