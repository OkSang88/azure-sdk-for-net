...
namespace Azure.ResourceManager.Sql.Tests.Mock
{
    ...
    public partial class ManagedInstanceAdministratorMockTests : MockTestBase
    {
        ...
        public async Task GetAsync()
        {
            ...
            var managedInstanceAdministrator = GetArmClient().GetManagedInstanceAdministrator(new ResourceIdentifier("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/Default-SQL-SouthEastAsia/providers/Microsoft.Sql/managedInstances/managedInstance/administrators/ActiveDirectory"));
