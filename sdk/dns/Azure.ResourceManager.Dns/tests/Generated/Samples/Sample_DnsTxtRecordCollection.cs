...
{
    public partial class Sample_DnsTxtRecordCollection
    {
        // Create A recordset
        ...
        public async Task CreateOrUpdate_CreateARecordset()
        {
            ...
            // get the collection of this DnsTxtRecordResource
            DnsTxtRecordCollection collection = dnsZone.GetDnsTxtRecords();
...
IPv4Address = "127.0.0.1",
            ...
            ArmOperation<DnsTxtRecordResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, relativeRecordSetName, data);
            DnsTxtRecordResource result = lro.Value;
...
"string1","string2"
        ...
        public async Task Get_GetARecordset()
        {
            ...
            // invoke the operation
            string relativeRecordSetName = "record1";
            DnsTxtRecordResource result = await collection.GetAsync(relativeRecordSetName);
        ...
        public async Task GetAll_ListARecordsets()
        {
            ...
            await foreach (DnsTxtRecordResource item in collection.GetAllAsync())
            {
