...
namespace MicrosoftDatadogClient
{
    internal partial class TagRulesRestOperations
    {
        ...
        public TagRulesRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ClientOptions options, Uri endpoint = null, string apiVersion = "2021-03-01")
        {
