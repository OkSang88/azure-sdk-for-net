...
{
    public partial class NotificationHubResourceData : IUtf8JsonSerializable
    {
        ...
        internal static NotificationHubResourceData DeserializeNotificationHubResourceData(JsonElement element)
        {
            ...
            return new NotificationHubResourceData(id, name, type, tags, location, sku.Value, name0.Value, registrationTtl.Value, Optional.ToList(authorizationRules), apnsCredential.Value, wnsCredential.Value, gcmCredential.Value, mpnsCredential.Value, admCredential.Value, baiduCredential.Value);
        }
    }
}
