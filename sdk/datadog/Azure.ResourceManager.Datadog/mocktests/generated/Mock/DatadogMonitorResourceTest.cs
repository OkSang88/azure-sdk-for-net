...
using Azure.ResourceManager.Datadog.Tests.Mock.Models;
...
namespace Azure.ResourceManager.Datadog.Tests.Mock.Tests.Mock
{
    ...
    public partial class DatadogMonitorResourceMockTests : MockTestBase
    {
        ...
        public async Task Update()
        {
            ...
            var datadogMonitorResourceId = Datadog.Tests.Mock.DatadogMonitorResource.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "myResourceGroup", "myMonitor");
            var datadogMonitorResource = GetArmClient().GetDatadogMonitorResource(datadogMonitorResourceId);
            Datadog.Tests.Mock.Models.DatadogMonitorResourceUpdateParameters body = null;
        ...
        public async Task SetDefaultKey()
        {
            ...
            var datadogMonitorResourceId = Datadog.Tests.Mock.DatadogMonitorResource.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "myResourceGroup", "myMonitor");
            var datadogMonitorResource = GetArmClient().GetDatadogMonitorResource(datadogMonitorResourceId);
            Datadog.Tests.Mock.Models.DatadogApiKey body = null;
