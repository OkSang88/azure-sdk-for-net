...
namespace ServiceFabricManagementClient.Models
{
    ...
    public partial class ArmRollingUpgradeMonitoringPolicy
    {
        ...
        internal ArmRollingUpgradeMonitoringPolicy(ArmUpgradeFailureAction? failureAction, string healthCheckWaitDuration, string healthCheckStableDuration, string healthCheckRetryTimeout, string upgradeTimeout, string upgradeDomainTimeout)
        {
