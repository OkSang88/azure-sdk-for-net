...
namespace ServiceFabricManagedClustersManagementClient.Models
{
    ...
    public partial class VmssExtension
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="name"/>, <paramref name="publisher"/>, <paramref name="type"/>, or <paramref name="typeHandlerVersion"/> is null. </exception>
        public VmssExtension(string name, string publisher, string type, string typeHandlerVersion)
        {
            if (name == null)
            {
        ...
        internal VmssExtension(string name, string publisher, string type, string typeHandlerVersion, bool? autoUpgradeMinorVersion, object settings, object protectedSettings, string forceUpdateTag, IList<string> provisionAfterExtensions, string provisioningState)
        {
            Name = name;
            Publisher = publisher;
            Type = type;
