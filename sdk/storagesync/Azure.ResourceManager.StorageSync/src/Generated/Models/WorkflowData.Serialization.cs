...
namespace Azure.ResourceManager.StorageSync
{
    public partial class WorkflowData : IUtf8JsonSerializable
    {
        ...
        internal static WorkflowData DeserializeWorkflowData(JsonElement element)
        {
            ...
            return new WorkflowData(id, name, type, lastStepName.Value, Optional.ToNullable(status), Optional.ToNullable(operation), steps.Value, lastOperationId.Value, commandName.Value, Optional.ToNullable(createdTimestamp), Optional.ToNullable(lastStatusTimestamp));
        }
    }
}
