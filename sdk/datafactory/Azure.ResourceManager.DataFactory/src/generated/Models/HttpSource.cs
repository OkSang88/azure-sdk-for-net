...
namespace DataFactoryManagementClient.Models
{
    ...
    public partial class HttpSource : CopySource
    {
        ...
        internal HttpSource(string type, object sourceRetryCount, object sourceRetryWait, object maxConcurrentConnections, object disableMetricsCollection, IDictionary<string, object> additionalProperties, object httpRequestTimeout) : base(type, sourceRetryCount, sourceRetryWait, maxConcurrentConnections, disableMetricsCollection, additionalProperties)
        {
