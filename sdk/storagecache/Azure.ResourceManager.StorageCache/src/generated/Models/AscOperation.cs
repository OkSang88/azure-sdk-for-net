...
namespace StorageCacheManagementClient.Models
{
    ...
    public partial class AscOperation
    {
        ...
        {
            Output = new ChangeTrackingDictionary<string, object>();
        }
        ...
        internal AscOperation(string id, string name, string startTime, string endTime, string status, ErrorResponse error, IReadOnlyDictionary<string, object> output)
        {
            Id = id;
            Name = name;
            StartTime = startTime;
