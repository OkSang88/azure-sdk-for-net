...
namespace DataFactoryManagementClient.Models
{
    ...
    public partial class PipelineCreateOrUpdateOperation : Operation<PipelineResource>
    {
        private readonly OperationOrResponseInternals<PipelineResource> _operation;

        /// <summary> Initializes a new instance of PipelineCreateOrUpdateOperation for mocking. </summary>
        protected PipelineCreateOrUpdateOperation()
        {
        }

        internal PipelineCreateOrUpdateOperation(ArmResource operationsBase, Response<PipelineResourceData> response)
        {
