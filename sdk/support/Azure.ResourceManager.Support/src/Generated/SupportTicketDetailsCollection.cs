...
namespace Azure.ResourceManager.Support
{
    ...
    public partial class SupportTicketDetailsCollection : ArmCollection, IEnumerable<SupportTicketDetails>, IAsyncEnumerable<SupportTicketDetails>
    {
        ...
        internal SupportTicketDetailsCollection(ArmResource parent) : base(parent)
        {
            ...
            ClientOptions.TryGetApiVersion(SupportTicketDetails.ResourceType, out string apiVersion);
        ...
        public virtual SupportTicketDetailsCreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, string supportTicketName, SupportTicketDetailsData createSupportTicketParameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new SupportTicketDetailsCreateOrUpdateOperation(this, _clientDiagnostics, Pipeline, _supportTicketsRestClient.CreateCreateRequest(Id.SubscriptionId, supportTicketName, createSupportTicketParameters).Request, response);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="supportTicketName"/> or <paramref name="createSupportTicketParameters"/> is null. </exception>
        public async virtual Task<SupportTicketDetailsCreateOrUpdateOperation> CreateOrUpdateAsync(bool waitForCompletion, string supportTicketName, SupportTicketDetailsData createSupportTicketParameters, CancellationToken cancellationToken = default)
        {
            if (supportTicketName == null)
            {
                throw new ArgumentNullException(nameof(supportTicketName));
        ...
        public virtual Pageable<SupportTicketDetails> GetAll(int? top = null, string filter = null, CancellationToken cancellationToken = default)
        {
            Page<SupportTicketDetails> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    ...
                    return Page.FromValues(response.Value.Value.Select(value => new SupportTicketDetails(this, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
