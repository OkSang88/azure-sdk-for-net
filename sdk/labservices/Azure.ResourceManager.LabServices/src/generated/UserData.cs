...
namespace LabServicesClient
{
    ...
    public partial class UserData : Resource
    {
        ...
        /// <param name="systemData"> Metadata pertaining to creation and last modification of the user resource. </param>
        ...
        /// <param name="invitationSent"> Date and time when the invitation message was sent to the user. </param>
        /// <param name="totalUsage"> How long the user has used their virtual machines in this lab. </param>
        internal UserData(ResourceIdentifier id, string name, ResourceType type, SystemData systemData, TimeSpan? additionalUsageQuota, ProvisioningState? provisioningState, string displayName, string email, RegistrationState? registrationState, InvitationState? invitationState, DateTimeOffset? invitationSent, TimeSpan? totalUsage) : base(id, name, type)
        {
