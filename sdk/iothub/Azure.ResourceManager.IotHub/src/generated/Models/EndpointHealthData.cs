...
namespace IotHubClient.Models
{
    ...
    {
        /// <summary> Initializes a new instance of EndpointHealthData. </summary>
        ...
        /// <param name="lastKnownErrorTime"> Time at which the last known error occurred. </param>
        /// <param name="lastSuccessfulSendAttemptTime"> Last time iot hub successfully sent a message to the endpoint. </param>
        /// <param name="lastSendAttemptTime"> Last time iot hub tried to send a message to the endpoint. </param>
        internal EndpointHealthData(string endpointId, EndpointHealthStatus? healthStatus, string lastKnownError, DateTimeOffset? lastKnownErrorTime, DateTimeOffset? lastSuccessfulSendAttemptTime, DateTimeOffset? lastSendAttemptTime)
        {
