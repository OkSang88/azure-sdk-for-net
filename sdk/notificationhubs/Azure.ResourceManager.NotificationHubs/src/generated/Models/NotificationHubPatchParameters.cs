...
namespace NotificationHubsManagementClient.Models
{
    ...
    public partial class NotificationHubPatchParameters : Resource
    {
        ...
        public NotificationHubPatchParameters(AzureLocation location) : base(location)
        {
