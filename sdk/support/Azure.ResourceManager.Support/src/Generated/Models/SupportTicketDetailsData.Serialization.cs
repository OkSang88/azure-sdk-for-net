...
{
    public partial class SupportTicketDetailsData : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Optional.IsDefined(ProblemStartTime))
            {
                writer.WritePropertyName("problemStartTime");
                writer.WriteStringValue(ProblemStartTime.Value, "O");
            }
        ...
        internal static SupportTicketDetailsData DeserializeSupportTicketDetailsData(JsonElement element)
        {
            ...
            Optional<SeverityLevel> severity = default;
            Optional<string> enrollmentId = default;
            Optional<bool> require24X7Response = default;
            Optional<ContactProfile> contactDetails = default;
            Optional<ServiceLevelAgreement> serviceLevelAgreement = default;
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("severity"))
                        {
                            ...
                            severity = new SeverityLevel(property0.Value.GetString());
                            continue;
                        }
                        ...
                        if (property0.NameEquals("contactDetails"))
                        {
                            ...
                            contactDetails = ContactProfile.DeserializeContactProfile(property0.Value);
                            continue;
                        }
                        if (property0.NameEquals("serviceLevelAgreement"))
                        {
                            ...
                            serviceLevelAgreement = ServiceLevelAgreement.DeserializeServiceLevelAgreement(property0.Value);
                            continue;
                        }
