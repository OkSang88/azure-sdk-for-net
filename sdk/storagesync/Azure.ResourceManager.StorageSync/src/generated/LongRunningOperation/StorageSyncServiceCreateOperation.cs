...
namespace MicrosoftStorageSync.Models
{
    ...
    public partial class StorageSyncServiceCreateOperation : Operation<StorageSyncService>, IOperationSource<StorageSyncService>
    {
        private readonly OperationInternals<StorageSyncService> _operation;

        private readonly ArmResource _operationBase;

        /// <summary> Initializes a new instance of StorageSyncServiceCreateOperation for mocking. </summary>
        protected StorageSyncServiceCreateOperation()
        {
        }

        internal StorageSyncServiceCreateOperation(ArmResource operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<StorageSyncService>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "StorageSyncServiceCreateOperation");
