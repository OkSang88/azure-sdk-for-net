# Azure AlertsResourceManager Management client library for .NET
...
Install the Azure AlertsResourceManager management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.AlertsResourceManager -Version 1.0.0-preview.1 
```
