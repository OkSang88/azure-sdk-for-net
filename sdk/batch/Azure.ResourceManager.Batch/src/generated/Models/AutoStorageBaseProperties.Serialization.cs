...
{
    public partial class AutoStorageBaseProperties : IUtf8JsonSerializable
    {
        ...
        internal static AutoStorageBaseProperties DeserializeAutoStorageBaseProperties(JsonElement element)
        {
            ...
            return new AutoStorageBaseProperties(storageAccountId, Optional.ToNullable(authenticationMode), nodeIdentityReference.Value);
        }
    }
}
