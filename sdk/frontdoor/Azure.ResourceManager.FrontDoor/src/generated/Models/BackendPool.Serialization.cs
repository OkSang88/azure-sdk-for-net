...
{
    public partial class BackendPool : IUtf8JsonSerializable
    {
        ...
        internal static BackendPool DeserializeBackendPool(JsonElement element)
        {
            Optional<string> name = default;
            Optional<string> type = default;
            Optional<string> id = default;
            Optional<IList<Backend>> backends = default;
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        if (property0.NameEquals("backends"))
                        {
                            ...
                            List<Backend> array = new List<Backend>();
                            foreach (var item in property0.Value.EnumerateArray())
                            {
                                array.Add(Backend.DeserializeBackend(item));
                            }
                            backends = array;
                            continue;
                        }
            ...
            return new BackendPool(id.Value, name.Value, type.Value, Optional.ToList(backends), loadBalancingSettings, healthProbeSettings, Optional.ToNullable(resourceState));
        }
    }
}
