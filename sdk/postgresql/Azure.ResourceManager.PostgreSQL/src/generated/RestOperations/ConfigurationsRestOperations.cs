...
namespace PostgreSQLManagementClient
{
    internal partial class ConfigurationsRestOperations
    {
        ...
        public ConfigurationsRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ClientOptions options, Uri endpoint = null, string apiVersion = "2021-06-01")
        {
