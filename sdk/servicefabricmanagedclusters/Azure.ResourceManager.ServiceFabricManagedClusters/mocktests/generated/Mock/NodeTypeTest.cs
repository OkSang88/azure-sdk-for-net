...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Tests.Mock
{
    ...
    public partial class NodeTypeMockTests : MockTestBase
    {
        ...
        public async Task Get()
        {
            ...
            var nodeTypeId = ServiceFabricManagedClusters.NodeType.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "resRg", "myCluster", "FE");
        ...
        public async Task Delete()
        {
            ...
            var nodeTypeId = ServiceFabricManagedClusters.NodeType.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "resRg", "myCluster", "BE");
            var nodeType = GetArmClient().GetNodeType(nodeTypeId);
        ...
        public async Task Update()
        {
            ...
            var nodeTypeId = ServiceFabricManagedClusters.NodeType.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "resRg", "myCluster", "BE");
            var nodeType = GetArmClient().GetNodeType(nodeTypeId);
            ServiceFabricManagedClusters.Models.NodeTypeUpdateParameters parameters = new ServiceFabricManagedClusters.Models.NodeTypeUpdateParameters();
        ...
        public async Task Update2()
        {
            ...
            ServiceFabricManagedClusters.Models.NodeTypeUpdateParameters parameters = new ServiceFabricManagedClusters.Models.NodeTypeUpdateParameters()
            {
                Sku = new ServiceFabricManagedClusters.Models.NodeTypeSku(capacity: 10)
                {
                    Name = "Standard_S0",
                    Tier = "Standard",
                },
        ...
        public async Task Restart()
        {
            ...
            var nodeTypeId = ServiceFabricManagedClusters.NodeType.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "resRg", "myCluster", "BE");
            var nodeType = GetArmClient().GetNodeType(nodeTypeId);
            ServiceFabricManagedClusters.Models.NodeTypeActionParameters parameters = new ServiceFabricManagedClusters.Models.NodeTypeActionParameters(nodes: new List<string>()
{
"BE_0","BE_3",});
