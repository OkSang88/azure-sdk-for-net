...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class McasDataConnector : DataConnectorData
    {
        ...
        internal McasDataConnector(ResourceIdentifier id, string name, ResourceType type, SystemData systemData, string etag, DataConnectorKind kind, string tenantId, McasDataConnectorDataTypes dataTypes) : base(id, name, type, systemData, etag, kind)
        {
            TenantId = tenantId;
            DataTypes = dataTypes;
            Kind = kind;
