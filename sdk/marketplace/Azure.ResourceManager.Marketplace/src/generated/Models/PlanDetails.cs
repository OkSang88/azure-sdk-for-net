...
namespace MarketplaceRPService.Models
{
    ...
    public partial class PlanDetails
    {
        ...
        internal PlanDetails(string planId, Status? status, object requestDate, string justification, string subscriptionId, string subscriptionName)
        {
            PlanId = planId;
            Status = status;
