...
{
    /// <summary> A Class representing a Database along with the instance operations that can be performed on it. </summary>
    public partial class Database : ArmResource
    {
        /// <summary> Generate the resource identifier of a <see cref="Database"/> instance. </summary>
        ...
        /// <summary> Initializes a new instance of the <see cref="Database"/> class for mocking. </summary>
        protected Database()
        {
        }
        ...
        internal Database(ArmResource options, DatabaseData data) : base(options, data.Id)
        {
            HasData = true;
            _data = data;
        ...
        internal Database(ArmResource options, ResourceIdentifier id) : base(options, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _databasesRestClient = new DatabasesRestOperations(_clientDiagnostics, Pipeline, ClientOptions, BaseUri);
#if DEBUG
        ...
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal Database(ArmClientOptions clientOptions, TokenCredential credential, Uri uri, HttpPipeline pipeline, ResourceIdentifier id) : base(clientOptions, credential, uri, pipeline, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _databasesRestClient = new DatabasesRestOperations(_clientDiagnostics, Pipeline, ClientOptions, BaseUri);
#if DEBUG
        ...
        public async virtual Task<Response<Database>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("Database.Get");
            scope.Start();
            try
            {
        ...
        /// <summary> Gets information about a database. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<Database> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("Database.Get");
            scope.Start();
            try
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("Database.GetAvailableLocations");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("Database.Delete");
            scope.Start();
            try
            {
