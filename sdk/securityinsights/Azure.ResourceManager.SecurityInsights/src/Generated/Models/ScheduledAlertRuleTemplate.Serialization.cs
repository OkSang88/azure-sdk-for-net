...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    public partial class ScheduledAlertRuleTemplate : IUtf8JsonSerializable
    {
        ...
        internal static ScheduledAlertRuleTemplate DeserializeScheduledAlertRuleTemplate(JsonElement element)
        {
            ...
            return new ScheduledAlertRuleTemplate(id, name, type, systemData, kind, Optional.ToNullable(alertRulesCreatedByTemplateCount), Optional.ToNullable(lastUpdatedDateUTC), Optional.ToNullable(createdDateUTC), description.Value, displayName.Value, Optional.ToList(requiredDataConnectors), Optional.ToNullable(status), query.Value, Optional.ToNullable(severity), Optional.ToList(tactics), version.Value, Optional.ToDictionary(customDetails), Optional.ToList(entityMappings), alertDetailsOverride.Value, Optional.ToNullable(queryFrequency), Optional.ToNullable(queryPeriod), Optional.ToNullable(triggerOperator), Optional.ToNullable(triggerThreshold), eventGroupingSettings.Value);
        }
    }
}
