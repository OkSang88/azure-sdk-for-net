...
namespace DataFactoryManagementClient.Models
{
    ...
    public partial class LinkedIntegrationRuntime
    {
        ...
        /// <param name="createTime"> The creating time of the linked integration runtime. </param>
        internal LinkedIntegrationRuntime(string name, string subscriptionId, string dataFactoryName, string dataFactoryLocation, DateTimeOffset? createTime)
        {
            Name = name;
