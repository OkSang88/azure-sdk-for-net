...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class HdfsReadSettings : IUtf8JsonSerializable
    {
        ...
        internal static HdfsReadSettings DeserializeHdfsReadSettings(JsonElement element)
        {
            ...
            return new HdfsReadSettings(type, maxConcurrentConnections.Value, disableMetricsCollection.Value, additionalProperties, recursive.Value, wildcardFolderPath.Value, wildcardFileName.Value, fileListPath.Value, Optional.ToNullable(enablePartitionDiscovery), partitionRootPath.Value, modifiedDatetimeStart.Value, modifiedDatetimeEnd.Value, distcpSettings.Value, deleteFilesAfterCompletion.Value);
        }
    }
}
