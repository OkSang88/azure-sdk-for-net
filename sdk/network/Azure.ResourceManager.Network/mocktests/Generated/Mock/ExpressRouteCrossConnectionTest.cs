...
namespace Azure.ResourceManager.Network.Tests.Mock
{
    ...
    public partial class ExpressRouteCrossConnectionMockTests : MockTestBase
    {
        ...
        public async Task GetAsync()
        {
            ...
            var expressRouteCrossConnection = GetArmClient().GetExpressRouteCrossConnection(new ResourceIdentifier("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/CrossConnection-SiliconValley/providers/Microsoft.Network/expressRouteCrossConnections/<circuitServiceKey>"));
