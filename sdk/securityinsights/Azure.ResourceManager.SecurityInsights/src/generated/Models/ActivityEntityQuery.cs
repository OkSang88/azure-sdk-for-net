...
namespace SecurityInsights.Models
{
    ...
    public partial class ActivityEntityQuery : EntityQueryData
    {
        /// <summary> Initializes a new instance of ActivityEntityQuery. </summary>
        ...
        internal ActivityEntityQuery(ResourceIdentifier id, string name, ResourceType type, SystemData systemData, string etag, EntityQueryKind kind, string title, string content, string description, ActivityEntityQueriesPropertiesQueryDefinitions queryDefinitions, EntityType? inputEntityType, IList<IList<string>> requiredInputFieldsSets, IDictionary<string, IList<string>> entitiesFilter, string templateName, bool? enabled, DateTimeOffset? createdTimeUtc, DateTimeOffset? lastModifiedTimeUtc) : base(id, name, type, systemData, etag, kind)
        {
            Title = title;
            Content = content;
