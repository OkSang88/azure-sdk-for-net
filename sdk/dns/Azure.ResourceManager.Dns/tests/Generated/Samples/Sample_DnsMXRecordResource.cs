...
{
    public partial class Sample_DnsMXRecordResource
    {
        // Patch A recordset
        ...
        public async Task Update_PatchARecordset()
        {
            ...
            // this example assumes you already have this DnsMXRecordResource created on azure
            // for more information of creating DnsMXRecordResource, please refer to the document of DnsMXRecordResource
            string subscriptionId = "subid";
            string resourceGroupName = "rg1";
            string zoneName = "zone1";
            string relativeRecordSetName = "record1";
            ResourceIdentifier dnsMXRecordResourceId = DnsMXRecordResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, zoneName, relativeRecordSetName);
            DnsMXRecordResource dnsMXRecord = client.GetDnsMXRecordResource(dnsMXRecordResourceId);
...
["key2"] = "value2",
            ...
            DnsMXRecordResource result = await dnsMXRecord.UpdateAsync(data);
...
["key2"] = "value2",
        ...
        public async Task Delete_DeleteARecordset()
        {
            ...
            // invoke the operation
            await dnsMXRecord.DeleteAsync(WaitUntil.Completed);
        ...
        public async Task Get_GetARecordset()
        {
            ...
            // invoke the operation
            DnsMXRecordResource result = await dnsMXRecord.GetAsync();
