...
namespace Azure.ResourceManager.AppPlatform
{
    ...
    public partial class DeploymentResource : ArmResource
    {
        ...
        internal DeploymentResource(ArmResource options, DeploymentResourceData data) : base(options, data.Id)
        {
            HasData = true;
            _data = data;
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("DeploymentResource.GetAvailableLocations");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async virtual Task<DeploymentResourceDeleteOperation> DeleteAsync(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new DeploymentResourceDeleteOperation(_clientDiagnostics, Pipeline, _deploymentsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name).Request, response);
        ...
        /// <param name="waitForCompletion"> Waits for the completion of the long running operations. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual DeploymentResourceDeleteOperation Delete(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("DeploymentResource.Delete");
            scope.Start();
            try
        ...
        public async virtual Task<DeploymentResourceUpdateOperation> UpdateAsync(bool waitForCompletion, DeploymentResourceData deploymentResource, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new DeploymentResourceUpdateOperation(this, _clientDiagnostics, Pipeline, _deploymentsRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, deploymentResource).Request, response);
                if (waitForCompletion)
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="deploymentResource"/> is null. </exception>
        public virtual DeploymentResourceUpdateOperation Update(bool waitForCompletion, DeploymentResourceData deploymentResource, CancellationToken cancellationToken = default)
        {
            if (deploymentResource == null)
            {
                throw new ArgumentNullException(nameof(deploymentResource));
        ...
        /// <param name="waitForCompletion"> Waits for the completion of the long running operations. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async virtual Task<DeploymentResourceStartOperation> StartAsync(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new DeploymentResourceStartOperation(_clientDiagnostics, Pipeline, _deploymentsRestClient.CreateStartRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name).Request, response);
                if (waitForCompletion)
                    await operation.WaitForCompletionResponseAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        /// <param name="waitForCompletion"> Waits for the completion of the long running operations. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual DeploymentResourceStartOperation Start(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("DeploymentResource.Start");
            scope.Start();
            try
        ...
        /// <param name="waitForCompletion"> Waits for the completion of the long running operations. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async virtual Task<DeploymentResourceStopOperation> StopAsync(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new DeploymentResourceStopOperation(_clientDiagnostics, Pipeline, _deploymentsRestClient.CreateStopRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name).Request, response);
                if (waitForCompletion)
                    await operation.WaitForCompletionResponseAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        /// <param name="waitForCompletion"> Waits for the completion of the long running operations. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual DeploymentResourceStopOperation Stop(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("DeploymentResource.Stop");
            scope.Start();
            try
        ...
        /// <param name="waitForCompletion"> Waits for the completion of the long running operations. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async virtual Task<DeploymentResourceRestartOperation> RestartAsync(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new DeploymentResourceRestartOperation(_clientDiagnostics, Pipeline, _deploymentsRestClient.CreateRestartRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name).Request, response);
                if (waitForCompletion)
                    await operation.WaitForCompletionResponseAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        /// <param name="waitForCompletion"> Waits for the completion of the long running operations. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual DeploymentResourceRestartOperation Restart(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("DeploymentResource.Restart");
            scope.Start();
            try
        ...
        public async virtual Task<DeploymentResourceGenerateHeapDumpOperation> GenerateHeapDumpAsync(bool waitForCompletion, DiagnosticParameters diagnosticParameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new DeploymentResourceGenerateHeapDumpOperation(_clientDiagnostics, Pipeline, _deploymentsRestClient.CreateGenerateHeapDumpRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, diagnosticParameters).Request, response);
                if (waitForCompletion)
                    await operation.WaitForCompletionResponseAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="diagnosticParameters"/> is null. </exception>
        public virtual DeploymentResourceGenerateHeapDumpOperation GenerateHeapDump(bool waitForCompletion, DiagnosticParameters diagnosticParameters, CancellationToken cancellationToken = default)
        {
            if (diagnosticParameters == null)
            {
                throw new ArgumentNullException(nameof(diagnosticParameters));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="diagnosticParameters"/> is null. </exception>
        public async virtual Task<DeploymentResourceGenerateThreadDumpOperation> GenerateThreadDumpAsync(bool waitForCompletion, DiagnosticParameters diagnosticParameters, CancellationToken cancellationToken = default)
        {
            if (diagnosticParameters == null)
            {
                throw new ArgumentNullException(nameof(diagnosticParameters));
            ...
            try
            {
                ...
                var operation = new DeploymentResourceGenerateThreadDumpOperation(_clientDiagnostics, Pipeline, _deploymentsRestClient.CreateGenerateThreadDumpRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, diagnosticParameters).Request, response);
                if (waitForCompletion)
                    await operation.WaitForCompletionResponseAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="diagnosticParameters"/> is null. </exception>
        public virtual DeploymentResourceGenerateThreadDumpOperation GenerateThreadDump(bool waitForCompletion, DiagnosticParameters diagnosticParameters, CancellationToken cancellationToken = default)
        {
            if (diagnosticParameters == null)
            {
                throw new ArgumentNullException(nameof(diagnosticParameters));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="diagnosticParameters"/> is null. </exception>
        public async virtual Task<DeploymentResourceStartJFROperation> StartJFRAsync(bool waitForCompletion, DiagnosticParameters diagnosticParameters, CancellationToken cancellationToken = default)
        {
            if (diagnosticParameters == null)
            {
                throw new ArgumentNullException(nameof(diagnosticParameters));
            ...
            try
            {
                ...
                var operation = new DeploymentResourceStartJFROperation(_clientDiagnostics, Pipeline, _deploymentsRestClient.CreateStartJFRRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, diagnosticParameters).Request, response);
                if (waitForCompletion)
                    await operation.WaitForCompletionResponseAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="diagnosticParameters"/> is null. </exception>
        public virtual DeploymentResourceStartJFROperation StartJFR(bool waitForCompletion, DiagnosticParameters diagnosticParameters, CancellationToken cancellationToken = default)
        {
            if (diagnosticParameters == null)
            {
                throw new ArgumentNullException(nameof(diagnosticParameters));
