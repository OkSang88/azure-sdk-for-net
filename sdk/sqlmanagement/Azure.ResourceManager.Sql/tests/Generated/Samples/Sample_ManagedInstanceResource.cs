...
["tagKey1"] = "TagValue1",
        ...
        public async Task GetTopQueries_ObtainListOfInstanceSTopResourceConsumingQueries()
        {
            ...
            SqlMetricType? observationMetric = SqlMetricType.Duration;
            await foreach (TopQueries item in managedInstance.GetTopQueriesAsync(interval: interval, observationMetric: observationMetric))
            {
        ...
        public async Task GetTopQueries_ObtainListOfInstanceSTopResourceConsumingQueriesFullBlownRequestAndResponse()
        {
            ...
            SqlMetricType? observationMetric = SqlMetricType.Cpu;
            await foreach (TopQueries item in managedInstance.GetTopQueriesAsync(databases: databases, startTime: startTime, endTime: endTime, interval: interval, observationMetric: observationMetric))
            {
                Console.WriteLine($"Succeeded: {item}");
            }
