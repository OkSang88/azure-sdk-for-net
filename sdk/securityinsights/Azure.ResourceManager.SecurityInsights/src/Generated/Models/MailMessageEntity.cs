...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class MailMessageEntity : EntityData
    {
        ...
        internal MailMessageEntity(ResourceIdentifier id, string name, ResourceType type, SystemData systemData, EntityKind kind, IReadOnlyDictionary<string, object> additionalData, string friendlyName, IReadOnlyList<string> fileEntityIds, string recipient, IReadOnlyList<string> urls, IReadOnlyList<string> threats, string p1Sender, string p1SenderDisplayName, string p1SenderDomain, string senderIP, string p2Sender, string p2SenderDisplayName, string p2SenderDomain, DateTimeOffset? receiveDate, Guid? networkMessageId, string internetMessageId, string subject, string language, IReadOnlyList<string> threatDetectionMethods, int? bodyFingerprintBin1, int? bodyFingerprintBin2, int? bodyFingerprintBin3, int? bodyFingerprintBin4, int? bodyFingerprintBin5, AntispamMailDirection? antispamDirection, DeliveryAction? deliveryAction, DeliveryLocation? deliveryLocation) : base(id, name, type, systemData, kind)
        {
