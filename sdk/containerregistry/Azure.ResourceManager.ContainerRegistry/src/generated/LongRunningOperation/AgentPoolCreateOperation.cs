...
namespace ContainerRegistryManagementClient.Models
{
    ...
    public partial class AgentPoolCreateOperation : Operation<AgentPool>, IOperationSource<AgentPool>
    {
        private readonly OperationInternals<AgentPool> _operation;

        private readonly ArmResource _operationBase;

        /// <summary> Initializes a new instance of AgentPoolCreateOperation for mocking. </summary>
        protected AgentPoolCreateOperation()
        {
        }

        internal AgentPoolCreateOperation(ArmResource operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Azure.Core.Request request, Response response)
        {
            _operation = new OperationInternals<AgentPool>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "AgentPoolCreateOperation");
