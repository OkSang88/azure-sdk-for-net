...
namespace AppPlatformManagementClient.Models
{
    public partial class NetworkProfile : IUtf8JsonSerializable
    {
        ...
        {
            Optional<string> serviceRuntimeSubnetId = default;
            Optional<string> appSubnetId = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    serviceRuntimeSubnetId = property.Value.GetString();
                    continue;
                }
                if (property.NameEquals("appSubnetId"))
                {
                    appSubnetId = property.Value.GetString();
                    continue;
                }
