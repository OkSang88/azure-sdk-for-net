...
namespace Azure.ResourceManager.MachineLearningCompute
{
    ...
    {
        private static MachineLearningComputeRestOperations GetMachineLearningComputeRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions clientOptions, Uri endpoint = null, string apiVersion = default)
        {
            return new MachineLearningComputeRestOperations(clientDiagnostics, pipeline, clientOptions, endpoint, apiVersion);
        }
        ...
        public static AsyncPageable<ResourceOperation> GetAvailableOperationsMachineLearningComputesAsync(this Tenant tenant, CancellationToken cancellationToken = default)
        {
            return tenant.UseClientContext((baseUri, credential, options, pipeline) =>
            {
                ...
                MachineLearningComputeRestOperations restOperations = GetMachineLearningComputeRestOperations(clientDiagnostics, pipeline, options, baseUri);
