...
namespace DataFactoryManagementClient.Models
{
    ...
    public partial class GlobalParameterSpecification
    {
        ...
        /// <param name="type"> Global Parameter type. </param>
        /// <param name="value"> Value of parameter. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="value"/> is null. </exception>
        public GlobalParameterSpecification(GlobalParameterType type, object value)
        {
            if (value == null)
            {
        ...
        public GlobalParameterType Type { get; set; }
