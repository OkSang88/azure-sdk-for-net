...
namespace Azure.ResourceManager.ServiceFabric
{
    ...
    public partial class ClusterCollection : ArmCollection, IEnumerable<Cluster>, IAsyncEnumerable<Cluster>
    {
        ...
        internal ClusterCollection(ArmResource parent) : base(parent)
        {
            ...
            ClientOptions.TryGetApiVersion(Cluster.ResourceType, out string apiVersion);
        ...
        public virtual ClusterCreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, string clusterName, ClusterData parameters, CancellationToken cancellationToken = default)
        {
            if (clusterName == null)
            {
            ...
            try
            {
                var response = _clustersRestClient.CreateOrUpdate(Id.SubscriptionId, Id.ResourceGroupName, clusterName, parameters, cancellationToken);
                var operation = new ClusterCreateOrUpdateOperation(this, _clientDiagnostics, Pipeline, _clustersRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, clusterName, parameters).Request, response);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="clusterName"/> or <paramref name="parameters"/> is null. </exception>
        public async virtual Task<ClusterCreateOrUpdateOperation> CreateOrUpdateAsync(bool waitForCompletion, string clusterName, ClusterData parameters, CancellationToken cancellationToken = default)
        {
            if (clusterName == null)
            {
                throw new ArgumentNullException(nameof(clusterName));
            ...
            try
            {
                var response = await _clustersRestClient.CreateOrUpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, clusterName, parameters, cancellationToken).ConfigureAwait(false);
                var operation = new ClusterCreateOrUpdateOperation(this, _clientDiagnostics, Pipeline, _clustersRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, clusterName, parameters).Request, response);
                if (waitForCompletion)
        ...
        public virtual Pageable<Cluster> GetAll(CancellationToken cancellationToken = default)
        {
            Page<Cluster> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    ...
                    return Page.FromValues(response.Value.Value.Select(value => new Cluster(this, value)), null, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
