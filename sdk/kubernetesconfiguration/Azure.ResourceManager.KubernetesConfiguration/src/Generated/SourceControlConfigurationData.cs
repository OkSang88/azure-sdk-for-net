...
{
    /// <summary> A class representing the SourceControlConfiguration data model. </summary>
    public partial class SourceControlConfigurationData : Resource
    {
        /// <summary> Initializes a new instance of SourceControlConfigurationData. </summary>
        ...
        /// <param name="repositoryUrl"> Url of the SourceControl Repository. </param>
        ...
        /// <param name="enableHelmOperator"> Option to enable Helm Operator for this git configuration. </param>
        ...
        internal SourceControlConfigurationData(ResourceIdentifier id, string name, ResourceType type, SystemData systemData, string repositoryUrl, string operatorNamespace, string operatorInstanceName, OperatorType? operatorType, string operatorParams, IDictionary<string, string> configurationProtectedSettings, OperatorScopeType? operatorScope, string repositoryPublicKey, string sshKnownHostsContents, bool? enableHelmOperator, HelmOperatorProperties helmOperatorProperties, ProvisioningStateType? provisioningState, ComplianceStatus complianceStatus) : base(id, name, type)
        {
