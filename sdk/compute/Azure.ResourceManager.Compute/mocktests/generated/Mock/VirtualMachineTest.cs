...
namespace Azure.ResourceManager.Compute.Tests.Mock
{
    ...
    public partial class VirtualMachineMockTests : MockTestBase
    {
        ...
        public async Task GetAsync()
        {
            ...
            var virtualMachine = GetArmClient().GetVirtualMachine(new ResourceIdentifier("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/myResourceGroup/providers/Microsoft.Compute/virtualMachines/myVM"));
        ...
        public async Task GeneralizeAsync()
        {
            ...
            var virtualMachine = GetArmClient().GetVirtualMachine(new ResourceIdentifier("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/myResourceGroup/providers/Microsoft.Compute/virtualMachines/myVMName"));

            await virtualMachine.GeneralizeAsync();
        }

        [RecordedTest]
        public void GetAvailableSizesAsync()
        {
        ...
        public async Task ReapplyAsync()
        {
            ...
            var virtualMachine = GetArmClient().GetVirtualMachine(new ResourceIdentifier("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/ResourceGroup/providers/Microsoft.Compute/virtualMachines/VMName"));
        ...
        public async Task AssessPatchesAsync()
        {
            ...
            var virtualMachine = GetArmClient().GetVirtualMachine(new ResourceIdentifier("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/myResourceGroupName/providers/Microsoft.Compute/virtualMachines/myVMName"));
        ...
        public async Task RunCommandAsync()
        {
            ...
            var virtualMachine = GetArmClient().GetVirtualMachine(new ResourceIdentifier("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/crptestar98131/providers/Microsoft.Compute/virtualMachines/vm3036"));
