...
namespace Azure.ResourceManager.Quota
{
    internal partial class QuotaRequestStatusRestOperations
    {
        ...
        public QuotaRequestStatusRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, Uri endpoint = null, string apiVersion = default)
        {
            this.endpoint = endpoint ?? new Uri("https://management.azure.com");
            this.apiVersion = apiVersion ?? "2021-03-15-preview";
        ...
        public async Task<Response<QuotaRequestDetailsData>> GetAsync(string scope, string id, CancellationToken cancellationToken = default)
        {
            if (scope == null)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="scope"/> or <paramref name="id"/> is null. </exception>
        public Response<QuotaRequestDetailsData> Get(string scope, string id, CancellationToken cancellationToken = default)
        {
            if (scope == null)
            {
                throw new ArgumentNullException(nameof(scope));
