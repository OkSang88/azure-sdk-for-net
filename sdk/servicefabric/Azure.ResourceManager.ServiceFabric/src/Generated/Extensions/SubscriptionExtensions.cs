...
namespace Azure.ResourceManager.ServiceFabric
{
    ...
    public static partial class SubscriptionExtensions
    {
        ...
        private static ClusterVersionsRestOperations GetClusterVersionsRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions clientOptions, Uri endpoint = null, string apiVersion = default)
        {
            return new ClusterVersionsRestOperations(clientDiagnostics, pipeline, clientOptions, endpoint, apiVersion);
        }
        ...
        public static AsyncPageable<ClusterCodeVersionsResult> GetClusterVersionsAsync(this Subscription subscription, string location, string clusterVersion, CancellationToken cancellationToken = default)
        {
            ...
            {
                var clientDiagnostics = new ClientDiagnostics(options);
                ClusterVersionsRestOperations restOperations = GetClusterVersionsRestOperations(clientDiagnostics, pipeline, options, baseUri);
