...
{
    public partial class FusionAlertRuleTemplate : IUtf8JsonSerializable
    {
        ...
        internal static FusionAlertRuleTemplate DeserializeFusionAlertRuleTemplate(JsonElement element)
        {
            ...
            return new FusionAlertRuleTemplate(id, name, type, systemData, kind, Optional.ToNullable(alertRulesCreatedByTemplateCount), Optional.ToNullable(lastUpdatedDateUTC), Optional.ToNullable(createdDateUTC), description.Value, displayName.Value, Optional.ToList(requiredDataConnectors), Optional.ToNullable(status), Optional.ToNullable(severity), Optional.ToList(tactics));
        }
    }
}
