...
namespace DataFactoryManagementClient.Tests.Mock
{
    ...
    public partial class IntegrationRuntimeResourceMockTests : MockTestBase
    {
        ...
        public async Task Get()
        {
            ...
            var integrationRuntimeResourceId = DataFactoryManagementClient.IntegrationRuntimeResource.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "exampleResourceGroup", "exampleFactoryName", "exampleIntegrationRuntime");
        ...
        public async Task Update()
        {
            ...
            var integrationRuntimeResourceId = DataFactoryManagementClient.IntegrationRuntimeResource.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "exampleResourceGroup", "exampleFactoryName", "exampleIntegrationRuntime");
            var integrationRuntimeResource = GetArmClient().GetIntegrationRuntimeResource(integrationRuntimeResourceId);
            DataFactoryManagementClient.Models.UpdateIntegrationRuntimeRequest updateIntegrationRuntimeRequest = new DataFactoryManagementClient.Models.UpdateIntegrationRuntimeRequest()
            {
                AutoUpdate = new DataFactoryManagementClient.Models.IntegrationRuntimeAutoUpdate("Off"),
        ...
        public async Task RegenerateAuthKey()
        {
            ...
            var integrationRuntimeResourceId = DataFactoryManagementClient.IntegrationRuntimeResource.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "exampleResourceGroup", "exampleFactoryName", "exampleIntegrationRuntime");
            var integrationRuntimeResource = GetArmClient().GetIntegrationRuntimeResource(integrationRuntimeResourceId);
            DataFactoryManagementClient.Models.IntegrationRuntimeRegenerateKeyParameters regenerateKeyParameters = new DataFactoryManagementClient.Models.IntegrationRuntimeRegenerateKeyParameters()
            {
                KeyName = new DataFactoryManagementClient.Models.IntegrationRuntimeAuthKeyName("authKey2"),
            };
        ...
        public async Task Start()
        {
            ...
            var integrationRuntimeResourceId = DataFactoryManagementClient.IntegrationRuntimeResource.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "exampleResourceGroup", "exampleFactoryName", "exampleManagedIntegrationRuntime");
            var integrationRuntimeResource = GetArmClient().GetIntegrationRuntimeResource(integrationRuntimeResourceId);
        ...
        public async Task RemoveLinks()
        {
            ...
            var integrationRuntimeResourceId = DataFactoryManagementClient.IntegrationRuntimeResource.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "exampleResourceGroup", "exampleFactoryName", "exampleIntegrationRuntime");
            var integrationRuntimeResource = GetArmClient().GetIntegrationRuntimeResource(integrationRuntimeResourceId);
            DataFactoryManagementClient.Models.LinkedIntegrationRuntimeRequest linkedIntegrationRuntimeRequest = new DataFactoryManagementClient.Models.LinkedIntegrationRuntimeRequest(linkedFactoryName: "exampleFactoryName-linked");
        ...
        public async Task CreateLinkedIntegrationRuntime()
        {
            ...
            var integrationRuntimeResourceId = DataFactoryManagementClient.IntegrationRuntimeResource.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "exampleResourceGroup", "exampleFactoryName", "exampleIntegrationRuntime");
            var integrationRuntimeResource = GetArmClient().GetIntegrationRuntimeResource(integrationRuntimeResourceId);
            DataFactoryManagementClient.Models.CreateLinkedIntegrationRuntimeRequest createLinkedIntegrationRuntimeRequest = new DataFactoryManagementClient.Models.CreateLinkedIntegrationRuntimeRequest()
            {
        ...
        public async Task RefreshIntegrationRuntimeObjectMetadata()
        {
            ...
            var integrationRuntimeResourceId = DataFactoryManagementClient.IntegrationRuntimeResource.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "exampleResourceGroup", "exampleFactoryName", "testactivityv2");
            var integrationRuntimeResource = GetArmClient().GetIntegrationRuntimeResource(integrationRuntimeResourceId);
        ...
        public async Task GetAllIntegrationRuntimeObjectMetadata()
        {
            ...
            var integrationRuntimeResourceId = DataFactoryManagementClient.IntegrationRuntimeResource.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "exampleResourceGroup", "exampleFactoryName", "testactivityv2");
            var integrationRuntimeResource = GetArmClient().GetIntegrationRuntimeResource(integrationRuntimeResourceId);
            DataFactoryManagementClient.Models.GetSsisObjectMetadataRequest getMetadataRequest = new DataFactoryManagementClient.Models.GetSsisObjectMetadataRequest()
            {
        ...
        public async Task UpdateIntegrationRuntimeNode()
        {
            ...
            var integrationRuntimeResource = GetArmClient().GetIntegrationRuntimeResource(integrationRuntimeResourceId);
            string nodeName = "Node_1";
            DataFactoryManagementClient.Models.UpdateIntegrationRuntimeNodeRequest updateIntegrationRuntimeNodeRequest = new DataFactoryManagementClient.Models.UpdateIntegrationRuntimeNodeRequest()
            {
