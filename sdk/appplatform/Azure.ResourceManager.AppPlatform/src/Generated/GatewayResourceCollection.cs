...
namespace Azure.ResourceManager.AppPlatform
{
    ...
    public partial class GatewayResourceCollection : ArmCollection, IEnumerable<GatewayResource>, IAsyncEnumerable<GatewayResource>
    {
        ...
        internal GatewayResourceCollection(ArmResource parent) : base(parent)
        {
            ...
            ClientOptions.TryGetApiVersion(GatewayResource.ResourceType, out string apiVersion);
        ...
        public virtual GatewayResourceCreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, string gatewayName, GatewayResourceData gatewayResource, CancellationToken cancellationToken = default)
        {
            if (gatewayName == null)
            {
            ...
            try
            {
                ...
                var operation = new GatewayResourceCreateOrUpdateOperation(this, _clientDiagnostics, Pipeline, _gatewaysRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, gatewayName, gatewayResource).Request, response);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="gatewayName"/> or <paramref name="gatewayResource"/> is null. </exception>
        public async virtual Task<GatewayResourceCreateOrUpdateOperation> CreateOrUpdateAsync(bool waitForCompletion, string gatewayName, GatewayResourceData gatewayResource, CancellationToken cancellationToken = default)
        {
            if (gatewayName == null)
            {
                throw new ArgumentNullException(nameof(gatewayName));
        ...
        public virtual Pageable<GatewayResource> GetAll(CancellationToken cancellationToken = default)
        {
            Page<GatewayResource> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    ...
                    return Page.FromValues(response.Value.Value.Select(value => new GatewayResource(this, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
