...
namespace NotificationHubsManagementClient.Models
{
    ...
    {
        /// <summary> Initializes a new instance of NotificationHubCreateOrUpdateParameters. </summary>
        /// <param name="location"> The location. </param>
        public NotificationHubCreateOrUpdateParameters(AzureLocation location) : base(location)
        {
        ...
        internal NotificationHubCreateOrUpdateParameters(ResourceIdentifier id, string name, ResourceType type, IDictionary<string, string> tags, AzureLocation location, Sku sku, string namePropertiesName, string registrationTtl, IList<SharedAccessAuthorizationRuleProperties> authorizationRules, ApnsCredential apnsCredential, WnsCredential wnsCredential, GcmCredential gcmCredential, MpnsCredential mpnsCredential, AdmCredential admCredential, BaiduCredential baiduCredential) : base(id, name, type, tags, location, sku)
        {
