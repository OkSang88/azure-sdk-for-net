...
namespace Azure.ResourceManager.SignalR
{
    ...
    public partial class SignalRResourceCollection : ArmCollection, IEnumerable<SignalRResource>, IAsyncEnumerable<SignalRResource>
    {
        ...
        internal SignalRResourceCollection(ArmResource parent) : base(parent)
        {
            ...
            ClientOptions.TryGetApiVersion(SignalRResource.ResourceType, out string apiVersion);
        ...
        public virtual SignalRResourceCreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, string resourceName, SignalRResourceData parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new SignalRResourceCreateOrUpdateOperation(this, _clientDiagnostics, Pipeline, _signalRRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, resourceName, parameters).Request, response);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceName"/> or <paramref name="parameters"/> is null. </exception>
        public async virtual Task<SignalRResourceCreateOrUpdateOperation> CreateOrUpdateAsync(bool waitForCompletion, string resourceName, SignalRResourceData parameters, CancellationToken cancellationToken = default)
        {
            if (resourceName == null)
            {
                throw new ArgumentNullException(nameof(resourceName));
        ...
        public virtual Pageable<SignalRResource> GetAll(CancellationToken cancellationToken = default)
        {
            Page<SignalRResource> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    ...
                    return Page.FromValues(response.Value.Value.Select(value => new SignalRResource(this, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
