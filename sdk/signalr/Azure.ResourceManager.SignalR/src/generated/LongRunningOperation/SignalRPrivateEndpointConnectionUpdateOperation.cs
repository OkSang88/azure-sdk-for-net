...
namespace SignalRManagementClient.Models
{
    ...
    public partial class SignalRPrivateEndpointConnectionUpdateOperation : Operation<PrivateEndpointConnection>
    {
        private readonly OperationOrResponseInternals<PrivateEndpointConnection> _operation;

        /// <summary> Initializes a new instance of SignalRPrivateEndpointConnectionUpdateOperation for mocking. </summary>
        protected SignalRPrivateEndpointConnectionUpdateOperation()
        {
        }

        internal SignalRPrivateEndpointConnectionUpdateOperation(ArmResource operationsBase, Response<PrivateEndpointConnectionData> response)
        {
