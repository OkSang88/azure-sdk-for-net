...
{
    public partial class ServiceBusQueueMessage : IUtf8JsonSerializable
    {
        ...
        internal static ServiceBusQueueMessage DeserializeServiceBusQueueMessage(JsonElement element)
        {
            ...
            return new ServiceBusQueueMessage(authentication.Value, brokeredMessageProperties.Value, Optional.ToDictionary(customMessageProperties), message.Value, @namespace.Value, Optional.ToNullable(transportType), queueName.Value);
        }
    }
}
