...
namespace MicrosoftStorageSync
{
    ...
    public partial class SyncGroup : ArmResource
    {
        ...
        public async virtual Task<Response<SyncGroup>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _syncGroupsRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<SyncGroup> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _syncGroupsRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
        ...
        public async virtual Task<SyncGroupDeleteOperation> DeleteAsync(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _syncGroupsRestClient.DeleteAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new SyncGroupDeleteOperation(response);
        ...
        public virtual SyncGroupDeleteOperation Delete(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _syncGroupsRestClient.Delete(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                var operation = new SyncGroupDeleteOperation(response);
                if (waitForCompletion)
        ...
        /// <summary> Gets a collection of CloudEndpoints in the SyncGroup. </summary>
        /// <returns> An object representing collection of CloudEndpoints and their operations over a SyncGroup. </returns>
        public virtual CloudEndpointCollection GetCloudEndpoints()
        {
            return new CloudEndpointCollection(this);
        }
        #endregion

        #region ServerEndpoint

        /// <summary> Gets a collection of ServerEndpoints in the SyncGroup. </summary>
        /// <returns> An object representing collection of ServerEndpoints and their operations over a SyncGroup. </returns>
        public virtual ServerEndpointCollection GetServerEndpoints()
        {
            return new ServerEndpointCollection(this);
        }
        #endregion
    }
}
