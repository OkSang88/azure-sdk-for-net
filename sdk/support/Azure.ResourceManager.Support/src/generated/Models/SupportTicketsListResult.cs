...
namespace MicrosoftSupport.Models
{
    ...
    internal partial class SupportTicketsListResult
    {
        ...
        {
            Value = new ChangeTrackingList<SupportTicketDetailsData>();
        }
        ...
        internal SupportTicketsListResult(IReadOnlyList<SupportTicketDetailsData> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
        ...
        public IReadOnlyList<SupportTicketDetailsData> Value { get; }
