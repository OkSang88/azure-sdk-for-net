    ...
    public partial class CertificateResource : ArmResource
    {
        ...
        public async virtual Task<CertificateDeleteOperation> DeleteAsync(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new CertificateDeleteOperation(_clientDiagnostics, Pipeline, _certificatesRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response);
