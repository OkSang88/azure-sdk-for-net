...
namespace Azure.ResourceManager.KubernetesConfiguration.Models
{
    public partial class KustomizationDefinition : IUtf8JsonSerializable
    {
        ...
        internal static KustomizationDefinition DeserializeKustomizationDefinition(JsonElement element)
        {
            ...
            Optional<IList<DependsOnDefinition>> dependsOn = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("dependsOn"))
                {
                    ...
                    List<DependsOnDefinition> array = new List<DependsOnDefinition>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(DependsOnDefinition.DeserializeDependsOnDefinition(item));
                    }
                    dependsOn = array;
                    continue;
                }
            ...
            return new KustomizationDefinition(path.Value, Optional.ToList(dependsOn), Optional.ToNullable(timeoutInSeconds), Optional.ToNullable(syncIntervalInSeconds), Optional.ToNullable(retryIntervalInSeconds), Optional.ToNullable(prune), Optional.ToNullable(force));
        }
    }
}
