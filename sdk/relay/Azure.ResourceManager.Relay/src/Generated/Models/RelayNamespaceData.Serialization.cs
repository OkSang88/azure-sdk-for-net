...
namespace Azure.ResourceManager.Relay
{
    public partial class RelayNamespaceData : IUtf8JsonSerializable
    {
        ...
        internal static RelayNamespaceData DeserializeRelayNamespaceData(JsonElement element)
        {
            ...
            return new RelayNamespaceData(id, name, type, tags, location, sku.Value, Optional.ToNullable(provisioningState), Optional.ToNullable(createdAt), Optional.ToNullable(updatedAt), serviceBusEndpoint.Value, metricId.Value);
        }
    }
}
