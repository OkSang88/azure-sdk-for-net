...
namespace Azure.ResourceManager.Logz
{
    internal partial class SingleSignOnRestOperations
    {
        ...
        public SingleSignOnRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, Uri endpoint = null, string apiVersion = default)
        {
