...
namespace Azure.ResourceManager.HybridDataManager.Tests.Mock
{
    ...
    public partial class JobDefinitionCollectionMockTests : MockTestBase
    {
        ...
        public async Task CreateOrUpdate()
        {
            ...
            HybridDataManager.JobDefinitionData jobDefinition = new HybridDataManager.JobDefinitionData(dataSourceId: "/subscriptions/6e0219f5-327a-4365-904f-05eed4227ad7/resourceGroups/ResourceGroupForSDKTest/providers/Microsoft.HybridData/dataManagers/TestAzureSDKOperations/dataStores/TestStorSimpleSource1", dataSinkId: "/subscriptions/6e0219f5-327a-4365-904f-05eed4227ad7/resourceGroups/ResourceGroupForSDKTest/providers/Microsoft.HybridData/dataManagers/TestAzureSDKOperations/dataStores/TestAzureStorage1", state: HybridDataManager.Models.State.Enabled)
            {
                RunLocation = HybridDataManager.Models.RunLocation.Westus,
                UserConfirmation = HybridDataManager.Models.UserConfirmation.Required,
...
"TestAutomation",
            ...
            var dataServiceId = HybridDataManager.DataService.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "ResourceGroupForSDKTest", "TestAzureSDKOperations", "DataTransformation");
