...
namespace Insights.Models
{
    ...
    public partial class AutoscaleSettingDeleteOperation : Operation
    {
        private readonly OperationOrResponseInternals _operation;

        /// <summary> Initializes a new instance of AutoscaleSettingDeleteOperation for mocking. </summary>
        protected AutoscaleSettingDeleteOperation()
        {
        }

        internal AutoscaleSettingDeleteOperation(Azure.Response response)
        {
