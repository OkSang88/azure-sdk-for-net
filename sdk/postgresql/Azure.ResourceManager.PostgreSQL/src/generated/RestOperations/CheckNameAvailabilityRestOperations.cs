...
namespace PostgreSQLManagementClient
{
    internal partial class CheckNameAvailabilityRestOperations
    {
        ...
        public CheckNameAvailabilityRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ClientOptions options, Uri endpoint = null, string apiVersion = "2021-06-01")
        {
