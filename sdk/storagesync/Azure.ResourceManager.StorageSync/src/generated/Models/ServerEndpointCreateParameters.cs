...
namespace MicrosoftStorageSync.Models
{
    ...
    public partial class ServerEndpointCreateParameters : Resource
    {
        /// <summary> Initializes a new instance of ServerEndpointCreateParameters. </summary>
        ...
        internal ServerEndpointCreateParameters(ResourceIdentifier id, string name, ResourceType type, string serverLocalPath, FeatureStatus? cloudTiering, int? volumeFreeSpacePercent, int? tierFilesOlderThanDays, string friendlyName, string serverResourceId, FeatureStatus? offlineDataTransfer, string offlineDataTransferShareName, InitialDownloadPolicy? initialDownloadPolicy, LocalCacheMode? localCacheMode, InitialUploadPolicy? initialUploadPolicy) : base(id, name, type)
        {
