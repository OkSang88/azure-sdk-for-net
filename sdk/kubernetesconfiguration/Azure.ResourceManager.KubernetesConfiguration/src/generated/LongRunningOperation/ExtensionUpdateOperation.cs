...
namespace SourceControlConfigurationClient.Models
{
    ...
    public partial class ExtensionUpdateOperation : Operation<Extension>, IOperationSource<Extension>
    {
        ...
        {
            _operation = new OperationInternals<Extension>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.AzureAsyncOperation, "ExtensionUpdateOperation");
