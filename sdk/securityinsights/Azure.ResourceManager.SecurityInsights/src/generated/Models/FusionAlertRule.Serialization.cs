...
{
    public partial class FusionAlertRule : IUtf8JsonSerializable
    {
        ...
        internal static FusionAlertRule DeserializeFusionAlertRule(JsonElement element)
        {
            ...
            return new FusionAlertRule(id, name, type, systemData, etag.Value, kind, alertRuleTemplateName.Value, description.Value, displayName.Value, Optional.ToNullable(enabled), Optional.ToNullable(lastModifiedUtc), Optional.ToNullable(severity), Optional.ToList(tactics));
        }
    }
}
