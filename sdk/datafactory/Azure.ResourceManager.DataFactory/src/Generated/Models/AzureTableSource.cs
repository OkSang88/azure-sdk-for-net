...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AzureTableSource : TabularSource
    {
        ...
        internal AzureTableSource(string type, object sourceRetryCount, object sourceRetryWait, object maxConcurrentConnections, object disableMetricsCollection, IDictionary<string, object> additionalProperties, object queryTimeout, object additionalColumns, object azureTableSourceQuery, object azureTableSourceIgnoreTableNotFound) : base(type, sourceRetryCount, sourceRetryWait, maxConcurrentConnections, disableMetricsCollection, additionalProperties, queryTimeout, additionalColumns)
        {
