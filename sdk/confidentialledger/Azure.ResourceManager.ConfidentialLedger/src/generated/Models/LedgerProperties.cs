...
namespace ConfidentialLedger.Models
{
    ...
    public partial class LedgerProperties
    {
        ...
        internal LedgerProperties(string ledgerName, string ledgerUri, string identityServiceUri, string ledgerInternalNamespace, LedgerType? ledgerType, ProvisioningState? provisioningState, IList<AADBasedSecurityPrincipal> aadBasedSecurityPrincipals, IList<CertBasedSecurityPrincipal> certBasedSecurityPrincipals)
        {
