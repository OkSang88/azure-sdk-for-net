...
namespace Azure.ResourceManager.DeviceProvisioningServices
{
    ...
    public partial class ProvisioningServiceDescription : ArmResource
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async virtual Task<ProvisioningServiceDescriptionDeleteOperation> DeleteAsync(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ProvisioningServiceDescriptionDeleteOperation(_clientDiagnostics, Pipeline, _iotDpsResourceRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name).Request, response);
        ...
        /// <param name="waitForCompletion"> Waits for the completion of the long running operations. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual ProvisioningServiceDescriptionDeleteOperation Delete(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ProvisioningServiceDescription.Delete");
            scope.Start();
            try
        ...
        public async virtual Task<ProvisioningServiceDescriptionUpdateOperation> UpdateAsync(bool waitForCompletion, TagsResource provisioningServiceTags, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ProvisioningServiceDescriptionUpdateOperation(this, _clientDiagnostics, Pipeline, _iotDpsResourceRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, provisioningServiceTags).Request, response);
                if (waitForCompletion)
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="provisioningServiceTags"/> is null. </exception>
        public virtual ProvisioningServiceDescriptionUpdateOperation Update(bool waitForCompletion, TagsResource provisioningServiceTags, CancellationToken cancellationToken = default)
        {
            if (provisioningServiceTags == null)
            {
                throw new ArgumentNullException(nameof(provisioningServiceTags));
