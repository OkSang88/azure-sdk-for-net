...
namespace MicrosoftSupport
{
    internal partial class ServicesRestOperations
    {
        ...
        public ServicesRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ClientOptions options, Uri endpoint = null, string apiVersion = "2020-04-01")
        {
