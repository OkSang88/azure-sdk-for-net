...
namespace AzureStackHCIClient.Models
{
    /// <summary> Update an HCI cluster. </summary>
    public partial class ClusterUpdateOperation : Operation<Cluster>
    {
        ...
        internal ClusterUpdateOperation(ArmResource operationsBase, Response<ClusterData> response)
        {
