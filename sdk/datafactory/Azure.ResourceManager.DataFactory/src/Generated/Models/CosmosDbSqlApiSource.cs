...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class CosmosDbSqlApiSource : CopySource
    {
        ...
        internal CosmosDbSqlApiSource(string type, object sourceRetryCount, object sourceRetryWait, object maxConcurrentConnections, object disableMetricsCollection, IDictionary<string, object> additionalProperties, object query, object pageSize, object preferredRegions, object detectDatetime, object additionalColumns) : base(type, sourceRetryCount, sourceRetryWait, maxConcurrentConnections, disableMetricsCollection, additionalProperties)
        {
            Query = query;
            PageSize = pageSize;
