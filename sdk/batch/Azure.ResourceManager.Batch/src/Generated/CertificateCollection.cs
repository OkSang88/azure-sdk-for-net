...
namespace Azure.ResourceManager.Batch
{
    ...
    public partial class CertificateCollection : ArmCollection, IEnumerable<Certificate>, IAsyncEnumerable<Certificate>
    {
        ...
        internal CertificateCollection(ArmResource parent) : base(parent)
        {
            ...
            _certificateRestClient = new CertificateRestOperations(_clientDiagnostics, Pipeline, ClientOptions, BaseUri, apiVersion);
#if DEBUG
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="certificateName"/> or <paramref name="parameters"/> is null. </exception>
        public virtual CertificateCreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, string certificateName, CertificateCreateOrUpdateParameters parameters, string ifMatch = null, string ifNoneMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _certificateRestClient.Create(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, certificateName, parameters, ifMatch, ifNoneMatch, cancellationToken);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="certificateName"/> or <paramref name="parameters"/> is null. </exception>
        public async virtual Task<CertificateCreateOrUpdateOperation> CreateOrUpdateAsync(bool waitForCompletion, string certificateName, CertificateCreateOrUpdateParameters parameters, string ifMatch = null, string ifNoneMatch = null, CancellationToken cancellationToken = default)
        {
            if (certificateName == null)
            {
                throw new ArgumentNullException(nameof(certificateName));
            ...
            try
            {
                var response = await _certificateRestClient.CreateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, certificateName, parameters, ifMatch, ifNoneMatch, cancellationToken).ConfigureAwait(false);
                var operation = new CertificateCreateOrUpdateOperation(this, response);
                if (waitForCompletion)
        ...
        public virtual Response<Certificate> Get(string certificateName, CancellationToken cancellationToken = default)
        {
            if (certificateName == null)
            {
                throw new ArgumentNullException(nameof(certificateName));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="certificateName"/> is null. </exception>
        public async virtual Task<Response<Certificate>> GetAsync(string certificateName, CancellationToken cancellationToken = default)
        {
            if (certificateName == null)
            {
                throw new ArgumentNullException(nameof(certificateName));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="certificateName"/> is null. </exception>
        public virtual Response<Certificate> GetIfExists(string certificateName, CancellationToken cancellationToken = default)
        {
            if (certificateName == null)
            {
                throw new ArgumentNullException(nameof(certificateName));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="certificateName"/> is null. </exception>
        public async virtual Task<Response<Certificate>> GetIfExistsAsync(string certificateName, CancellationToken cancellationToken = default)
        {
            if (certificateName == null)
            {
                throw new ArgumentNullException(nameof(certificateName));
        ...
        public virtual Pageable<Certificate> GetAll(int? maxresults = null, string select = null, string filter = null, CancellationToken cancellationToken = default)
        {
        ...
        public virtual AsyncPageable<Certificate> GetAllAsync(int? maxresults = null, string select = null, string filter = null, CancellationToken cancellationToken = default)
        {
