...
namespace FrontDoorManagementClient.Models
{
    ...
    public partial class ManagedRuleSetDefinition : TrackedResource
    {
        ...
        internal ManagedRuleSetDefinition(ResourceIdentifier id, string name, Azure.Core.ResourceType type, IDictionary<string, string> tags, AzureLocation location, string provisioningState, string ruleSetId, string ruleSetType, string ruleSetVersion, IReadOnlyList<ManagedRuleGroupDefinition> ruleGroups) : base(id, name, type, tags, location)
        {
