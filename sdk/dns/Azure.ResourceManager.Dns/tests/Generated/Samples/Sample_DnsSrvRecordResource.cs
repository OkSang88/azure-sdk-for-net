...
{
    public partial class Sample_DnsSrvRecordResource
    {
        // Patch A recordset
        ...
        public async Task Update_PatchARecordset()
        {
            ...
            // this example assumes you already have this DnsSrvRecordResource created on azure
            // for more information of creating DnsSrvRecordResource, please refer to the document of DnsSrvRecordResource
            string subscriptionId = "subid";
            string resourceGroupName = "rg1";
            string zoneName = "zone1";
            string relativeRecordSetName = "record1";
            ResourceIdentifier dnsDnsSrvRecordInfoResourceId = DnsSrvRecordResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, zoneName, relativeRecordSetName);
            DnsSrvRecordResource dnsDnsSrvRecordInfo = client.GetDnsSrvRecordResource(dnsDnsSrvRecordInfoResourceId);
...
["key2"] = "value2",
            ...
            DnsSrvRecordResource result = await dnsDnsSrvRecordInfo.UpdateAsync(data);
...
["key2"] = "value2",
        ...
        public async Task Delete_DeleteARecordset()
        {
            ...
            // invoke the operation
            await dnsDnsSrvRecordInfo.DeleteAsync(WaitUntil.Completed);
        ...
        public async Task Get_GetARecordset()
        {
            ...
            // invoke the operation
            DnsSrvRecordResource result = await dnsDnsSrvRecordInfo.GetAsync();
