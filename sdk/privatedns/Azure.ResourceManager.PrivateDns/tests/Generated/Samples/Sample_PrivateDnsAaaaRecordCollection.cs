...
{
    public partial class Sample_PrivateDnsAaaaRecordCollection
    {
        ...
        public async Task CreateOrUpdate_PUTPrivateDNSZoneARecordSet()
        {
            ...
            // get the collection of this PrivateDnsAaaaRecordResource
            PrivateDnsAaaaRecordCollection collection = privateDnsZone.GetPrivateDnsAaaaRecords();
...
IPv4Address = "1.2.3.4",
            ...
            ArmOperation<PrivateDnsAaaaRecordResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, relativeRecordSetName, data);
            PrivateDnsAaaaRecordResource result = lro.Value;
...
"string1","string2"
        ...
        public async Task Get_GETPrivateDNSZoneARecordSet()
        {
            ...
            // invoke the operation
            string relativeRecordSetName = "recordA";
            PrivateDnsAaaaRecordResource result = await collection.GetAsync(relativeRecordSetName);
        ...
        public async Task GetAll_GETPrivateDNSZoneARecordSets()
        {
            ...
            await foreach (PrivateDnsAaaaRecordResource item in collection.GetAllAsync())
            {
