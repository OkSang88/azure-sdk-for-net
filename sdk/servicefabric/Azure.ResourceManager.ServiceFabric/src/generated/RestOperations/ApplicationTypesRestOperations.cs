...
namespace ServiceFabricManagementClient
{
    internal partial class ApplicationTypesRestOperations
    {
        ...
        public ApplicationTypesRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ClientOptions options, Uri endpoint = null, string apiVersion = "2021-06-01")
        {
