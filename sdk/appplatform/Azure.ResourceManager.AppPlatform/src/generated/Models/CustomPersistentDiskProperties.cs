...
namespace AppPlatformManagementClient.Models
{
    ...
    public partial class CustomPersistentDiskProperties
    {
        ...
        internal CustomPersistentDiskProperties(CustomPersistentDiskPropertiesType type, string mountPath, bool? readOnly, IList<string> mountOptions)
        {
            Type = type;
            MountPath = mountPath;
            ReadOnly = readOnly;
        ...
        internal CustomPersistentDiskPropertiesType Type { get; set; }
