...
namespace SignalRManagementClient
{
    ...
    {
        private static SignalRRestOperations GetSignalRRestOperations(ClientDiagnostics clientDiagnostics, TokenCredential credential, ArmClientOptions clientOptions, HttpPipeline pipeline, Uri endpoint = null)
        {
            return new SignalRRestOperations(clientDiagnostics, pipeline, clientOptions, endpoint);
        }
        ...
        public static async Task<Response<NameAvailability>> CheckNameAvailabilitySignalRAsync(this Subscription subscription, string location, NameAvailabilityParameters parameters, CancellationToken cancellationToken = default)
        {
            ...
            return await subscription.UseClientContext(async (baseUri, credential, options, pipeline) =>
            {
                ...
                try
                {
                    var restOperations = GetSignalRRestOperations(clientDiagnostics, credential, options, pipeline, baseUri);
        ...
        public static AsyncPageable<SignalRResource> GetSignalRsAsync(this Subscription subscription, CancellationToken cancellationToken = default)
        {
            return subscription.UseClientContext((baseUri, credential, options, pipeline) =>
            {
                var clientDiagnostics = new ClientDiagnostics(options);
                ...
                {
                    using var scope = clientDiagnostics.CreateScope("SubscriptionExtensions.GetSignalRs");
                    scope.Start();
                    try
                    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of resource operations that may take multiple service requests to iterate over. </returns>
        public static Pageable<SignalRResource> GetSignalRs(this Subscription subscription, CancellationToken cancellationToken = default)
        {
            return subscription.UseClientContext((baseUri, credential, options, pipeline) =>
            {
                var clientDiagnostics = new ClientDiagnostics(options);
