...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class MigrateMySqlStatusData : ResourceData
    {
        ...
        internal MigrateMySqlStatusData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, MigrationOperationStatus? migrationOperationStatus, string operationId, bool? localMySqlEnabled, string kind) : base(id, name, resourceType, systemData)
        {
        ...
        public MigrationOperationStatus? MigrationOperationStatus { get; }
