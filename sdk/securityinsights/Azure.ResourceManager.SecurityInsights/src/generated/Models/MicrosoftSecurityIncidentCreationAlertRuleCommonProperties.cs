...
namespace SecurityInsights.Models
{
    ...
    {
        /// <summary> Initializes a new instance of MicrosoftSecurityIncidentCreationAlertRuleCommonProperties. </summary>
        /// <param name="productFilter"> The alerts&apos; productName on which the cases will be generated. </param>
        internal MicrosoftSecurityIncidentCreationAlertRuleCommonProperties(MicrosoftSecurityProductName productFilter)
        {
