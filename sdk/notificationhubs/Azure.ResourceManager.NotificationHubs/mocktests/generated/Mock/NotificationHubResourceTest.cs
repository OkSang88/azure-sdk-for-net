...
namespace Azure.ResourceManager.NotificationHubs.Tests.Mock.Tests.Mock
{
    ...
    public partial class NotificationHubResourceMockTests : MockTestBase
    {
        ...
        public async Task Update()
        {
            ...
            var notificationHubResourceId = NotificationHubs.Tests.Mock.NotificationHubResource.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "sdkresourceGroup", "nh-sdk-ns", "sdk-notificationHubs-8708");
            var notificationHubResource = GetArmClient().GetNotificationHubResource(notificationHubResourceId);
            NotificationHubs.Tests.Mock.Models.NotificationHubPatchParameters parameters = new NotificationHubs.Tests.Mock.Models.NotificationHubPatchParameters(location: AzureLocation.WestUS);
