...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    public partial class ThreatIntelligenceAlertRuleTemplate : IUtf8JsonSerializable
    {
        ...
        internal static ThreatIntelligenceAlertRuleTemplate DeserializeThreatIntelligenceAlertRuleTemplate(JsonElement element)
        {
            ...
            return new ThreatIntelligenceAlertRuleTemplate(id, name, type, systemData, kind, Optional.ToNullable(alertRulesCreatedByTemplateCount), Optional.ToNullable(lastUpdatedDateUTC), Optional.ToNullable(createdDateUTC), description.Value, displayName.Value, Optional.ToList(requiredDataConnectors), Optional.ToNullable(status), Optional.ToNullable(severity), Optional.ToList(tactics));
        }
    }
}
