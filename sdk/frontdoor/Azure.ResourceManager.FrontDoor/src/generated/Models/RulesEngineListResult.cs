...
namespace FrontDoorManagementClient.Models
{
    ...
    internal partial class RulesEngineListResult
    {
        ...
        {
            Value = new ChangeTrackingList<RulesEngineData>();
        }
        ...
        internal RulesEngineListResult(IReadOnlyList<RulesEngineData> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
        ...
        public IReadOnlyList<RulesEngineData> Value { get; }
