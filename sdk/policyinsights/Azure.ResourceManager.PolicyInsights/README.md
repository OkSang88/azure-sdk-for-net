# Azure PolicyInsights Management client library for .NET
...
Install the Azure PolicyInsights management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.PolicyInsights -Version 1.0.0-preview.1 
```
