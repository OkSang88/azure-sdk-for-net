...
namespace Azure.ResourceManager.Sql.Tests.Mock
{
    ...
    public partial class ServerSecurityAlertPolicyMockTests : MockTestBase
    {
        ...
        public async Task GetAsync()
        {
            ...
            var serverSecurityAlertPolicy = GetArmClient().GetServerSecurityAlertPolicy(new ResourceIdentifier("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/securityalert-4799/providers/Microsoft.Sql/servers/securityalert-6440/securityAlertPolicies/Default"));
