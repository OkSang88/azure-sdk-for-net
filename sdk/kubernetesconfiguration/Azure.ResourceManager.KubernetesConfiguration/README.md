# Azure KubernetesConfiguration Management client library for .NET
...
Install the Azure KubernetesConfiguration management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.KubernetesConfiguration -Version 1.0.0-preview.1 
```
