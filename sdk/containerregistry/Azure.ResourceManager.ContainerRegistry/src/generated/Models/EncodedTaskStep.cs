...
namespace ContainerRegistryManagementClient.Models
{
    ...
    {
        /// <summary> Initializes a new instance of EncodedTaskStep. </summary>
        ...
        internal EncodedTaskStep(StepType type, IReadOnlyList<BaseImageDependency> baseImageDependencies, string contextPath, string contextAccessToken, string encodedTaskContent, string encodedValuesContent, IList<SetValue> values) : base(type, baseImageDependencies, contextPath, contextAccessToken)
        {
            EncodedTaskContent = encodedTaskContent;
