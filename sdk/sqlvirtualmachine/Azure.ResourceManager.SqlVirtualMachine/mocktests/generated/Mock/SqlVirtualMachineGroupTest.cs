...
namespace Azure.ResourceManager.SqlVirtualMachine.Tests.Mock
{
    ...
    public partial class SqlVirtualMachineGroupMockTests : MockTestBase
    {
        ...
        public async Task Update()
        {
            ...
            var sqlVirtualMachineGroupId = SqlVirtualMachine.SqlVirtualMachineGroup.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "testrg", "testvmgroup");
            var sqlVirtualMachineGroup = GetArmClient().GetSqlVirtualMachineGroup(sqlVirtualMachineGroupId);
            SqlVirtualMachine.Models.SqlVirtualMachineGroupUpdate parameters = new SqlVirtualMachine.Models.SqlVirtualMachineGroupUpdate();
        ...
        public async Task GetSqlVirtualMachinesBySqlVmGroup()
        {
            ...
            var sqlVirtualMachineGroupId = SqlVirtualMachine.SqlVirtualMachineGroup.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "testrg", "testvm");
            var sqlVirtualMachineGroup = GetArmClient().GetSqlVirtualMachineGroup(sqlVirtualMachineGroupId);
