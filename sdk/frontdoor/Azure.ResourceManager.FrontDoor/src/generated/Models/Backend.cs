...
namespace FrontDoorManagementClient.Models
{
    ...
    {
        /// <summary> Initializes a new instance of Backend. </summary>
        public Backend()
        {
        }
        ...
        internal Backend(string address, string privateLinkAlias, string privateLinkResourceId, string privateLinkLocation, PrivateEndpointStatus? privateEndpointStatus, string privateLinkApprovalMessage, int? httpPort, int? httpsPort, BackendEnabledState? enabledState, int? priority, int? weight, string backendHostHeader)
        {
            Address = address;
