...
namespace Azure.ResourceManager.Sql.Tests.Mock
{
    ...
    public partial class PrivateEndpointConnectionMockTests : MockTestBase
    {
        ...
        public async Task GetAsync()
        {
            ...
            var privateEndpointConnection = GetArmClient().GetPrivateEndpointConnection(new ResourceIdentifier("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/Default/providers/Microsoft.Sql/servers/test-svr/privateEndpointConnections/private-endpoint-connection-name"));
