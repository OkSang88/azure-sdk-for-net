...
namespace ServiceFabricManagedClustersManagementClient
{
    ...
    public partial class ApplicationResourceData : ProxyResource
    {
        ...
        internal ApplicationResourceData(ResourceIdentifier id, string name, ResourceType type, IDictionary<string, string> tags, AzureLocation location, SystemData systemData, ManagedIdentity identity, string provisioningState, string version, IDictionary<string, string> parameters, ApplicationUpgradePolicy upgradePolicy, IList<ApplicationUserAssignedIdentity> managedIdentities) : base(id, name, type, tags, location, systemData)
        {
            Identity = identity;
