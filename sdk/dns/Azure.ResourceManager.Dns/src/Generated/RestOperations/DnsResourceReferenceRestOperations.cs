...
namespace DnsManagementClient
{
    internal partial class DnsResourceReferenceRestOperations
    {
        ...
        public DnsResourceReferenceRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ClientOptions options, Uri endpoint = null, string apiVersion = "2018-05-01")
        {
