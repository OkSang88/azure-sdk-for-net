...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AzureFileStorageWriteSettings : StoreWriteSettings
    {
        ...
        internal AzureFileStorageWriteSettings(string type, object maxConcurrentConnections, object disableMetricsCollection, object copyBehavior, IDictionary<string, object> additionalProperties) : base(type, maxConcurrentConnections, disableMetricsCollection, copyBehavior, additionalProperties)
        {
