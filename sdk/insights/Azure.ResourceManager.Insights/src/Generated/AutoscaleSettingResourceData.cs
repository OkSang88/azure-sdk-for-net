...
namespace Insights
{
    /// <summary> A class representing the AutoscaleSettingResource data model. </summary>
    public partial class AutoscaleSettingResourceData : TrackedResource
    {
        /// <summary> Initializes a new instance of AutoscaleSettingResourceData. </summary>
        ...
        internal AutoscaleSettingResourceData(ResourceIdentifier id, string name, ResourceType type, IDictionary<string, string> tags, AzureLocation location, IList<AutoscaleProfile> profiles, IList<AutoscaleNotification> notifications, bool? enabled, string namePropertiesName, string targetResourceUri) : base(id, name, type, tags, location)
        {
            Profiles = profiles;
