...
namespace Azure.ResourceManager.Sql.Tests.Mock
{
    ...
    public partial class PrivateLinkResourceCollectionMockTests : MockTestBase
    {
        ...
        public async Task GetAsync()
        {
            ...
            var collection = GetArmClient().GetSqlServer(new ResourceIdentifier("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/Default/providers/Microsoft.Sql/servers/test-svr")).GetPrivateLinkResources();
