...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class TeamInformation
    {
        ...
        /// <param name="primaryChannelUrl"> The primary channel URL of the team. </param>
        ...
        internal TeamInformation(string teamId, string primaryChannelUrl, DateTimeOffset? teamCreationTimeUtc, string name, string description)
        {
            TeamId = teamId;
        ...
        public string PrimaryChannelUrl { get; }
