# Azure DeviceProvisioningServices Management client library for .NET
...
Install the Azure DeviceProvisioningServices management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.DeviceProvisioningServices -Version 1.0.0-preview.1 
```
