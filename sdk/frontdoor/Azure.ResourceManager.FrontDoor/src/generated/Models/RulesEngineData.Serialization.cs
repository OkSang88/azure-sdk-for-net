...
{
    public partial class RulesEngineData : IUtf8JsonSerializable
    {
        ...
        internal static RulesEngineData DeserializeRulesEngineData(JsonElement element)
        {
            ...
            return new RulesEngineData(id, name, type, Optional.ToList(rules), Optional.ToNullable(resourceState));
        }
    }
}
