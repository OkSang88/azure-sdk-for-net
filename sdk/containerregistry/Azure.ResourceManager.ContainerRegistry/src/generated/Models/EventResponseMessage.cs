...
namespace ContainerRegistryManagementClient.Models
{
    ...
    {
        /// <summary> Initializes a new instance of EventResponseMessage. </summary>
        ...
        internal EventResponseMessage(string content, IReadOnlyDictionary<string, string> headers, string reasonPhrase, string statusCode, string version)
        {
            Content = content;
            Headers = headers;
