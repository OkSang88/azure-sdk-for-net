...
{
    public partial class ActivityCustomEntityQuery : IUtf8JsonSerializable
    {
        ...
        internal static ActivityCustomEntityQuery DeserializeActivityCustomEntityQuery(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("templateName"))
                        {
            ...
            return new ActivityCustomEntityQuery(id, name, type, systemData, etag.Value, kind, title.Value, content.Value, description.Value, queryDefinitions.Value, Optional.ToNullable(inputEntityType), Optional.ToList(requiredInputFieldsSets), Optional.ToDictionary(entitiesFilter), templateName.Value, Optional.ToNullable(enabled), Optional.ToNullable(createdTimeUtc), Optional.ToNullable(lastModifiedTimeUtc));
        }
    }
}
