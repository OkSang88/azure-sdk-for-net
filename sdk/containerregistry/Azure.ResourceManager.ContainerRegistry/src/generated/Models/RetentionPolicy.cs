...
namespace ContainerRegistryManagementClient.Models
{
    ...
    public partial class RetentionPolicy
    {
        ...
        /// <param name="lastUpdatedTime"> The timestamp when the policy was last updated. </param>
        /// <param name="status"> The value that indicates whether the policy is enabled or not. </param>
        internal RetentionPolicy(int? days, DateTimeOffset? lastUpdatedTime, PolicyStatus? status)
        {
            Days = days;
