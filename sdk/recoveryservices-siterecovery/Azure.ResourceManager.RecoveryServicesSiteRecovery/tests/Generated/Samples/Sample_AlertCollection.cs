...
namespace Azure.ResourceManager.RecoveryServicesSiteRecovery
{
    public partial class Sample_AlertCollection
    {
        ...
        {
            // Generated from example definition: specification/recoveryservicessiterecovery/resource-manager/Microsoft.RecoveryServices/stable/2022-08-01/examples/ReplicationAlertSettings_List.json
            ...
            AlertCollection collection = resourceGroupResource.GetAlerts(resourceName);

            // invoke the operation and iterate over the result
            await foreach (AlertResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                AlertData resourceData = item.Data;
        ...
        public async Task Get_GetsAnEmailNotificationAlertConfiguration()
        {
            ...
            AlertResource result = await collection.GetAsync(alertSettingName);
...
"ronehr@microsoft.com"
            ...
            ArmOperation<AlertResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, alertSettingName, content);
