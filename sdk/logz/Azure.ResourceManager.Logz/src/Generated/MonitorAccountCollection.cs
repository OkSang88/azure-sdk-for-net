...
namespace Azure.ResourceManager.Logz
{
    ...
    public partial class MonitorAccountCollection : ArmCollection, IEnumerable<MonitorAccount>, IAsyncEnumerable<MonitorAccount>
    {
        ...
        internal MonitorAccountCollection(ArmResource parent) : base(parent)
        {
            ...
            ClientOptions.TryGetApiVersion(MonitorAccount.ResourceType, out string apiVersion);
        ...
        public virtual MonitorAccountCreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, string subAccountName, LogzMonitorResourceData body = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new MonitorAccountCreateOrUpdateOperation(this, _clientDiagnostics, Pipeline, _subAccountRestClient.CreateCreateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, subAccountName, body).Request, response);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="subAccountName"/> is null. </exception>
        public async virtual Task<MonitorAccountCreateOrUpdateOperation> CreateOrUpdateAsync(bool waitForCompletion, string subAccountName, LogzMonitorResourceData body = null, CancellationToken cancellationToken = default)
        {
            if (subAccountName == null)
            {
                throw new ArgumentNullException(nameof(subAccountName));
        ...
        public virtual Pageable<MonitorAccount> GetAll(CancellationToken cancellationToken = default)
        {
            Page<MonitorAccount> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    ...
                    return Page.FromValues(response.Value.Value.Select(value => new MonitorAccount(this, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
