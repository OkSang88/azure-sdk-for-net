...
namespace SecurityInsights.Models
{
    ...
    {
        /// <summary> Initializes a new instance of GroupingConfiguration. </summary>
        ...
        public GroupingConfiguration(bool enabled, bool reopenClosedIncident, TimeSpan lookbackDuration, MatchingMethod matchingMethod)
        {
            Enabled = enabled;
            ReopenClosedIncident = reopenClosedIncident;
            LookbackDuration = lookbackDuration;
            MatchingMethod = matchingMethod;
            GroupByEntities = new ChangeTrackingList<EntityMappingType>();
            GroupByAlertDetails = new ChangeTrackingList<AlertDetail>();
        ...
        internal GroupingConfiguration(bool enabled, bool reopenClosedIncident, TimeSpan lookbackDuration, MatchingMethod matchingMethod, IList<EntityMappingType> groupByEntities, IList<AlertDetail> groupByAlertDetails, IList<string> groupByCustomDetails)
        {
            Enabled = enabled;
            ReopenClosedIncident = reopenClosedIncident;
            LookbackDuration = lookbackDuration;
        ...
        public IList<EntityMappingType> GroupByEntities { get; }
        /// <summary> A list of alert details to group by (when matchingMethod is Selected). </summary>
        public IList<AlertDetail> GroupByAlertDetails { get; }
