...
namespace Azure.ResourceManager.Relay
{
    public partial class HybridConnectionData : IUtf8JsonSerializable
    {
        ...
        internal static HybridConnectionData DeserializeHybridConnectionData(JsonElement element)
        {
            ...
            return new HybridConnectionData(id, name, type, Optional.ToNullable(createdAt), Optional.ToNullable(updatedAt), Optional.ToNullable(listenerCount), Optional.ToNullable(requiresClientAuthorization), userMetadata.Value);
        }
    }
}
