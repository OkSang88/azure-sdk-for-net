...
namespace FrontDoorManagementClient.Models
{
    public partial class Timeseries : IUtf8JsonSerializable
    {
        ...
        internal static Timeseries DeserializeTimeseries(JsonElement element)
        {
            ...
            return new Timeseries(id, name, type, tags, location, endpoint.Value, startDateTimeUTC.Value, endDateTimeUTC.Value, Optional.ToNullable(aggregationInterval), Optional.ToNullable(timeseriesType), country.Value, Optional.ToList(timeseriesData));
        }
    }
}
