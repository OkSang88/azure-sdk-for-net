        ...
        internal static RemoteRenderingAccountData DeserializeRemoteRenderingAccountData(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("plan"))
                {
                    ...
                    plan = Identity.DeserializeIdentity(property.Value);
                    continue;
                }
            ...
            return new RemoteRenderingAccountData(id, name, type, tags, location, identity.Value, plan.Value, sku.Value, kind.Value, systemData, storageAccountName.Value, accountId.Value, accountDomain.Value);
        }
    }
}
