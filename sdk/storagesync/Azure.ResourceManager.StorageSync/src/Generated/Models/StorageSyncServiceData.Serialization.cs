...
namespace Azure.ResourceManager.StorageSync
{
    public partial class StorageSyncServiceData : IUtf8JsonSerializable
    {
        ...
        internal static StorageSyncServiceData DeserializeStorageSyncServiceData(JsonElement element)
        {
            ...
            return new StorageSyncServiceData(id, name, type, tags, location, Optional.ToNullable(incomingTrafficPolicy), Optional.ToNullable(storageSyncServiceStatus), storageSyncServiceUid.Value, provisioningState.Value, lastWorkflowId.Value, lastOperationName.Value, Optional.ToList(privateEndpointConnections));
        }
    }
}
