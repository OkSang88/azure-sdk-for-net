...
namespace StorSimple8000SeriesManagementClient.Tests.Mock
{
    ...
    public partial class VolumeMockTests : MockTestBase
    {
        ...
        {
            // Example: VolumesGet
            var volumeId = StorSimple8000SeriesManagementClient.Volume.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "ResourceGroupForSDKTest", "ManagerForSDKTest1", "Device05ForSDKTest", "VolumeContainerForSDKTest", "Volume1ForSDKTest");
        ...
        public async Task GetMetrics()
        {
            ...
            var volumeId = StorSimple8000SeriesManagementClient.Volume.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "ResourceGroupForSDKTest", "ManagerForSDKTest1", "Device05ForSDKTest", "vcForOdataFilterTest", "CloneVolForSDKTest890836587");
            var volume = GetArmClient().GetVolume(volumeId);
