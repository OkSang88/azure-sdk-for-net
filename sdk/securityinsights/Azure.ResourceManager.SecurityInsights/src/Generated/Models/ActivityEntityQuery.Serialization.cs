...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    public partial class ActivityEntityQuery : IUtf8JsonSerializable
    {
        ...
        internal static ActivityEntityQuery DeserializeActivityEntityQuery(JsonElement element)
        {
            ...
            return new ActivityEntityQuery(id, name, type, systemData, etag.Value, kind, title.Value, content.Value, description.Value, queryDefinitions.Value, Optional.ToNullable(inputEntityType), Optional.ToList(requiredInputFieldsSets), Optional.ToDictionary(entitiesFilter), templateName.Value, Optional.ToNullable(enabled), Optional.ToNullable(createdTimeUtc), Optional.ToNullable(lastModifiedTimeUtc));
        }
    }
}
