# Azure DataMigration Management client library for .NET
...
Install the Azure DataMigration management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.DataMigration -Version 1.0.0-preview.1 
```
