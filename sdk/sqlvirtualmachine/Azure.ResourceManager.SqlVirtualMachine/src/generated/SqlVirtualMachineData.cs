...
namespace SqlVirtualMachineManagementClient
{
    ...
    public partial class SqlVirtualMachineData : TrackedResource
    {
        ...
        internal SqlVirtualMachineData(ResourceIdentifier id, string name, ResourceType type, IDictionary<string, string> tags, AzureLocation location, ResourceIdentity identity, string virtualMachineResourceId, string provisioningState, string sqlImageOffer, SqlServerLicenseType? sqlServerLicenseType, SqlManagementMode? sqlManagement, SqlImageSku? sqlImageSku, string sqlVirtualMachineGroupResourceId, WsfcDomainCredentials wsfcDomainCredentials, AutoPatchingSettings autoPatchingSettings, AutoBackupSettings autoBackupSettings, KeyVaultCredentialSettings keyVaultCredentialSettings, ServerConfigurationsManagementSettings serverConfigurationsManagementSettings, StorageConfigurationSettings storageConfigurationSettings) : base(id, name, type, tags, location)
        {
            Identity = identity;
