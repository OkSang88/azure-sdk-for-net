...
namespace SourceControlConfigurationClient
{
    ...
    public partial class ExtensionCollection : ArmCollection, IEnumerable<Extension>, IAsyncEnumerable<Extension>
    {
        ...
        public virtual ExtensionCreateOperation CreateOrUpdate(bool waitForCompletion, string extensionName, ExtensionData extension, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ExtensionCreateOperation(Parent, _clientDiagnostics, Pipeline, _extensionsRestClient.CreateCreateRequest(Id.SubscriptionId, Id.ResourceGroupName, _clusterRp, _clusterResourceName, _clusterName, extensionName, extension).Request, response);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="extensionName"/> or <paramref name="extension"/> is null. </exception>
        public async virtual Task<ExtensionCreateOperation> CreateOrUpdateAsync(bool waitForCompletion, string extensionName, ExtensionData extension, CancellationToken cancellationToken = default)
        {
            if (extensionName == null)
            {
                throw new ArgumentNullException(nameof(extensionName));
