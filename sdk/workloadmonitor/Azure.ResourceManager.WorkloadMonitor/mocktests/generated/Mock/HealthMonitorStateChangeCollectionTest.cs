...
namespace Azure.ResourceManager.WorkloadMonitor.Tests.Mock
{
    ...
    public partial class HealthMonitorStateChangeCollectionMockTests : MockTestBase
    {
        ...
        public async Task Get()
        {
            ...
            var healthMonitorId = WorkloadMonitor.HealthMonitor.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "tugamidiAlerts", "Microsoft.Compute", "virtualMachines", "linuxEUS", "logical-disks|C@3A");
        ...
        public async Task GetAll3()
        {
            ...
            var healthMonitorId = WorkloadMonitor.HealthMonitor.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "tugamidiAlerts", "Microsoft.Compute", "virtualMachines", "linuxEUS", "logical-disks|C@3A|free-space");
            var collection = GetArmClient().GetHealthMonitor(healthMonitorId).GetHealthMonitorStateChanges();
            await foreach (var _ in collection.GetAllAsync(filter, expand, startTimestampUtc, endTimestampUtc))
            {
            }
