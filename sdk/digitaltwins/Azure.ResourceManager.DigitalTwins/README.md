# Azure DigitalTwins Management client library for .NET
...
Install the Azure DigitalTwins management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.DigitalTwins -Version 1.0.0-preview.1 
```
