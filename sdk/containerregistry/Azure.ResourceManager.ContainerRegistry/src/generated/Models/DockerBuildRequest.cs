...
namespace ContainerRegistryManagementClient.Models
{
    ...
    {
        /// <summary> Initializes a new instance of DockerBuildRequest. </summary>
        ...
        internal DockerBuildRequest(string type, bool? isArchiveEnabled, string agentPoolName, string logTemplate, IList<string> imageNames, bool? isPushEnabled, bool? noCache, string dockerFilePath, string target, IList<Argument> arguments, int? timeout, PlatformProperties platform, AgentProperties agentConfiguration, string sourceLocation, Credentials credentials) : base(type, isArchiveEnabled, agentPoolName, logTemplate)
        {
