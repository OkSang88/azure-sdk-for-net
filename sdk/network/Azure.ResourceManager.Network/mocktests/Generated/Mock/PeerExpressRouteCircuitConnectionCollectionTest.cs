...
namespace Azure.ResourceManager.Network.Tests.Mock
{
    ...
    public partial class PeerExpressRouteCircuitConnectionCollectionMockTests : MockTestBase
    {
        ...
        public async Task GetAsync()
        {
            ...
            var collection = GetArmClient().GetExpressRouteCircuitPeering(new ResourceIdentifier("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.Network/expressRouteCircuits/ExpressRouteARMCircuitA/peerings/AzurePrivatePeering")).GetPeerExpressRouteCircuitConnections();
