...
{
    public partial class Sample_PrivateDnsSrvRecordCollection
    {
        ...
        public async Task CreateOrUpdate_PUTPrivateDNSZoneARecordSet()
        {
            ...
            // get the collection of this PrivateDnsSrvRecordResource
            PrivateDnsSrvRecordCollection collection = privateDnsZone.GetPrivateDnsSrvRecords();
...
IPv4Address = "1.2.3.4",
            ...
            ArmOperation<PrivateDnsSrvRecordResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, relativeRecordSetName, data);
            PrivateDnsSrvRecordResource result = lro.Value;
...
"string1","string2"
        ...
        public async Task Get_GETPrivateDNSZoneARecordSet()
        {
            ...
            // invoke the operation
            string relativeRecordSetName = "recordA";
            PrivateDnsSrvRecordResource result = await collection.GetAsync(relativeRecordSetName);
        ...
        public async Task GetAll_GETPrivateDNSZoneARecordSets()
        {
            ...
            await foreach (PrivateDnsSrvRecordResource item in collection.GetAllAsync())
            {
