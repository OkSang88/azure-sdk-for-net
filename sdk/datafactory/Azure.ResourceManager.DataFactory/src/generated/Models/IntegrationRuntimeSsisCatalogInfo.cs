...
namespace DataFactoryManagementClient.Models
{
    ...
    public partial class IntegrationRuntimeSsisCatalogInfo
    {
        ...
        internal IntegrationRuntimeSsisCatalogInfo(string catalogServerEndpoint, string catalogAdminUserName, SecureString catalogAdminPassword, IntegrationRuntimeSsisCatalogPricingTier? catalogPricingTier, string dualStandbyPairName, IDictionary<string, object> additionalProperties)
        {
