...
namespace Azure.ResourceManager.AppPlatform
{
    internal partial class GatewayRouteConfigsRestOperations
    {
        ...
        public GatewayRouteConfigsRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ClientOptions options, Uri endpoint = null, string apiVersion = "2022-01-01-preview")
        {
        ...
        internal HttpMessage CreateCreateOrUpdateRequest(string subscriptionId, string resourceGroupName, string serviceName, string gatewayName, string routeConfigName, GatewayRouteConfigResourceData gatewayRouteConfigResource)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            ...
            content.JsonWriter.WriteObjectValue(gatewayRouteConfigResource);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="subscriptionId"/>, <paramref name="resourceGroupName"/>, <paramref name="serviceName"/>, <paramref name="gatewayName"/>, <paramref name="routeConfigName"/>, or <paramref name="gatewayRouteConfigResource"/> is null. </exception>
        public async Task<Response> CreateOrUpdateAsync(string subscriptionId, string resourceGroupName, string serviceName, string gatewayName, string routeConfigName, GatewayRouteConfigResourceData gatewayRouteConfigResource, CancellationToken cancellationToken = default)
        {
            if (subscriptionId == null)
            {
                throw new ArgumentNullException(nameof(subscriptionId));
            ...
            using var message = CreateCreateOrUpdateRequest(subscriptionId, resourceGroupName, serviceName, gatewayName, routeConfigName, gatewayRouteConfigResource);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="subscriptionId"/>, <paramref name="resourceGroupName"/>, <paramref name="serviceName"/>, <paramref name="gatewayName"/>, <paramref name="routeConfigName"/>, or <paramref name="gatewayRouteConfigResource"/> is null. </exception>
        public Response CreateOrUpdate(string subscriptionId, string resourceGroupName, string serviceName, string gatewayName, string routeConfigName, GatewayRouteConfigResourceData gatewayRouteConfigResource, CancellationToken cancellationToken = default)
        {
            if (subscriptionId == null)
            {
                throw new ArgumentNullException(nameof(subscriptionId));
