...
namespace Azure.ResourceManager.ServiceFabric.Models
{
    ...
    public partial class ClusterUpgradePolicy
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="upgradeReplicaSetCheckTimeout"/>, <paramref name="healthCheckWaitDuration"/>, <paramref name="healthCheckStableDuration"/>, <paramref name="healthCheckRetryTimeout"/>, <paramref name="upgradeTimeout"/>, <paramref name="upgradeDomainTimeout"/>, or <paramref name="healthPolicy"/> is null. </exception>
        public ClusterUpgradePolicy(string upgradeReplicaSetCheckTimeout, string healthCheckWaitDuration, string healthCheckStableDuration, string healthCheckRetryTimeout, string upgradeTimeout, string upgradeDomainTimeout, ClusterHealthPolicy healthPolicy)
        {
            ...
            {
                throw new ArgumentNullException(nameof(healthCheckWaitDuration));
            }
            if (healthCheckStableDuration == null)
            {
                throw new ArgumentNullException(nameof(healthCheckStableDuration));
            }
