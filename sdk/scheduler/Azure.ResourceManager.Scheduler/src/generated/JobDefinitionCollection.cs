...
namespace SchedulerManagementClient
{
    ...
    public partial class JobDefinitionCollection : ArmCollection, IEnumerable<JobDefinition>, IAsyncEnumerable<JobDefinition>
    {
        ...
        public virtual JobCreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, string jobName, JobDefinitionData job, CancellationToken cancellationToken = default)
        {
            if (jobName == null)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="jobName"/> or <paramref name="job"/> is null. </exception>
        public async virtual Task<JobCreateOrUpdateOperation> CreateOrUpdateAsync(bool waitForCompletion, string jobName, JobDefinitionData job, CancellationToken cancellationToken = default)
        {
            if (jobName == null)
            {
                throw new ArgumentNullException(nameof(jobName));
