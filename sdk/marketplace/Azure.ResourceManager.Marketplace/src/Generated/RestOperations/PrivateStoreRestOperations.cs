...
namespace Azure.ResourceManager.Marketplace
{
    internal partial class PrivateStoreRestOperations
    {
        ...
        public PrivateStoreRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, Uri endpoint = null, string apiVersion = default)
        {
        ...
        internal HttpMessage CreateCreateApprovalRequestRequest(string privateStoreId, string requestApprovalId, RequestApprovalResourceData payload)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Put;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="privateStoreId"/> or <paramref name="requestApprovalId"/> is null. </exception>
        public async Task<Response<RequestApprovalResourceData>> CreateApprovalRequestAsync(string privateStoreId, string requestApprovalId, RequestApprovalResourceData payload = null, CancellationToken cancellationToken = default)
        {
            if (privateStoreId == null)
            {
                throw new ArgumentNullException(nameof(privateStoreId));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="privateStoreId"/> or <paramref name="requestApprovalId"/> is null. </exception>
        public Response<RequestApprovalResourceData> CreateApprovalRequest(string privateStoreId, string requestApprovalId, RequestApprovalResourceData payload = null, CancellationToken cancellationToken = default)
        {
            if (privateStoreId == null)
            {
                throw new ArgumentNullException(nameof(privateStoreId));
        ...
        internal HttpMessage CreateUpdateAdminRequestApprovalRequest(string privateStoreId, string adminRequestApprovalId, AdminRequestApprovalsResourceData payload)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Put;
        ...
        public async Task<Response<AdminRequestApprovalsResourceData>> UpdateAdminRequestApprovalAsync(string privateStoreId, string adminRequestApprovalId, AdminRequestApprovalsResourceData payload = null, CancellationToken cancellationToken = default)
        {
            if (privateStoreId == null)
            {
                throw new ArgumentNullException(nameof(privateStoreId));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="privateStoreId"/> or <paramref name="adminRequestApprovalId"/> is null. </exception>
        public Response<AdminRequestApprovalsResourceData> UpdateAdminRequestApproval(string privateStoreId, string adminRequestApprovalId, AdminRequestApprovalsResourceData payload = null, CancellationToken cancellationToken = default)
        {
            if (privateStoreId == null)
            {
                throw new ArgumentNullException(nameof(privateStoreId));
