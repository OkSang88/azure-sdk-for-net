...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class ManagedPrivateEndpoint
    {
        ...
        internal ManagedPrivateEndpoint(ConnectionStateProperties connectionState, IList<string> fqdns, string groupId, bool? isReserved, string privateLinkResourceId, string provisioningState, IDictionary<string, object> additionalProperties)
        {
