...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class SalesforceSource : TabularSource
    {
        ...
        internal SalesforceSource(string type, object sourceRetryCount, object sourceRetryWait, object maxConcurrentConnections, object disableMetricsCollection, IDictionary<string, object> additionalProperties, object queryTimeout, object additionalColumns, object query, SalesforceSourceReadBehavior? readBehavior) : base(type, sourceRetryCount, sourceRetryWait, maxConcurrentConnections, disableMetricsCollection, additionalProperties, queryTimeout, additionalColumns)
        {
            Query = query;
