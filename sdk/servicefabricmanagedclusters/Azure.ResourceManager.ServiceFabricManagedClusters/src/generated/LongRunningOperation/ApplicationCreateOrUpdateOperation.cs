...
namespace ServiceFabricManagedClustersManagementClient.Models
{
    ...
    public partial class ApplicationCreateOrUpdateOperation : Operation<ApplicationResource>, IOperationSource<ApplicationResource>
    {
        ...
        internal ApplicationCreateOrUpdateOperation(ArmResource operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<ApplicationResource>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "ApplicationCreateOrUpdateOperation");
