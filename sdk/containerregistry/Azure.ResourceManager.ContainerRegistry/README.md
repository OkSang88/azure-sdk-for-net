# Azure ContainerRegistry Management client library for .NET
...
Install the Azure ContainerRegistry management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.ContainerRegistry -Version 1.0.0-preview.1 
```
