# Azure ServiceFabric Management client library for .NET
...
Install the Azure ServiceFabric management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.ServiceFabric -Version 1.0.0-preview.1 
```
