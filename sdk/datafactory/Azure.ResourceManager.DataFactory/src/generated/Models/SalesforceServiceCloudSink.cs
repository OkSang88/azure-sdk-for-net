...
namespace DataFactoryManagementClient.Models
{
    ...
    public partial class SalesforceServiceCloudSink : CopySink
    {
        ...
        internal SalesforceServiceCloudSink(string type, object writeBatchSize, object writeBatchTimeout, object sinkRetryCount, object sinkRetryWait, object maxConcurrentConnections, object disableMetricsCollection, IDictionary<string, object> additionalProperties, SalesforceSinkWriteBehavior? writeBehavior, object externalIdFieldName, object ignoreNullValues) : base(type, writeBatchSize, writeBatchTimeout, sinkRetryCount, sinkRetryWait, maxConcurrentConnections, disableMetricsCollection, additionalProperties)
        {
