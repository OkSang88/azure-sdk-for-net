...
namespace ContainerRegistryManagementClient.Models
{
    ...
    {
        /// <summary> Initializes a new instance of SourceTriggerDescriptor. </summary>
        ...
        internal SourceTriggerDescriptor(string id, string eventType, string commitId, string pullRequestId, string repositoryUrl, string branchName, string providerType)
        {
            Id = id;
            EventType = eventType;
            CommitId = commitId;
