...
namespace AzureAgriFoodRPService
{
    ...
    public partial class ExtensionData : Resource
    {
        ...
        internal ExtensionData(ResourceIdentifier id, string name, ResourceType type, SystemData systemData, string eTag, string extensionId, string extensionCategory, string installedExtensionVersion, string extensionAuthLink, string extensionApiDocsLink) : base(id, name, type)
        {
