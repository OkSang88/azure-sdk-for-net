...
{
    public partial class ServiceResourceUpdate : IUtf8JsonSerializable
    {
        ...
        internal static ServiceResourceUpdate DeserializeServiceResourceUpdate(JsonElement element)
        {
            ...
            return new ServiceResourceUpdate(id, name, type, tags, location, etag.Value, systemData, placementConstraints.Value, Optional.ToList(correlationScheme), Optional.ToList(serviceLoadMetrics), Optional.ToList(servicePlacementPolicies), Optional.ToNullable(defaultMoveCost), Optional.ToNullable(serviceKind));
        }
    }
}
