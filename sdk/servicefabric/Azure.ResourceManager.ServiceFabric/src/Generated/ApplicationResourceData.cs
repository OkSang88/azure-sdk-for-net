...
namespace Azure.ResourceManager.ServiceFabric
{
    ...
    public partial class ApplicationResourceData : ProxyResource
    {
        ...
        internal ApplicationResourceData(ResourceIdentifier id, string name, ResourceType type, IDictionary<string, string> tags, AzureLocation location, string etag, SystemData systemData, ManagedIdentity identity, string typeVersion, IDictionary<string, string> parameters, ApplicationUpgradePolicy upgradePolicy, long? minimumNodes, long? maximumNodes, bool? removeApplicationCapacity, IList<ApplicationMetricDescription> metrics, IList<ApplicationUserAssignedIdentity> managedIdentities, string provisioningState, string typeName) : base(id, name, type, tags, location, etag, systemData)
        {
            Identity = identity;
