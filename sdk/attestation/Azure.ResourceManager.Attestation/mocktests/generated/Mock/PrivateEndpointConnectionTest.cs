...
namespace Azure.ResourceManager.Attestation.Tests.Mock.Tests.Mock
{
    ...
    public partial class PrivateEndpointConnectionMockTests : MockTestBase
    {
        ...
        public async Task Get()
        {
            ...
            var privateEndpointConnectionId = Attestation.Tests.Mock.PrivateEndpointConnection.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "res6977", "sto2527", "{privateEndpointConnectionName}");
        ...
        {
            // Example: AttestationProviderDeletePrivateEndpointConnection
            var privateEndpointConnectionId = Attestation.Tests.Mock.PrivateEndpointConnection.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "res6977", "sto2527", "{privateEndpointConnectionName}");
            var privateEndpointConnection = GetArmClient().GetPrivateEndpointConnection(privateEndpointConnectionId);
