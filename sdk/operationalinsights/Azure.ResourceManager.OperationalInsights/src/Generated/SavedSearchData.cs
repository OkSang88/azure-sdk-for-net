...
{
    /// <summary> A class representing the SavedSearch data model. </summary>
    public partial class SavedSearchData : Resource
    {
        /// <summary> Initializes a new instance of SavedSearchData. </summary>
        ...
        internal SavedSearchData(ResourceIdentifier id, string name, ResourceType type, string etag, string category, string displayName, string query, string functionAlias, string functionParameters, long? version, IList<Tag> tags) : base(id, name, type)
        {
            Etag = etag;
            Category = category;
            DisplayName = displayName;
