...
namespace ServiceFabricManagedClustersManagementClient
{
    ...
    public partial class ServiceResource : ArmResource
    {
        ...
        public async virtual Task<Response<ServiceResource>> UpdateAsync(ServiceUpdateParameters parameters, CancellationToken cancellationToken = default)
        {
            if (parameters == null)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="parameters"/> is null. </exception>
        public virtual Response<ServiceResource> Update(ServiceUpdateParameters parameters, CancellationToken cancellationToken = default)
        {
            if (parameters == null)
            {
                throw new ArgumentNullException(nameof(parameters));
