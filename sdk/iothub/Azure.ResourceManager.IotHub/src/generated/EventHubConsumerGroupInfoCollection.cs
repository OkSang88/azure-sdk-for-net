...
namespace IotHubClient
{
    ...
    public partial class EventHubConsumerGroupInfoCollection : ArmCollection, IEnumerable<EventHubConsumerGroupInfo>, IAsyncEnumerable<EventHubConsumerGroupInfo>
    {
        ...
        public virtual IotHubResourceCreateEventHubConsumerGroupOperation CreateOrUpdate(bool waitForCompletion, string name, EventHubConsumerGroupBodyDescription consumerGroupBody, CancellationToken cancellationToken = default)
        {
            if (name == null)
            {
            ...
            try
            {
                ...
                var operation = new IotHubResourceCreateEventHubConsumerGroupOperation(Parent, response);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="name"/> or <paramref name="consumerGroupBody"/> is null. </exception>
        public async virtual Task<IotHubResourceCreateEventHubConsumerGroupOperation> CreateOrUpdateAsync(bool waitForCompletion, string name, EventHubConsumerGroupBodyDescription consumerGroupBody, CancellationToken cancellationToken = default)
        {
            if (name == null)
            {
                throw new ArgumentNullException(nameof(name));
        ...
        public virtual Response<EventHubConsumerGroupInfo> Get(string name, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new EventHubConsumerGroupInfo(Parent, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual Pageable<EventHubConsumerGroupInfo> GetAll(CancellationToken cancellationToken = default)
        {
            Page<EventHubConsumerGroupInfo> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    ...
                    return Page.FromValues(response.Value.Value.Select(value => new EventHubConsumerGroupInfo(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
