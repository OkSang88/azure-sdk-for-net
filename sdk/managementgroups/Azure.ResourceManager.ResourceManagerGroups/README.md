# Azure ResourceManagerGroups Management client library for .NET
...
Install the Azure ResourceManagerGroups management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.ResourceManagerGroups -Version 1.0.0-preview.1 
```
