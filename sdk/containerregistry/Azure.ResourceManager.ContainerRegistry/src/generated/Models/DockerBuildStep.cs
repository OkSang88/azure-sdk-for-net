...
namespace ContainerRegistryManagementClient.Models
{
    ...
    {
        /// <summary> Initializes a new instance of DockerBuildStep. </summary>
        ...
        internal DockerBuildStep(StepType type, IReadOnlyList<BaseImageDependency> baseImageDependencies, string contextPath, string contextAccessToken, IList<string> imageNames, bool? isPushEnabled, bool? noCache, string dockerFilePath, string target, IList<Argument> arguments) : base(type, baseImageDependencies, contextPath, contextAccessToken)
        {
