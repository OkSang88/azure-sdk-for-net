...
namespace Azure.ResourceManager.SecurityInsights
{
    ...
    public static partial class ResourceGroupExtensions
    {
        ...
        private static IPGeodataRestOperations GetIPGeodataRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions clientOptions, Uri endpoint = null, string apiVersion = default)
        {
            return new IPGeodataRestOperations(clientDiagnostics, pipeline, clientOptions, endpoint, apiVersion);
        }

        private static DomainWhoisRestOperations GetDomainWhoisRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions clientOptions, Uri endpoint = null, string apiVersion = default)
        {
            return new DomainWhoisRestOperations(clientDiagnostics, pipeline, clientOptions, endpoint, apiVersion);
        }

        private static SourceControlRestOperations GetSourceControlRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions clientOptions, Uri endpoint = null, string apiVersion = default)
        {
            return new SourceControlRestOperations(clientDiagnostics, pipeline, clientOptions, endpoint, apiVersion);
        }

        private static DataConnectorsCheckRequirementsRestOperations GetDataConnectorsCheckRequirementsRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions clientOptions, Uri endpoint = null, string apiVersion = default)
        {
            return new DataConnectorsCheckRequirementsRestOperations(clientDiagnostics, pipeline, clientOptions, endpoint, apiVersion);
        }

        private static ThreatIntelligenceIndicatorRestOperations GetThreatIntelligenceIndicatorRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions clientOptions, Uri endpoint = null, string apiVersion = default)
        {
            return new ThreatIntelligenceIndicatorRestOperations(clientDiagnostics, pipeline, clientOptions, endpoint, apiVersion);
        }

        private static ThreatIntelligenceIndicatorMetricsRestOperations GetThreatIntelligenceIndicatorMetricsRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions clientOptions, Uri endpoint = null, string apiVersion = default)
        {
            return new ThreatIntelligenceIndicatorMetricsRestOperations(clientDiagnostics, pipeline, clientOptions, endpoint, apiVersion);
        }
        ...
        public static async Task<Response<EnrichmentIpGeodata>> GetIPGeodatumAsync(this ResourceGroup resourceGroup, string ipAddress, CancellationToken cancellationToken = default)
        {
            ...
            return await resourceGroup.UseClientContext(async (baseUri, credential, options, pipeline) =>
            {
                ...
                try
                {
                    IPGeodataRestOperations restOperations = GetIPGeodataRestOperations(clientDiagnostics, pipeline, options, baseUri);
        ...
        public static async Task<Response<EnrichmentDomainWhois>> GetDomainWhoiAsync(this ResourceGroup resourceGroup, string domain, CancellationToken cancellationToken = default)
        {
            ...
            return await resourceGroup.UseClientContext(async (baseUri, credential, options, pipeline) =>
            {
                ...
                try
                {
                    DomainWhoisRestOperations restOperations = GetDomainWhoisRestOperations(clientDiagnostics, pipeline, options, baseUri);
        ...
        public static AsyncPageable<Repo> GetRepositoriesSourceControlsAsync(this ResourceGroup resourceGroup, string workspaceName, RepoType repoType, CancellationToken cancellationToken = default)
        {
            ...
            {
                var clientDiagnostics = new ClientDiagnostics(options);
                SourceControlRestOperations restOperations = GetSourceControlRestOperations(clientDiagnostics, pipeline, options, baseUri);
        ...
        public static async Task<Response<DataConnectorRequirementsState>> PostDataConnectorsCheckRequirementAsync(this ResourceGroup resourceGroup, string workspaceName, DataConnectorsCheckRequirements dataConnectorsCheckRequirements, CancellationToken cancellationToken = default)
        {
            ...
            return await resourceGroup.UseClientContext(async (baseUri, credential, options, pipeline) =>
            {
                ...
                try
                {
                    DataConnectorsCheckRequirementsRestOperations restOperations = GetDataConnectorsCheckRequirementsRestOperations(clientDiagnostics, pipeline, options, baseUri);
        ...
        public static async Task<Response<ThreatIntelligenceInformation>> CreateIndicatorThreatIntelligenceIndicatorAsync(this ResourceGroup resourceGroup, string workspaceName, ThreatIntelligenceIndicatorModelForRequestBody threatIntelligenceProperties, CancellationToken cancellationToken = default)
        {
            ...
            return await resourceGroup.UseClientContext(async (baseUri, credential, options, pipeline) =>
            {
                ...
                try
                {
                    ThreatIntelligenceIndicatorRestOperations restOperations = GetThreatIntelligenceIndicatorRestOperations(clientDiagnostics, pipeline, options, baseUri);
        ...
        /// <returns> A collection of resource operations that may take multiple service requests to iterate over. </returns>
        public static AsyncPageable<ThreatIntelligenceInformation> GetAllThreatIntelligenceInformationByQueryIndicatorAsync(this ResourceGroup resourceGroup, string workspaceName, ThreatIntelligenceFilteringCriteria threatIntelligenceFilteringCriteria, CancellationToken cancellationToken = default)
        {
            if (workspaceName == null)
            {
                throw new ArgumentNullException(nameof(workspaceName));
            ...
            return resourceGroup.UseClientContext((baseUri, credential, options, pipeline) =>
            {
                ...
                {
                    using var scope = clientDiagnostics.CreateScope("ResourceGroupExtensions.GetAllThreatIntelligenceInformationByQueryIndicator");
                    scope.Start();
                    try
                    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="workspaceName"/> or <paramref name="threatIntelligenceFilteringCriteria"/> is null. </exception>
        /// <returns> A collection of resource operations that may take multiple service requests to iterate over. </returns>
        public static Pageable<ThreatIntelligenceInformation> GetAllThreatIntelligenceInformationByQueryIndicator(this ResourceGroup resourceGroup, string workspaceName, ThreatIntelligenceFilteringCriteria threatIntelligenceFilteringCriteria, CancellationToken cancellationToken = default)
        {
            if (workspaceName == null)
            {
                throw new ArgumentNullException(nameof(workspaceName));
        ...
        public static AsyncPageable<ThreatIntelligenceMetrics> GetThreatIntelligenceIndicatorMetricsAsync(this ResourceGroup resourceGroup, string workspaceName, CancellationToken cancellationToken = default)
        {
            ...
            {
                var clientDiagnostics = new ClientDiagnostics(options);
                ThreatIntelligenceIndicatorMetricsRestOperations restOperations = GetThreatIntelligenceIndicatorMetricsRestOperations(clientDiagnostics, pipeline, options, baseUri);
