...
namespace Azure.ResourceManager.AppPlatform
{
    internal partial class GatewayCustomDomainsRestOperations
    {
        ...
        public GatewayCustomDomainsRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ClientOptions options, Uri endpoint = null, string apiVersion = "2022-01-01-preview")
        {
        ...
        public async Task<Response<GatewayCustomDomainResourceData>> GetAsync(string subscriptionId, string resourceGroupName, string serviceName, string gatewayName, string domainName, CancellationToken cancellationToken = default)
        {
            ...
            switch (message.Response.Status)
            {
                ...
                case 404:
                    return Response.FromValue((GatewayCustomDomainResourceData)null, message.Response);
                default:
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="subscriptionId"/>, <paramref name="resourceGroupName"/>, <paramref name="serviceName"/>, <paramref name="gatewayName"/>, or <paramref name="domainName"/> is null. </exception>
        public Response<GatewayCustomDomainResourceData> Get(string subscriptionId, string resourceGroupName, string serviceName, string gatewayName, string domainName, CancellationToken cancellationToken = default)
        {
            if (subscriptionId == null)
            {
                throw new ArgumentNullException(nameof(subscriptionId));
        ...
        internal HttpMessage CreateCreateOrUpdateRequest(string subscriptionId, string resourceGroupName, string serviceName, string gatewayName, string domainName, GatewayCustomDomainResourceData gatewayCustomDomainResource)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            ...
            content.JsonWriter.WriteObjectValue(gatewayCustomDomainResource);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="subscriptionId"/>, <paramref name="resourceGroupName"/>, <paramref name="serviceName"/>, <paramref name="gatewayName"/>, <paramref name="domainName"/>, or <paramref name="gatewayCustomDomainResource"/> is null. </exception>
        public async Task<Response> CreateOrUpdateAsync(string subscriptionId, string resourceGroupName, string serviceName, string gatewayName, string domainName, GatewayCustomDomainResourceData gatewayCustomDomainResource, CancellationToken cancellationToken = default)
        {
            if (subscriptionId == null)
            {
                throw new ArgumentNullException(nameof(subscriptionId));
            ...
            using var message = CreateCreateOrUpdateRequest(subscriptionId, resourceGroupName, serviceName, gatewayName, domainName, gatewayCustomDomainResource);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="subscriptionId"/>, <paramref name="resourceGroupName"/>, <paramref name="serviceName"/>, <paramref name="gatewayName"/>, <paramref name="domainName"/>, or <paramref name="gatewayCustomDomainResource"/> is null. </exception>
        public Response CreateOrUpdate(string subscriptionId, string resourceGroupName, string serviceName, string gatewayName, string domainName, GatewayCustomDomainResourceData gatewayCustomDomainResource, CancellationToken cancellationToken = default)
        {
            if (subscriptionId == null)
            {
                throw new ArgumentNullException(nameof(subscriptionId));
