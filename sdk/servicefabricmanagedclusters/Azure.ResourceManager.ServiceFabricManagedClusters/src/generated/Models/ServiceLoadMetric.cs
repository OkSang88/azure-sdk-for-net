...
namespace ServiceFabricManagedClustersManagementClient.Models
{
    ...
    {
        /// <summary> Initializes a new instance of ServiceLoadMetric. </summary>
        ...
        internal ServiceLoadMetric(string name, ServiceLoadMetricWeight? weight, int? primaryDefaultLoad, int? secondaryDefaultLoad, int? defaultLoad)
        {
            Name = name;
            Weight = weight;
