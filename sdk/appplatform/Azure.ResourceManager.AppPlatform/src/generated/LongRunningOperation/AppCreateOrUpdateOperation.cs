...
namespace AppPlatformManagementClient.Models
{
    ...
    public partial class AppCreateOrUpdateOperation : Operation<AppResource>, IOperationSource<AppResource>
    {
        ...
        {
            _operation = new OperationInternals<AppResource>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.AzureAsyncOperation, "AppCreateOrUpdateOperation");
