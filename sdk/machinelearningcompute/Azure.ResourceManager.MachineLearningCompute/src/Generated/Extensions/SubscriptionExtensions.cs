...
namespace Azure.ResourceManager.MachineLearningCompute
{
    ...
    {
        private static OperationalizationClustersRestOperations GetOperationalizationClustersRestOperations(ClientDiagnostics clientDiagnostics, TokenCredential credential, ArmClientOptions clientOptions, HttpPipeline pipeline, Uri endpoint = null)
        {
            return new OperationalizationClustersRestOperations(clientDiagnostics, pipeline, clientOptions, endpoint);
        }
        ...
        public static AsyncPageable<OperationalizationCluster> GetOperationalizationClustersBySubscriptionIdAsync(this Subscription subscription, string skiptoken = null, CancellationToken cancellationToken = default)
        {
            return subscription.UseClientContext((baseUri, credential, options, pipeline) =>
            {
                var clientDiagnostics = new ClientDiagnostics(options);
                var restOperations = GetOperationalizationClustersRestOperations(clientDiagnostics, credential, options, pipeline, baseUri);
                async Task<Page<OperationalizationCluster>> FirstPageFunc(int? pageSizeHint)
                {
                    using var scope = clientDiagnostics.CreateScope("SubscriptionExtensions.GetOperationalizationClustersBySubscriptionId");
                    scope.Start();
                    try
                    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of resource operations that may take multiple service requests to iterate over. </returns>
        public static Pageable<OperationalizationCluster> GetOperationalizationClustersBySubscriptionId(this Subscription subscription, string skiptoken = null, CancellationToken cancellationToken = default)
        {
            return subscription.UseClientContext((baseUri, credential, options, pipeline) =>
            {
                var clientDiagnostics = new ClientDiagnostics(options);
