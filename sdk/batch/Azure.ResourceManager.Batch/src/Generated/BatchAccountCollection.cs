...
namespace Azure.ResourceManager.Batch
{
    ...
    public partial class BatchAccountCollection : ArmCollection, IEnumerable<BatchAccount>, IAsyncEnumerable<BatchAccount>
    {
        ...
        internal BatchAccountCollection(ArmResource parent) : base(parent)
        {
            ...
            _batchAccountRestClient = new BatchAccountRestOperations(_clientDiagnostics, Pipeline, ClientOptions, BaseUri);
#if DEBUG
        ...
        public virtual BatchAccountCreateOperation CreateOrUpdate(bool waitForCompletion, string accountName, BatchAccountCreateParameters parameters, CancellationToken cancellationToken = default)
        {
            if (accountName == null)
            {
            ...
            try
            {
                ...
                var operation = new BatchAccountCreateOperation(Parent, _clientDiagnostics, Pipeline, _batchAccountRestClient.CreateCreateRequest(Id.SubscriptionId, Id.ResourceGroupName, accountName, parameters).Request, response);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="accountName"/> or <paramref name="parameters"/> is null. </exception>
        public async virtual Task<BatchAccountCreateOperation> CreateOrUpdateAsync(bool waitForCompletion, string accountName, BatchAccountCreateParameters parameters, CancellationToken cancellationToken = default)
        {
            if (accountName == null)
            {
                throw new ArgumentNullException(nameof(accountName));
        ...
        public virtual Response<BatchAccount> Get(string accountName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new BatchAccount(Parent, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual Pageable<BatchAccount> GetAll(CancellationToken cancellationToken = default)
        {
            Page<BatchAccount> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    ...
                    return Page.FromValues(response.Value.Value.Select(value => new BatchAccount(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
