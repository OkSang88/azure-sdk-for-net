...
namespace Azure.ResourceManager.DeviceProvisioningServices
{
    ...
    public partial class CertificateResponseCollection : ArmCollection, IEnumerable<CertificateResponse>, IAsyncEnumerable<CertificateResponse>
    {
        ...
        internal CertificateResponseCollection(ArmResource parent) : base(parent)
        {
            ...
            ClientOptions.TryGetApiVersion(CertificateResponse.ResourceType, out string apiVersion);
        ...
        public virtual CertificateResponseCreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, string certificateName, CertificateBodyDescription certificateDescription, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new CertificateResponseCreateOrUpdateOperation(this, response);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="certificateName"/> or <paramref name="certificateDescription"/> is null. </exception>
        public async virtual Task<CertificateResponseCreateOrUpdateOperation> CreateOrUpdateAsync(bool waitForCompletion, string certificateName, CertificateBodyDescription certificateDescription, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            if (certificateName == null)
            {
                throw new ArgumentNullException(nameof(certificateName));
        ...
        public virtual Pageable<CertificateResponse> GetAll(CancellationToken cancellationToken = default)
        {
            Page<CertificateResponse> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    ...
                    return Page.FromValues(response.Value.Value.Select(value => new CertificateResponse(this, value)), null, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
