...
namespace IotDpsClient.Models
{
    ...
    public partial class IotDpsResourceDeletePrivateEndpointConnectionOperation : Operation<PrivateEndpointConnectionData>, IOperationSource<PrivateEndpointConnectionData>
    {
        private readonly OperationInternals<PrivateEndpointConnectionData> _operation;

        /// <summary> Initializes a new instance of IotDpsResourceDeletePrivateEndpointConnectionOperation for mocking. </summary>
        protected IotDpsResourceDeletePrivateEndpointConnectionOperation()
        {
        }

        internal IotDpsResourceDeletePrivateEndpointConnectionOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<PrivateEndpointConnectionData>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "IotDpsResourceDeletePrivateEndpointConnectionOperation");
        }
