# Azure GuestConfiguration Management client library for .NET
...
Install the Azure GuestConfiguration management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.GuestConfiguration -Version 1.0.0-preview.1 
```
