...
namespace Insights
{
    public partial class ActionGroupResourceData : IUtf8JsonSerializable
    {
        ...
        internal static ActionGroupResourceData DeserializeActionGroupResourceData(JsonElement element)
        {
            ...
            return new ActionGroupResourceData(id, name, type, tags, location, groupShortName.Value, Optional.ToNullable(enabled), Optional.ToList(emailReceivers), Optional.ToList(smsReceivers), Optional.ToList(webhookReceivers), Optional.ToList(itsmReceivers), Optional.ToList(azureAppPushReceivers), Optional.ToList(automationRunbookReceivers), Optional.ToList(voiceReceivers), Optional.ToList(logicAppReceivers), Optional.ToList(azureFunctionReceivers), Optional.ToList(armRoleReceivers));
        }
    }
}
