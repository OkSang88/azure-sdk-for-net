...
namespace IotHubClient.Models
{
    ...
    {
        /// <summary> Initializes a new instance of StorageEndpointProperties. </summary>
        ...
        internal StorageEndpointProperties(TimeSpan? sasTtlAsIso8601, string connectionString, string containerName, AuthenticationType? authenticationType, ManagedIdentity identity)
        {
