# Azure ApplicationInsights Management client library for .NET
...
Install the Azure ApplicationInsights management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.ApplicationInsights -Version 1.0.0-preview.1 
```
