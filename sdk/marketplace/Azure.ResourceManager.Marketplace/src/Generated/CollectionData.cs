...
namespace Azure.ResourceManager.Marketplace
{
    ...
    public partial class CollectionData : Resource
    {
        ...
        internal CollectionData(ResourceIdentifier id, string name, ResourceType type, SystemData systemData, string collectionId, string collectionName, string claim, bool? allSubscriptions, IList<string> subscriptionsList, bool? enabled, long? numberOfOffers) : base(id, name, type, systemData)
        {
