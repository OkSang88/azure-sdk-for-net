...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AzureSqlSink : CopySink
    {
        ...
        internal AzureSqlSink(string type, object writeBatchSize, object writeBatchTimeout, object sinkRetryCount, object sinkRetryWait, object maxConcurrentConnections, object disableMetricsCollection, IDictionary<string, object> additionalProperties, object sqlWriterStoredProcedureName, object sqlWriterTableType, object preCopyScript, IDictionary<string, StoredProcedureParameter> storedProcedureParameters, object storedProcedureTableTypeParameterName, object tableOption, object sqlWriterUseTableLock, object writeBehavior, SqlUpsertSettings upsertSettings) : base(type, writeBatchSize, writeBatchTimeout, sinkRetryCount, sinkRetryWait, maxConcurrentConnections, disableMetricsCollection, additionalProperties)
        {
