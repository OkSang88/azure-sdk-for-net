...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Tests.Mock
{
    ...
    public partial class ApplicationTypeVersionResourceMockTests : MockTestBase
    {
        ...
        public async Task Get()
        {
            ...
            var applicationTypeVersionResourceId = ServiceFabricManagedClusters.ApplicationTypeVersionResource.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "resRg", "myCluster", "myAppType", "1.0");
        ...
        public async Task Update()
        {
            ...
            var applicationTypeVersionResourceId = ServiceFabricManagedClusters.ApplicationTypeVersionResource.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "resRg", "myCluster", "myAppType", "1.0");
            var applicationTypeVersionResource = GetArmClient().GetApplicationTypeVersionResource(applicationTypeVersionResourceId);
            ServiceFabricManagedClusters.Models.ApplicationTypeVersionUpdateParameters parameters = new ServiceFabricManagedClusters.Models.ApplicationTypeVersionUpdateParameters();
