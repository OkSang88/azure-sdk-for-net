...
namespace PowerBIDedicated
{
    ...
    public partial class AutoScaleVCoreData : Resource
    {
        ...
        internal AutoScaleVCoreData(ResourceIdentifier id, string name, ResourceType type, IDictionary<string, string> tags, AzureLocation location, SystemData systemData, AutoScaleVCoreSku sku, int? capacityLimit, string capacityObjectId, VCoreProvisioningState? provisioningState) : base(id, name, type, tags, location, systemData)
        {
            Sku = sku;
