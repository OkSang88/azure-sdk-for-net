...
namespace Azure.ResourceManager.Sql
{
    public partial class Sample_SqlDatabaseSensitivityLabelResource
    {
        ...
        public async Task Update_UpdatesTheSensitivityLabelOfAGivenColumnWithAllParameters()
        {
            ...
            ArmOperation<SqlDatabaseSensitivityLabelResource> lro = await sqlDatabaseSensitivityLabel.UpdateAsync(WaitUntil.Completed, data);
        ...
        {
            // Generated from example definition: specification/sql/resource-manager/Microsoft.Sql/preview/2020-11-01-preview/examples/ColumnSensitivityLabelDelete.json
            // this example is just showing the usage of "SensitivityLabels_Delete" operation, for the dependent resources, they will have to be created separately.
            ...
            // invoke the operation
            await sqlDatabaseSensitivityLabel.DeleteAsync(WaitUntil.Completed);
