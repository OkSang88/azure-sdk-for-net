...
namespace Azure.ResourceManager.DataFactory
{
    public partial class PipelineResourceData : IUtf8JsonSerializable
    {
        ...
        internal static PipelineResourceData DeserializePipelineResourceData(JsonElement element)
        {
            ...
            return new PipelineResourceData(id, name, type, etag.Value, description.Value, Optional.ToList(activities), Optional.ToDictionary(parameters), Optional.ToDictionary(variables), Optional.ToNullable(concurrency), Optional.ToList(annotations), Optional.ToDictionary(runDimensions), folder.Value, policy.Value, additionalProperties);
        }
    }
}
