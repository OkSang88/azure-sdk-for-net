...
namespace Azure.ResourceManager.LabServices
{
    public partial class LabData : IUtf8JsonSerializable
    {
        ...
        internal static LabData DeserializeLabData(JsonElement element)
        {
            ...
            return new LabData(id, name, type, tags, location, systemData, autoShutdownProfile.Value, connectionProfile.Value, virtualMachineProfile.Value, securityProfile.Value, rosterProfile.Value, labPlanId.Value, title.Value, description.Value, Optional.ToNullable(provisioningState), networkProfile.Value, Optional.ToNullable(state));
        }
    }
}
