...
namespace SecurityInsights.Models
{
    ...
    {
        /// <summary> Initializes a new instance of ThreatIntelligence. </summary>
        ...
        internal ThreatIntelligence(double? confidence, string providerName, string reportLink, string threatDescription, string threatName, string threatType)
        {
