...
namespace ContainerRegistryManagementClient.Models
{
    ...
    {
        /// <summary> Initializes a new instance of EventRequestMessage. </summary>
        ...
        internal EventRequestMessage(EventContent content, IReadOnlyDictionary<string, string> headers, string method, string requestUri, string version)
        {
            Content = content;
            Headers = headers;
            Method = method;
