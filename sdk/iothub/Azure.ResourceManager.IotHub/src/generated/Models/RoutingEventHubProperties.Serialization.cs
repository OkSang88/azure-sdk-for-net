...
namespace IotHubClient.Models
{
    public partial class RoutingEventHubProperties : IUtf8JsonSerializable
    {
        ...
        internal static RoutingEventHubProperties DeserializeRoutingEventHubProperties(JsonElement element)
        {
            ...
            return new RoutingEventHubProperties(id.Value, connectionString.Value, endpointUri.Value, entityPath.Value, Optional.ToNullable(authenticationType), identity.Value, name, subscriptionId.Value, resourceGroup.Value);
        }
    }
}
