...
namespace Insights
{
    public partial class DiagnosticSettingsResourceData : IUtf8JsonSerializable
    {
        ...
        internal static DiagnosticSettingsResourceData DeserializeDiagnosticSettingsResourceData(JsonElement element)
        {
            ...
            return new DiagnosticSettingsResourceData(id, name, type, storageAccountId.Value, serviceBusRuleId.Value, eventHubAuthorizationRuleId.Value, eventHubName.Value, Optional.ToList(metrics), Optional.ToList(logs), workspaceId.Value, logAnalyticsDestinationType.Value);
        }
    }
}
