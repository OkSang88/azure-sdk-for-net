...
namespace FrontDoorManagementClient
{
    ...
    public partial class Profile : ArmResource
    {
        ...
        internal Profile(ArmResource options, ProfileData data) : base(options, data.Id)
        {
            ...
            _networkExperimentProfilesRestClient = new NetworkExperimentProfilesRestOperations(_clientDiagnostics, Pipeline, ClientOptions, BaseUri);
            _preconfiguredEndpointsRestClient = new PreconfiguredEndpointsRestOperations(_clientDiagnostics, Pipeline, ClientOptions, BaseUri);
#if DEBUG
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async virtual Task<NetworkExperimentProfileDeleteOperation> DeleteAsync(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new NetworkExperimentProfileDeleteOperation(_clientDiagnostics, Pipeline, _networkExperimentProfilesRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name).Request, response);
        ...
        /// <param name="waitForCompletion"> Waits for the completion of the long running operations. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual NetworkExperimentProfileDeleteOperation Delete(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("Profile.Delete");
            scope.Start();
            try
        ...
        public async virtual Task<NetworkExperimentProfileUpdateOperation> UpdateAsync(bool waitForCompletion, ProfileUpdateModel parameters, CancellationToken cancellationToken = default)
        {
            if (parameters == null)
            {
            ...
            try
            {
                ...
                var operation = new NetworkExperimentProfileUpdateOperation(this, _clientDiagnostics, Pipeline, _networkExperimentProfilesRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, parameters).Request, response);
                if (waitForCompletion)
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="parameters"/> is null. </exception>
        public virtual NetworkExperimentProfileUpdateOperation Update(bool waitForCompletion, ProfileUpdateModel parameters, CancellationToken cancellationToken = default)
        {
            if (parameters == null)
            {
                throw new ArgumentNullException(nameof(parameters));
