...
namespace DataFactoryManagementClient.Models
{
    ...
    public partial class TriggerSubscribeToEventsOperation : Operation<TriggerSubscriptionOperationStatus>, IOperationSource<TriggerSubscriptionOperationStatus>
    {
        private readonly OperationInternals<TriggerSubscriptionOperationStatus> _operation;

        /// <summary> Initializes a new instance of TriggerSubscribeToEventsOperation for mocking. </summary>
        protected TriggerSubscribeToEventsOperation()
        {
        }

        internal TriggerSubscribeToEventsOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<TriggerSubscriptionOperationStatus>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "TriggerSubscribeToEventsOperation");
        }
