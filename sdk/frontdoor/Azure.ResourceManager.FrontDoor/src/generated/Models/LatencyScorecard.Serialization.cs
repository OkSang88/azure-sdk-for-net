...
namespace FrontDoorManagementClient.Models
{
    public partial class LatencyScorecard : IUtf8JsonSerializable
    {
        ...
        internal static LatencyScorecard DeserializeLatencyScorecard(JsonElement element)
        {
            ...
            return new LatencyScorecard(id, name, type, tags, location, id0.Value, name0.Value, description.Value, endpointA.Value, endpointB.Value, Optional.ToNullable(startDateTimeUTC), Optional.ToNullable(endDateTimeUTC), country.Value, Optional.ToList(latencyMetrics));
        }
    }
}
