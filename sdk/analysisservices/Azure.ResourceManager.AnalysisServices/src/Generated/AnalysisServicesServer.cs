...
namespace Azure.ResourceManager.AnalysisServices
{
    ...
    public partial class AnalysisServicesServer : ArmResource
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async virtual Task<AnalysisServicesServerDeleteOperation> DeleteAsync(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new AnalysisServicesServerDeleteOperation(_clientDiagnostics, Pipeline, _serversRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name).Request, response);
        ...
        /// <param name="waitForCompletion"> Waits for the completion of the long running operations. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual AnalysisServicesServerDeleteOperation Delete(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("AnalysisServicesServer.Delete");
            scope.Start();
            try
        ...
        public async virtual Task<AnalysisServicesServerUpdateOperation> UpdateAsync(bool waitForCompletion, AnalysisServicesServerUpdateParameters serverUpdateParameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new AnalysisServicesServerUpdateOperation(this, _clientDiagnostics, Pipeline, _serversRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, serverUpdateParameters).Request, response);
                if (waitForCompletion)
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="serverUpdateParameters"/> is null. </exception>
        public virtual AnalysisServicesServerUpdateOperation Update(bool waitForCompletion, AnalysisServicesServerUpdateParameters serverUpdateParameters, CancellationToken cancellationToken = default)
        {
            if (serverUpdateParameters == null)
            {
                throw new ArgumentNullException(nameof(serverUpdateParameters));
        ...
        /// <param name="waitForCompletion"> Waits for the completion of the long running operations. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async virtual Task<AnalysisServicesServerSuspendOperation> SuspendAsync(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new AnalysisServicesServerSuspendOperation(_clientDiagnostics, Pipeline, _serversRestClient.CreateSuspendRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name).Request, response);
                if (waitForCompletion)
                    await operation.WaitForCompletionResponseAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        /// <param name="waitForCompletion"> Waits for the completion of the long running operations. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual AnalysisServicesServerSuspendOperation Suspend(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("AnalysisServicesServer.Suspend");
            scope.Start();
            try
        ...
        /// <param name="waitForCompletion"> Waits for the completion of the long running operations. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async virtual Task<AnalysisServicesServerResumeOperation> ResumeAsync(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new AnalysisServicesServerResumeOperation(_clientDiagnostics, Pipeline, _serversRestClient.CreateResumeRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name).Request, response);
                if (waitForCompletion)
                    await operation.WaitForCompletionResponseAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        /// <param name="waitForCompletion"> Waits for the completion of the long running operations. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual AnalysisServicesServerResumeOperation Resume(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("AnalysisServicesServer.Resume");
            scope.Start();
            try
