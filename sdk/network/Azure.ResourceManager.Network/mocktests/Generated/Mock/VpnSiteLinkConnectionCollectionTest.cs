...
namespace Azure.ResourceManager.Network.Tests.Mock
{
    ...
    public partial class VpnSiteLinkConnectionCollectionMockTests : MockTestBase
    {
        ...
        public async Task GetAsync()
        {
            ...
            var collection = GetArmClient().GetVpnConnection(new ResourceIdentifier("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.Network/vpnGateways/gateway1/vpnConnections/vpnConnection1")).GetVpnSiteLinkConnections();
