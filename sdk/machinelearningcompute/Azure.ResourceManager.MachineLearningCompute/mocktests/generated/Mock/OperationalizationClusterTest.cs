...
namespace MachineLearningComputeManagementClient.Tests.Mock
{
    ...
    public partial class OperationalizationClusterMockTests : MockTestBase
    {
        ...
        public async Task Get()
        {
            ...
            var operationalizationClusterId = MachineLearningComputeManagementClient.OperationalizationCluster.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "myResourceGroup", "myCluster");
        ...
        public async Task Update()
        {
            ...
            var operationalizationClusterId = MachineLearningComputeManagementClient.OperationalizationCluster.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "myResourceGroup", "myCluster");
            var operationalizationCluster = GetArmClient().GetOperationalizationCluster(operationalizationClusterId);
            MachineLearningComputeManagementClient.Models.OperationalizationClusterUpdateParameters parameters = new MachineLearningComputeManagementClient.Models.OperationalizationClusterUpdateParameters();
