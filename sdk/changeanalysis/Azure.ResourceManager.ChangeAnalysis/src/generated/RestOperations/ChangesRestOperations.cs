...
namespace AzureChangeAnalysisManagementClient
{
    internal partial class ChangesRestOperations
    {
        ...
        public ChangesRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ClientOptions options, Uri endpoint = null, string apiVersion = "2021-04-01")
        {
