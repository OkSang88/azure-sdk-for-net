...
{
    public partial class ServiceBusMessage : IUtf8JsonSerializable
    {
        ...
        internal static ServiceBusMessage DeserializeServiceBusMessage(JsonElement element)
        {
            ...
            return new ServiceBusMessage(authentication.Value, brokeredMessageProperties.Value, Optional.ToDictionary(customMessageProperties), message.Value, @namespace.Value, Optional.ToNullable(transportType));
        }
    }
}
