...
{
    public partial class Sample_PrivateDnsPtrRecordCollection
    {
        ...
        public async Task CreateOrUpdate_PUTPrivateDNSZoneARecordSet()
        {
            ...
            // get the collection of this PrivateDnsPtrRecordResource
            PrivateDnsPtrRecordCollection collection = privateDnsZone.GetPrivateDnsPtrRecords();
...
IPv4Address = "1.2.3.4",
            ...
            ArmOperation<PrivateDnsPtrRecordResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, relativeRecordSetName, data);
            PrivateDnsPtrRecordResource result = lro.Value;
...
"string1","string2"
        ...
        public async Task Get_GETPrivateDNSZoneARecordSet()
        {
            ...
            // invoke the operation
            string relativeRecordSetName = "recordA";
            PrivateDnsPtrRecordResource result = await collection.GetAsync(relativeRecordSetName);
        ...
        public async Task GetAll_GETPrivateDNSZoneARecordSets()
        {
            ...
            await foreach (PrivateDnsPtrRecordResource item in collection.GetAllAsync())
            {
