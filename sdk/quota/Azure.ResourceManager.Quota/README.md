# Azure Quota Management client library for .NET
...
Install the Azure Quota management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.Quota -Version 1.0.0-preview.1 
```
