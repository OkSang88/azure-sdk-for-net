...
{
    public partial class IPv4FirewallRule : IUtf8JsonSerializable
    {
        ...
        internal static IPv4FirewallRule DeserializeIPv4FirewallRule(JsonElement element)
        {
            ...
            return new IPv4FirewallRule(firewallRuleName.Value, rangeStart.Value, rangeEnd.Value);
        }
    }
}
