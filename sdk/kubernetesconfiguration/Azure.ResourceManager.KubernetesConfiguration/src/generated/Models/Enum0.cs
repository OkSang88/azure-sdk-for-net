...
namespace SourceControlConfigurationClient.Models
{
    ...
    public readonly partial struct Enum0 : IEquatable<Enum0>
    {
        ...
        private const string MicrosoftContainerServiceValue = "Microsoft.ContainerService";
        private const string MicrosoftKubernetesValue = "Microsoft.Kubernetes";

        /// <summary> Microsoft.ContainerService. </summary>
        public static Enum0 MicrosoftContainerService { get; } = new Enum0(MicrosoftContainerServiceValue);
        /// <summary> Microsoft.Kubernetes. </summary>
        public static Enum0 MicrosoftKubernetes { get; } = new Enum0(MicrosoftKubernetesValue);
