...
{
    /// <summary> A class representing the GatewayResourceDescription data model. </summary>
    public partial class GatewayResourceDescriptionData : TrackedResource
    {
        /// <summary> Initializes a new instance of GatewayResourceDescriptionData. </summary>
        ...
        public GatewayResourceDescriptionData(AzureLocation location, NetworkRef sourceNetwork, NetworkRef destinationNetwork) : base(location)
        {
        ...
        internal GatewayResourceDescriptionData(ResourceIdentifier id, string name, ResourceType type, IDictionary<string, string> tags, AzureLocation location, string provisioningState, string description, NetworkRef sourceNetwork, NetworkRef destinationNetwork, IList<TcpConfig> tcp, IList<HttpConfig> http, ResourceStatus? status, string statusDetails, string ipAddress) : base(id, name, type, tags, location)
        {
