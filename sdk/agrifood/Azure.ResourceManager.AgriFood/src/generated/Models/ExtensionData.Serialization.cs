...
namespace AzureAgriFoodRPService
{
    public partial class ExtensionData : IUtf8JsonSerializable
    {
        ...
        internal static ExtensionData DeserializeExtensionData(JsonElement element)
        {
            ...
            return new ExtensionData(id, name, type, systemData, eTag.Value, extensionId.Value, extensionCategory.Value, installedExtensionVersion.Value, extensionAuthLink.Value, extensionApiDocsLink.Value);
        }
    }
}
