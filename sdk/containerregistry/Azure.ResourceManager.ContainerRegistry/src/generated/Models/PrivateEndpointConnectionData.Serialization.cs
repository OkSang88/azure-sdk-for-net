...
namespace ContainerRegistryManagementClient
{
    public partial class PrivateEndpointConnectionData : IUtf8JsonSerializable
    {
        ...
        internal static PrivateEndpointConnectionData DeserializePrivateEndpointConnectionData(JsonElement element)
        {
            ...
            return new PrivateEndpointConnectionData(id, name, type, systemData.Value, privateEndpoint, privateLinkServiceConnectionState.Value, Optional.ToNullable(provisioningState));
        }
    }
}
