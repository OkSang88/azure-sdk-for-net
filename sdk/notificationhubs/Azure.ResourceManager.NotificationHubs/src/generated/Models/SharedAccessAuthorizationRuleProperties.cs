...
namespace NotificationHubsManagementClient.Models
{
    ...
    public partial class SharedAccessAuthorizationRuleProperties
    {
        ...
        internal SharedAccessAuthorizationRuleProperties(IList<AccessRights> rights, string primaryKey, string secondaryKey, string keyName, string claimType, string claimValue, string modifiedTime, string createdTime, int? revision)
        {
            Rights = rights;
