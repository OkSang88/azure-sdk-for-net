...
namespace Azure.ResourceManager.Batch
{
    ...
    {
        private static BatchAccountRestOperations GetBatchAccountRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions clientOptions, Uri endpoint = null, string apiVersion = default)
        {
            return new BatchAccountRestOperations(clientDiagnostics, pipeline, clientOptions, endpoint, apiVersion);
        }
        ...
        public static AsyncPageable<BatchAccount> GetBatchAccountsAsync(this Subscription subscription, CancellationToken cancellationToken = default)
        {
            return subscription.UseClientContext((baseUri, credential, options, pipeline) =>
            {
                ...
                options.TryGetApiVersion(BatchAccount.ResourceType, out string apiVersion);
                BatchAccountRestOperations restOperations = GetBatchAccountRestOperations(clientDiagnostics, pipeline, options, baseUri, apiVersion);
