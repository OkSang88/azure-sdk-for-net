...
namespace Azure.ResourceManager.HybridContainerService.Samples
{
    public partial class Sample_ProvisionedClusterCollection
    {
        ...
        public async Task Get_GetProvisionedCluster()
        {
            ...
            ProvisionedClusterResource result = await collection.GetAsync(provisionedClustersName);
        ...
        public async Task Exists_GetProvisionedCluster()
        {
            ...
            // invoke the operation
            string provisionedClustersName = "test-hybridakscluster";
            bool result = await collection.ExistsAsync(provisionedClustersName);
        ...
        {
            // Generated from example definition: specification/hybridaks/resource-manager/Microsoft.HybridContainerService/preview/2022-05-01-preview/examples/PutProvisionedCluster.json
...
"/subscriptions/a3e42606-29b1-4d7d-b1d9-9ff6b9d3c71b/resourceGroups/test-arcappliance-resgrp/providers/Microsoft.HybridContainerService/storageSpaces/test-storage"
            ...
            ArmOperation<ProvisionedClusterResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, provisionedClustersName, content);
        ...
        {
            // Generated from example definition: specification/hybridaks/resource-manager/Microsoft.HybridContainerService/preview/2022-05-01-preview/examples/ListProvisionedClusterByResourceGroup.json
