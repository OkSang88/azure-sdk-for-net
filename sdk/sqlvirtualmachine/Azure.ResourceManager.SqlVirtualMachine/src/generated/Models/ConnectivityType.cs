...
namespace SqlVirtualMachineManagementClient.Models
{
    ...
    public readonly partial struct ConnectivityType : IEquatable<ConnectivityType>
    {
        ...
        public static ConnectivityType Local { get; } = new ConnectivityType(LocalValue);
        /// <summary> PRIVATE. </summary>
        public static ConnectivityType Private { get; } = new ConnectivityType(PrivateValue);
        /// <summary> PUBLIC. </summary>
        public static ConnectivityType Public { get; } = new ConnectivityType(PublicValue);
