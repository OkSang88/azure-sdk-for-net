...
namespace Azure.ResourceManager.HybridDataManager
{
    ...
    public partial class DataStoreCollection : ArmCollection, IEnumerable<DataStore>, IAsyncEnumerable<DataStore>
    {
        ...
        internal DataStoreCollection(ArmResource parent) : base(parent)
        {
            ...
            ClientOptions.TryGetApiVersion(DataStore.ResourceType, out string apiVersion);
        ...
        public virtual DataStoreCreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, string dataStoreName, DataStoreData dataStore, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new DataStoreCreateOrUpdateOperation(this, _clientDiagnostics, Pipeline, _dataStoresRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, dataStoreName, dataStore).Request, response);
        ...
        public virtual Pageable<DataStore> GetAll(string filter = null, CancellationToken cancellationToken = default)
        {
            Page<DataStore> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    ...
                    return Page.FromValues(response.Value.Value.Select(value => new DataStore(this, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
