...
namespace AppPlatformManagementClient.Models
{
    ...
    public partial class ApiPortalProperties
    {
        ...
        /// <param name="url"> URL of the API portal, exposed when &apos;public&apos; is true. </param>
        ...
        internal ApiPortalProperties(ApiPortalProvisioningState? provisioningState, bool? @public, string url, bool? httpsOnly, IList<string> gatewayIds, IList<string> sourceUrls, SsoProperties ssoProperties, ApiPortalResourceRequests resourceRequests, IReadOnlyList<ApiPortalInstance> instances)
        {
