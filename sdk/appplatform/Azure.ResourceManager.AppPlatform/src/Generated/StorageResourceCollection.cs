...
namespace Azure.ResourceManager.AppPlatform
{
    ...
    public partial class StorageResourceCollection : ArmCollection, IEnumerable<StorageResource>, IAsyncEnumerable<StorageResource>
    {
        ...
        public virtual StorageCreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, string storageName, StorageResourceData storageResource, CancellationToken cancellationToken = default)
        {
            if (storageName == null)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="storageName"/> or <paramref name="storageResource"/> is null. </exception>
        public async virtual Task<StorageCreateOrUpdateOperation> CreateOrUpdateAsync(bool waitForCompletion, string storageName, StorageResourceData storageResource, CancellationToken cancellationToken = default)
        {
            if (storageName == null)
            {
                throw new ArgumentNullException(nameof(storageName));
