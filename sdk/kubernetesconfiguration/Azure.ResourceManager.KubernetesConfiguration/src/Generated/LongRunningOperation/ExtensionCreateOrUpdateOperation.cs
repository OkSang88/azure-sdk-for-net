...
namespace Azure.ResourceManager.KubernetesConfiguration.Models
{
    ...
    public partial class ExtensionCreateOrUpdateOperation : Operation<Extension>, IOperationSource<Extension>
    {
        private readonly OperationInternals<Extension> _operation;

        private readonly ArmResource _operationBase;

        /// <summary> Initializes a new instance of ExtensionCreateOrUpdateOperation for mocking. </summary>
        protected ExtensionCreateOrUpdateOperation()
        {
        }

        internal ExtensionCreateOrUpdateOperation(ArmResource operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<Extension>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.AzureAsyncOperation, "ExtensionCreateOrUpdateOperation");
