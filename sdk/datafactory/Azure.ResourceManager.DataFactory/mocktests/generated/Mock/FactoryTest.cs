...
namespace Azure.ResourceManager.DataFactory.Tests.Mock.Tests.Mock
{
    ...
    public partial class FactoryMockTests : MockTestBase
    {
        ...
        public async Task Update()
        {
            ...
            var factoryId = DataFactory.Tests.Mock.Factory.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "exampleResourceGroup", "exampleFactoryName");
            var factory = GetArmClient().GetFactory(factoryId);
            DataFactory.Tests.Mock.Models.FactoryUpdateParameters factoryUpdateParameters = new DataFactory.Tests.Mock.Models.FactoryUpdateParameters();
        ...
        public async Task GetGitHubAccessToken()
        {
            ...
            var factoryId = DataFactory.Tests.Mock.Factory.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "exampleResourceGroup", "exampleFactoryName");
            var factory = GetArmClient().GetFactory(factoryId);
            DataFactory.Tests.Mock.Models.GitHubAccessTokenRequest gitHubAccessTokenRequest = new DataFactory.Tests.Mock.Models.GitHubAccessTokenRequest(gitHubAccessCode: "some", gitHubAccessTokenBaseUrl: "some")
            {
                GitHubClientId = "some",
            };
        ...
        public async Task GetDataPlaneAccess()
        {
            ...
            var factoryId = DataFactory.Tests.Mock.Factory.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "exampleResourceGroup", "exampleFactoryName");
            var factory = GetArmClient().GetFactory(factoryId);
            DataFactory.Tests.Mock.Models.UserAccessPolicy policy = new DataFactory.Tests.Mock.Models.UserAccessPolicy()
            {
                Permissions = "r",
                AccessResourcePath = "",
        ...
        public async Task GetFeatureValueByFactoryExposureControl()
        {
            ...
            var factoryId = DataFactory.Tests.Mock.Factory.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "exampleResourceGroup", "exampleFactoryName");
            var factory = GetArmClient().GetFactory(factoryId);
            DataFactory.Tests.Mock.Models.ExposureControlRequest exposureControlRequest = new DataFactory.Tests.Mock.Models.ExposureControlRequest()
            {
        ...
        public async Task QueryFeatureValuesByFactoryExposureControl()
        {
            ...
            var factoryId = DataFactory.Tests.Mock.Factory.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "exampleResourceGroup", "exampleFactoryName");
            var factory = GetArmClient().GetFactory(factoryId);
            DataFactory.Tests.Mock.Models.ExposureControlBatchRequest exposureControlBatchRequest = new DataFactory.Tests.Mock.Models.ExposureControlBatchRequest(exposureControlRequests: new List<DataFactory.Tests.Mock.Models.ExposureControlRequest>()
{
new DataFactory.Tests.Mock.Models.ExposureControlRequest()
{
FeatureName = "ADFIntegrationRuntimeSharingRbac", FeatureType = "Feature", },new DataFactory.Tests.Mock.Models.ExposureControlRequest()
{
FeatureName = "ADFSampleFeature", FeatureType = "Feature", },});
        ...
        public async Task QueryPipelineRuns()
        {
            ...
            var factoryId = DataFactory.Tests.Mock.Factory.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "exampleResourceGroup", "exampleFactoryName");
            var factory = GetArmClient().GetFactory(factoryId);
            DataFactory.Tests.Mock.Models.RunFilterParameters filterParameters = new DataFactory.Tests.Mock.Models.RunFilterParameters(lastUpdatedAfter: DateTimeOffset.Parse("2018-06-16T00:36:44.3345758Z"), lastUpdatedBefore: DateTimeOffset.Parse("2018-06-16T00:49:48.3686473Z"));
        ...
        public async Task QueryTriggers()
        {
            ...
            var factoryId = DataFactory.Tests.Mock.Factory.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "exampleResourceGroup", "exampleFactoryName");
            var factory = GetArmClient().GetFactory(factoryId);
            DataFactory.Tests.Mock.Models.TriggerFilterParameters filterParameters = new DataFactory.Tests.Mock.Models.TriggerFilterParameters()
            {
        ...
        public async Task CreateDataFlowDebugSession()
        {
            ...
            var factoryId = DataFactory.Tests.Mock.Factory.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "exampleResourceGroup", "exampleFactoryName");
            var factory = GetArmClient().GetFactory(factoryId);
            DataFactory.Tests.Mock.Models.CreateDataFlowDebugSessionRequest request = new DataFactory.Tests.Mock.Models.CreateDataFlowDebugSessionRequest()
            {
                TimeToLive = 60,
                IntegrationRuntime = new DataFactory.Tests.Mock.Models.IntegrationRuntimeDebugResource(properties: new DataFactory.Tests.Mock.Models.ManagedIntegrationRuntime()
                {
                    ComputeProperties = new DataFactory.Tests.Mock.Models.IntegrationRuntimeComputeProperties()
                    {
                        Location = "AutoResolve",
                        DataFlowProperties = new DataFactory.Tests.Mock.Models.IntegrationRuntimeDataFlowProperties()
                        {
                            ComputeType = new DataFactory.Tests.Mock.Models.DataFlowComputeType("General"),
                            CoreCount = 48,
                            TimeToLive = 10,
                        },
                    },
                    Type = new DataFactory.Tests.Mock.Models.IntegrationRuntimeType("Managed"),
                })
                {
                    Name = "ir1",
                },
        ...
        public async Task AddDataFlowDataFlowDebugSession()
        {
            ...
            var factoryId = DataFactory.Tests.Mock.Factory.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "exampleResourceGroup", "exampleFactoryName");
            var factory = GetArmClient().GetFactory(factoryId);
            DataFactory.Tests.Mock.Models.DataFlowDebugPackage request = new DataFactory.Tests.Mock.Models.DataFlowDebugPackage()
            {
                SessionId = "f06ed247-9d07-49b2-b05e-2cb4a2fc871e",
                DataFlow = new DataFactory.Tests.Mock.Models.DataFlowDebugResource(properties: new DataFactory.Tests.Mock.Models.MappingDataFlow()
                {
                ...
                DebugSettings = new DataFactory.Tests.Mock.Models.DataFlowDebugPackageDebugSettings()
                {
        ...
        public async Task DeleteDataFlowDebugSession()
        {
            ...
            var factoryId = DataFactory.Tests.Mock.Factory.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "exampleResourceGroup", "exampleFactoryName");
            var factory = GetArmClient().GetFactory(factoryId);
            DataFactory.Tests.Mock.Models.DeleteDataFlowDebugSessionRequest request = new DataFactory.Tests.Mock.Models.DeleteDataFlowDebugSessionRequest()
            {
        ...
        public async Task ExecuteCommandDataFlowDebugSession()
        {
            ...
            var factoryId = DataFactory.Tests.Mock.Factory.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "exampleResourceGroup", "exampleFactoryName");
            var factory = GetArmClient().GetFactory(factoryId);
            DataFactory.Tests.Mock.Models.DataFlowDebugCommandRequest request = new DataFactory.Tests.Mock.Models.DataFlowDebugCommandRequest()
            {
                SessionId = "f06ed247-9d07-49b2-b05e-2cb4a2fc871e",
                Command = new DataFactory.Tests.Mock.Models.DataFlowDebugCommandType("executePreviewQuery"),
                CommandPayload = new DataFactory.Tests.Mock.Models.DataFlowDebugCommandPayload(streamName: "source1")
                {
                    RowLimits = 100,
                },
            };
