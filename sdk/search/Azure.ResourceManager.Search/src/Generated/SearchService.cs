...
namespace Azure.ResourceManager.Search
{
    ...
    public partial class SearchService : ArmResource
    {
        ...
        internal SearchService(ArmResource options, SearchServiceData data) : base(options, data.Id)
        {
            ...
            _adminKeysRestClient = new AdminKeysRestOperations(_clientDiagnostics, Pipeline, ClientOptions, BaseUri, apiVersion);
            _queryKeysRestClient = new QueryKeysRestOperations(_clientDiagnostics, Pipeline, ClientOptions, BaseUri, apiVersion);
        ...
        /// <param name="searchManagementRequestOptions"> Parameter group. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async virtual Task<SearchServiceDeleteOperation> DeleteAsync(bool waitForCompletion, SearchManagementRequestOptions searchManagementRequestOptions = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new SearchServiceDeleteOperation(response);
        ...
        /// <param name="searchManagementRequestOptions"> Parameter group. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual SearchServiceDeleteOperation Delete(bool waitForCompletion, SearchManagementRequestOptions searchManagementRequestOptions = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("SearchService.Delete");
            scope.Start();
            try
