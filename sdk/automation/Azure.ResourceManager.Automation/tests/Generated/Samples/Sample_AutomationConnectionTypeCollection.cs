...
namespace Azure.ResourceManager.Automation
{
    public partial class Sample_AutomationConnectionTypeCollection
    {
        ...
        public async Task CreateOrUpdate_CreateOrUpdateConnectionType()
        {
            ...
            // invoke the operation
            string connectionTypeName = "myCT";
            AutomationConnectionTypeCreateOrUpdateContent content = new AutomationConnectionTypeCreateOrUpdateContent("myCT", new System.Collections.Generic.IDictionary<string, AutomationConnectionFieldDefinition>()
            {
