# Azure HealthcareApis Management client library for .NET
...
Install the Azure HealthcareApis management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.HealthcareApis -Version 1.0.0-preview.1 
```
