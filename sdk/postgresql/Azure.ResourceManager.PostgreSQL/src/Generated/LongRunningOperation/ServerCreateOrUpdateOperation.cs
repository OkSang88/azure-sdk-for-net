...
namespace Azure.ResourceManager.PostgreSQL.Models
{
    ...
    public partial class ServerCreateOrUpdateOperation : Operation<Server>, IOperationSource<Server>
    {
        private readonly OperationInternals<Server> _operation;

        private readonly ArmResource _operationBase;

        /// <summary> Initializes a new instance of ServerCreateOrUpdateOperation for mocking. </summary>
        protected ServerCreateOrUpdateOperation()
        {
        }

        internal ServerCreateOrUpdateOperation(ArmResource operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<Server>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "ServerCreateOrUpdateOperation");
