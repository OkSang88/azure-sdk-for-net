...
namespace DataFactoryManagementClient.Models
{
    ...
    public partial class SelfHostedIntegrationRuntimeStatus : IntegrationRuntimeStatus
    {
        ...
        /// <param name="scheduledUpdateDate"> The date at which the integration runtime will be scheduled to update, in ISO8601 format. </param>
        ...
        internal SelfHostedIntegrationRuntimeStatus(IntegrationRuntimeType type, string dataFactoryName, IntegrationRuntimeState? state, IReadOnlyDictionary<string, object> additionalProperties, DateTimeOffset? createTime, string taskQueueId, IntegrationRuntimeInternalChannelEncryptionMode? internalChannelEncryption, string version, IReadOnlyList<SelfHostedIntegrationRuntimeNode> nodes, DateTimeOffset? scheduledUpdateDate, string updateDelayOffset, string localTimeZoneOffset, IReadOnlyDictionary<string, string> capabilities, IReadOnlyList<string> serviceUrls, IntegrationRuntimeAutoUpdate? autoUpdate, string versionStatus, IReadOnlyList<LinkedIntegrationRuntime> links, string pushedVersion, string latestVersion, DateTimeOffset? autoUpdateETA) : base(type, dataFactoryName, state, additionalProperties)
        {
        ...
        public DateTimeOffset? ScheduledUpdateDate { get; }
