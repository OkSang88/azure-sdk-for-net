...
namespace HybridDataManagementClient
{
    ...
    public partial class DataServiceData : Azure.ResourceManager.Models.Resource
    {
        ...
        internal DataServiceData(ResourceIdentifier id, string name, ResourceType type, State state, IList<string> supportedDataSinkTypes, IList<string> supportedDataSourceTypes) : base(id, name, type)
        {
            State = state;
