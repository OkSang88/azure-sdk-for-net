...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class WranglingDataFlow : DataFlow
    {
        ...
        internal WranglingDataFlow(string type, string description, IList<object> annotations, DataFlowFolder folder, IList<PowerQuerySource> sources, string script, string documentLocale) : base(type, description, annotations, folder)
        {
            Sources = sources;
            Script = script;
            DocumentLocale = documentLocale;
            Type = type ?? "WranglingDataFlow";
        }
