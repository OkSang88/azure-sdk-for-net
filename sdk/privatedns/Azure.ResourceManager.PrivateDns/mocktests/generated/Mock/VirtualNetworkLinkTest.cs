...
namespace Azure.ResourceManager.PrivateDns.Tests.Mock
{
    ...
    public partial class VirtualNetworkLinkMockTests : MockTestBase
    {
        ...
        public async Task Get()
        {
            ...
            var virtualNetworkLinkId = PrivateDns.VirtualNetworkLink.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "resourceGroup1", "privatezone1.com", "virtualNetworkLink1");
        ...
        public async Task Update()
        {
            ...
            var virtualNetworkLinkId = PrivateDns.VirtualNetworkLink.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "resourceGroup1", "privatezone1.com", "virtualNetworkLink1");
            var virtualNetworkLink = GetArmClient().GetVirtualNetworkLink(virtualNetworkLinkId);
            PrivateDns.VirtualNetworkLinkData parameters = new PrivateDns.VirtualNetworkLinkData(location: AzureLocation.WestUS)
            {
