...
namespace Azure.ResourceManager.DataFactory
{
    ...
    public partial class IntegrationRuntimeResourceCollection : ArmCollection, IEnumerable<IntegrationRuntimeResource>, IAsyncEnumerable<IntegrationRuntimeResource>
    {
        ...
        public virtual IntegrationRuntimeCreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, string integrationRuntimeName, IntegrationRuntimeResourceData integrationRuntime, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new IntegrationRuntimeCreateOrUpdateOperation(Parent, response);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="integrationRuntimeName"/> or <paramref name="integrationRuntime"/> is null. </exception>
        public async virtual Task<IntegrationRuntimeCreateOrUpdateOperation> CreateOrUpdateAsync(bool waitForCompletion, string integrationRuntimeName, IntegrationRuntimeResourceData integrationRuntime, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            if (integrationRuntimeName == null)
            {
                throw new ArgumentNullException(nameof(integrationRuntimeName));
        ...
        public virtual Response<IntegrationRuntimeResource> Get(string integrationRuntimeName, string ifNoneMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new IntegrationRuntimeResource(Parent, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual Pageable<IntegrationRuntimeResource> GetAll(CancellationToken cancellationToken = default)
        {
            Page<IntegrationRuntimeResource> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    ...
                    return Page.FromValues(response.Value.Value.Select(value => new IntegrationRuntimeResource(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
