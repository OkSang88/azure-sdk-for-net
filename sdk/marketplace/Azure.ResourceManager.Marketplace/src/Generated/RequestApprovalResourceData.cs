...
namespace Azure.ResourceManager.Marketplace
{
    ...
    public partial class RequestApprovalResourceData : Resource
    {
        ...
        internal RequestApprovalResourceData(ResourceIdentifier id, string name, ResourceType type, SystemData systemData, string offerId, string offerDisplayName, string publisherId, IList<PlanDetails> plansDetails, bool? isClosed, long? messageCode) : base(id, name, type, systemData)
        {
            OfferId = offerId;
