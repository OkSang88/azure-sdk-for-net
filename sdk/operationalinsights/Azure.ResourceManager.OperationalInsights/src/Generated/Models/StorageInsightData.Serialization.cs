...
namespace Azure.ResourceManager.OperationalInsights
{
    public partial class StorageInsightData : IUtf8JsonSerializable
    {
        ...
        internal static StorageInsightData DeserializeStorageInsightData(JsonElement element)
        {
            ...
            return new StorageInsightData(id, name, type, eTag.Value, Optional.ToDictionary(tags), Optional.ToList(containers), Optional.ToList(tables), storageAccount.Value, status.Value);
        }
    }
}
