...
namespace Azure.ResourceManager.OperationalInsights
{
    ...
    public static partial class ResourceGroupExtensions
    {
        ...
        public static AsyncPageable<Workspace> GetWorkspacesByDeletedWorkspaceAsync(this ResourceGroup resourceGroup, CancellationToken cancellationToken = default)
        {
            return resourceGroup.UseClientContext((baseUri, credential, options, pipeline) =>
            {
                ...
                {
                    using var scope = clientDiagnostics.CreateScope("ResourceGroupExtensions.GetWorkspacesByDeletedWorkspace");
                    scope.Start();
                    try
                    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of resource operations that may take multiple service requests to iterate over. </returns>
        public static Pageable<Workspace> GetWorkspacesByDeletedWorkspace(this ResourceGroup resourceGroup, CancellationToken cancellationToken = default)
        {
            return resourceGroup.UseClientContext((baseUri, credential, options, pipeline) =>
            {
                var clientDiagnostics = new ClientDiagnostics(options);
