...
namespace Azure.ResourceManager.Quantum.Tests.Mock
{
    ...
    public partial class QuantumWorkspaceMockTests : MockTestBase
    {
        ...
        public async Task Get()
        {
            ...
            var quantumWorkspaceId = Quantum.QuantumWorkspace.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "quantumResourcegroup", "quantumworkspace1");
        ...
        public async Task Update()
        {
            ...
            var quantumWorkspaceId = Quantum.QuantumWorkspace.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "quantumResourcegroup", "quantumworkspace1");
            var quantumWorkspace = GetArmClient().GetQuantumWorkspace(quantumWorkspaceId);
            Quantum.Models.TagsObject workspaceTags = new Quantum.Models.TagsObject();
