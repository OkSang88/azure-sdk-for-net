...
namespace Insights.Tests.Mock
{
    ...
    public partial class DiagnosticSettingsResourceMockTests : MockTestBase
    {
        ...
        public async Task GetAsync()
        {
            ...
            var diagnosticSettingsResource = GetArmClient().GetDiagnosticSettingsResource(new ResourceIdentifier("/subscriptions/00000000-0000-0000-0000-000000000000/resourcegroups/viruela1/providers/microsoft.logic/workflows/viruela6/providers"));
