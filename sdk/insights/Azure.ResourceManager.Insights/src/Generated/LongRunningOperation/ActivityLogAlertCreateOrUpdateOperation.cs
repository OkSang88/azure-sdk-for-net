...
namespace Insights.Models
{
    ...
    public partial class ActivityLogAlertCreateOrUpdateOperation : Operation<ActivityLogAlertResource>
    {
        private readonly OperationOrResponseInternals<ActivityLogAlertResource> _operation;

        /// <summary> Initializes a new instance of ActivityLogAlertCreateOrUpdateOperation for mocking. </summary>
        protected ActivityLogAlertCreateOrUpdateOperation()
        {
        }

        internal ActivityLogAlertCreateOrUpdateOperation(ArmResource operationsBase, Response<ActivityLogAlertResourceData> response)
        {
