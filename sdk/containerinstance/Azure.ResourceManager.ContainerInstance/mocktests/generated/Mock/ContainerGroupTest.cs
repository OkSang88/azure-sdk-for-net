...
namespace Azure.ResourceManager.ContainerInstance.Tests.Mock.Tests.Mock
{
    ...
    public partial class ContainerGroupMockTests : MockTestBase
    {
        ...
        public async Task Get()
        {
            ...
            var containerGroupId = ContainerInstance.Tests.Mock.ContainerGroup.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "demo", "demo1");
        ...
        public async Task Update()
        {
            ...
            var containerGroupId = ContainerInstance.Tests.Mock.ContainerGroup.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "demoResource", "demo1");
            var containerGroup = GetArmClient().GetContainerGroup(containerGroupId);
            ContainerInstance.Tests.Mock.Models.Resource resource = new ContainerInstance.Tests.Mock.Models.Resource(location: AzureLocation.WestUS)
            {
            };
        ...
        public async Task ExecuteCommandContainer()
        {
            ...
            var containerGroup = GetArmClient().GetContainerGroup(containerGroupId);
            string containerName = "container1";
            ContainerInstance.Tests.Mock.Models.ContainerExecRequest containerExecRequest = new ContainerInstance.Tests.Mock.Models.ContainerExecRequest()
            {
                Command = "/bin/bash",
                TerminalSize = new ContainerInstance.Tests.Mock.Models.ContainerExecRequestTerminalSize()
                {
                    Rows = 12,
                    Cols = 12,
                },
