...
namespace ServiceFabricMeshManagementClient
{
    internal partial class SecretValueRestOperations
    {
        ...
        public SecretValueRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ClientOptions options, Uri endpoint = null, string apiVersion = "2018-09-01-preview")
        {
