...
namespace Azure.ResourceManager.StorageSync.Tests.Mock.Tests.Mock
{
    ...
    public partial class WorkflowMockTests : MockTestBase
    {
        ...
        public async Task Get()
        {
            ...
            var workflowId = StorageSync.Tests.Mock.Workflow.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "SampleResourceGroup_1", "SampleStorageSyncService_1", "828219ea-083e-48b5-89ea-8fd9991b2e75");
        ...
        public async Task Abort()
        {
            ...
            var workflowId = StorageSync.Tests.Mock.Workflow.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "SampleResourceGroup_1", "SampleStorageSyncService_1", "7ffd50b3-5574-478d-9ff2-9371bc42ce68");
            var workflow = GetArmClient().GetWorkflow(workflowId);
