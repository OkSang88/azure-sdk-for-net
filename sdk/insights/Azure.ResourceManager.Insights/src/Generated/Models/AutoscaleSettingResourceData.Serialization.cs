...
namespace Insights
{
    public partial class AutoscaleSettingResourceData : IUtf8JsonSerializable
    {
        ...
        internal static AutoscaleSettingResourceData DeserializeAutoscaleSettingResourceData(JsonElement element)
        {
            ...
            return new AutoscaleSettingResourceData(id, name, type, tags, location, profiles, Optional.ToList(notifications), Optional.ToNullable(enabled), name0.Value, targetResourceUri.Value);
        }
    }
}
