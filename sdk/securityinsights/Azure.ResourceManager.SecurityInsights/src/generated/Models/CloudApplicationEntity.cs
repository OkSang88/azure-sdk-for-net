...
namespace SecurityInsights.Models
{
    ...
    public partial class CloudApplicationEntity : EntityData
    {
        ...
        internal CloudApplicationEntity(ResourceIdentifier id, string name, ResourceType type, SystemData systemData, EntityKind kind, IReadOnlyDictionary<string, object> additionalData, string friendlyName, int? appId, string appName, string instanceName) : base(id, name, type, systemData, kind)
        {
