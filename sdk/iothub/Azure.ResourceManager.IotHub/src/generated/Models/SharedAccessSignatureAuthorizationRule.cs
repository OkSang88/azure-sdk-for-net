...
namespace IotHubClient.Models
{
    ...
    public partial class SharedAccessSignatureAuthorizationRule
    {
        ...
        public SharedAccessSignatureAuthorizationRule(string keyName, AccessRights rights)
        {
            if (keyName == null)
            {
        ...
        /// <param name="rights"> The permissions assigned to the shared access policy. </param>
        internal SharedAccessSignatureAuthorizationRule(string keyName, string primaryKey, string secondaryKey, AccessRights rights)
        {
            KeyName = keyName;
