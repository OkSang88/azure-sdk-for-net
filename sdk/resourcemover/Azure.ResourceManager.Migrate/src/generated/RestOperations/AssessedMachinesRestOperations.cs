...
namespace AzureMigrateV2
{
    internal partial class AssessedMachinesRestOperations
    {
        ...
        public AssessedMachinesRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ClientOptions options, Uri endpoint = null, string apiVersion = "2019-10-01")
        {
