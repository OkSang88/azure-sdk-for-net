...
namespace PowerBIDedicated
{
    ...
    public partial class AutoScaleVCoreCollection : ArmCollection, IEnumerable<AutoScaleVCore>, IAsyncEnumerable<AutoScaleVCore>
    {
        ...
        internal AutoScaleVCoreCollection(ArmResource parent) : base(parent)
        {
            ...
            _autoScaleVCoresRestClient = new AutoScaleVCoresRestOperations(_clientDiagnostics, Pipeline, ClientOptions, BaseUri);
#if DEBUG
        ...
        public virtual AutoScaleVCoreCreateOperation CreateOrUpdate(bool waitForCompletion, string vcoreName, AutoScaleVCoreData vCoreParameters, CancellationToken cancellationToken = default)
        {
            if (vcoreName == null)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="vcoreName"/> or <paramref name="vCoreParameters"/> is null. </exception>
        public async virtual Task<AutoScaleVCoreCreateOperation> CreateOrUpdateAsync(bool waitForCompletion, string vcoreName, AutoScaleVCoreData vCoreParameters, CancellationToken cancellationToken = default)
        {
            if (vcoreName == null)
            {
                throw new ArgumentNullException(nameof(vcoreName));
