...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    public partial class BindingResourceUpdateOperation : Operation<BindingResource>, IOperationSource<BindingResource>
    {
        private readonly OperationInternals<BindingResource> _operation;

        private readonly ArmResource _operationBase;

        /// <summary> Initializes a new instance of BindingResourceUpdateOperation for mocking. </summary>
        protected BindingResourceUpdateOperation()
        {
        }

        internal BindingResourceUpdateOperation(ArmResource operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<BindingResource>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.AzureAsyncOperation, "BindingResourceUpdateOperation");
