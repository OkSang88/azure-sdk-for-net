...
namespace Azure.ResourceManager.StorSimple8000Series
{
    ...
    public partial class VolumeCollection : ArmCollection, IEnumerable<Volume>, IAsyncEnumerable<Volume>
    {
        ...
        internal VolumeCollection(ArmResource parent) : base(parent)
        {
            ...
            ClientOptions.TryGetApiVersion(Volume.ResourceType, out string apiVersion);
        ...
        public virtual VolumeCreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, string volumeName, VolumeData parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new VolumeCreateOrUpdateOperation(this, _clientDiagnostics, Pipeline, _volumesRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, volumeName, parameters).Request, response);
        ...
        public virtual Pageable<Volume> GetAll(CancellationToken cancellationToken = default)
        {
            Page<Volume> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    ...
                    return Page.FromValues(response.Value.Value.Select(value => new Volume(this, value)), null, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
