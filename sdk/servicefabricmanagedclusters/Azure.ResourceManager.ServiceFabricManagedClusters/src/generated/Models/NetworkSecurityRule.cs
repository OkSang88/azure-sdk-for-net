...
namespace ServiceFabricManagedClustersManagementClient.Models
{
    ...
    {
        /// <summary> Initializes a new instance of NetworkSecurityRule. </summary>
        ...
        public NetworkSecurityRule(string name, NsgProtocol protocol, Access access, int priority, Direction direction)
        {
            if (name == null)
            {
        ...
        /// <param name="priority"> The priority of the rule. The value can be in the range 1000 to 3000. Values outside this range are reserved for Service Fabric ManagerCluster Resource Provider. The priority number must be unique for each rule in the collection. The lower the priority number, the higher the priority of the rule. </param>
        /// <param name="direction"> Network security rule direction. </param>
        internal NetworkSecurityRule(string name, string description, NsgProtocol protocol, IList<string> sourceAddressPrefixes, IList<string> destinationAddressPrefixes, IList<string> sourcePortRanges, IList<string> destinationPortRanges, string sourceAddressPrefix, string destinationAddressPrefix, string sourcePortRange, string destinationPortRange, Access access, int priority, Direction direction)
        {
            Name = name;
        ...
        public NsgProtocol Protocol { get; set; }
