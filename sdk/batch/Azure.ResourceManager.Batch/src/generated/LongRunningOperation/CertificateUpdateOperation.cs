...
namespace BatchManagementClient.Models
{
    ...
    public partial class CertificateUpdateOperation : Operation<Certificate>
    {
        private readonly OperationOrResponseInternals<Certificate> _operation;

        /// <summary> Initializes a new instance of CertificateUpdateOperation for mocking. </summary>
        protected CertificateUpdateOperation()
        {
        }

        internal CertificateUpdateOperation(ArmResource operationsBase, Response<CertificateData> response)
        {
