...
{
    public partial class TIDataConnector : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Optional.IsDefined(TipLookbackPeriod))
            {
                if (TipLookbackPeriod != null)
                {
                    writer.WritePropertyName("tipLookbackPeriod");
                    writer.WriteStringValue(TipLookbackPeriod.Value, "O");
                }
                else
                {
        ...
        internal static TIDataConnector DeserializeTIDataConnector(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("tipLookbackPeriod"))
                        {
            ...
            return new TIDataConnector(id, name, type, systemData, etag.Value, kind, tenantId.Value, Optional.ToNullable(tipLookbackPeriod), dataTypes.Value);
        }
    }
}
