...
namespace Azure.ResourceManager.Marketplace
{
    public partial class AdminRequestApprovalsResourceData : IUtf8JsonSerializable
    {
        ...
        internal static AdminRequestApprovalsResourceData DeserializeAdminRequestApprovalsResourceData(JsonElement element)
        {
            ...
            return new AdminRequestApprovalsResourceData(id, name, type, systemData.Value, offerId.Value, displayName.Value, publisherId.Value, Optional.ToNullable(adminAction), Optional.ToList(approvedPlans), comment.Value, administrator.Value, Optional.ToList(plans), Optional.ToList(collectionIds));
        }
    }
}
