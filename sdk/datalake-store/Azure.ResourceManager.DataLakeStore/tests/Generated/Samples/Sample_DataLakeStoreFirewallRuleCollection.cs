...
{
    public partial class Sample_DataLakeStoreFirewallRuleCollection
    {
        ...
        public async Task GetAll_ListsTheDataLakeStoreFirewallRulesWithinTheSpecifiedDataLakeStoreAccount()
        {
            ...
            // get the collection of this DataLakeStoreFirewallRuleResource
            DataLakeStoreFirewallRuleCollection collection = dataLakeStoreAccount.GetDataLakeStoreFirewallRules();

            // invoke the operation and iterate over the result
            await foreach (DataLakeStoreFirewallRuleResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                DataLakeStoreFirewallRuleData resourceData = item.Data;
        ...
        public async Task CreateOrUpdate_CreatesOrUpdatesTheSpecifiedFirewallRuleDuringUpdateTheFirewallRuleWithTheSpecifiedNameWillBeReplacedWithThisNewFirewallRule()
        {
            ...
            DataLakeStoreFirewallRuleCreateOrUpdateContent content = new DataLakeStoreFirewallRuleCreateOrUpdateContent(IPAddress.Parse("1.1.1.1"), IPAddress.Parse("2.2.2.2"));
        ...
        public async Task Get_GetsTheSpecifiedDataLakeStoreFirewallRule()
        {
            ...
            // invoke the operation
            string firewallRuleName = "test_rule";
            DataLakeStoreFirewallRuleResource result = await collection.GetAsync(firewallRuleName);
