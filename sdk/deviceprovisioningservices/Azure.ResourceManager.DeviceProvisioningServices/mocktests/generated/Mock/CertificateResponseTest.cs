...
namespace Azure.ResourceManager.DeviceProvisioningServices.Tests.Mock.Tests.Mock
{
    ...
    public partial class CertificateResponseMockTests : MockTestBase
    {
        ...
        public async Task Get()
        {
            ...
            var certificateResponseId = DeviceProvisioningServices.Tests.Mock.CertificateResponse.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "myResourceGroup", "myFirstProvisioningService", "cert");
        ...
        public async Task Delete()
        {
            ...
            DeviceProvisioningServices.Tests.Mock.Models.CertificatePurpose? certificatePurpose = null;
        ...
        public async Task VerifyCertificate()
        {
            ...
            var certificateResponse = GetArmClient().GetCertificateResponse(certificateResponseId);
            string ifMatch = "AAAAAAAADGk=";
            DeviceProvisioningServices.Tests.Mock.Models.VerificationCodeRequest request = new DeviceProvisioningServices.Tests.Mock.Models.VerificationCodeRequest()
            {
                Certificate = "#####################################",
            };
            string certificateName1 = null;
