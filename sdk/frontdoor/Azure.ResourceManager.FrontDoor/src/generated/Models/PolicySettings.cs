...
namespace FrontDoorManagementClient.Models
{
    ...
    public partial class PolicySettings
    {
        ...
        /// <param name="redirectUrl"> If action type is redirect, this field represents redirect URL for the client. </param>
        ...
        internal PolicySettings(PolicyEnabledState? enabledState, PolicyMode? mode, string redirectUrl, int? customBlockResponseStatusCode, string customBlockResponseBody, PolicyRequestBodyCheck? requestBodyCheck)
        {
