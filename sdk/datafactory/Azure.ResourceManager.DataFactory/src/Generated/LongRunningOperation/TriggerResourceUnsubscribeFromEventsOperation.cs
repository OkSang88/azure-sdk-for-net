...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class TriggerResourceUnsubscribeFromEventsOperation : Operation<TriggerSubscriptionOperationStatus>, IOperationSource<TriggerSubscriptionOperationStatus>
    {
        private readonly OperationInternals<TriggerSubscriptionOperationStatus> _operation;

        /// <summary> Initializes a new instance of TriggerResourceUnsubscribeFromEventsOperation for mocking. </summary>
        protected TriggerResourceUnsubscribeFromEventsOperation()
        {
        }

        internal TriggerResourceUnsubscribeFromEventsOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<TriggerSubscriptionOperationStatus>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "TriggerResourceUnsubscribeFromEventsOperation");
        }
