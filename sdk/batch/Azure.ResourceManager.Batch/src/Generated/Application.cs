...
namespace Azure.ResourceManager.Batch
{
    ...
    public partial class Application : ArmResource
    {
        ...
        public async virtual Task<Response<Application>> UpdateAsync(ApplicationData parameters, CancellationToken cancellationToken = default)
        {
            if (parameters == null)
            {
            ...
            try
            {
                var response = await _applicationRestClient.UpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, parameters, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(new Application(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="parameters"/> is null. </exception>
        public virtual Response<Application> Update(ApplicationData parameters, CancellationToken cancellationToken = default)
        {
            if (parameters == null)
            {
                throw new ArgumentNullException(nameof(parameters));
            ...
            try
            {
                var response = _applicationRestClient.Update(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, parameters, cancellationToken);
                return Response.FromValue(new Application(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        /// <summary> Gets a collection of ApplicationPackages in the Application. </summary>
        /// <returns> An object representing collection of ApplicationPackages and their operations over a Application. </returns>
        public virtual ApplicationPackageCollection GetApplicationPackages()
        {
            return new ApplicationPackageCollection(this);
        }
        #endregion
    }
}
