# Azure RecoveryServices Management client library for .NET
...
Install the Azure RecoveryServices management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.RecoveryServices -Version 1.0.0-preview.1 
```
