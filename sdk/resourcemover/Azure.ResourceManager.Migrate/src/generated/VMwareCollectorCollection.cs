...
namespace AzureMigrateV2
{
    ...
    public partial class VMwareCollectorCollection : ArmCollection, IEnumerable<VMwareCollector>, IAsyncEnumerable<VMwareCollector>
    {
        ...
        public virtual VMwareCollectorCreateOperation CreateOrUpdate(bool waitForCompletion, string vmWareCollectorName, VMwareCollectorData collectorBody = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new VMwareCollectorCreateOperation(Parent, response);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="vmWareCollectorName"/> is null. </exception>
        public async virtual Task<VMwareCollectorCreateOperation> CreateOrUpdateAsync(bool waitForCompletion, string vmWareCollectorName, VMwareCollectorData collectorBody = null, CancellationToken cancellationToken = default)
        {
            if (vmWareCollectorName == null)
            {
                throw new ArgumentNullException(nameof(vmWareCollectorName));
        ...
        public virtual Response<VMwareCollector> Get(string vmWareCollectorName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new VMwareCollector(Parent, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual Pageable<VMwareCollector> GetAll(CancellationToken cancellationToken = default)
        {
            Page<VMwareCollector> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    ...
                    return Page.FromValues(response.Value.Value.Select(value => new VMwareCollector(Parent, value)), null, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
