...
namespace AppPlatformManagementClient.Models
{
    ...
    public partial class DeploymentUpdateOperation : Operation<DeploymentResource>, IOperationSource<DeploymentResource>
    {
        private readonly OperationInternals<DeploymentResource> _operation;

        private readonly ArmResource _operationBase;

        /// <summary> Initializes a new instance of DeploymentUpdateOperation for mocking. </summary>
        protected DeploymentUpdateOperation()
        {
        }

        internal DeploymentUpdateOperation(ArmResource operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<DeploymentResource>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.AzureAsyncOperation, "DeploymentUpdateOperation");
