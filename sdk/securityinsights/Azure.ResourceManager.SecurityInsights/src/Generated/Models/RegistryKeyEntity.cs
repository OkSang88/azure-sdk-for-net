...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class RegistryKeyEntity : EntityData
    {
        ...
        internal RegistryKeyEntity(ResourceIdentifier id, string name, ResourceType type, SystemData systemData, EntityKind kind, IReadOnlyDictionary<string, object> additionalData, string friendlyName, RegistryHive? hive, string key) : base(id, name, type, systemData, kind)
        {
