...
namespace Azure.ResourceManager.Migrate
{
    ...
    public partial class GroupCollection : ArmCollection, IEnumerable<Group>, IAsyncEnumerable<Group>
    {
        ...
        internal GroupCollection(ArmResource parent) : base(parent)
        {
            ...
            ClientOptions.TryGetApiVersion(Group.ResourceType, out string apiVersion);
        ...
        public virtual GroupCreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, string groupName, GroupData group = null, CancellationToken cancellationToken = default)
        {
            if (groupName == null)
            {
            ...
            try
            {
                ...
                var operation = new GroupCreateOrUpdateOperation(this, response);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="groupName"/> is null. </exception>
        public async virtual Task<GroupCreateOrUpdateOperation> CreateOrUpdateAsync(bool waitForCompletion, string groupName, GroupData group = null, CancellationToken cancellationToken = default)
        {
            if (groupName == null)
            {
                throw new ArgumentNullException(nameof(groupName));
        ...
        public virtual Pageable<Group> GetAll(CancellationToken cancellationToken = default)
        {
            Page<Group> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    ...
                    return Page.FromValues(response.Value.Value.Select(value => new Group(this, value)), null, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
