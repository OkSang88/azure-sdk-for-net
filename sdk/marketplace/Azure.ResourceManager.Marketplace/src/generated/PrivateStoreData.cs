...
namespace MarketplaceRPService
{
    ...
    public partial class PrivateStoreData : Resource
    {
        ...
        internal PrivateStoreData(ResourceIdentifier id, string name, ResourceType type, SystemData systemData, Availability? availability, string privateStoreId, string eTag, string privateStoreName, string tenantId, bool? isGov, IReadOnlyList<string> collectionIds, IDictionary<string, string> branding, IList<Recipient> recipients, bool? sendToAllMarketplaceAdmins) : base(id, name, type, systemData)
        {
