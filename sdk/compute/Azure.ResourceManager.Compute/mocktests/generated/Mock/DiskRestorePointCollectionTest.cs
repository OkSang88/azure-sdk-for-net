...
namespace Azure.ResourceManager.Compute.Tests.Mock
{
    ...
    public partial class DiskRestorePointCollectionMockTests : MockTestBase
    {
        ...
        public async Task GetAsync()
        {
            ...
            var collection = GetArmClient().GetRestorePoint(new ResourceIdentifier("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/myResourceGroup/providers/Microsoft.Compute/restorePointCollections/rpc/restorePoints/vmrp")).GetDiskRestorePoints();
