...
namespace RedisManagementClient
{
    ...
    public partial class RedisResourceData : TrackedResource
    {
        ...
        public RedisResourceData(AzureLocation location, Models.Sku sku) : base(location)
        {
            if (sku == null)
            {
        ...
        internal RedisResourceData(ResourceIdentifier id, string name, ResourceType type, IDictionary<string, string> tags, AzureLocation location, IList<string> zones, ManagedServiceIdentity identity, RedisCommonPropertiesRedisConfiguration redisConfiguration, string redisVersion, bool? enableNonSslPort, int? replicasPerMaster, int? replicasPerPrimary, IDictionary<string, string> tenantSettings, int? shardCount, TlsVersion? minimumTlsVersion, PublicNetworkAccess? publicNetworkAccess, Models.Sku sku, string subnetId, string staticIP, ProvisioningState? provisioningState, string hostName, int? port, int? sslPort, RedisAccessKeys accessKeys, IReadOnlyList<SubResource> linkedServers, IReadOnlyList<RedisInstanceDetails> instances, IReadOnlyList<PrivateEndpointConnectionData> privateEndpointConnections) : base(id, name, type, tags, location)
        {
            Zones = zones;
            Identity = identity;
