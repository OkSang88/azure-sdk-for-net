...
namespace Azure.ResourceManager.StorageSync
{
    ...
    public partial class CloudEndpointData : Resource
    {
        ...
        internal CloudEndpointData(ResourceIdentifier id, string name, ResourceType type, string storageAccountResourceId, string azureFileShareName, string storageAccountTenantId, string partnershipId, string friendlyName, string backupEnabled, string provisioningState, string lastWorkflowId, string lastOperationName, CloudEndpointChangeEnumerationStatus changeEnumerationStatus) : base(id, name, type)
        {
