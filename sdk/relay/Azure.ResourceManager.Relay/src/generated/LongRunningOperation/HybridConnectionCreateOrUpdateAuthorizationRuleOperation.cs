...
namespace RelayAPI.Models
{
    ...
    public partial class HybridConnectionCreateOrUpdateAuthorizationRuleOperation : Operation<NamespaceHybridConnectionAuthorizationRule>
    {
        private readonly OperationOrResponseInternals<NamespaceHybridConnectionAuthorizationRule> _operation;

        /// <summary> Initializes a new instance of HybridConnectionCreateOrUpdateAuthorizationRuleOperation for mocking. </summary>
        protected HybridConnectionCreateOrUpdateAuthorizationRuleOperation()
        {
        }

        internal HybridConnectionCreateOrUpdateAuthorizationRuleOperation(ArmResource operationsBase, Response<AuthorizationRuleData> response)
        {
