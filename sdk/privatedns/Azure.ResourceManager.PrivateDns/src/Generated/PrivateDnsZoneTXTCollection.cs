...
namespace Azure.ResourceManager.PrivateDns
{
    ...
    public partial class PrivateDnsZoneTXTCollection : ArmCollection, IEnumerable<PrivateDnsZoneTXT>, IAsyncEnumerable<PrivateDnsZoneTXT>
    {
        ...
        internal PrivateDnsZoneTXTCollection(ArmResource parent) : base(parent)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            ClientOptions.TryGetApiVersion(PrivateDnsZoneTXT.ResourceType, out string apiVersion);
        ...
        public virtual PrivateDnsZoneTXTCreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, string relativeRecordSetName, RecordSetData parameters, string ifMatch = null, string ifNoneMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("PrivateDnsZoneTXTCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                var operation = new PrivateDnsZoneTXTCreateOrUpdateOperation(this, response);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="relativeRecordSetName"/> or <paramref name="parameters"/> is null. </exception>
        public async virtual Task<PrivateDnsZoneTXTCreateOrUpdateOperation> CreateOrUpdateAsync(bool waitForCompletion, string relativeRecordSetName, RecordSetData parameters, string ifMatch = null, string ifNoneMatch = null, CancellationToken cancellationToken = default)
        {
            if (relativeRecordSetName == null)
            {
                throw new ArgumentNullException(nameof(relativeRecordSetName));
        ...
        public virtual Response<PrivateDnsZoneTXT> Get(string relativeRecordSetName, CancellationToken cancellationToken = default)
        {
            if (relativeRecordSetName == null)
            {
                throw new ArgumentNullException(nameof(relativeRecordSetName));
            ...
            using var scope = _clientDiagnostics.CreateScope("PrivateDnsZoneTXTCollection.Get");
            scope.Start();
            try
            {
                ...
                return Response.FromValue(new PrivateDnsZoneTXT(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="relativeRecordSetName"/> is null. </exception>
        public async virtual Task<Response<PrivateDnsZoneTXT>> GetAsync(string relativeRecordSetName, CancellationToken cancellationToken = default)
        {
            if (relativeRecordSetName == null)
            {
                throw new ArgumentNullException(nameof(relativeRecordSetName));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="relativeRecordSetName"/> is null. </exception>
        public virtual Response<PrivateDnsZoneTXT> GetIfExists(string relativeRecordSetName, CancellationToken cancellationToken = default)
        {
            if (relativeRecordSetName == null)
            {
                throw new ArgumentNullException(nameof(relativeRecordSetName));
            ...
            using var scope = _clientDiagnostics.CreateScope("PrivateDnsZoneTXTCollection.GetIfExists");
            scope.Start();
            try
            {
                ...
                if (response.Value == null)
                    return Response.FromValue<PrivateDnsZoneTXT>(null, response.GetRawResponse());
                return Response.FromValue(new PrivateDnsZoneTXT(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="relativeRecordSetName"/> is null. </exception>
        public async virtual Task<Response<PrivateDnsZoneTXT>> GetIfExistsAsync(string relativeRecordSetName, CancellationToken cancellationToken = default)
        {
            if (relativeRecordSetName == null)
            {
                throw new ArgumentNullException(nameof(relativeRecordSetName));
        ...
        public virtual Response<bool> Exists(string relativeRecordSetName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("PrivateDnsZoneTXTCollection.Exists");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="PrivateDnsZoneTXT" /> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<PrivateDnsZoneTXT> GetAll(int? top = null, string recordsetnamesuffix = null, CancellationToken cancellationToken = default)
        {
            Page<PrivateDnsZoneTXT> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _clientDiagnostics.CreateScope("PrivateDnsZoneTXTCollection.GetAll");
                scope.Start();
                try
                {
                    ...
                    return Page.FromValues(response.Value.Value.Select(value => new PrivateDnsZoneTXT(this, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
            ...
            Page<PrivateDnsZoneTXT> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _clientDiagnostics.CreateScope("PrivateDnsZoneTXTCollection.GetAll");
                scope.Start();
                try
        ...
        /// <param name="recordsetnamesuffix"> The suffix label of the record set name to be used to filter the record set enumeration. If this parameter is specified, the returned enumeration will only contain records that end with &quot;.&lt;recordsetnamesuffix&gt;&quot;. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> An async collection of <see cref="PrivateDnsZoneTXT" /> that may take multiple service requests to iterate over. </returns>
        public virtual AsyncPageable<PrivateDnsZoneTXT> GetAllAsync(int? top = null, string recordsetnamesuffix = null, CancellationToken cancellationToken = default)
        {
            async Task<Page<PrivateDnsZoneTXT>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _clientDiagnostics.CreateScope("PrivateDnsZoneTXTCollection.GetAll");
                scope.Start();
                try
            ...
            async Task<Page<PrivateDnsZoneTXT>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _clientDiagnostics.CreateScope("PrivateDnsZoneTXTCollection.GetAll");
                scope.Start();
                try
        ...
        IEnumerator<PrivateDnsZoneTXT> IEnumerable<PrivateDnsZoneTXT>.GetEnumerator()
        {
        ...
        IAsyncEnumerator<PrivateDnsZoneTXT> IAsyncEnumerable<PrivateDnsZoneTXT>.GetAsyncEnumerator(CancellationToken cancellationToken)
        {
            return GetAllAsync(cancellationToken: cancellationToken).GetAsyncEnumerator(cancellationToken);
        }

        // Builders.
        // public ArmBuilder<Azure.Core.ResourceIdentifier, PrivateDnsZoneTXT, RecordSetData> Construct() { }
    }
}
