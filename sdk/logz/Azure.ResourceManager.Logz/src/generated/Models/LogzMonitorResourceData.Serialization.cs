...
{
    public partial class LogzMonitorResourceData : IUtf8JsonSerializable
    {
        ...
        internal static LogzMonitorResourceData DeserializeLogzMonitorResourceData(JsonElement element)
        {
            ...
            return new LogzMonitorResourceData(id, name, type, tags, location, systemData, properties.Value, identity.Value);
        }
    }
}
