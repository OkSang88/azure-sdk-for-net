...
{
    public partial class GatewayApiRoute : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Optional.IsDefined(TokenRelay))
            {
                writer.WritePropertyName("tokenRelay");
                writer.WriteBooleanValue(TokenRelay.Value);
            }
        ...
        internal static GatewayApiRoute DeserializeGatewayApiRoute(JsonElement element)
        {
            ...
            return new GatewayApiRoute(title.Value, description.Value, uri.Value, Optional.ToNullable(ssoEnabled), Optional.ToNullable(tokenRelay), Optional.ToList(predicates), Optional.ToList(filters), Optional.ToNullable(order), Optional.ToList(tags));
        }
    }
}
