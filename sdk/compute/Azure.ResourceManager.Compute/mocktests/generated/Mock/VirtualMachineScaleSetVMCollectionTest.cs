...
namespace Azure.ResourceManager.Compute.Tests.Mock
{
    ...
    public partial class VirtualMachineScaleSetVMCollectionMockTests : MockTestBase
    {
        ...
        public async Task GetAsync()
        {
            ...
            var collection = GetArmClient().GetVirtualMachineScaleSet(new ResourceIdentifier("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/myResourceGroup/providers/Microsoft.Compute/virtualMachineScaleSets/{{vmss-name}}")).GetVirtualMachineScaleSetVMs();
            string instanceId = "0";
