...
namespace MachineLearningComputeManagementClient.Models
{
    ...
    public partial class AcsClusterProperties
    {
        ...
        internal AcsClusterProperties(string clusterFqdn, OrchestratorType orchestratorType, KubernetesClusterProperties orchestratorProperties, IList<SystemService> systemServices, int? masterCount, int? agentCount, AgentVMSizeTypes? agentVmSize)
        {
        ...
        public AgentVMSizeTypes? AgentVmSize { get; set; }
    }
}
