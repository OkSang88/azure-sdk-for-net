...
namespace Azure.ResourceManager.KubernetesConfiguration.Models
{
    ...
    public readonly partial struct Enum1 : IEquatable<Enum1>
    {
        ...
        private const string ManagedClustersValue = "managedClusters";
        private const string ConnectedClustersValue = "connectedClusters";

        /// <summary> managedClusters. </summary>
        public static Enum1 ManagedClusters { get; } = new Enum1(ManagedClustersValue);
        /// <summary> connectedClusters. </summary>
        public static Enum1 ConnectedClusters { get; } = new Enum1(ConnectedClustersValue);
