...
namespace ContainerRegistryManagementClient.Models
{
    ...
    {
        /// <summary> Initializes a new instance of Target. </summary>
        internal Target()
        {
        }
        ...
        internal Target(string mediaType, long? size, string digest, long? length, string repository, string url, string tag, string name, string version)
        {
            MediaType = mediaType;
            Size = size;
            Digest = digest;
