...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class ManagedIntegrationRuntimeNode
    {
        ...
        internal ManagedIntegrationRuntimeNode(string nodeId, ManagedIntegrationRuntimeNodeStatus? status, IReadOnlyList<ManagedIntegrationRuntimeError> errors, IReadOnlyDictionary<string, object> additionalProperties)
        {
            NodeId = nodeId;
            Status = status;
            Errors = errors;
