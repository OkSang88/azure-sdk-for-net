...
namespace Azure.ResourceManager.FrontDoor
{
    ...
    public partial class WebApplicationFirewallPolicy : ArmResource
    {
        ...
        internal WebApplicationFirewallPolicy(ArmResource options, WebApplicationFirewallPolicyData data) : base(options, data.Id)
        {
            HasData = true;
            _data = data;
        ...
        public static readonly Azure.Core.ResourceType ResourceType = "Microsoft.Network/FrontDoorWebApplicationFirewallPolicies";
        ...
        public async virtual Task<WebApplicationFirewallPolicyDeleteOperation> DeleteAsync(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new WebApplicationFirewallPolicyDeleteOperation(_clientDiagnostics, Pipeline, _policiesRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name).Request, response);
        ...
        public async virtual Task<Response<WebApplicationFirewallPolicy>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("WebApplicationFirewallPolicy.AddTag");
            scope.Start();
            try
            {
                ...
                return Response.FromValue(new WebApplicationFirewallPolicy(this, originalResponse.Value), originalResponse.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public async virtual Task<Response<WebApplicationFirewallPolicy>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("WebApplicationFirewallPolicy.SetTags");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<WebApplicationFirewallPolicy>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("WebApplicationFirewallPolicy.RemoveTag");
            scope.Start();
            try
            {
                var originalTags = await TagResource.GetAsync(cancellationToken).ConfigureAwait(false);
