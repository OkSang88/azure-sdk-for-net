...
namespace Azure.ResourceManager.PrivateDns.Tests.Mock.Tests.Mock
{
    ...
    public partial class VirtualNetworkLinkMockTests : MockTestBase
    {
        ...
        public async Task Get()
        {
            ...
            var virtualNetworkLinkId = PrivateDns.Tests.Mock.VirtualNetworkLink.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "resourceGroup1", "privatezone1.com", "virtualNetworkLink1");
        ...
        public async Task Update()
        {
            ...
            var virtualNetworkLinkId = PrivateDns.Tests.Mock.VirtualNetworkLink.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "resourceGroup1", "privatezone1.com", "virtualNetworkLink1");
            var virtualNetworkLink = GetArmClient().GetVirtualNetworkLink(virtualNetworkLinkId);
            PrivateDns.Tests.Mock.VirtualNetworkLinkData parameters = new PrivateDns.Tests.Mock.VirtualNetworkLinkData(location: AzureLocation.WestUS)
            {
