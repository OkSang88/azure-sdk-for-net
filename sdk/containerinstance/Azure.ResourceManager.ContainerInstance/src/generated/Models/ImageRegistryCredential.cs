...
namespace ContainerInstanceManagementClient.Models
{
    ...
    public partial class ImageRegistryCredential
    {
        ...
        /// <param name="identityUrl"> The identity URL for the private registry. </param>
        internal ImageRegistryCredential(string server, string username, string password, string identity, string identityUrl)
        {
            Server = server;
            Username = username;
            Password = password;
