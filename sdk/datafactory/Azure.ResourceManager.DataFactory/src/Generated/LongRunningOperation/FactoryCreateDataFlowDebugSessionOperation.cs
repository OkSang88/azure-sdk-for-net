...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class FactoryCreateDataFlowDebugSessionOperation : Operation<CreateDataFlowDebugSessionResponse>, IOperationSource<CreateDataFlowDebugSessionResponse>
    {
        private readonly OperationInternals<CreateDataFlowDebugSessionResponse> _operation;

        /// <summary> Initializes a new instance of FactoryCreateDataFlowDebugSessionOperation for mocking. </summary>
        protected FactoryCreateDataFlowDebugSessionOperation()
        {
        }

        internal FactoryCreateDataFlowDebugSessionOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<CreateDataFlowDebugSessionResponse>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "FactoryCreateDataFlowDebugSessionOperation");
        }
