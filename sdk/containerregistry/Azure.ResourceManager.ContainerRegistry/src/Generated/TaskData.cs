...
namespace Azure.ResourceManager.ContainerRegistry
{
    ...
    public partial class TaskData : Resource
    {
        ...
        internal TaskData(ResourceIdentifier id, string name, ResourceType type, IDictionary<string, string> tags, AzureLocation location, SystemData systemData, ResourceIdentity identity, ProvisioningState? provisioningState, DateTimeOffset? creationDate, TaskStatus? status, PlatformProperties platform, AgentProperties agentConfiguration, string agentPoolName, int? timeout, TaskStepProperties step, TriggerProperties trigger, Credentials credentials, string logTemplate, bool? isSystemTask) : base(id, name, type, tags, location, systemData)
        {
            Identity = identity;
