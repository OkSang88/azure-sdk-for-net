...
namespace Azure.ResourceManager.Migrate.Tests.Mock
{
    ...
    public partial class ProjectMockTests : MockTestBase
    {
        ...
        public async Task Delete()
        {
            ...
            var projectId = Migrate.Project.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "abgoyal-westEurope", "abGoyalProject2");
            var project = GetArmClient().GetProject(projectId);
        ...
        public async Task Update()
        {
            ...
            var projectId = Migrate.Project.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "abgoyal-westEurope", "abGoyalProject2");
            var project = GetArmClient().GetProject(projectId);
            Migrate.ProjectData project2 = new Migrate.ProjectData()
            {
                ETag = "",
