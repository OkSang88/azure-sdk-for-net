...
namespace Azure.ResourceManager.AppPlatform.Tests.Mock.Tests.Mock
{
    ...
    public partial class BindingResourceMockTests : MockTestBase
    {
        ...
        public async Task Get()
        {
            ...
            var bindingResourceId = AppPlatform.Tests.Mock.BindingResource.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "myResourceGroup", "myservice", "myapp", "mybinding");
        ...
        public async Task Update()
        {
            ...
            var bindingResourceId = AppPlatform.Tests.Mock.BindingResource.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "myResourceGroup", "myservice", "myapp", "mybinding");
            var bindingResource = GetArmClient().GetBindingResource(bindingResourceId);
            AppPlatform.Tests.Mock.BindingResourceData bindingResource2 = new AppPlatform.Tests.Mock.BindingResourceData()
            {
