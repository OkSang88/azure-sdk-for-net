...
namespace Azure.ResourceManager.ServiceFabricMesh.Models
{
    ...
    public partial class GatewayProperties
    {
        ...
        public GatewayProperties(NetworkRef sourceNetwork, NetworkRef destinationNetwork)
        {
        ...
        internal GatewayProperties(string description, NetworkRef sourceNetwork, NetworkRef destinationNetwork, IList<TcpConfig> tcp, IList<HttpConfig> http, ResourceStatus? status, string statusDetails, string ipAddress)
        {
