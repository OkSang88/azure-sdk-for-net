...
namespace SecurityInsights.Models
{
    ...
    public partial class HostEntity : EntityData
    {
        ...
        internal HostEntity(ResourceIdentifier id, string name, ResourceType type, SystemData systemData, EntityKind kind, IReadOnlyDictionary<string, object> additionalData, string friendlyName, string azureID, string dnsDomain, string hostName, bool? isDomainJoined, string netBiosName, string ntDomain, string omsAgentID, OSFamily? osFamily, string osVersion) : base(id, name, type, systemData, kind)
        {
