...
namespace IotHubClient.Models
{
    ...
    public partial class RoutingEventHubProperties
    {
        ...
        internal RoutingEventHubProperties(string id, string connectionString, string endpointUri, string entityPath, AuthenticationType? authenticationType, ManagedIdentity identity, string name, string subscriptionId, string resourceGroup)
        {
            Id = id;
