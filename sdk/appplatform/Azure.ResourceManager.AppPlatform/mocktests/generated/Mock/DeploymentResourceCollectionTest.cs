...
namespace Azure.ResourceManager.AppPlatform.Tests.Mock.Tests.Mock
{
    ...
    public partial class DeploymentResourceCollectionMockTests : MockTestBase
    {
        ...
        public async Task CreateOrUpdate()
        {
            ...
            AppPlatform.Tests.Mock.DeploymentResourceData deploymentResource = new AppPlatform.Tests.Mock.DeploymentResourceData()
            {
                Properties = new AppPlatform.Tests.Mock.Models.DeploymentResourceProperties()
                {
                    ...
                    DeploymentSettings = new AppPlatform.Tests.Mock.Models.DeploymentSettings()
                    {
                        ResourceRequests = new AppPlatform.Tests.Mock.Models.ResourceRequests()
                        {
                            Cpu = "1000m",
                            Memory = "3Gi",
                        },
