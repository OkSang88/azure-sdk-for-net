...
{
    public partial class BucketDefinition : IUtf8JsonSerializable
    {
        ...
        internal static BucketDefinition DeserializeBucketDefinition(JsonElement element)
        {
            ...
            return new BucketDefinition(url.Value, bucketName.Value, Optional.ToNullable(insecure), Optional.ToNullable(timeoutInSeconds), Optional.ToNullable(syncIntervalInSeconds), accessKey.Value, localAuthRef.Value);
        }
    }
}
