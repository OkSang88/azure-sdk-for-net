# Azure ResourceManager Management client library for .NET
...
Install the Azure ResourceManager management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.ResourceManager -Version 1.0.0-preview.1 
```
