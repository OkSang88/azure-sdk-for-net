...
namespace Azure.ResourceManager.ChangeAnalysis
{
    internal partial class ResourceChangesRestOperations
    {
        ...
        public ResourceChangesRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, Uri endpoint = null, string apiVersion = default)
        {
