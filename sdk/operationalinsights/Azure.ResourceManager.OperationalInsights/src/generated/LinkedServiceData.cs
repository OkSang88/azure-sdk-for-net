...
{
    /// <summary> A class representing the LinkedService data model. </summary>
    public partial class LinkedServiceData : Resource
    {
        /// <summary> Initializes a new instance of LinkedServiceData. </summary>
        ...
        internal LinkedServiceData(ResourceIdentifier id, string name, ResourceType type, IDictionary<string, string> tags, string resourceId, string writeAccessResourceId, LinkedServiceEntityStatus? provisioningState) : base(id, name, type)
        {
            Tags = tags;
