...
namespace FrontDoorManagementClient.Models
{
    ...
    public partial class LatencyScorecard : TrackedResource
    {
        ...
        internal LatencyScorecard(ResourceIdentifier id, string name, Azure.Core.ResourceType type, IDictionary<string, string> tags, AzureLocation location, string idPropertiesId, string namePropertiesName, string description, string endpointA, string endpointB, DateTimeOffset? startDateTimeUTC, DateTimeOffset? endDateTimeUTC, string country, IList<LatencyMetric> latencyMetrics) : base(id, name, type, tags, location)
        {
