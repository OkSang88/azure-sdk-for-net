...
namespace ServiceFabricManagedClustersManagementClient
{
    internal partial class ManagedClusterVersionRestOperations
    {
        ...
        public ManagedClusterVersionRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ClientOptions options, Uri endpoint = null, string apiVersion = "2021-11-01-preview")
        {
        ...
        public async Task<Response<ManagedClusterCodeVersionResultData>> GetAsync(string subscriptionId, string location, string clusterVersion, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="subscriptionId"/>, <paramref name="location"/>, or <paramref name="clusterVersion"/> is null. </exception>
        public Response<ManagedClusterCodeVersionResultData> Get(string subscriptionId, string location, string clusterVersion, CancellationToken cancellationToken = default)
        {
            if (subscriptionId == null)
            {
                throw new ArgumentNullException(nameof(subscriptionId));
        ...
        internal HttpMessage CreateGetByEnvironmentRequest(string subscriptionId, string location, Enum25 environment, string clusterVersion)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="subscriptionId"/>, <paramref name="location"/>, or <paramref name="clusterVersion"/> is null. </exception>
        public async Task<Response<ManagedClusterCodeVersionResultData>> GetByEnvironmentAsync(string subscriptionId, string location, Enum25 environment, string clusterVersion, CancellationToken cancellationToken = default)
        {
            if (subscriptionId == null)
            {
                throw new ArgumentNullException(nameof(subscriptionId));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="subscriptionId"/>, <paramref name="location"/>, or <paramref name="clusterVersion"/> is null. </exception>
        public Response<ManagedClusterCodeVersionResultData> GetByEnvironment(string subscriptionId, string location, Enum25 environment, string clusterVersion, CancellationToken cancellationToken = default)
        {
            if (subscriptionId == null)
            {
                throw new ArgumentNullException(nameof(subscriptionId));
        ...
        public async Task<Response<IReadOnlyList<ManagedClusterCodeVersionResultData>>> ListAsync(string subscriptionId, string location, CancellationToken cancellationToken = default)
        {
            if (subscriptionId == null)
            {
                throw new ArgumentNullException(nameof(subscriptionId));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="subscriptionId"/> or <paramref name="location"/> is null. </exception>
        public Response<IReadOnlyList<ManagedClusterCodeVersionResultData>> List(string subscriptionId, string location, CancellationToken cancellationToken = default)
        {
            if (subscriptionId == null)
            {
                throw new ArgumentNullException(nameof(subscriptionId));
        ...
        internal HttpMessage CreateListByEnvironmentRequest(string subscriptionId, string location, Enum25 environment)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="subscriptionId"/> or <paramref name="location"/> is null. </exception>
        public async Task<Response<IReadOnlyList<ManagedClusterCodeVersionResultData>>> ListByEnvironmentAsync(string subscriptionId, string location, Enum25 environment, CancellationToken cancellationToken = default)
        {
            if (subscriptionId == null)
            {
                throw new ArgumentNullException(nameof(subscriptionId));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="subscriptionId"/> or <paramref name="location"/> is null. </exception>
        public Response<IReadOnlyList<ManagedClusterCodeVersionResultData>> ListByEnvironment(string subscriptionId, string location, Enum25 environment, CancellationToken cancellationToken = default)
        {
            if (subscriptionId == null)
            {
                throw new ArgumentNullException(nameof(subscriptionId));
