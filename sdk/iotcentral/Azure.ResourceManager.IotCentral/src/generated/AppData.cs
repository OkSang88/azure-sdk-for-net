...
namespace IotCentralClient
{
    ...
    public partial class AppData : TrackedResource
    {
        ...
        internal AppData(ResourceIdentifier id, string name, ResourceType type, IDictionary<string, string> tags, AzureLocation location, AppSkuInfo sku, SystemAssignedServiceIdentity identity, string applicationId, string displayName, string subdomain, string template, AppState? state) : base(id, name, type, tags, location)
        {
            Sku = sku;
            Identity = identity;
