    ...
    public partial class Cluster : ArmResource
    {
        ...
        public async virtual Task<ClusterDeleteOperation> DeleteAsync(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ClusterDeleteOperation(_clientDiagnostics, Pipeline, _clustersRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name).Request, response);
        ...
        public async virtual Task<ClusterUpdateOperation> UpdateAsync(bool waitForCompletion, ClusterPatch parameters, CancellationToken cancellationToken = default)
        {
            if (parameters == null)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="parameters"/> is null. </exception>
        public virtual ClusterUpdateOperation Update(bool waitForCompletion, ClusterPatch parameters, CancellationToken cancellationToken = default)
        {
            if (parameters == null)
            {
                throw new ArgumentNullException(nameof(parameters));
