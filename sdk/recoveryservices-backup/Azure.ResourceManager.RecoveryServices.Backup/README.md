# Azure RecoveryServices.Backup Management client library for .NET
...
Install the Azure RecoveryServices.Backup management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.RecoveryServices.Backup -Version 1.0.0-preview.1 
```
