...
namespace Azure.ResourceManager.OperationalInsights.Models
{
    ...
    public partial class WorkspacePatch : AzureEntityResource
    {
        ...
        internal WorkspacePatch(ResourceIdentifier id, string name, ResourceType type, string etag, IDictionary<string, string> tags, WorkspaceEntityStatus? provisioningState, string customerId, WorkspaceSku sku, int? retentionInDays, WorkspaceCapping workspaceCapping, string createdDate, string modifiedDate, PublicNetworkAccessType? publicNetworkAccessForIngestion, PublicNetworkAccessType? publicNetworkAccessForQuery, bool? forceCmkForQuery, IReadOnlyList<PrivateLinkScopedResource> privateLinkScopedResources, WorkspaceFeatures features) : base(id, name, type, etag)
        {
            Tags = tags;
