...
namespace Insights.Models
{
    ...
    public partial class AutoscaleSettingUpdateOperation : Operation<AutoscaleSettingResource>
    {
        private readonly OperationOrResponseInternals<AutoscaleSettingResource> _operation;

        /// <summary> Initializes a new instance of AutoscaleSettingUpdateOperation for mocking. </summary>
        protected AutoscaleSettingUpdateOperation()
        {
        }

        internal AutoscaleSettingUpdateOperation(ArmResource operationsBase, Response<AutoscaleSettingResourceData> response)
        {
