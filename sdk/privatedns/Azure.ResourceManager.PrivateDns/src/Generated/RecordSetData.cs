...
namespace Azure.ResourceManager.PrivateDns
{
    ...
    public partial class RecordSetData : Resource
    {
        ...
        internal RecordSetData(ResourceIdentifier id, string name, ResourceType type, string etag, IDictionary<string, string> metadata, long? ttl, string fqdn, bool? isAutoRegistered, IList<ARecord> aRecords, IList<AaaaRecord> aaaaRecords, CnameRecord cnameRecord, IList<MxRecord> mxRecords, IList<PtrRecord> ptrRecords, SoaRecord soaRecord, IList<SrvRecord> srvRecords, IList<TxtRecord> txtRecords) : base(id, name, type)
        {
            Etag = etag;
            Metadata = metadata;
            Ttl = ttl;
