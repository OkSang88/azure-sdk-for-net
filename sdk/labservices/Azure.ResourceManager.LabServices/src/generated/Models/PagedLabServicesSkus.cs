...
namespace LabServicesClient.Models
{
    ...
    internal partial class PagedLabServicesSkus
    {
        ...
        {
            Value = new ChangeTrackingList<LabServicesSku>();
        }
        ...
        internal PagedLabServicesSkus(IReadOnlyList<LabServicesSku> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
        ...
        public IReadOnlyList<LabServicesSku> Value { get; }
