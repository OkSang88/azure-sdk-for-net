...
namespace IotDpsClient.Models
{
    ...
    public partial class IotDpsResourceCreateOrUpdateOperation : Operation<ProvisioningServiceDescription>, IOperationSource<ProvisioningServiceDescription>
    {
        private readonly OperationInternals<ProvisioningServiceDescription> _operation;

        private readonly ArmResource _operationBase;

        /// <summary> Initializes a new instance of IotDpsResourceCreateOrUpdateOperation for mocking. </summary>
        protected IotDpsResourceCreateOrUpdateOperation()
        {
        }

        internal IotDpsResourceCreateOrUpdateOperation(ArmResource operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<ProvisioningServiceDescription>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "IotDpsResourceCreateOrUpdateOperation");
