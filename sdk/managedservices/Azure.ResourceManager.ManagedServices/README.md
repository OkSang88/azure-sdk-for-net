# Azure ManagedServices Management client library for .NET
...
Install the Azure ManagedServices management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.ManagedServices -Version 1.0.0-preview.1 
```
