...
{
    public partial class Sample_NetworkMappingCollection
    {
        ...
        {
            // Generated from example definition: specification/recoveryservicessiterecovery/resource-manager/Microsoft.RecoveryServices/stable/2022-08-01/examples/ReplicationNetworkMappings_ListByReplicationNetworks.json
            ...
            // get the collection of this NetworkMappingResource
            NetworkMappingCollection collection = network.GetNetworkMappings();

            // invoke the operation and iterate over the result
            await foreach (NetworkMappingResource item in collection.GetAllAsync())
            {
        ...
        public async Task Get_GetsNetworkMappingByName()
        {
            ...
            NetworkMappingResource result = await collection.GetAsync(networkMappingName);
        ...
        {
            // Generated from example definition: specification/recoveryservicessiterecovery/resource-manager/Microsoft.RecoveryServices/stable/2022-08-01/examples/ReplicationNetworkMappings_Create.json
            ...
            // invoke the operation
            string networkMappingName = "corpe2amap";
            NetworkMappingCreateOrUpdateContent content = new NetworkMappingCreateOrUpdateContent(new CreateNetworkMappingInputProperties("/subscriptions/c183865e-6077-46f2-a3b1-deb0f4f4650a/resourceGroups/siterecoveryProd1/providers/Microsoft.Network/virtualNetworks/vnetavrai")
            {
                RecoveryFabricName = "Microsoft Azure",
                FabricSpecificDetails = new FabricSpecificCreateNetworkMappingInput()
                {
                    InstanceType = "VmmToAzure",
                },
            });
            ArmOperation<NetworkMappingResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, networkMappingName, content);
