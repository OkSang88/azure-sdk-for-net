...
{
    public partial class OfficeIRMDataConnector : IUtf8JsonSerializable
    {
        ...
        internal static OfficeIRMDataConnector DeserializeOfficeIRMDataConnector(JsonElement element)
        {
            ...
            return new OfficeIRMDataConnector(id, name, type, systemData, etag.Value, kind, tenantId.Value, dataTypes.Value);
        }
    }
}
