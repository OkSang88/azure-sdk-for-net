...
namespace Azure.ResourceManager.StorSimple8000Series.Tests.Mock.Tests.Mock
{
    ...
    public partial class ManagerMockTests : MockTestBase
    {
        ...
        {
            // Example: ManagersGet
            var managerId = StorSimple8000Series.Tests.Mock.Manager.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "ResourceGroupForSDKTest", "ManagerForSDKTest2");
        ...
        public async Task Update()
        {
            ...
            var managerId = StorSimple8000Series.Tests.Mock.Manager.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "ResourceGroupForSDKTest", "ManagerForSDKTest2");
            var manager = GetArmClient().GetManager(managerId);
            StorSimple8000Series.Tests.Mock.Models.ManagerPatch parameters = new StorSimple8000Series.Tests.Mock.Models.ManagerPatch();
        ...
        public async Task ClearAlert()
        {
            ...
            var managerId = StorSimple8000Series.Tests.Mock.Manager.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "ResourceGroupForSDKTest", "ManagerForSDKTest1");
            var manager = GetArmClient().GetManager(managerId);
            StorSimple8000Series.Tests.Mock.Models.ClearAlertRequest parameters = new StorSimple8000Series.Tests.Mock.Models.ClearAlertRequest(alerts: new List<string>()
{
"/subscriptions/4385cf00-2d3a-425a-832f-f4285b1c9dce/resourceGroups/ResourceGroupForSDKTest/providers/Microsoft.StorSimple/managers/ManagerForSDKTest1/devices/Device05ForSDKTest/alerts/308b5bd2-824b-436f-840e-44bde075ef33",});
        ...
        public async Task ProvisionCloudAppliance()
        {
            ...
            var managerId = StorSimple8000Series.Tests.Mock.Manager.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "ResourceGroupForSDKTest", "ManagerForSDKTest1");
            var manager = GetArmClient().GetManager(managerId);
            StorSimple8000Series.Tests.Mock.Models.CloudAppliance parameters = new StorSimple8000Series.Tests.Mock.Models.CloudAppliance(name: "sca07forsdktest", vnetRegion: "West US")
            {
                ModelNumber = "8020",
            };
        ...
        public async Task ConfigureDevice()
        {
            ...
            var managerId = StorSimple8000Series.Tests.Mock.Manager.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "ResourceGroupForSDKTest", "ManagerForSDKTest1");
            var manager = GetArmClient().GetManager(managerId);
            StorSimple8000Series.Tests.Mock.Models.ConfigureDeviceRequest parameters = new StorSimple8000Series.Tests.Mock.Models.ConfigureDeviceRequest(friendlyName: "Device001ForSDKTest", currentDeviceName: "Device001ForSDKTest", timeZone: "Pacific Standard Time")
            {
                NetworkInterfaceData0Settings = new StorSimple8000Series.Tests.Mock.Models.NetworkInterfaceData0Settings()
                {
        ...
        public async Task EncryptionSettingsGet()
        {
            ...
            var encryptionSettingsId = StorSimple8000Series.Tests.Mock.EncryptionSettings.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "ResourceGroupForSDKTest", "ManagerForSDKTest1");
        ...
        public async Task ManagerExtendedInfoGet()
        {
            ...
            var managerExtendedInfoId = StorSimple8000Series.Tests.Mock.ManagerExtendedInfo.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "ResourceGroupForSDKTest", "ManagerForSDKTest1");
        ...
        public async Task ManagerExtendedInfoDelete()
        {
            ...
            var managerExtendedInfoId = StorSimple8000Series.Tests.Mock.ManagerExtendedInfo.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "ResourceGroupForSDKTest", "ManagerForSDKTest2");
            var managerExtendedInfo = GetArmClient().GetManagerExtendedInfo(managerExtendedInfoId);
        ...
        public async Task ManagerExtendedInfoUpdate()
        {
            ...
            StorSimple8000Series.Tests.Mock.ManagerExtendedInfoData parameters = new StorSimple8000Series.Tests.Mock.ManagerExtendedInfoData()
            {
