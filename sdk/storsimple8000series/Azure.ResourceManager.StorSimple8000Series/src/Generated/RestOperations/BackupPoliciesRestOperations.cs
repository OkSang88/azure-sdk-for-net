...
namespace Azure.ResourceManager.StorSimple8000Series
{
    internal partial class BackupPoliciesRestOperations
    {
        ...
        public BackupPoliciesRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, Uri endpoint = null, string apiVersion = default)
        {
