...
namespace Azure.ResourceManager.Batch
{
    public partial class PrivateEndpointConnectionData : IUtf8JsonSerializable
    {
        ...
        internal static PrivateEndpointConnectionData DeserializePrivateEndpointConnectionData(JsonElement element)
        {
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        if (property0.NameEquals("provisioningState"))
                        {
                            ...
                            provisioningState = property0.Value.GetString().ToPrivateEndpointConnectionProvisioningState();
                            continue;
                        }
            ...
            return new PrivateEndpointConnectionData(id, name, type, etag.Value, Optional.ToNullable(provisioningState), privateEndpoint, privateLinkServiceConnectionState.Value);
        }
    }
}
