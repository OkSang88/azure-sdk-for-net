...
namespace StorSimple8000SeriesManagementClient
{
    ...
    public partial class Device : ArmResource
    {
        ...
        internal Device(ArmResource options, DeviceData data) : base(options, data.Id)
        {
            ...
            _alertsRestClient = new AlertsRestOperations(_clientDiagnostics, Pipeline, ClientOptions, BaseUri);
            _backupsRestClient = new BackupsRestOperations(_clientDiagnostics, Pipeline, ClientOptions, BaseUri);
            _hardwareComponentGroupsRestClient = new HardwareComponentGroupsRestOperations(_clientDiagnostics, Pipeline, ClientOptions, BaseUri);
        ...
        public async virtual Task<BackupDeleteOperation> DeleteBackupAsync(bool waitForCompletion, string backupName, CancellationToken cancellationToken = default)
        {
            if (backupName == null)
            {
            ...
            try
            {
                ...
                var operation = new BackupDeleteOperation(_clientDiagnostics, Pipeline, _backupsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, backupName).Request, response);
                if (waitForCompletion)
                    await operation.WaitForCompletionResponseAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="backupName"/> is null. </exception>
        public virtual BackupDeleteOperation DeleteBackup(bool waitForCompletion, string backupName, CancellationToken cancellationToken = default)
        {
            if (backupName == null)
            {
                throw new ArgumentNullException(nameof(backupName));
        ...
        public async virtual Task<BackupCloneOperation> CloneBackupAsync(bool waitForCompletion, string backupName, string backupElementName, CloneRequest parameters, CancellationToken cancellationToken = default)
        {
            if (backupName == null)
            {
                throw new ArgumentNullException(nameof(backupName));
            ...
            try
            {
                ...
                var operation = new BackupCloneOperation(_clientDiagnostics, Pipeline, _backupsRestClient.CreateCloneRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, backupName, backupElementName, parameters).Request, response);
                if (waitForCompletion)
                    await operation.WaitForCompletionResponseAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="backupName"/>, <paramref name="backupElementName"/>, or <paramref name="parameters"/> is null. </exception>
        public virtual BackupCloneOperation CloneBackup(bool waitForCompletion, string backupName, string backupElementName, CloneRequest parameters, CancellationToken cancellationToken = default)
        {
            if (backupName == null)
            {
                throw new ArgumentNullException(nameof(backupName));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="backupName"/> is null. </exception>
        public async virtual Task<BackupRestoreOperation> RestoreBackupAsync(bool waitForCompletion, string backupName, CancellationToken cancellationToken = default)
        {
            if (backupName == null)
            {
                throw new ArgumentNullException(nameof(backupName));
            ...
            try
            {
                ...
                var operation = new BackupRestoreOperation(_clientDiagnostics, Pipeline, _backupsRestClient.CreateRestoreRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, backupName).Request, response);
                if (waitForCompletion)
                    await operation.WaitForCompletionResponseAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="backupName"/> is null. </exception>
        public virtual BackupRestoreOperation RestoreBackup(bool waitForCompletion, string backupName, CancellationToken cancellationToken = default)
        {
            if (backupName == null)
            {
                throw new ArgumentNullException(nameof(backupName));
        ...
        public async virtual Task<HardwareComponentGroupChangeControllerPowerStateOperation> ChangeControllerPowerStateHardwareComponentGroupAsync(bool waitForCompletion, string hardwareComponentGroupName, ControllerPowerStateChangeRequest parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new HardwareComponentGroupChangeControllerPowerStateOperation(_clientDiagnostics, Pipeline, _hardwareComponentGroupsRestClient.CreateChangeControllerPowerStateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, hardwareComponentGroupName, parameters).Request, response);
                if (waitForCompletion)
                    await operation.WaitForCompletionResponseAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="hardwareComponentGroupName"/> or <paramref name="parameters"/> is null. </exception>
        public virtual HardwareComponentGroupChangeControllerPowerStateOperation ChangeControllerPowerStateHardwareComponentGroup(bool waitForCompletion, string hardwareComponentGroupName, ControllerPowerStateChangeRequest parameters, CancellationToken cancellationToken = default)
        {
            if (hardwareComponentGroupName == null)
            {
                throw new ArgumentNullException(nameof(hardwareComponentGroupName));
