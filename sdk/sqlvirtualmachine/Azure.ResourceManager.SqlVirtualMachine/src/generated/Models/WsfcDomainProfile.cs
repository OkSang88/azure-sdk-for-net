...
namespace SqlVirtualMachineManagementClient.Models
{
    ...
    {
        /// <summary> Initializes a new instance of WsfcDomainProfile. </summary>
        ...
        /// <param name="ouPath"> Organizational Unit path in which the nodes and cluster will be present. </param>
        ...
        /// <param name="storageAccountUrl"> Fully qualified ARM resource id of the witness storage account. </param>
        /// <param name="storageAccountPrimaryKey"> Primary key of the witness storage account. </param>
        internal WsfcDomainProfile(string domainFqdn, string ouPath, string clusterBootstrapAccount, string clusterOperatorAccount, string sqlServiceAccount, string fileShareWitnessPath, string storageAccountUrl, string storageAccountPrimaryKey)
        {
