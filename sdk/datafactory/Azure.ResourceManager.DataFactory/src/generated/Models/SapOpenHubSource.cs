...
namespace DataFactoryManagementClient.Models
{
    ...
    public partial class SapOpenHubSource : TabularSource
    {
        ...
        internal SapOpenHubSource(string type, object sourceRetryCount, object sourceRetryWait, object maxConcurrentConnections, object disableMetricsCollection, IDictionary<string, object> additionalProperties, object queryTimeout, object additionalColumns, object excludeLastRequest, object baseRequestId, object customRfcReadTableFunctionModule, object sapDataColumnDelimiter) : base(type, sourceRetryCount, sourceRetryWait, maxConcurrentConnections, disableMetricsCollection, additionalProperties, queryTimeout, additionalColumns)
        {
