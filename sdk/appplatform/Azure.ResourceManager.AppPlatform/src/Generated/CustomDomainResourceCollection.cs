...
namespace Azure.ResourceManager.AppPlatform
{
    ...
    public partial class CustomDomainResourceCollection : ArmCollection, IEnumerable<CustomDomainResource>, IAsyncEnumerable<CustomDomainResource>
    {
        ...
        internal CustomDomainResourceCollection(ArmResource parent) : base(parent)
        {
            ...
            ClientOptions.TryGetApiVersion(CustomDomainResource.ResourceType, out string apiVersion);
        ...
        public virtual CustomDomainResourceCreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, string domainName, CustomDomainResourceData domainResource, CancellationToken cancellationToken = default)
        {
            if (domainName == null)
            {
            ...
            try
            {
                ...
                var operation = new CustomDomainResourceCreateOrUpdateOperation(this, _clientDiagnostics, Pipeline, _customDomainsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, domainName, domainResource).Request, response);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="domainName"/> or <paramref name="domainResource"/> is null. </exception>
        public async virtual Task<CustomDomainResourceCreateOrUpdateOperation> CreateOrUpdateAsync(bool waitForCompletion, string domainName, CustomDomainResourceData domainResource, CancellationToken cancellationToken = default)
        {
            if (domainName == null)
            {
                throw new ArgumentNullException(nameof(domainName));
        ...
        public virtual Response<CustomDomainResource> GetIfExists(string domainName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                if (response.Value == null)
                    return Response.FromValue<CustomDomainResource>(null, response.GetRawResponse());
                return Response.FromValue(new CustomDomainResource(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual Response<bool> Exists(string domainName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("CustomDomainResourceCollection.Exists");
            scope.Start();
            try
            {
        ...
        public virtual Pageable<CustomDomainResource> GetAll(CancellationToken cancellationToken = default)
        {
            Page<CustomDomainResource> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    ...
                    return Page.FromValues(response.Value.Value.Select(value => new CustomDomainResource(this, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
        ...
        // Builders.
        // public ArmBuilder<Azure.Core.ResourceIdentifier, CustomDomainResource, CustomDomainResourceData> Construct() { }
    }
}
