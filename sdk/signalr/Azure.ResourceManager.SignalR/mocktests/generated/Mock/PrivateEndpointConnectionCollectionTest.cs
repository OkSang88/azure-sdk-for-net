...
namespace SignalRManagementClient.Tests.Mock
{
    ...
    public partial class PrivateEndpointConnectionCollectionMockTests : MockTestBase
    {
        ...
        public async Task CreateOrUpdate()
        {
            ...
            SignalRManagementClient.PrivateEndpointConnectionData parameters = new SignalRManagementClient.PrivateEndpointConnectionData()
            {
                ...
                PrivateLinkServiceConnectionState = new SignalRManagementClient.Models.PrivateLinkServiceConnectionState()
                {
                    Status = new SignalRManagementClient.Models.PrivateLinkServiceConnectionStatus("Approved"),
