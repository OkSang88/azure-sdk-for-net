...
namespace Insights.Models
{
    ...
    public partial class ActionGroupDeleteOperation : Operation
    {
        private readonly OperationOrResponseInternals _operation;

        /// <summary> Initializes a new instance of ActionGroupDeleteOperation for mocking. </summary>
        protected ActionGroupDeleteOperation()
        {
        }

        internal ActionGroupDeleteOperation(Azure.Response response)
        {
