...
{
    internal partial class ClusterExtensionTypesRestOperations
    {
        ...
        /// <summary> Initializes a new instance of ClusterExtensionTypesRestOperations. </summary>
        ...
        public ClusterExtensionTypesRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ClientOptions options, Uri endpoint = null, string apiVersion = "2022-01-01-preview")
        {
        ...
        public async Task<Response<ExtensionTypeList>> ListAsync(string subscriptionId, string resourceGroupName, Enum0 clusterRp, Enum1 clusterResourceName, string clusterName, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="subscriptionId"/>, <paramref name="resourceGroupName"/>, or <paramref name="clusterName"/> is null. </exception>
        public Response<ExtensionTypeList> List(string subscriptionId, string resourceGroupName, Enum0 clusterRp, Enum1 clusterResourceName, string clusterName, CancellationToken cancellationToken = default)
        {
            if (subscriptionId == null)
            {
                throw new ArgumentNullException(nameof(subscriptionId));
        ...
        public async Task<Response<ExtensionTypeList>> ListNextPageAsync(string nextLink, string subscriptionId, string resourceGroupName, Enum0 clusterRp, Enum1 clusterResourceName, string clusterName, CancellationToken cancellationToken = default)
        {
            if (nextLink == null)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="nextLink"/>, <paramref name="subscriptionId"/>, <paramref name="resourceGroupName"/>, or <paramref name="clusterName"/> is null. </exception>
        public Response<ExtensionTypeList> ListNextPage(string nextLink, string subscriptionId, string resourceGroupName, Enum0 clusterRp, Enum1 clusterResourceName, string clusterName, CancellationToken cancellationToken = default)
        {
            if (nextLink == null)
            {
                throw new ArgumentNullException(nameof(nextLink));
