...
{
    public partial class CloudEndpointCreateParameters : IUtf8JsonSerializable
    {
        ...
        internal static CloudEndpointCreateParameters DeserializeCloudEndpointCreateParameters(JsonElement element)
        {
            ...
            return new CloudEndpointCreateParameters(id, name, type, storageAccountResourceId.Value, azureFileShareName.Value, storageAccountTenantId.Value, friendlyName.Value);
        }
    }
}
