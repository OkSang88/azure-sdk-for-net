...
namespace Azure.ResourceManager.StorSimple8000Series
{
    internal partial class DevicesRestOperations
    {
        ...
        public DevicesRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, Uri endpoint = null, string apiVersion = default)
        {
