...
namespace Azure.ResourceManager.DataFactory.Tests.Mock.Tests.Mock
{
    ...
    public partial class IntegrationRuntimeResourceMockTests : MockTestBase
    {
        ...
        public async Task Get()
        {
            ...
            var integrationRuntimeResourceId = DataFactory.Tests.Mock.IntegrationRuntimeResource.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "exampleResourceGroup", "exampleFactoryName", "exampleIntegrationRuntime");
        ...
        public async Task Update()
        {
            ...
            var integrationRuntimeResourceId = DataFactory.Tests.Mock.IntegrationRuntimeResource.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "exampleResourceGroup", "exampleFactoryName", "exampleIntegrationRuntime");
            var integrationRuntimeResource = GetArmClient().GetIntegrationRuntimeResource(integrationRuntimeResourceId);
            DataFactory.Tests.Mock.Models.UpdateIntegrationRuntimeRequest updateIntegrationRuntimeRequest = new DataFactory.Tests.Mock.Models.UpdateIntegrationRuntimeRequest()
            {
                AutoUpdate = new DataFactory.Tests.Mock.Models.IntegrationRuntimeAutoUpdate("Off"),
        ...
        public async Task RegenerateAuthKey()
        {
            ...
            var integrationRuntimeResourceId = DataFactory.Tests.Mock.IntegrationRuntimeResource.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "exampleResourceGroup", "exampleFactoryName", "exampleIntegrationRuntime");
            var integrationRuntimeResource = GetArmClient().GetIntegrationRuntimeResource(integrationRuntimeResourceId);
            DataFactory.Tests.Mock.Models.IntegrationRuntimeRegenerateKeyParameters regenerateKeyParameters = new DataFactory.Tests.Mock.Models.IntegrationRuntimeRegenerateKeyParameters()
            {
                KeyName = new DataFactory.Tests.Mock.Models.IntegrationRuntimeAuthKeyName("authKey2"),
            };
        ...
        public async Task Start()
        {
            ...
            var integrationRuntimeResourceId = DataFactory.Tests.Mock.IntegrationRuntimeResource.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "exampleResourceGroup", "exampleFactoryName", "exampleManagedIntegrationRuntime");
            var integrationRuntimeResource = GetArmClient().GetIntegrationRuntimeResource(integrationRuntimeResourceId);
        ...
        public async Task RemoveLinks()
        {
            ...
            var integrationRuntimeResourceId = DataFactory.Tests.Mock.IntegrationRuntimeResource.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "exampleResourceGroup", "exampleFactoryName", "exampleIntegrationRuntime");
            var integrationRuntimeResource = GetArmClient().GetIntegrationRuntimeResource(integrationRuntimeResourceId);
            DataFactory.Tests.Mock.Models.LinkedIntegrationRuntimeRequest linkedIntegrationRuntimeRequest = new DataFactory.Tests.Mock.Models.LinkedIntegrationRuntimeRequest(linkedFactoryName: "exampleFactoryName-linked");
        ...
        public async Task CreateLinkedIntegrationRuntime()
        {
            ...
            var integrationRuntimeResourceId = DataFactory.Tests.Mock.IntegrationRuntimeResource.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "exampleResourceGroup", "exampleFactoryName", "exampleIntegrationRuntime");
            var integrationRuntimeResource = GetArmClient().GetIntegrationRuntimeResource(integrationRuntimeResourceId);
            DataFactory.Tests.Mock.Models.CreateLinkedIntegrationRuntimeRequest createLinkedIntegrationRuntimeRequest = new DataFactory.Tests.Mock.Models.CreateLinkedIntegrationRuntimeRequest()
            {
        ...
        public async Task RefreshIntegrationRuntimeObjectMetadata()
        {
            ...
            var integrationRuntimeResourceId = DataFactory.Tests.Mock.IntegrationRuntimeResource.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "exampleResourceGroup", "exampleFactoryName", "testactivityv2");
            var integrationRuntimeResource = GetArmClient().GetIntegrationRuntimeResource(integrationRuntimeResourceId);
        ...
        public async Task GetAllIntegrationRuntimeObjectMetadata()
        {
            ...
            var integrationRuntimeResourceId = DataFactory.Tests.Mock.IntegrationRuntimeResource.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "exampleResourceGroup", "exampleFactoryName", "testactivityv2");
            var integrationRuntimeResource = GetArmClient().GetIntegrationRuntimeResource(integrationRuntimeResourceId);
            DataFactory.Tests.Mock.Models.GetSsisObjectMetadataRequest getMetadataRequest = new DataFactory.Tests.Mock.Models.GetSsisObjectMetadataRequest()
            {
        ...
        public async Task UpdateIntegrationRuntimeNode()
        {
            ...
            var integrationRuntimeResource = GetArmClient().GetIntegrationRuntimeResource(integrationRuntimeResourceId);
            string nodeName = "Node_1";
            DataFactory.Tests.Mock.Models.UpdateIntegrationRuntimeNodeRequest updateIntegrationRuntimeNodeRequest = new DataFactory.Tests.Mock.Models.UpdateIntegrationRuntimeNodeRequest()
            {
