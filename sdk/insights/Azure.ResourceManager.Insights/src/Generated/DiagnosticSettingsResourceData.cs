...
namespace Insights
{
    /// <summary> A class representing the DiagnosticSettingsResource data model. </summary>
    public partial class DiagnosticSettingsResourceData : Resource
    {
        /// <summary> Initializes a new instance of DiagnosticSettingsResourceData. </summary>
        public DiagnosticSettingsResourceData()
        {
