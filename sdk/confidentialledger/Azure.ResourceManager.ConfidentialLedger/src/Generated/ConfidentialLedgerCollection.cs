...
namespace Azure.ResourceManager.ConfidentialLedger
{
    ...
    public partial class ConfidentialLedgerCollection : ArmCollection, IEnumerable<ConfidentialLedger>, IAsyncEnumerable<ConfidentialLedger>
    {
        ...
        internal ConfidentialLedgerCollection(ArmResource parent) : base(parent)
        {
            ...
            ClientOptions.TryGetApiVersion(ConfidentialLedger.ResourceType, out string apiVersion);
        ...
        public virtual ConfidentialLedgerCreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, string ledgerName, ConfidentialLedgerData confidentialLedger, CancellationToken cancellationToken = default)
        {
            if (ledgerName == null)
            {
            ...
            try
            {
                ...
                var operation = new ConfidentialLedgerCreateOrUpdateOperation(this, _clientDiagnostics, Pipeline, _ledgerRestClient.CreateCreateRequest(Id.SubscriptionId, Id.ResourceGroupName, ledgerName, confidentialLedger).Request, response);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="ledgerName"/> or <paramref name="confidentialLedger"/> is null. </exception>
        public async virtual Task<ConfidentialLedgerCreateOrUpdateOperation> CreateOrUpdateAsync(bool waitForCompletion, string ledgerName, ConfidentialLedgerData confidentialLedger, CancellationToken cancellationToken = default)
        {
            if (ledgerName == null)
            {
                throw new ArgumentNullException(nameof(ledgerName));
        ...
        public virtual Pageable<ConfidentialLedger> GetAll(string filter = null, CancellationToken cancellationToken = default)
        {
            Page<ConfidentialLedger> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    ...
                    return Page.FromValues(response.Value.Value.Select(value => new ConfidentialLedger(this, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
