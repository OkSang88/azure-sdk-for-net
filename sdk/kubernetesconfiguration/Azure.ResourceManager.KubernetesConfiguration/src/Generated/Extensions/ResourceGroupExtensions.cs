...
namespace Azure.ResourceManager.KubernetesConfiguration
{
    ...
    public static partial class ResourceGroupExtensions
    {
        ...
        private static ClusterExtensionTypeRestOperations GetClusterExtensionTypeRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions clientOptions, Uri endpoint = null, string apiVersion = default)
        {
            return new ClusterExtensionTypeRestOperations(clientDiagnostics, pipeline, clientOptions, endpoint, apiVersion);
        }

        private static ClusterExtensionTypesRestOperations GetClusterExtensionTypesRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions clientOptions, Uri endpoint = null, string apiVersion = default)
        {
            return new ClusterExtensionTypesRestOperations(clientDiagnostics, pipeline, clientOptions, endpoint, apiVersion);
        }
        ...
        public static async Task<Response<ExtensionType>> GetClusterExtensionTypeAsync(this ResourceGroup resourceGroup, Enum0 clusterRp, Enum1 clusterResourceName, string clusterName, string extensionTypeName, CancellationToken cancellationToken = default)
        {
            ...
            return await resourceGroup.UseClientContext(async (baseUri, credential, options, pipeline) =>
            {
                ...
                try
                {
                    ClusterExtensionTypeRestOperations restOperations = GetClusterExtensionTypeRestOperations(clientDiagnostics, pipeline, options, baseUri);
        ...
        public static AsyncPageable<ExtensionType> GetClusterExtensionTypesAsync(this ResourceGroup resourceGroup, Enum0 clusterRp, Enum1 clusterResourceName, string clusterName, CancellationToken cancellationToken = default)
        {
            ...
            {
                var clientDiagnostics = new ClientDiagnostics(options);
                ClusterExtensionTypesRestOperations restOperations = GetClusterExtensionTypesRestOperations(clientDiagnostics, pipeline, options, baseUri);
