...
namespace IotHubClient.Models
{
    ...
    public partial class RoutingServiceBusTopicEndpointProperties
    {
        ...
        internal RoutingServiceBusTopicEndpointProperties(string id, string connectionString, string endpointUri, string entityPath, AuthenticationType? authenticationType, ManagedIdentity identity, string name, string subscriptionId, string resourceGroup)
        {
            Id = id;
