...
{
    public partial class PersistentDisk : IUtf8JsonSerializable
    {
        ...
        internal static PersistentDisk DeserializePersistentDisk(JsonElement element)
        {
            ...
            return new PersistentDisk(Optional.ToNullable(sizeInGB), Optional.ToNullable(usedInGB), mountPath.Value);
        }
    }
}
