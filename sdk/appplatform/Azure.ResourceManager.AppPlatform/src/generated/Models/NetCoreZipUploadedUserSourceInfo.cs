...
namespace AppPlatformManagementClient.Models
{
    ...
    public partial class NetCoreZipUploadedUserSourceInfo : UploadedUserSourceInfo
    {
        ...
        internal NetCoreZipUploadedUserSourceInfo(string type, string version, string relativePath, string netCoreMainEntryPath, string runtimeVersion) : base(type, version, relativePath)
        {
            NetCoreMainEntryPath = netCoreMainEntryPath;
            RuntimeVersion = runtimeVersion;
            Type = type ?? "NetCoreZip";
        }
