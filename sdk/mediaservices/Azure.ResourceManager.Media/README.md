# Azure Media Management client library for .NET
...
Install the Azure Media management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.Media -Version 1.0.0-preview.1 
```
