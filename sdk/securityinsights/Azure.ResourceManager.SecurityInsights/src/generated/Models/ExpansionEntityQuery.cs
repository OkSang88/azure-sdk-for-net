...
namespace SecurityInsights.Models
{
    ...
    public partial class ExpansionEntityQuery : EntityQueryData
    {
        ...
        internal ExpansionEntityQuery(ResourceIdentifier id, string name, ResourceType type, SystemData systemData, string etag, EntityQueryKind kind, IList<string> dataSources, string displayName, EntityType? inputEntityType, IList<string> inputFields, IList<EntityType> outputEntityTypes, string queryTemplate) : base(id, name, type, systemData, etag, kind)
        {
