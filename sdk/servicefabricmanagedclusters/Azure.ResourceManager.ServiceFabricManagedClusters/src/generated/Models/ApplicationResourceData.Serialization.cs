...
namespace ServiceFabricManagedClustersManagementClient
{
    public partial class ApplicationResourceData : IUtf8JsonSerializable
    {
        ...
        internal static ApplicationResourceData DeserializeApplicationResourceData(JsonElement element)
        {
            ...
            return new ApplicationResourceData(id, name, type, tags, location, systemData, identity.Value, provisioningState.Value, version.Value, Optional.ToDictionary(parameters), upgradePolicy.Value, Optional.ToList(managedIdentities));
        }
    }
}
