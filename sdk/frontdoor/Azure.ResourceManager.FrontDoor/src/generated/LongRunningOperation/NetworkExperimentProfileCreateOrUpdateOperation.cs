...
namespace FrontDoorManagementClient.Models
{
    ...
    public partial class NetworkExperimentProfileCreateOrUpdateOperation : Operation<Profile>, IOperationSource<Profile>
    {
        private readonly OperationInternals<Profile> _operation;

        private readonly ArmResource _operationBase;

        /// <summary> Initializes a new instance of NetworkExperimentProfileCreateOrUpdateOperation for mocking. </summary>
        protected NetworkExperimentProfileCreateOrUpdateOperation()
        {
        }

        internal NetworkExperimentProfileCreateOrUpdateOperation(ArmResource operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<Profile>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "NetworkExperimentProfileCreateOrUpdateOperation");
