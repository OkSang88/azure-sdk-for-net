...
{
    public partial class Sample_SensitivityLabelResource
    {
        ...
        public async Task Update_UpdatesTheSensitivityLabelOfAGivenColumnWithAllParameters()
        {
            ...
            // this example assumes you already have this SensitivityLabelResource created on azure
            // for more information of creating SensitivityLabelResource, please refer to the document of SensitivityLabelResource
            ...
            ArmOperation<SensitivityLabelResource> lro = await sensitivityLabel.UpdateAsync(WaitUntil.Completed, data);
        ...
        public async Task Delete_DeletesTheSensitivityLabelOfAGivenColumn()
        {
            ...
            // invoke the operation
            await sensitivityLabel.DeleteAsync(WaitUntil.Completed);
        ...
        public async Task Get_GetsTheSensitivityLabelOfAGivenColumn()
        {
            ...
            ResourceIdentifier sensitivityLabelResourceId = SensitivityLabelResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, workspaceName, sqlPoolName, schemaName, tableName, columnName, sensitivityLabelSource);
            SensitivityLabelResource sensitivityLabel = client.GetSensitivityLabelResource(sensitivityLabelResourceId);

            // invoke the operation
            SensitivityLabelResource result = await sensitivityLabel.GetAsync();
