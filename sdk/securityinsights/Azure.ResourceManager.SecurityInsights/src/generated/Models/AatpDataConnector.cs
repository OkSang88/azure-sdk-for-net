...
namespace SecurityInsights.Models
{
    ...
    public partial class AatpDataConnector : DataConnectorData
    {
        ...
        internal AatpDataConnector(ResourceIdentifier id, string name, ResourceType type, SystemData systemData, string etag, DataConnectorKind kind, string tenantId, AlertsDataTypeOfDataConnector dataTypes) : base(id, name, type, systemData, etag, kind)
        {
            TenantId = tenantId;
            DataTypes = dataTypes;
            Kind = kind;
