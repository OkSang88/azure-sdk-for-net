...
namespace LabServicesClient.Models
{
    ...
    {
        /// <summary> Initializes a new instance of LabServicesSkuCapacity. </summary>
        internal LabServicesSkuCapacity()
        {
        }
        ...
        internal LabServicesSkuCapacity(long? @default, long? minimum, long? maximum, ScaleType? scaleType)
        {
            Default = @default;
            Minimum = minimum;
            Maximum = maximum;
