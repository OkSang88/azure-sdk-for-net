...
namespace AzureMapsManagementClient.Tests.Mock
{
    ...
    public partial class CreatorMockTests : MockTestBase
    {
        ...
        public async Task Get()
        {
            ...
            var creatorId = AzureMapsManagementClient.Creator.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "myResourceGroup", "myMapsAccount", "myCreator");
        ...
        public async Task Update()
        {
            ...
            var creatorId = AzureMapsManagementClient.Creator.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "myResourceGroup", "myMapsAccount", "myCreator");
            var creator = GetArmClient().GetCreator(creatorId);
            AzureMapsManagementClient.Models.CreatorUpdateParameters creatorUpdateParameters = new AzureMapsManagementClient.Models.CreatorUpdateParameters()
            {
                StorageUnits = 10,
            };
