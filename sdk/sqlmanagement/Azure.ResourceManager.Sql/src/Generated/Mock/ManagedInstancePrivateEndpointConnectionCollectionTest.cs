...
namespace Azure.ResourceManager.Sql.Tests.Mock
{
    ...
    public partial class ManagedInstancePrivateEndpointConnectionCollectionMockTests : MockTestBase
    {
        ...
        public async Task CreateOrUpdateAsync()
        {
            ...
            var collection = GetArmClient().GetManagedInstance(new ResourceIdentifier("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/Default/providers/Microsoft.Sql/managedInstances/test-cl")).GetManagedInstancePrivateEndpointConnections();
