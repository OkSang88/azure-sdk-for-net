...
namespace Azure.ResourceManager.Monitor
{
    public partial class Sample_ActionGroupResource
    {
        ...
        {
            // Generated from example definition: specification/monitor/resource-manager/Microsoft.Insights/stable/2022-06-01/examples/deleteActionGroup.json
        ...
        {
            // Generated from example definition: specification/monitor/resource-manager/Microsoft.Insights/stable/2022-06-01/examples/patchActionGroup.json
...
["key2"] = "value2",
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task CreateNotifications_CreateNotificationsAtSubscriptionLevel()
        {
            // Generated from example definition: specification/monitor/resource-manager/Microsoft.Insights/stable/2022-06-01/examples/postTestNotifications.json
            // this example is just showing the usage of "ActionGroups_PostTestNotifications" operation, for the dependent resources, they will have to be created separately.
...
TenantId = Guid.Parse("68a4459a-ccb8-493c-b9da-dd30457d1b84"),
            ...
            ArmOperation<NotificationStatus> lro = await subscriptionResource.CreateNotificationsAsync(WaitUntil.Completed, content);
        ...
        {
            // Generated from example definition: specification/monitor/resource-manager/Microsoft.Insights/stable/2022-06-01/examples/postTestNotificationsAtResourceGroupLevel.json
            // this example is just showing the usage of "ActionGroups_CreateNotificationsAtResourceGroupLevel" operation, for the dependent resources, they will have to be created separately.
...
TenantId = Guid.Parse("68a4459a-ccb8-493c-b9da-dd30457d1b84"),
            ...
            ArmOperation<NotificationStatus> lro = await resourceGroupResource.CreateNotificationsAsync(WaitUntil.Completed, content);
            NotificationStatus result = lro.Value;
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task CreateNotifications_CreateNotificationsAtResourceGroupLevel1()
        {
            // Generated from example definition: specification/monitor/resource-manager/Microsoft.Insights/stable/2022-06-01/examples/postTestNotificationsAtActionGroupResourceLevel.json
...
TenantId = Guid.Parse("68a4459a-ccb8-493c-b9da-dd30457d1b84"),
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task GetNotificationStatus_GetNotificationDetailsAtSubscriptionLevel()
        {
            // Generated from example definition: specification/monitor/resource-manager/Microsoft.Insights/stable/2022-06-01/examples/getTestNotifications.json
            // this example is just showing the usage of "ActionGroups_GetTestNotifications" operation, for the dependent resources, they will have to be created separately.
            ...
            NotificationStatus result = await subscriptionResource.GetNotificationStatusAsync(notificationId);
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task GetNotificationStatus_GetNotificationDetailsAtResourceGroupLevel1()
        {
            // Generated from example definition: specification/monitor/resource-manager/Microsoft.Insights/stable/2022-06-01/examples/getTestNotificationsAtActionGroupResourceLevel.json
        ...
        {
            // Generated from example definition: specification/monitor/resource-manager/Microsoft.Insights/stable/2022-06-01/examples/enableReceiver.json
