...
namespace Azure.ResourceManager.FrontDoor
{
    ...
    public partial class ExperimentData : TrackedResource
    {
        ...
        internal ExperimentData(ResourceIdentifier id, string name, Azure.Core.ResourceType type, IDictionary<string, string> tags, AzureLocation location, string description, Endpoint endpointA, Endpoint endpointB, State? enabledState, NetworkExperimentResourceState? resourceState, string status, string scriptFileUri) : base(id, name, type, tags, location)
        {
