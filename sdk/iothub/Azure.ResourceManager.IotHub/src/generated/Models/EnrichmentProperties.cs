...
namespace IotHubClient.Models
{
    ...
    {
        /// <summary> Initializes a new instance of EnrichmentProperties. </summary>
        ...
        public EnrichmentProperties(string key, string value, IEnumerable<string> endpointNames)
        {
            if (key == null)
            {
        ...
        /// <param name="value"> The value for the enrichment property. </param>
        /// <param name="endpointNames"> The list of endpoints for which the enrichment is applied to the message. </param>
        internal EnrichmentProperties(string key, string value, IList<string> endpointNames)
        {
            Key = key;
            Value = value;
