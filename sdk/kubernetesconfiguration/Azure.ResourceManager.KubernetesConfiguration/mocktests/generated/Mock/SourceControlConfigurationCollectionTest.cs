...
namespace Azure.ResourceManager.KubernetesConfiguration.Tests.Mock
{
    ...
    public partial class SourceControlConfigurationCollectionMockTests : MockTestBase
    {
        ...
        public async Task CreateOrUpdate()
        {
            ...
            KubernetesConfiguration.SourceControlConfigurationData sourceControlConfiguration = new KubernetesConfiguration.SourceControlConfigurationData()
            {
                ...
                OperatorType = new KubernetesConfiguration.Models.OperatorType("Flux"),
                OperatorParams = "--git-email=xyzgituser@users.srs.github.com",
                OperatorScope = new KubernetesConfiguration.Models.OperatorScopeType("namespace"),
                ...
                HelmOperatorProperties = new KubernetesConfiguration.Models.HelmOperatorProperties()
                {
                    ChartVersion = "0.3.0",
