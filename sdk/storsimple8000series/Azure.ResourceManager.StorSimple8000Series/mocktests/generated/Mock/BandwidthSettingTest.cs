...
namespace Azure.ResourceManager.StorSimple8000Series.Tests.Mock.Tests.Mock
{
    ...
    public partial class BandwidthSettingMockTests : MockTestBase
    {
        ...
        public async Task Get()
        {
            ...
            var bandwidthSettingId = StorSimple8000Series.Tests.Mock.BandwidthSetting.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "ResourceGroupForSDKTest", "ManagerForSDKTest1", "bandwidthSetting1");
        ...
        public async Task Delete()
        {
            ...
            var bandwidthSettingId = StorSimple8000Series.Tests.Mock.BandwidthSetting.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "ResourceGroupForSDKTest", "ManagerForSDKTest1", "BWSForTest");
            var bandwidthSetting = GetArmClient().GetBandwidthSetting(bandwidthSettingId);
