# Azure ManagedNetwork Management client library for .NET
...
Install the Azure ManagedNetwork management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.ManagedNetwork -Version 1.0.0-preview.1 
```
