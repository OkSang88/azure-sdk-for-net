...
namespace Azure.ResourceManager.MachineLearning
{
    public partial class Sample_MachineLearningOnlineDeploymentCollection
    {
        ...
        {
            // Generated from example definition: specification/machinelearningservices/resource-manager/Microsoft.MachineLearningServices/stable/2022-10-01/examples/OnlineDeployment/list.json
        ...
        {
            // Generated from example definition: specification/machinelearningservices/resource-manager/Microsoft.MachineLearningServices/stable/2022-10-01/examples/OnlineDeployment/KubernetesOnlineDeployment/createOrUpdate.json
            ...
            // invoke the operation
            string deploymentName = "testDeploymentName";
            MachineLearningOnlineDeploymentData data = new MachineLearningOnlineDeploymentData(new AzureLocation("string"), new MachineLearningOnlineDeploymentProperties()
            {
                ...
                ScaleSettings = new MachineLearningOnlineScaleSettings()
                {
                ...
                Tags =
{
        ...
        {
            // Generated from example definition: specification/machinelearningservices/resource-manager/Microsoft.MachineLearningServices/stable/2022-10-01/examples/OnlineDeployment/ManagedOnlineDeployment/createOrUpdate.json
            // this example is just showing the usage of "OnlineDeployments_CreateOrUpdate" operation, for the dependent resources, they will have to be created separately.
            ...
            {
                AppInsightsEnabled = false,
                EndpointComputeType = MachineLearningEndpointComputeType.Managed,
                InstanceType = "string",
                LivenessProbe = new MachineLearningProbeSettings()
                {
                    FailureThreshold = 1,
