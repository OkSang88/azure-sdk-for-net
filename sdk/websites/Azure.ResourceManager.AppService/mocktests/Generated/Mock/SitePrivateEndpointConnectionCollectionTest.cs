...
namespace Azure.ResourceManager.AppService.Tests.Mock
{
    ...
    public partial class SitePrivateEndpointConnectionCollectionMockTests : MockTestBase
    {
        ...
        public async Task CreateOrUpdateAsync()
        {
            ...
            var collection = GetArmClient().GetWebSite(new ResourceIdentifier("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg/providers/Microsoft.Web/sites/testSite")).GetSitePrivateEndpointConnections();
