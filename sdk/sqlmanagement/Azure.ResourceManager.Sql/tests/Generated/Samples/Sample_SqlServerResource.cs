...
namespace Azure.ResourceManager.Sql.Samples
{
    public partial class Sample_SqlServerResource
    {
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task ExecuteSqlVulnerabilityAssessmentExecuteScan_ExecutesADatabaseSVulnerabilityAssessmentScan()
        {
            // Generated from example definition: specification/sql/resource-manager/Microsoft.Sql/preview/2022-02-01-preview/examples/SqlVulnerabilityAssessmentScansExecute.json
            // this example is just showing the usage of "SqlVulnerabilityAssessmentExecuteScan_Execute" operation, for the dependent resources, they will have to be created separately.
            ...
            await sqlServer.ExecuteSqlVulnerabilityAssessmentExecuteScanAsync(WaitUntil.Completed, vulnerabilityAssessmentName);
