...
{
    public partial class Sample_DnsMXRecordCollection
    {
        // Create A recordset
        ...
        public async Task CreateOrUpdate_CreateARecordset()
        {
            ...
            // get the collection of this DnsMXRecordResource
            DnsMXRecordCollection collection = dnsZone.GetDnsMXRecords();
...
IPv4Address = "127.0.0.1",
            ...
            ArmOperation<DnsMXRecordResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, relativeRecordSetName, data);
            DnsMXRecordResource result = lro.Value;
...
"string1","string2"
        ...
        public async Task Get_GetARecordset()
        {
            ...
            // invoke the operation
            string relativeRecordSetName = "record1";
            DnsMXRecordResource result = await collection.GetAsync(relativeRecordSetName);
        ...
        public async Task GetAll_ListARecordsets()
        {
            ...
            await foreach (DnsMXRecordResource item in collection.GetAllAsync())
            {
