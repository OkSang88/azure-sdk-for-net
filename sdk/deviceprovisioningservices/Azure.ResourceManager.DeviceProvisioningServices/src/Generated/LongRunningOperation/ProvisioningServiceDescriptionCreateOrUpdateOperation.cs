...
namespace Azure.ResourceManager.DeviceProvisioningServices.Models
{
    ...
    public partial class ProvisioningServiceDescriptionCreateOrUpdateOperation : Operation<ProvisioningServiceDescription>, IOperationSource<ProvisioningServiceDescription>
    {
        private readonly OperationInternals<ProvisioningServiceDescription> _operation;

        private readonly ArmResource _operationBase;

        /// <summary> Initializes a new instance of ProvisioningServiceDescriptionCreateOrUpdateOperation for mocking. </summary>
        protected ProvisioningServiceDescriptionCreateOrUpdateOperation()
        {
        }

        internal ProvisioningServiceDescriptionCreateOrUpdateOperation(ArmResource operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<ProvisioningServiceDescription>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "ProvisioningServiceDescriptionCreateOrUpdateOperation");
