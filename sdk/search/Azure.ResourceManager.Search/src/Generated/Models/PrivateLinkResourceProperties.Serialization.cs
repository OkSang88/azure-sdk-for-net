...
namespace Azure.ResourceManager.Search.Models
{
    public partial class PrivateLinkResourceProperties
    {
        internal static PrivateLinkResourceProperties DeserializePrivateLinkResourceProperties(JsonElement element)
        {
            ...
            return new PrivateLinkResourceProperties(groupId.Value, Optional.ToList(requiredMembers), Optional.ToList(requiredZoneNames), Optional.ToList(shareablePrivateLinkResourceTypes));
        }
    }
}
