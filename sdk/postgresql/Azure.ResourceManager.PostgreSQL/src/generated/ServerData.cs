...
namespace PostgreSQLManagementClient
{
    ...
    public partial class ServerData : TrackedResource
    {
        ...
        internal ServerData(ResourceIdentifier id, string name, ResourceType type, IDictionary<string, string> tags, AzureLocation location, Models.Sku sku, SystemData systemData, string administratorLogin, string administratorLoginPassword, ServerVersion? version, string minorVersion, ServerState? state, string fullyQualifiedDomainName, Storage storage, Backup backup, Network network, HighAvailability highAvailability, MaintenanceWindow maintenanceWindow, string sourceServerResourceId, DateTimeOffset? pointInTimeUTC, string availabilityZone, CreateMode? createMode) : base(id, name, type, tags, location)
        {
            Sku = sku;
