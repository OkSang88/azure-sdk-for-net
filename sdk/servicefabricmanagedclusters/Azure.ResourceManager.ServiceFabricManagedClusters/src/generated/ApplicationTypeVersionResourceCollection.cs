...
namespace ServiceFabricManagedClustersManagementClient
{
    ...
    public partial class ApplicationTypeVersionResourceCollection : ArmCollection, IEnumerable<ApplicationTypeVersionResource>, IAsyncEnumerable<ApplicationTypeVersionResource>
    {
        ...
        public virtual ApplicationTypeVersionCreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, string version, ApplicationTypeVersionResourceData parameters, CancellationToken cancellationToken = default)
        {
            if (version == null)
            {
            ...
            try
            {
                ...
                var operation = new ApplicationTypeVersionCreateOrUpdateOperation(Parent, _clientDiagnostics, Pipeline, _applicationTypeVersionsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, version, parameters).Request, response);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="version"/> or <paramref name="parameters"/> is null. </exception>
        public async virtual Task<ApplicationTypeVersionCreateOrUpdateOperation> CreateOrUpdateAsync(bool waitForCompletion, string version, ApplicationTypeVersionResourceData parameters, CancellationToken cancellationToken = default)
        {
            if (version == null)
            {
                throw new ArgumentNullException(nameof(version));
        ...
        public virtual Response<ApplicationTypeVersionResource> Get(string version, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new ApplicationTypeVersionResource(Parent, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual Pageable<ApplicationTypeVersionResource> GetAll(CancellationToken cancellationToken = default)
        {
            Page<ApplicationTypeVersionResource> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _applicationTypeVersionsRestClient.ListByApplicationTypes(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new ApplicationTypeVersionResource(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
            ...
            Page<ApplicationTypeVersionResource> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _applicationTypeVersionsRestClient.ListByApplicationTypesNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new ApplicationTypeVersionResource(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual AsyncPageable<ApplicationTypeVersionResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            async Task<Page<ApplicationTypeVersionResource>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _applicationTypeVersionsRestClient.ListByApplicationTypesAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new ApplicationTypeVersionResource(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            async Task<Page<ApplicationTypeVersionResource>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _applicationTypeVersionsRestClient.ListByApplicationTypesNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new ApplicationTypeVersionResource(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
