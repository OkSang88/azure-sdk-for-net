...
namespace AppPlatformManagementClient.Models
{
    ...
    public partial class JarUploadedUserSourceInfo : UploadedUserSourceInfo
    {
        ...
        internal JarUploadedUserSourceInfo(string type, string version, string relativePath, string runtimeVersion, string jvmOptions) : base(type, version, relativePath)
        {
