...
namespace Azure.ResourceManager.Authorization
{
    internal partial class AccessReviewScheduleDefinitionsRestOperations
    {
        ...
        public AccessReviewScheduleDefinitionsRestOperations(HttpPipeline pipeline, string applicationId, Uri endpoint = null, string apiVersion = default)
        {
        ...
        /// <exception cref="ArgumentException"> <paramref name="subscriptionId"/> or <paramref name="scheduleDefinitionId"/> is an empty string, and was expected to be non-empty. </exception>
