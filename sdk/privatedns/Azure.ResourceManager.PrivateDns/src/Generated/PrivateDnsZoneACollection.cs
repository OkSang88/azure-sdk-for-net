...
namespace Azure.ResourceManager.PrivateDns
{
    ...
    public partial class PrivateDnsZoneACollection : ArmCollection, IEnumerable<PrivateDnsZoneA>, IAsyncEnumerable<PrivateDnsZoneA>
    {
        ...
        internal PrivateDnsZoneACollection(ArmResource parent) : base(parent)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            ClientOptions.TryGetApiVersion(PrivateDnsZoneA.ResourceType, out string apiVersion);
        ...
        public virtual PrivateDnsZoneACreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, string relativeRecordSetName, RecordSetData parameters, string ifMatch = null, string ifNoneMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("PrivateDnsZoneACollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                var operation = new PrivateDnsZoneACreateOrUpdateOperation(this, response);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="relativeRecordSetName"/> or <paramref name="parameters"/> is null. </exception>
        public async virtual Task<PrivateDnsZoneACreateOrUpdateOperation> CreateOrUpdateAsync(bool waitForCompletion, string relativeRecordSetName, RecordSetData parameters, string ifMatch = null, string ifNoneMatch = null, CancellationToken cancellationToken = default)
        {
            if (relativeRecordSetName == null)
            {
                throw new ArgumentNullException(nameof(relativeRecordSetName));
        ...
        public virtual Response<PrivateDnsZoneA> Get(string relativeRecordSetName, CancellationToken cancellationToken = default)
        {
            if (relativeRecordSetName == null)
            {
                throw new ArgumentNullException(nameof(relativeRecordSetName));
            ...
            using var scope = _clientDiagnostics.CreateScope("PrivateDnsZoneACollection.Get");
            scope.Start();
            try
            {
                ...
                return Response.FromValue(new PrivateDnsZoneA(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="relativeRecordSetName"/> is null. </exception>
        public async virtual Task<Response<PrivateDnsZoneA>> GetAsync(string relativeRecordSetName, CancellationToken cancellationToken = default)
        {
            if (relativeRecordSetName == null)
            {
                throw new ArgumentNullException(nameof(relativeRecordSetName));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="relativeRecordSetName"/> is null. </exception>
        public virtual Response<PrivateDnsZoneA> GetIfExists(string relativeRecordSetName, CancellationToken cancellationToken = default)
        {
            if (relativeRecordSetName == null)
            {
                throw new ArgumentNullException(nameof(relativeRecordSetName));
            ...
            using var scope = _clientDiagnostics.CreateScope("PrivateDnsZoneACollection.GetIfExists");
            scope.Start();
            try
            {
                ...
                if (response.Value == null)
                    return Response.FromValue<PrivateDnsZoneA>(null, response.GetRawResponse());
                return Response.FromValue(new PrivateDnsZoneA(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="relativeRecordSetName"/> is null. </exception>
        public async virtual Task<Response<PrivateDnsZoneA>> GetIfExistsAsync(string relativeRecordSetName, CancellationToken cancellationToken = default)
        {
            if (relativeRecordSetName == null)
            {
                throw new ArgumentNullException(nameof(relativeRecordSetName));
        ...
        public virtual Response<bool> Exists(string relativeRecordSetName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("PrivateDnsZoneACollection.Exists");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="PrivateDnsZoneA" /> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<PrivateDnsZoneA> GetAll(int? top = null, string recordsetnamesuffix = null, CancellationToken cancellationToken = default)
        {
            Page<PrivateDnsZoneA> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _clientDiagnostics.CreateScope("PrivateDnsZoneACollection.GetAll");
                scope.Start();
                try
                {
                    ...
                    return Page.FromValues(response.Value.Value.Select(value => new PrivateDnsZoneA(this, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
            ...
            Page<PrivateDnsZoneA> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _clientDiagnostics.CreateScope("PrivateDnsZoneACollection.GetAll");
                scope.Start();
                try
        ...
        /// <param name="recordsetnamesuffix"> The suffix label of the record set name to be used to filter the record set enumeration. If this parameter is specified, the returned enumeration will only contain records that end with &quot;.&lt;recordsetnamesuffix&gt;&quot;. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> An async collection of <see cref="PrivateDnsZoneA" /> that may take multiple service requests to iterate over. </returns>
        public virtual AsyncPageable<PrivateDnsZoneA> GetAllAsync(int? top = null, string recordsetnamesuffix = null, CancellationToken cancellationToken = default)
        {
            async Task<Page<PrivateDnsZoneA>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _clientDiagnostics.CreateScope("PrivateDnsZoneACollection.GetAll");
                scope.Start();
                try
            ...
            async Task<Page<PrivateDnsZoneA>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _clientDiagnostics.CreateScope("PrivateDnsZoneACollection.GetAll");
                scope.Start();
                try
        ...
        IEnumerator<PrivateDnsZoneA> IEnumerable<PrivateDnsZoneA>.GetEnumerator()
        {
        ...
        IAsyncEnumerator<PrivateDnsZoneA> IAsyncEnumerable<PrivateDnsZoneA>.GetAsyncEnumerator(CancellationToken cancellationToken)
        {
            return GetAllAsync(cancellationToken: cancellationToken).GetAsyncEnumerator(cancellationToken);
        }

        // Builders.
        // public ArmBuilder<Azure.Core.ResourceIdentifier, PrivateDnsZoneA, RecordSetData> Construct() { }
    }
}
