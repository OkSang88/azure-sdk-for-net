...
Value = "NotePad,sql",
        ...
        public async Task GetGuestConfigurationAssignments_ListAllGuestConfigurationAssignmentsForASubscription()
        {
            ...
            await foreach (GuestConfigurationAssignmentData item in subscriptionResource.GetGuestConfigurationAssignmentsAsync())
            {
                // for demo we just print out the id
        ...
        public async Task GetGuestConfigurationAssignments_ListAllGuestConfigurationAssignmentsForAResourceGroup()
        {
            ...
            // invoke the operation and iterate over the result
            await foreach (GuestConfigurationAssignmentData item in resourceGroupResource.GetGuestConfigurationAssignmentsAsync())
            {
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {item.Id}");
            }
