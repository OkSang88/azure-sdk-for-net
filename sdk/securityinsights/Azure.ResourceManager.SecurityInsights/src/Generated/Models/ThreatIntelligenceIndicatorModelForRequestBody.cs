...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    {
        /// <summary> Initializes a new instance of ThreatIntelligenceIndicatorModelForRequestBody. </summary>
        /// <param name="kind"> The kind of the entity. </param>
        public ThreatIntelligenceIndicatorModelForRequestBody(ThreatIntelligenceResourceKindEnum kind) : base(kind)
        {
        ...
        internal ThreatIntelligenceIndicatorModelForRequestBody(ThreatIntelligenceResourceKindEnum kind, string etag, IReadOnlyDictionary<string, object> additionalData, string friendlyName, IList<string> threatIntelligenceTags, string lastUpdatedTimeUtc, string source, string displayName, string description, IList<string> indicatorTypes, string pattern, string patternType, string patternVersion, IList<ThreatIntelligenceKillChainPhase> killChainPhases, IList<ThreatIntelligenceParsedPattern> parsedPattern, string externalId, string createdByRef, bool? defanged, string externalLastUpdatedTimeUtc, IList<ThreatIntelligenceExternalReference> externalReferences, IList<ThreatIntelligenceGranularMarkingModel> granularMarkings, IList<string> labels, bool? revoked, int? confidence, IList<string> objectMarkingRefs, string language, IList<string> threatTypes, string validFrom, string validUntil, string created, string modified, IDictionary<string, object> extensions) : base(kind)
        {
            Etag = etag;
