...
namespace Azure.ResourceManager.IotHub.Tests.Mock
{
    ...
    public partial class CertificateDescriptionCollectionMockTests : MockTestBase
    {
        ...
        public async Task CreateOrUpdate()
        {
            ...
            IotHub.CertificateDescriptionData certificateDescription = new IotHub.CertificateDescriptionData()
            {
                Properties = new IotHub.Models.CertificateProperties()
                {
                    Certificate = "############################################",
                },
            };
            ...
            var iotHubDescriptionId = IotHub.IotHubDescription.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "myResourceGroup", "iothub");
