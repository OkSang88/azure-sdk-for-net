...
{
    public partial class FactoryData : IUtf8JsonSerializable
    {
        ...
        internal static FactoryData DeserializeFactoryData(JsonElement element)
        {
            ...
            return new FactoryData(id, name, type, tags, location, eTag.Value, identity.Value, provisioningState.Value, Optional.ToNullable(createTime), version.Value, repoConfiguration.Value, Optional.ToDictionary(globalParameters), encryption.Value, Optional.ToNullable(publicNetworkAccess), additionalProperties);
        }
    }
}
