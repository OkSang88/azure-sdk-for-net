...
namespace ServiceFabricManagedClustersManagementClient.Models
{
    ...
    public partial class ServiceCreateOrUpdateOperation : Operation<ServiceResource>, IOperationSource<ServiceResource>
    {
        ...
        {
            _operation = new OperationInternals<ServiceResource>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "ServiceCreateOrUpdateOperation");
