...
namespace Azure.ResourceManager.LabServices.Tests.Mock.Tests.Mock
{
    ...
    public partial class VirtualMachineMockTests : MockTestBase
    {
        ...
        public async Task Get()
        {
            ...
            var virtualMachineId = LabServices.Tests.Mock.VirtualMachine.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "testrg123", "testlab", "template");
        ...
        public async Task ResetPassword()
        {
            ...
            var virtualMachineId = LabServices.Tests.Mock.VirtualMachine.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "testrg123", "testlab", "template");
            var virtualMachine = GetArmClient().GetVirtualMachine(virtualMachineId);
            LabServices.Tests.Mock.Models.ResetPasswordBody body = new LabServices.Tests.Mock.Models.ResetPasswordBody(username: "example-username", password: "example-password");
