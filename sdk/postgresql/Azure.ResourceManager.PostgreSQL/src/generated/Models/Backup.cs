...
namespace PostgreSQLManagementClient.Models
{
    ...
    public partial class Backup
    {
        ...
        /// <param name="earliestRestoreDate"> The earliest restore point time (ISO8601 format) for server. </param>
        internal Backup(int? backupRetentionDays, GeoRedundantBackupEnum? geoRedundantBackup, DateTimeOffset? earliestRestoreDate)
        {
