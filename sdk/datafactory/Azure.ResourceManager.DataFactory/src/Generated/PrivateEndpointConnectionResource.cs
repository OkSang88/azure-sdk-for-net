...
namespace Azure.ResourceManager.DataFactory
{
    ...
    public partial class PrivateEndpointConnectionResource : ArmResource
    {
        ...
        internal PrivateEndpointConnectionResource(ArmResource options, PrivateEndpointConnectionResourceData data) : base(options, data.Id)
        {
            HasData = true;
            _data = data;
        ...
        internal PrivateEndpointConnectionResource(ArmResource options, ResourceIdentifier id) : base(options, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            ClientOptions.TryGetApiVersion(ResourceType, out string apiVersion);
            _privateEndpointConnectionRestClient = new PrivateEndpointConnectionRestOperations(_clientDiagnostics, Pipeline, ClientOptions, BaseUri, apiVersion);
        ...
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal PrivateEndpointConnectionResource(ArmClientOptions clientOptions, TokenCredential credential, Uri uri, HttpPipeline pipeline, ResourceIdentifier id) : base(clientOptions, credential, uri, pipeline, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            ClientOptions.TryGetApiVersion(ResourceType, out string apiVersion);
            _privateEndpointConnectionRestClient = new PrivateEndpointConnectionRestOperations(_clientDiagnostics, Pipeline, ClientOptions, BaseUri, apiVersion);
        ...
        public async virtual Task<Response<PrivateEndpointConnectionResource>> GetAsync(string ifNoneMatch = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("PrivateEndpointConnectionResource.Get");
            scope.Start();
            try
            {
                var response = await _privateEndpointConnectionRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, ifNoneMatch, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<PrivateEndpointConnectionResource> Get(string ifNoneMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _privateEndpointConnectionRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, ifNoneMatch, cancellationToken);
                if (response.Value == null)
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("PrivateEndpointConnectionResource.GetAvailableLocations");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async virtual Task<PrivateEndpointConnectionResourceDeleteOperation> DeleteAsync(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("PrivateEndpointConnectionResource.Delete");
            scope.Start();
            try
            {
                ...
                var operation = new PrivateEndpointConnectionResourceDeleteOperation(response);
        ...
        /// <param name="waitForCompletion"> Waits for the completion of the long running operations. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual PrivateEndpointConnectionResourceDeleteOperation Delete(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("PrivateEndpointConnectionResource.Delete");
            scope.Start();
            try
