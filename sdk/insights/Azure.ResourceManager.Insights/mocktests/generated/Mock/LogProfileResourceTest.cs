...
namespace Insights.Tests.Mock
{
    ...
    public partial class LogProfileResourceMockTests : MockTestBase
    {
        ...
        public async Task GetAsync()
        {
            ...
            var logProfileResource = GetArmClient().GetLogProfileResource(new ResourceIdentifier("/subscriptions/00000000-0000-0000-0000-000000000000/providers/microsoft.insights/logprofiles/default"));
        ...
        public async Task DeleteAsync()
        {
            ...
            var logProfileResource = GetArmClient().GetLogProfileResource(new ResourceIdentifier("/subscriptions/00000000-0000-0000-0000-000000000000/providers/microsoft.insights/logprofiles/Rac46PostSwapRG"));
