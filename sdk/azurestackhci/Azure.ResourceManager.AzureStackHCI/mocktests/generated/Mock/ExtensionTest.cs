...
namespace AzureStackHCIClient.Tests.Mock
{
    ...
    public partial class ExtensionMockTests : MockTestBase
    {
        ...
        public async Task Get()
        {
            ...
            var extensionId = AzureStackHCIClient.Extension.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "test-rg", "myCluster", "default", "MicrosoftMonitoringAgent");
        ...
        public async Task Update()
        {
            ...
            var extensionId = AzureStackHCIClient.Extension.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "test-rg", "myCluster", "default", "MicrosoftMonitoringAgent");
            var extension = GetArmClient().GetExtension(extensionId);
            AzureStackHCIClient.ExtensionData extension2 = new AzureStackHCIClient.ExtensionData()
            {
