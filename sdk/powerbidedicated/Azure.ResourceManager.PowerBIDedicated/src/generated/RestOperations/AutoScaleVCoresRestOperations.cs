...
namespace PowerBIDedicated
{
    internal partial class AutoScaleVCoresRestOperations
    {
        ...
        public AutoScaleVCoresRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ClientOptions options, Uri endpoint = null, string apiVersion = "2021-01-01")
        {
        ...
        internal HttpMessage CreateCreateRequest(string subscriptionId, string resourceGroupName, string vcoreName, AutoScaleVCoreData vCoreParameters)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="subscriptionId"/>, <paramref name="resourceGroupName"/>, <paramref name="vcoreName"/>, or <paramref name="vCoreParameters"/> is null. </exception>
        public async Task<Response<AutoScaleVCoreData>> CreateAsync(string subscriptionId, string resourceGroupName, string vcoreName, AutoScaleVCoreData vCoreParameters, CancellationToken cancellationToken = default)
        {
            if (subscriptionId == null)
            {
                throw new ArgumentNullException(nameof(subscriptionId));
            ...
            using var message = CreateCreateRequest(subscriptionId, resourceGroupName, vcoreName, vCoreParameters);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="subscriptionId"/>, <paramref name="resourceGroupName"/>, <paramref name="vcoreName"/>, or <paramref name="vCoreParameters"/> is null. </exception>
        public Response<AutoScaleVCoreData> Create(string subscriptionId, string resourceGroupName, string vcoreName, AutoScaleVCoreData vCoreParameters, CancellationToken cancellationToken = default)
        {
            if (subscriptionId == null)
            {
                throw new ArgumentNullException(nameof(subscriptionId));
        ...
        internal HttpMessage CreateUpdateRequest(string subscriptionId, string resourceGroupName, string vcoreName, AutoScaleVCoreUpdateParameters vCoreUpdateParameters)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="subscriptionId"/>, <paramref name="resourceGroupName"/>, <paramref name="vcoreName"/>, or <paramref name="vCoreUpdateParameters"/> is null. </exception>
        public async Task<Response<AutoScaleVCoreData>> UpdateAsync(string subscriptionId, string resourceGroupName, string vcoreName, AutoScaleVCoreUpdateParameters vCoreUpdateParameters, CancellationToken cancellationToken = default)
        {
            if (subscriptionId == null)
            {
                throw new ArgumentNullException(nameof(subscriptionId));
            ...
            using var message = CreateUpdateRequest(subscriptionId, resourceGroupName, vcoreName, vCoreUpdateParameters);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="subscriptionId"/>, <paramref name="resourceGroupName"/>, <paramref name="vcoreName"/>, or <paramref name="vCoreUpdateParameters"/> is null. </exception>
        public Response<AutoScaleVCoreData> Update(string subscriptionId, string resourceGroupName, string vcoreName, AutoScaleVCoreUpdateParameters vCoreUpdateParameters, CancellationToken cancellationToken = default)
        {
            if (subscriptionId == null)
            {
                throw new ArgumentNullException(nameof(subscriptionId));
