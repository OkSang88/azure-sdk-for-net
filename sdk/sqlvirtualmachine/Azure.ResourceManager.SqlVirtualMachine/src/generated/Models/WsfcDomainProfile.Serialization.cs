...
namespace SqlVirtualMachineManagementClient.Models
{
    public partial class WsfcDomainProfile : IUtf8JsonSerializable
    {
        ...
        internal static WsfcDomainProfile DeserializeWsfcDomainProfile(JsonElement element)
        {
            ...
            return new WsfcDomainProfile(domainFqdn.Value, ouPath.Value, clusterBootstrapAccount.Value, clusterOperatorAccount.Value, sqlServiceAccount.Value, fileShareWitnessPath.Value, storageAccountUrl.Value, storageAccountPrimaryKey.Value);
        }
    }
}
