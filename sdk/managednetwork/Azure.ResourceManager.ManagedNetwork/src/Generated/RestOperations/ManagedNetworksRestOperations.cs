...
namespace Azure.ResourceManager.ManagedNetwork
{
    internal partial class ManagedNetworksRestOperations
    {
        ...
        public ManagedNetworksRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, Uri endpoint = null, string apiVersion = default)
        {
