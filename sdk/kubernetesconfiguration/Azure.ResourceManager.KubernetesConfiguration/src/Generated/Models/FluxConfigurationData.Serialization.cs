...
namespace Azure.ResourceManager.KubernetesConfiguration
{
    public partial class FluxConfigurationData : IUtf8JsonSerializable
    {
        ...
        internal static FluxConfigurationData DeserializeFluxConfigurationData(JsonElement element)
        {
            ...
            Optional<string> lastSourceUpdatedCommitId = default;
            Optional<DateTimeOffset?> lastSourceUpdatedAt = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("lastSourceUpdatedCommitId"))
                        {
                            if (property0.Value.ValueKind == JsonValueKind.Null)
                            {
                                lastSourceUpdatedCommitId = null;
                                continue;
                            }
                            lastSourceUpdatedCommitId = property0.Value.GetString();
                            continue;
                        }
                        if (property0.NameEquals("lastSourceUpdatedAt"))
                        {
                            if (property0.Value.ValueKind == JsonValueKind.Null)
                            {
                            ...
                            lastSourceUpdatedAt = property0.Value.GetDateTimeOffset("O");
                            continue;
                        }
            ...
            return new FluxConfigurationData(id, name, type, systemData, Optional.ToNullable(scope), @namespace.Value, Optional.ToNullable(sourceKind), Optional.ToNullable(suspend), gitRepository.Value, bucket.Value, Optional.ToDictionary(kustomizations), Optional.ToDictionary(configurationProtectedSettings), Optional.ToList(statuses), repositoryPublicKey.Value, lastSourceUpdatedCommitId.Value, Optional.ToNullable(lastSourceUpdatedAt), Optional.ToNullable(complianceState), Optional.ToNullable(provisioningState), errorMessage.Value);
        }
    }
}
