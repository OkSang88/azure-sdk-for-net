...
namespace Azure.ResourceManager.Batch.Tests.Mock.Tests.Mock
{
    ...
    public partial class BatchAccountCollectionMockTests : MockTestBase
    {
        ...
        public async Task CreateOrUpdate()
        {
            ...
            Batch.Tests.Mock.Models.BatchAccountCreateParameters parameters = new Batch.Tests.Mock.Models.BatchAccountCreateParameters(location: "japaneast")
            {
                ...
                PoolAllocationMode = Batch.Tests.Mock.Models.PoolAllocationMode.UserSubscription,
                KeyVaultReference = new Batch.Tests.Mock.Models.KeyVaultReference(id: "/subscriptions/subid/resourceGroups/default-azurebatch-japaneast/providers/Microsoft.KeyVault/vaults/sample", url: "http://sample.vault.azure.net/"),
            };
        ...
        public async Task CreateOrUpdate5()
        {
            ...
            Batch.Tests.Mock.Models.BatchAccountCreateParameters parameters = new Batch.Tests.Mock.Models.BatchAccountCreateParameters(location: "japaneast")
            {
                AutoStorage = new Batch.Tests.Mock.Models.AutoStorageBaseProperties(storageAccountId: "/subscriptions/subid/resourceGroups/default-azurebatch-japaneast/providers/Microsoft.Storage/storageAccounts/samplestorage"),
                KeyVaultReference = new Batch.Tests.Mock.Models.KeyVaultReference(id: "/subscriptions/subid/resourceGroups/default-azurebatch-japaneast/providers/Microsoft.KeyVault/vaults/sample", url: "http://sample.vault.azure.net/"),
                PublicNetworkAccess = Batch.Tests.Mock.Models.PublicNetworkAccessType.Disabled,
            };
