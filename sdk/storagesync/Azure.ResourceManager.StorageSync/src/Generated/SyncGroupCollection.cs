...
namespace Azure.ResourceManager.StorageSync
{
    ...
    public partial class SyncGroupCollection : ArmCollection, IEnumerable<SyncGroup>, IAsyncEnumerable<SyncGroup>
    {
        ...
        public virtual SyncGroupCreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, string syncGroupName, SyncGroupCreateParameters parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new SyncGroupCreateOrUpdateOperation(this, response);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="syncGroupName"/> or <paramref name="parameters"/> is null. </exception>
        public async virtual Task<SyncGroupCreateOrUpdateOperation> CreateOrUpdateAsync(bool waitForCompletion, string syncGroupName, SyncGroupCreateParameters parameters, CancellationToken cancellationToken = default)
        {
            if (syncGroupName == null)
            {
                throw new ArgumentNullException(nameof(syncGroupName));
        ...
        public virtual Pageable<SyncGroup> GetAll(CancellationToken cancellationToken = default)
        {
            Page<SyncGroup> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    ...
                    return Page.FromValues(response.Value.Value.Select(value => new SyncGroup(this, value)), null, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
