...
namespace RedisManagementClient.Models
{
    ...
    public partial class PrivateEndpointConnectionPutOperation : Operation<PrivateEndpointConnection>, IOperationSource<PrivateEndpointConnection>
    {
        ...
        internal PrivateEndpointConnectionPutOperation(ArmResource operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<PrivateEndpointConnection>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "PrivateEndpointConnectionPutOperation");
