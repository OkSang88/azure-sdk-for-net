...
namespace PrivateDnsManagementClient
{
    public partial class VirtualNetworkLinkData : IUtf8JsonSerializable
    {
        ...
        internal static VirtualNetworkLinkData DeserializeVirtualNetworkLinkData(JsonElement element)
        {
            ...
            return new VirtualNetworkLinkData(id, name, type, tags, location, etag.Value, virtualNetwork, Optional.ToNullable(registrationEnabled), Optional.ToNullable(virtualNetworkLinkState), Optional.ToNullable(provisioningState));
        }
    }
}
