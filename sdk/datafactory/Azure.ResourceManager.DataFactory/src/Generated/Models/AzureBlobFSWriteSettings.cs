...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AzureBlobFSWriteSettings : StoreWriteSettings
    {
        ...
        internal AzureBlobFSWriteSettings(string type, object maxConcurrentConnections, object disableMetricsCollection, object copyBehavior, IDictionary<string, object> additionalProperties, object blockSizeInMB) : base(type, maxConcurrentConnections, disableMetricsCollection, copyBehavior, additionalProperties)
        {
