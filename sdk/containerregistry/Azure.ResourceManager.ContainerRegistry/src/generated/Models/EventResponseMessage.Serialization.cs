...
namespace ContainerRegistryManagementClient.Models
{
    ...
    {
        internal static EventResponseMessage DeserializeEventResponseMessage(JsonElement element)
        {
            ...
            return new EventResponseMessage(content.Value, Optional.ToDictionary(headers), reasonPhrase.Value, statusCode.Value, version.Value);
        }
    }
}
