# Azure SecurityCenter Management client library for .NET
...
Install the Azure SecurityCenter management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.SecurityCenter -Version 1.0.0-preview.1 
```
