...
namespace Azure.ResourceManager.Marketplace.Tests.Mock.Tests.Mock
{
    ...
    public partial class CollectionMockTests : MockTestBase
    {
        ...
        public async Task Delete()
        {
            ...
            var collectionId = Marketplace.Tests.Mock.Collection.CreateResourceIdentifier("a0e28e55-90c4-41d8-8e34-bb7ef7775406", "d0f5aa2c-ecc3-4d87-906a-f8c486dcc4f1");
            var collection = GetArmClient().GetCollection(collectionId);
        ...
        public async Task TransferOffers()
        {
            ...
            var collectionId = Marketplace.Tests.Mock.Collection.CreateResourceIdentifier("a0e28e55-90c4-41d8-8e34-bb7ef7775406", "56a1a02d-8cf8-45df-bf37-d5f7120fcb3d");
            var collection = GetArmClient().GetCollection(collectionId);
            Marketplace.Tests.Mock.Models.TransferOffersProperties payload = new Marketplace.Tests.Mock.Models.TransferOffersProperties()
            {
                Operation = "copy",
            };
