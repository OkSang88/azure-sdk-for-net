...
namespace Azure.ResourceManager.AppPlatform
{
    ...
    public partial class ServiceRegistryResourceData : ProxyResource
    {
        ...
        internal ServiceRegistryResourceData(ResourceIdentifier id, string name, ResourceType type, SystemData systemData, ServiceRegistryProperties properties) : base(id, name, type, systemData)
        {
