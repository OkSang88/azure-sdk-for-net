...
namespace Azure.ResourceManager.Logz.Tests.Mock
{
    ...
    public partial class MonitorAccountMockTests : MockTestBase
    {
        ...
        public async Task Get()
        {
            ...
            var monitorAccountId = Logz.MonitorAccount.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "myResourceGroup", "myMonitor", "SubAccount1");
        ...
        public async Task Delete()
        {
            ...
            var monitorAccountId = Logz.MonitorAccount.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "myResourceGroup", "myMonitor", "someName");
            var monitorAccount = GetArmClient().GetMonitorAccount(monitorAccountId);
