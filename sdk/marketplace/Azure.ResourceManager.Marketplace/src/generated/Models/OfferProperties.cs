...
namespace MarketplaceRPService.Models
{
    ...
    public partial class OfferProperties
    {
        ...
        internal OfferProperties(string uniqueOfferId, string offerDisplayName, string publisherDisplayName, string eTag, string privateStoreId, string createdAt, string modifiedAt, IReadOnlyList<string> specificPlanIdsLimitation, bool? updateSuppressedDueIdempotence, IReadOnlyDictionary<string, string> iconFileUris, IReadOnlyList<Plan> plans)
        {
