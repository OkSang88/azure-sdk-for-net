...
namespace Azure.ResourceManager.NotificationHubs.Tests.Mock
{
    ...
    public partial class NamespaceNotificationHubAuthorizationRuleMockTests : MockTestBase
    {
        ...
        public async Task Get()
        {
            ...
            var namespaceNotificationHubAuthorizationRuleId = NotificationHubs.NamespaceNotificationHubAuthorizationRule.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "5ktrial", "nh-sdk-ns", "nh-sdk-hub", "DefaultListenSharedAccessSignature");
        ...
        public async Task GetKeys()
        {
            ...
            var namespaceNotificationHubAuthorizationRuleId = NotificationHubs.NamespaceNotificationHubAuthorizationRule.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "5ktrial", "nh-sdk-ns", "nh-sdk-hub", "sdk-AuthRules-5800");
            var namespaceNotificationHubAuthorizationRule = GetArmClient().GetNamespaceNotificationHubAuthorizationRule(namespaceNotificationHubAuthorizationRuleId);
        ...
        public async Task RegenerateKeys()
        {
            ...
            var namespaceNotificationHubAuthorizationRuleId = NotificationHubs.NamespaceNotificationHubAuthorizationRule.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "5ktrial", "nh-sdk-ns", "nh-sdk-hub", "DefaultListenSharedAccessSignature");
            var namespaceNotificationHubAuthorizationRule = GetArmClient().GetNamespaceNotificationHubAuthorizationRule(namespaceNotificationHubAuthorizationRuleId);
            NotificationHubs.Models.PolicykeyResource parameters = new NotificationHubs.Models.PolicykeyResource()
            {
