...
namespace ServiceFabricManagedClustersManagementClient.Models
{
    ...
    {
        /// <summary> Initializes a new instance of PartitionInstanceCountScaleMechanism. </summary>
        ...
        /// <param name="maxInstanceCount"> Maximum number of instances of the partition. </param>
        /// <param name="scaleIncrement"> The number of instances to add or remove during a scaling operation. </param>
        internal PartitionInstanceCountScaleMechanism(ServiceScalingMechanismKind kind, int minInstanceCount, int maxInstanceCount, int scaleIncrement) : base(kind)
        {
            MinInstanceCount = minInstanceCount;
            MaxInstanceCount = maxInstanceCount;
            ScaleIncrement = scaleIncrement;
