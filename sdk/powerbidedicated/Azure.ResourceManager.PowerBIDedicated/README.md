# Azure PowerBIDedicated Management client library for .NET
...
Install the Azure PowerBIDedicated management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.PowerBIDedicated -Version 1.0.0-preview.1 
```
