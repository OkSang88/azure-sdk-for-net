...
namespace AzureAgriFoodRPService.Models
{
    ...
    {
        internal static FarmBeatsExtensionListResponse DeserializeFarmBeatsExtensionListResponse(JsonElement element)
        {
            ...
            return new FarmBeatsExtensionListResponse(Optional.ToList(value), nextLink.Value);
        }
    }
}
