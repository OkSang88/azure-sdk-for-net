...
namespace AzureStackHCIClient
{
    ...
    public partial class ArcSettingCollection : ArmCollection, IEnumerable<ArcSetting>, IAsyncEnumerable<ArcSetting>
    {
        ...
        public virtual ArcSettingCreateOperation CreateOrUpdate(bool waitForCompletion, string arcSettingName, ArcSettingData arcSetting, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="arcSettingName"/> or <paramref name="arcSetting"/> is null. </exception>
        public async virtual Task<ArcSettingCreateOperation> CreateOrUpdateAsync(bool waitForCompletion, string arcSettingName, ArcSettingData arcSetting, CancellationToken cancellationToken = default)
        {
            if (arcSettingName == null)
            {
                throw new ArgumentNullException(nameof(arcSettingName));
