...
namespace IotHubClient.Models
{
    public partial class RoutingServiceBusQueueEndpointProperties : IUtf8JsonSerializable
    {
        ...
        internal static RoutingServiceBusQueueEndpointProperties DeserializeRoutingServiceBusQueueEndpointProperties(JsonElement element)
        {
            ...
            return new RoutingServiceBusQueueEndpointProperties(id.Value, connectionString.Value, endpointUri.Value, entityPath.Value, Optional.ToNullable(authenticationType), identity.Value, name, subscriptionId.Value, resourceGroup.Value);
        }
    }
}
