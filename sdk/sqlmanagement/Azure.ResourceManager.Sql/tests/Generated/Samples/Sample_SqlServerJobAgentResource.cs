...
["mytag1"] = "myvalue1",
        ...
        public async Task GetJobExecutionsByAgent_ListAllJobExecutionsInAJobAgentWithFiltering()
        {
            ...
            bool? isActive = false;
            await foreach (SqlServerJobExecutionResource item in sqlServerJobAgent.GetJobExecutionsByAgentAsync(createTimeMin: createTimeMin, createTimeMax: createTimeMax, endTimeMin: endTimeMin, endTimeMax: endTimeMax, isActive: isActive))
            {
        ...
        public async Task GetJobExecutionsByAgent_ListAllJobExecutionsInAJobAgent()
        {
            ...
            // invoke the operation and iterate over the result
            await foreach (SqlServerJobExecutionResource item in sqlServerJobAgent.GetJobExecutionsByAgentAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                SqlServerJobExecutionData resourceData = item.Data;
