...
namespace ContainerRegistryManagementClient.Models
{
    public partial class KeyVaultProperties : IUtf8JsonSerializable
    {
        ...
        internal static KeyVaultProperties DeserializeKeyVaultProperties(JsonElement element)
        {
            ...
            return new KeyVaultProperties(keyIdentifier.Value, versionedKeyIdentifier.Value, identity.Value, Optional.ToNullable(keyRotationEnabled), Optional.ToNullable(lastKeyRotationTimestamp));
        }
    }
}
