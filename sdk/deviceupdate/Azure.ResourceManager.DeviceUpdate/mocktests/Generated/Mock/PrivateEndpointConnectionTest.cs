...
namespace Azure.ResourceManager.DeviceUpdate.Tests.Mock
{
    ...
    public partial class PrivateEndpointConnectionMockTests : MockTestBase
    {
        ...
        public async Task GetAsync()
        {
            ...
            var privateEndpointConnection = GetArmClient().GetPrivateEndpointConnection(new ResourceIdentifier("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/test-rg/providers/Microsoft.DeviceUpdate/accounts/contoso/privateEndpointConnections/peexample01"));
