...
{
    public partial class HubAndSpokePeeringPolicyProperties : IUtf8JsonSerializable
    {
        ...
        internal static HubAndSpokePeeringPolicyProperties DeserializeHubAndSpokePeeringPolicyProperties(JsonElement element)
        {
            Type type = default;
            ...
            return new HubAndSpokePeeringPolicyProperties(Optional.ToNullable(provisioningState), etag.Value, type, hub, Optional.ToList(spokes), Optional.ToList(mesh));
        }
    }
}
