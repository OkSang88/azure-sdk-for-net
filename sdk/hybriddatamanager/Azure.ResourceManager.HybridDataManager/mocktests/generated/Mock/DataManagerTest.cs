...
namespace Azure.ResourceManager.HybridDataManager.Tests.Mock
{
    ...
    public partial class DataManagerMockTests : MockTestBase
    {
        ...
        public async Task Update()
        {
            ...
            var dataManagerId = HybridDataManager.DataManager.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "ResourceGroupForSDKTest", "TestAzureSDKOperations");
            var dataManager = GetArmClient().GetDataManager(dataManagerId);
            HybridDataManager.Models.DataManagerUpdateParameter dataManagerUpdateParameter = new HybridDataManager.Models.DataManagerUpdateParameter()
            {
                Sku = new HybridDataManager.Models.Sku()
                {
                    Name = "DS0",
                    Tier = "Standard",
                },
