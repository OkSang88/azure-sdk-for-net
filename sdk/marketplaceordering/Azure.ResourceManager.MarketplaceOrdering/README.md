# Azure MarketplaceOrdering Management client library for .NET
...
Install the Azure MarketplaceOrdering management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.MarketplaceOrdering -Version 1.0.0-preview.1 
```
