...
{
    public partial class Sample_DnsCaaRecordCollection
    {
        // Create A recordset
        ...
        public async Task CreateOrUpdate_CreateARecordset()
        {
            ...
            // get the collection of this DnsCaaRecordResource
            DnsCaaRecordCollection collection = dnsZone.GetDnsCaaRecords();
...
IPv4Address = "127.0.0.1",
            ...
            ArmOperation<DnsCaaRecordResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, relativeRecordSetName, data);
            DnsCaaRecordResource result = lro.Value;
...
"string1","string2"
        ...
        public async Task Get_GetARecordset()
        {
            ...
            // invoke the operation
            string relativeRecordSetName = "record1";
            DnsCaaRecordResource result = await collection.GetAsync(relativeRecordSetName);
        ...
        public async Task GetAll_ListARecordsets()
        {
            ...
            await foreach (DnsCaaRecordResource item in collection.GetAllAsync())
            {
