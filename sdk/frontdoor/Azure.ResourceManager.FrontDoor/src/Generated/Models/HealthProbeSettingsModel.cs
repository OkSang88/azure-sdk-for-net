...
namespace Azure.ResourceManager.FrontDoor.Models
{
    ...
    public partial class HealthProbeSettingsModel : SubResource
    {
        ...
        internal HealthProbeSettingsModel(string id, string name, string type, string path, FrontDoorProtocol? protocol, int? intervalInSeconds, FrontDoorHealthProbeMethod? healthProbeMethod, HealthProbeEnabled? enabledState, FrontDoorResourceState? resourceState) : base(id)
        {
            Name = name;
            Type = type;
            Path = path;
