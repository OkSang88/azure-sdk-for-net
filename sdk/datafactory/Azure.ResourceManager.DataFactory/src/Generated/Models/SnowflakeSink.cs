...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class SnowflakeSink : CopySink
    {
        ...
        internal SnowflakeSink(string type, object writeBatchSize, object writeBatchTimeout, object sinkRetryCount, object sinkRetryWait, object maxConcurrentConnections, object disableMetricsCollection, IDictionary<string, object> additionalProperties, object preCopyScript, SnowflakeImportCopyCommand importSettings) : base(type, writeBatchSize, writeBatchTimeout, sinkRetryCount, sinkRetryWait, maxConcurrentConnections, disableMetricsCollection, additionalProperties)
        {
