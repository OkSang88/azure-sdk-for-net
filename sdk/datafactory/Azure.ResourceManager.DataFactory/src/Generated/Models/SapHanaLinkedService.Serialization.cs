...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class SapHanaLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static SapHanaLinkedService DeserializeSapHanaLinkedService(JsonElement element)
        {
            ...
            return new SapHanaLinkedService(type, connectVia.Value, description.Value, Optional.ToDictionary(parameters), Optional.ToList(annotations), additionalProperties, connectionString.Value, server.Value, Optional.ToNullable(authenticationType), userName.Value, password.Value, encryptedCredential.Value);
        }
    }
}
