    ...
    public partial class PrivateDnsZoneTXTCollection : ArmCollection, IEnumerable<PrivateDnsZoneTXT>, IAsyncEnumerable<PrivateDnsZoneTXT>
    {
        ...
        public virtual Response<PrivateDnsZoneTXT> Get(string relativeRecordSetName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new PrivateDnsZoneTXT(Parent, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual Pageable<PrivateDnsZoneTXT> GetAll(int? top = null, string recordsetnamesuffix = null, CancellationToken cancellationToken = default)
        {
            Page<PrivateDnsZoneTXT> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    ...
                    return Page.FromValues(response.Value.Value.Select(value => new PrivateDnsZoneTXT(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
