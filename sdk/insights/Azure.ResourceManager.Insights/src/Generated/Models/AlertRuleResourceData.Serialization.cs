...
namespace Insights
{
    public partial class AlertRuleResourceData : IUtf8JsonSerializable
    {
        ...
        internal static AlertRuleResourceData DeserializeAlertRuleResourceData(JsonElement element)
        {
            ...
            return new AlertRuleResourceData(id, name, type, tags, location, name0, description.Value, isEnabled, condition, Optional.ToList(actions), Optional.ToNullable(lastUpdatedTime));
        }
    }
}
