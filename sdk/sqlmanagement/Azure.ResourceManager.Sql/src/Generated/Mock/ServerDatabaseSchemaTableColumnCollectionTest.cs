...
namespace Azure.ResourceManager.Sql.Tests.Mock
{
    ...
    public partial class ServerDatabaseSchemaTableColumnCollectionMockTests : MockTestBase
    {
        ...
        public async Task GetAsync()
        {
            ...
            var collection = GetArmClient().GetServerDatabaseSchemaTable(new ResourceIdentifier("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/myRG/providers/Microsoft.Sql/servers/serverName/databases/myDatabase/schemas/dbo/tables/table1")).GetServerDatabaseSchemaTableColumns();
