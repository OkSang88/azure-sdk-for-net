...
namespace Azure.ResourceManager.OperationalInsights
{
    ...
    public partial class Table : ArmResource
    {
        ...
        internal Table(ArmResource options, TableData data) : base(options, data.Id)
        {
            HasData = true;
            _data = data;
        ...
        public async virtual Task<Response<Table>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _tablesRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<Table> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _tablesRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("Table.GetAvailableLocations");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<Table>> UpdateAsync(TableData parameters, CancellationToken cancellationToken = default)
        {
            if (parameters == null)
            {
            ...
            try
            {
                var response = await _tablesRestClient.UpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, parameters, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(new Table(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="parameters"/> is null. </exception>
        public virtual Response<Table> Update(TableData parameters, CancellationToken cancellationToken = default)
        {
            if (parameters == null)
            {
                throw new ArgumentNullException(nameof(parameters));
            ...
            try
            {
                var response = _tablesRestClient.Update(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, parameters, cancellationToken);
                return Response.FromValue(new Table(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
