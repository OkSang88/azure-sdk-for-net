...
namespace Azure.ResourceManager.AppService.Models
{
    public partial class DeploymentLocations
    {
        internal static DeploymentLocations DeserializeDeploymentLocations(JsonElement element)
        {
            ...
            Optional<IReadOnlyList<WebAppServiceEnvironment>> hostingEnvironments = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("hostingEnvironments"))
                {
                    ...
                    List<WebAppServiceEnvironment> array = new List<WebAppServiceEnvironment>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(WebAppServiceEnvironment.DeserializeWebAppServiceEnvironment(item));
                    }
