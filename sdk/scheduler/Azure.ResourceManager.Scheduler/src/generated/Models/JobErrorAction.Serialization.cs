...
{
    public partial class JobErrorAction : IUtf8JsonSerializable
    {
        ...
        internal static JobErrorAction DeserializeJobErrorAction(JsonElement element)
        {
            ...
            return new JobErrorAction(Optional.ToNullable(type), request.Value, queueMessage.Value, serviceBusQueueMessage.Value, serviceBusTopicMessage.Value, retryPolicy.Value);
        }
    }
}
