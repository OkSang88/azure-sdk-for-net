...
{
    public partial class Sample_RecoveryPlanCollection
    {
        ...
        {
            // Generated from example definition: specification/recoveryservicessiterecovery/resource-manager/Microsoft.RecoveryServices/stable/2022-08-01/examples/ReplicationRecoveryPlans_List.json
            ...
            // get the collection of this RecoveryPlanResource
            string resourceName = "vault1";
            RecoveryPlanCollection collection = resourceGroupResource.GetRecoveryPlans(resourceName);

            // invoke the operation and iterate over the result
            await foreach (RecoveryPlanResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                RecoveryPlanData resourceData = item.Data;
        ...
        public async Task Get_GetsTheRequestedRecoveryPlan()
        {
            ...
            RecoveryPlanResource result = await collection.GetAsync(recoveryPlanName);
        ...
        {
            // Generated from example definition: specification/recoveryservicessiterecovery/resource-manager/Microsoft.RecoveryServices/stable/2022-08-01/examples/ReplicationRecoveryPlans_Create.json
...
EndGroupActions =
{
            ...
            ArmOperation<RecoveryPlanResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, recoveryPlanName, content);
