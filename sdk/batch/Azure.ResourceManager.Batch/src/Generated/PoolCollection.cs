...
namespace Azure.ResourceManager.Batch
{
    ...
    public partial class PoolCollection : ArmCollection, IEnumerable<Pool>, IAsyncEnumerable<Pool>
    {
        ...
        internal PoolCollection(ArmResource parent) : base(parent)
        {
            ...
            ClientOptions.TryGetApiVersion(Pool.ResourceType, out string apiVersion);
            _poolRestClient = new PoolRestOperations(_clientDiagnostics, Pipeline, ClientOptions, BaseUri, apiVersion);
#if DEBUG
        ...
        public virtual PoolCreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, string poolName, PoolData parameters, string ifMatch = null, string ifNoneMatch = null, CancellationToken cancellationToken = default)
        {
            if (poolName == null)
            {
            ...
            try
            {
                ...
                var operation = new PoolCreateOrUpdateOperation(this, response);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="poolName"/> or <paramref name="parameters"/> is null. </exception>
        public async virtual Task<PoolCreateOrUpdateOperation> CreateOrUpdateAsync(bool waitForCompletion, string poolName, PoolData parameters, string ifMatch = null, string ifNoneMatch = null, CancellationToken cancellationToken = default)
        {
            if (poolName == null)
            {
                throw new ArgumentNullException(nameof(poolName));
        ...
        public virtual Pageable<Pool> GetAll(int? maxresults = null, string select = null, string filter = null, CancellationToken cancellationToken = default)
        {
            Page<Pool> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    ...
                    return Page.FromValues(response.Value.Value.Select(value => new Pool(this, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
