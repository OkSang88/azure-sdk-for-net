# Azure SqlVirtualMachine Management client library for .NET
...
Install the Azure SqlVirtualMachine management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.SqlVirtualMachine -Version 1.0.0-preview.1 
```
