# Azure ManagedServiceIdentity Management client library for .NET
...
Install the Azure ManagedServiceIdentity management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.ManagedServiceIdentity -Version 1.0.0-preview.1 
```
