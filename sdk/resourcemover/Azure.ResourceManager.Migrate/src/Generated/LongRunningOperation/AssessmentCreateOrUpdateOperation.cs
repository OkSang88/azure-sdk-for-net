...
namespace Azure.ResourceManager.Migrate.Models
{
    ...
    /// 
    /// </summary>
    public partial class AssessmentCreateOrUpdateOperation : Operation<Assessment>
    {
        private readonly OperationOrResponseInternals<Assessment> _operation;

        /// <summary> Initializes a new instance of AssessmentCreateOrUpdateOperation for mocking. </summary>
        protected AssessmentCreateOrUpdateOperation()
        {
        }

        internal AssessmentCreateOrUpdateOperation(ArmResource operationsBase, Response<AssessmentData> response)
        {
