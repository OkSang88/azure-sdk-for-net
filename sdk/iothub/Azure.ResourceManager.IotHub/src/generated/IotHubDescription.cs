...
namespace IotHubClient
{
    ...
    public partial class IotHubDescription : ArmResource
    {
        ...
        internal IotHubDescription(ArmResource options, IotHubDescriptionData data) : base(options, data.Id)
        {
            ...
            _iotHubRestClient = new IotHubRestOperations(_clientDiagnostics, Pipeline, ClientOptions, BaseUri);
#if DEBUG
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async virtual Task<IotHubResourceDeleteOperation> DeleteAsync(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new IotHubResourceDeleteOperation(_clientDiagnostics, Pipeline, _iotHubResourceRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name).Request, response);
        ...
        /// <param name="waitForCompletion"> Waits for the completion of the long running operations. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual IotHubResourceDeleteOperation Delete(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("IotHubDescription.Delete");
            scope.Start();
            try
        ...
        public async virtual Task<IotHubResourceUpdateOperation> UpdateAsync(bool waitForCompletion, TagsResource iotHubTags, CancellationToken cancellationToken = default)
        {
            if (iotHubTags == null)
            {
            ...
            try
            {
                ...
                var operation = new IotHubResourceUpdateOperation(this, _clientDiagnostics, Pipeline, _iotHubResourceRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, iotHubTags).Request, response);
                if (waitForCompletion)
                    await operation.WaitForCompletionAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="iotHubTags"/> is null. </exception>
        public virtual IotHubResourceUpdateOperation Update(bool waitForCompletion, TagsResource iotHubTags, CancellationToken cancellationToken = default)
        {
            if (iotHubTags == null)
            {
                throw new ArgumentNullException(nameof(iotHubTags));
        ...
        public async virtual Task<IotHubManualFailoverOperation> ManualFailoverIotHubAsync(bool waitForCompletion, FailoverInput failoverInput, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new IotHubManualFailoverOperation(_clientDiagnostics, Pipeline, _iotHubRestClient.CreateManualFailoverRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, failoverInput).Request, response);
                if (waitForCompletion)
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="failoverInput"/> is null. </exception>
        public virtual IotHubManualFailoverOperation ManualFailoverIotHub(bool waitForCompletion, FailoverInput failoverInput, CancellationToken cancellationToken = default)
        {
            if (failoverInput == null)
            {
                throw new ArgumentNullException(nameof(failoverInput));
