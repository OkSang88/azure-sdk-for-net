...
namespace ServiceFabricManagementClient
{
    internal partial class ClusterVersionsRestOperations
    {
        ...
        public ClusterVersionsRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ClientOptions options, Uri endpoint = null, string apiVersion = "2021-06-01")
        {
