...
namespace Azure.ResourceManager.ContainerRegistry.Models
{
    ...
    public partial class AgentPoolCreateOrUpdateOperation : Operation<AgentPool>, IOperationSource<AgentPool>
    {
        private readonly OperationInternals<AgentPool> _operation;

        private readonly ArmResource _operationBase;

        /// <summary> Initializes a new instance of AgentPoolCreateOrUpdateOperation for mocking. </summary>
        protected AgentPoolCreateOrUpdateOperation()
        {
        }

        internal AgentPoolCreateOrUpdateOperation(ArmResource operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Azure.Core.Request request, Response response)
        {
            _operation = new OperationInternals<AgentPool>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "AgentPoolCreateOrUpdateOperation");
