...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    {
        /// <summary> Initializes a new instance of MetadataDependencies. </summary>
        ...
        internal MetadataDependencies(string contentId, Kind? kind, string version, string name, Operator? @operator, IList<MetadataDependencies> criteria)
        {
            ContentId = contentId;
            Kind = kind;
            Version = version;
