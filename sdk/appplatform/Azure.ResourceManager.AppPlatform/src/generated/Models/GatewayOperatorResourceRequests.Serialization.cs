...
namespace AppPlatformManagementClient.Models
{
    ...
    {
        internal static GatewayOperatorResourceRequests DeserializeGatewayOperatorResourceRequests(JsonElement element)
        {
            ...
            return new GatewayOperatorResourceRequests(cpu.Value, memory.Value, Optional.ToNullable(instanceCount));
        }
    }
}
