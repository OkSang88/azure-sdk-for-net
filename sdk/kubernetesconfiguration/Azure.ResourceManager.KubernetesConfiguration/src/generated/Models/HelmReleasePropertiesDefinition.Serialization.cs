...
namespace SourceControlConfigurationClient.Models
{
    ...
    {
        internal static HelmReleasePropertiesDefinition DeserializeHelmReleasePropertiesDefinition(JsonElement element)
        {
            Optional<long?> lastRevisionApplied = default;
            Optional<ObjectReferenceDefinition> helmChartRef = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("helmChartRef"))
                {
                    ...
                    helmChartRef = ObjectReferenceDefinition.DeserializeObjectReferenceDefinition(property.Value);
                    continue;
                }
            ...
            return new HelmReleasePropertiesDefinition(Optional.ToNullable(lastRevisionApplied), helmChartRef.Value, Optional.ToNullable(failureCount), Optional.ToNullable(installFailureCount), Optional.ToNullable(upgradeFailureCount));
        }
    }
}
