...
namespace Insights
{
    public partial class LogProfileResourceData : IUtf8JsonSerializable
    {
        ...
        internal static LogProfileResourceData DeserializeLogProfileResourceData(JsonElement element)
        {
            ...
            return new LogProfileResourceData(id, name, type, tags, location, storageAccountId.Value, serviceBusRuleId.Value, locations, categories, retentionPolicy);
        }
    }
}
