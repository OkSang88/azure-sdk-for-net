...
namespace Azure.ResourceManager.ServiceFabric.Models
{
    ...
    public partial class ApplicationResourceUpdateOperation : Operation<ApplicationResource>, IOperationSource<ApplicationResource>
    {
        private readonly OperationInternals<ApplicationResource> _operation;

        private readonly ArmResource _operationBase;

        /// <summary> Initializes a new instance of ApplicationResourceUpdateOperation for mocking. </summary>
        protected ApplicationResourceUpdateOperation()
        {
        }

        internal ApplicationResourceUpdateOperation(ArmResource operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<ApplicationResource>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "ApplicationResourceUpdateOperation");
