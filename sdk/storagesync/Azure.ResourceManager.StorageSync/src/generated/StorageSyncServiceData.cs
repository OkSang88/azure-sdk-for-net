...
namespace MicrosoftStorageSync
{
    ...
    public partial class StorageSyncServiceData : TrackedResource
    {
        ...
        internal StorageSyncServiceData(ResourceIdentifier id, string name, ResourceType type, IDictionary<string, string> tags, AzureLocation location, IncomingTrafficPolicy? incomingTrafficPolicy, int? storageSyncServiceStatus, string storageSyncServiceUid, string provisioningState, string lastWorkflowId, string lastOperationName, IReadOnlyList<PrivateEndpointConnectionData> privateEndpointConnections) : base(id, name, type, tags, location)
        {
