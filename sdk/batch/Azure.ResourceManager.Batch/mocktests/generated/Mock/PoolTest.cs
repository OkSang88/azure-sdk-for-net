...
namespace Azure.ResourceManager.Batch.Tests.Mock.Tests.Mock
{
    ...
    public partial class PoolMockTests : MockTestBase
    {
        ...
        {
            // Example: GetPool
            var poolId = Batch.Tests.Mock.Pool.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "default-azurebatch-japaneast", "sampleacct", "testpool");
        ...
        public async Task Update()
        {
            ...
            Batch.Tests.Mock.PoolData parameters = new Batch.Tests.Mock.PoolData()
            {
                ...
                {
                    AutoScale = new Batch.Tests.Mock.Models.AutoScaleSettings(formula: "$TargetDedicatedNodes=34"),
                },
            };
            string ifMatch = null;
