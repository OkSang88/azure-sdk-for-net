...
namespace BatchManagementClient
{
    ...
    public partial class CertificateCollection : ArmCollection, IEnumerable<Certificate>, IAsyncEnumerable<Certificate>
    {
        ...
        public virtual CertificateCreateOperation CreateOrUpdate(bool waitForCompletion, string certificateName, CertificateCreateOrUpdateParameters parameters, string ifMatch = null, string ifNoneMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new CertificateCreateOperation(Parent, response);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="certificateName"/> or <paramref name="parameters"/> is null. </exception>
        public async virtual Task<CertificateCreateOperation> CreateOrUpdateAsync(bool waitForCompletion, string certificateName, CertificateCreateOrUpdateParameters parameters, string ifMatch = null, string ifNoneMatch = null, CancellationToken cancellationToken = default)
        {
            if (certificateName == null)
            {
                throw new ArgumentNullException(nameof(certificateName));
