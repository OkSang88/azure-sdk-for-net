...
namespace OperationalInsightsManagementClient
{
    ...
    public partial class Workspace : ArmResource
    {
        ...
        internal Workspace(ArmResource options, WorkspaceData data) : base(options, data.Id)
        {
            ...
            _intelligencePacksRestClient = new IntelligencePacksRestOperations(_clientDiagnostics, Pipeline, ClientOptions, BaseUri);
            _managementGroupsRestClient = new ManagementGroupsRestOperations(_clientDiagnostics, Pipeline, ClientOptions, BaseUri);
            _sharedKeysRestClient = new SharedKeysRestOperations(_clientDiagnostics, Pipeline, ClientOptions, BaseUri);
            _usagesRestClient = new UsagesRestOperations(_clientDiagnostics, Pipeline, ClientOptions, BaseUri);
            _availableServiceTiersRestClient = new AvailableServiceTiersRestOperations(_clientDiagnostics, Pipeline, ClientOptions, BaseUri);
            _gatewaysRestClient = new GatewaysRestOperations(_clientDiagnostics, Pipeline, ClientOptions, BaseUri);
            _schemaRestClient = new SchemaRestOperations(_clientDiagnostics, Pipeline, ClientOptions, BaseUri);
            _workspacePurgeRestClient = new WorkspacePurgeRestOperations(_clientDiagnostics, Pipeline, ClientOptions, BaseUri);
#if DEBUG
