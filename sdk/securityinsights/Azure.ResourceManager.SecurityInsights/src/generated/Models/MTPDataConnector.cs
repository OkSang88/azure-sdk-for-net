...
namespace SecurityInsights.Models
{
    ...
    public partial class MTPDataConnector : DataConnectorData
    {
        ...
        internal MTPDataConnector(ResourceIdentifier id, string name, ResourceType type, SystemData systemData, string etag, DataConnectorKind kind, string tenantId, MTPDataConnectorDataTypes dataTypes) : base(id, name, type, systemData, etag, kind)
        {
            TenantId = tenantId;
            DataTypes = dataTypes;
            Kind = kind;
