# Azure AnalysisServices Management client library for .NET
...
Install the Azure AnalysisServices management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.AnalysisServices -Version 1.0.0-preview.1 
```
