# Azure NetApp Management client library for .NET
...
Install the Azure NetApp management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.NetApp -Version 1.0.0-preview.1 
```
