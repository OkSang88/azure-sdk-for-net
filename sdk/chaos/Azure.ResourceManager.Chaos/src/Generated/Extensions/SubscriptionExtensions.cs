...
namespace Azure.ResourceManager.Chaos
{
    ...
    public static partial class SubscriptionExtensions
    {
        ...
        private static ExperimentsRestOperations GetExperimentsRestOperations(ClientDiagnostics clientDiagnostics, TokenCredential credential, ArmClientOptions clientOptions, HttpPipeline pipeline, Uri endpoint = null)
        {
            return new ExperimentsRestOperations(clientDiagnostics, pipeline, clientOptions, endpoint);
        }
        ...
        public static AsyncPageable<Experiment> GetExperimentsAsync(this Subscription subscription, bool? running = null, string continuationToken = null, CancellationToken cancellationToken = default)
        {
            return subscription.UseClientContext((baseUri, credential, options, pipeline) =>
            {
                ...
                var restOperations = GetExperimentsRestOperations(clientDiagnostics, credential, options, pipeline, baseUri);
