...
namespace Azure.ResourceManager.AgriFood
{
    ...
    public partial class ExtensionCollection : ArmCollection, IEnumerable<Extension>, IAsyncEnumerable<Extension>
    {
        ...
        public virtual ExtensionCreateOperation CreateOrUpdate(bool waitForCompletion, string extensionId, CancellationToken cancellationToken = default)
        {
            if (extensionId == null)
            {
            ...
            try
            {
                ...
                var operation = new ExtensionCreateOperation(Parent, response);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="extensionId"/> is null. </exception>
        public async virtual Task<ExtensionCreateOperation> CreateOrUpdateAsync(bool waitForCompletion, string extensionId, CancellationToken cancellationToken = default)
        {
            if (extensionId == null)
            {
                throw new ArgumentNullException(nameof(extensionId));
