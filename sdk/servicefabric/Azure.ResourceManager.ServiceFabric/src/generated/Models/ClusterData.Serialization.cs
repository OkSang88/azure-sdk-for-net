...
namespace ServiceFabricManagementClient
{
    public partial class ClusterData : IUtf8JsonSerializable
    {
        ...
        internal static ClusterData DeserializeClusterData(JsonElement element)
        {
            ...
            Optional<IList<AddOnFeatures>> addOnFeatures = default;
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        if (property0.NameEquals("addOnFeatures"))
                        {
                            ...
                            List<AddOnFeatures> array = new List<AddOnFeatures>();
                            foreach (var item in property0.Value.EnumerateArray())
                            {
                                array.Add(new AddOnFeatures(item.GetString()));
                            }
                            addOnFeatures = array;
                            continue;
                        }
