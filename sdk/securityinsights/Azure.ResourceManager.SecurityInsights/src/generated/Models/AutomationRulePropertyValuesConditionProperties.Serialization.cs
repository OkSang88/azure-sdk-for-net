...
{
    public partial class AutomationRulePropertyValuesConditionProperties : IUtf8JsonSerializable
    {
        ...
        internal static AutomationRulePropertyValuesConditionProperties DeserializeAutomationRulePropertyValuesConditionProperties(JsonElement element)
        {
            ...
            return new AutomationRulePropertyValuesConditionProperties(Optional.ToNullable(propertyName), Optional.ToNullable(@operator), Optional.ToList(propertyValues));
        }
    }
}
