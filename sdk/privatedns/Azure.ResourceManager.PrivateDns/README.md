# Azure PrivateDns Management client library for .NET
...
Install the Azure PrivateDns management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.PrivateDns -Version 1.0.0-preview.1 
```
