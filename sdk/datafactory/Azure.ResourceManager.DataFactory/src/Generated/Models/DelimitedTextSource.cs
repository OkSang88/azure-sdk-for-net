...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class DelimitedTextSource : CopySource
    {
        ...
        internal DelimitedTextSource(string type, object sourceRetryCount, object sourceRetryWait, object maxConcurrentConnections, object disableMetricsCollection, IDictionary<string, object> additionalProperties, StoreReadSettings storeSettings, DelimitedTextReadSettings formatSettings, object additionalColumns) : base(type, sourceRetryCount, sourceRetryWait, maxConcurrentConnections, disableMetricsCollection, additionalProperties)
        {
