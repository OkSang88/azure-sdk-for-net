...
namespace DataFactoryManagementClient.Models
{
    ...
    public partial class TriggerCreateOrUpdateOperation : Operation<TriggerResource>
    {
        private readonly OperationOrResponseInternals<TriggerResource> _operation;

        /// <summary> Initializes a new instance of TriggerCreateOrUpdateOperation for mocking. </summary>
        protected TriggerCreateOrUpdateOperation()
        {
        }

        internal TriggerCreateOrUpdateOperation(ArmResource operationsBase, Response<TriggerResourceData> response)
        {
