...
namespace AzureAnalysisServices
{
    ...
    public partial class AnalysisServicesServerData : Resource
    {
        ...
        public AnalysisServicesServerData(AzureLocation location, ResourceSku sku) : base(location, sku)
        {
            if (sku == null)
            {
        ...
        internal AnalysisServicesServerData(ResourceIdentifier id, string name, ResourceType type, IDictionary<string, string> tags, AzureLocation location, ResourceSku sku, ServerAdministrators asAdministrators, string backupBlobContainerUri, GatewayDetails gatewayDetails, IPv4FirewallSettings ipV4FirewallSettings, ConnectionMode? querypoolConnectionMode, ManagedMode? managedMode, ServerMonitorMode? serverMonitorMode, State? state, ProvisioningState? provisioningState, string serverFullName, ResourceSku skuPropertiesSku) : base(id, name, type, tags, location, sku)
        {
