...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class TriggerResourceSubscribeToEventsOperation : Operation<TriggerSubscriptionOperationStatus>, IOperationSource<TriggerSubscriptionOperationStatus>
    {
        private readonly OperationInternals<TriggerSubscriptionOperationStatus> _operation;

        /// <summary> Initializes a new instance of TriggerResourceSubscribeToEventsOperation for mocking. </summary>
        protected TriggerResourceSubscribeToEventsOperation()
        {
        }

        internal TriggerResourceSubscribeToEventsOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<TriggerSubscriptionOperationStatus>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "TriggerResourceSubscribeToEventsOperation");
        }
