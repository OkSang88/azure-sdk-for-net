...
namespace SearchManagementClient
{
    ...
    public partial class SearchServiceData : TrackedResource
    {
        ...
        internal SearchServiceData(ResourceIdentifier id, string name, ResourceType type, IDictionary<string, string> tags, AzureLocation location, Models.Sku sku, Identity identity, int? replicaCount, int? partitionCount, HostingMode? hostingMode, PublicNetworkAccess? publicNetworkAccess, SearchServiceStatus? status, string statusDetails, ProvisioningState? provisioningState, NetworkRuleSet networkRuleSet, IReadOnlyList<PrivateEndpointConnectionData> privateEndpointConnections, IReadOnlyList<SharedPrivateLinkResourceData> sharedPrivateLinkResources) : base(id, name, type, tags, location)
        {
            Sku = sku;
            Identity = identity;
