...
namespace AppPlatformManagementClient.Tests.Mock
{
    ...
    public partial class BuildCollectionMockTests : MockTestBase
    {
        ...
        public async Task CreateOrUpdate()
        {
            ...
            AppPlatformManagementClient.BuildData build = new AppPlatformManagementClient.BuildData()
            {
                Properties = new AppPlatformManagementClient.Models.BuildProperties()
                {
