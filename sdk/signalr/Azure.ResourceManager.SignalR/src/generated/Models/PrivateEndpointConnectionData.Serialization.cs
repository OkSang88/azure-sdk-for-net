...
namespace SignalRManagementClient
{
    public partial class PrivateEndpointConnectionData : IUtf8JsonSerializable
    {
        ...
        internal static PrivateEndpointConnectionData DeserializePrivateEndpointConnectionData(JsonElement element)
        {
            ...
            return new PrivateEndpointConnectionData(id, name, type, systemData, Optional.ToNullable(provisioningState), privateEndpoint, Optional.ToList(groupIds), privateLinkServiceConnectionState.Value);
        }
    }
}
