...
namespace Azure.ResourceManager.Compute.Tests.Mock
{
    ...
    public partial class GalleryImageVersionCollectionMockTests : MockTestBase
    {
        ...
        public async Task CreateOrUpdateAsync()
        {
            ...
            var collection = GetArmClient().GetGalleryImage(new ResourceIdentifier("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/myResourceGroup/providers/Microsoft.Compute/galleries/myGalleryName/images/myGalleryImageName")).GetGalleryImageVersions();
