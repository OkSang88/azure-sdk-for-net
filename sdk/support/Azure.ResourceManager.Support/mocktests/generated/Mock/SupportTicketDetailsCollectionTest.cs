...
namespace MicrosoftSupport.Tests.Mock
{
    ...
    public partial class SupportTicketDetailsCollectionMockTests : MockTestBase
    {
        ...
        public async Task CreateOrUpdate()
        {
            ...
            MicrosoftSupport.SupportTicketDetailsData createSupportTicketParameters = new MicrosoftSupport.SupportTicketDetailsData()
            {
                ...
                Severity = new MicrosoftSupport.Models.SeverityLevel("moderate"),
                ContactDetails = new MicrosoftSupport.Models.ContactProfile(firstName: "abc", lastName: "xyz", preferredContactMethod: new MicrosoftSupport.Models.PreferredContactMethod("email"), primaryEmailAddress: "abc@contoso.com", preferredTimeZone: "Pacific Standard Time", country: "usa", preferredSupportLanguage: "en-US"),
                Title = "my title",
        ...
        public async Task CreateOrUpdate3()
        {
            ...
            MicrosoftSupport.SupportTicketDetailsData createSupportTicketParameters = new MicrosoftSupport.SupportTicketDetailsData()
            {
                ...
                TechnicalTicketDetails = new MicrosoftSupport.Models.TechnicalTicketDetails()
                {
        ...
        public async Task CreateOrUpdate4()
        {
            ...
            MicrosoftSupport.SupportTicketDetailsData createSupportTicketParameters = new MicrosoftSupport.SupportTicketDetailsData()
            {
                ...
                QuotaTicketDetails = new MicrosoftSupport.Models.QuotaTicketDetails()
                {
