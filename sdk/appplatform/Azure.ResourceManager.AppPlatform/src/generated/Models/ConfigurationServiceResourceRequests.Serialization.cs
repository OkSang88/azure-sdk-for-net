...
namespace AppPlatformManagementClient.Models
{
    ...
    {
        internal static ConfigurationServiceResourceRequests DeserializeConfigurationServiceResourceRequests(JsonElement element)
        {
            ...
            return new ConfigurationServiceResourceRequests(cpu.Value, memory.Value, Optional.ToNullable(instanceCount));
        }
    }
}
