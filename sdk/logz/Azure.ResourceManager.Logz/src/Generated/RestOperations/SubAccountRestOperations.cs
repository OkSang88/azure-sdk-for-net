...
namespace Azure.ResourceManager.Logz
{
    internal partial class SubAccountRestOperations
    {
        ...
        public SubAccountRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, Uri endpoint = null, string apiVersion = default)
        {
