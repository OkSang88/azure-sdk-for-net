...
namespace Azure.ResourceManager.KubernetesConfiguration.Models
{
    ...
    {
        /// <summary> Initializes a new instance of KustomizationDefinition. </summary>
        public KustomizationDefinition()
        {
            DependsOn = new ChangeTrackingList<DependsOnDefinition>();
        }
        ...
        internal KustomizationDefinition(string path, IList<DependsOnDefinition> dependsOn, long? timeoutInSeconds, long? syncIntervalInSeconds, long? retryIntervalInSeconds, bool? prune, bool? force)
        {
            Path = path;
            DependsOn = dependsOn;
        ...
        public IList<DependsOnDefinition> DependsOn { get; set; }
