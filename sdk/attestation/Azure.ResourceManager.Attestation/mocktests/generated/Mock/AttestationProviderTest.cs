...
namespace AttestationManagementClient.Tests.Mock
{
    ...
    public partial class AttestationProviderMockTests : MockTestBase
    {
        ...
        public async Task Get()
        {
            ...
            var attestationProviderId = AttestationManagementClient.AttestationProvider.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "MyResourceGroup", "myattestationprovider");
        ...
        public async Task Delete()
        {
            ...
            var attestationProviderId = AttestationManagementClient.AttestationProvider.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "sample-resource-group", "myattestationprovider");
            var attestationProvider = GetArmClient().GetAttestationProvider(attestationProviderId);
        ...
        public async Task Update()
        {
            ...
            var attestationProviderId = AttestationManagementClient.AttestationProvider.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "MyResourceGroup", "myattestationprovider");
            var attestationProvider = GetArmClient().GetAttestationProvider(attestationProviderId);
            AttestationManagementClient.Models.AttestationServicePatchParams updateParams = new AttestationManagementClient.Models.AttestationServicePatchParams();
