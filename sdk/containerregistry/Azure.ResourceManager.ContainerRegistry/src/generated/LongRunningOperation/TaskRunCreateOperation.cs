...
namespace ContainerRegistryManagementClient.Models
{
    ...
    public partial class TaskRunCreateOperation : Operation<TaskRun>, IOperationSource<TaskRun>
    {
        private readonly OperationInternals<TaskRun> _operation;

        private readonly ArmResource _operationBase;

        /// <summary> Initializes a new instance of TaskRunCreateOperation for mocking. </summary>
        protected TaskRunCreateOperation()
        {
        }

        internal TaskRunCreateOperation(ArmResource operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Azure.Core.Request request, Response response)
        {
            _operation = new OperationInternals<TaskRun>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "TaskRunCreateOperation");
