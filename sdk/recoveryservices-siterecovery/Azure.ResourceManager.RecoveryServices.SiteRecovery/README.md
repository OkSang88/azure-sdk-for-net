# Azure RecoveryServices.SiteRecovery Management client library for .NET
...
Install the Azure RecoveryServices.SiteRecovery management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.RecoveryServices.SiteRecovery -Version 1.0.0-preview.1 
```
