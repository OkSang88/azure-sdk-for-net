...
{
    public partial class ApplicationResourceProperties : IUtf8JsonSerializable
    {
        ...
        internal static ApplicationResourceProperties DeserializeApplicationResourceProperties(JsonElement element)
        {
            ...
            return new ApplicationResourceProperties(provisioningState.Value, description.Value, Optional.ToList(services), diagnostics.Value, debugParams.Value, Optional.ToList(serviceNames), Optional.ToNullable(status), statusDetails.Value, Optional.ToNullable(healthState), unhealthyEvaluation.Value);
        }
    }
}
