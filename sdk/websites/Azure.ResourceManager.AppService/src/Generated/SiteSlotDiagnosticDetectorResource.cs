...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteSlotDiagnosticDetectorResource : ArmResource
    {
        ...
        private readonly DetectorDefinitionData _data;
        ...
        internal SiteSlotDiagnosticDetectorResource(ArmClient client, DetectorDefinitionData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual DetectorDefinitionData Data
        {
            get
            {
                if (!HasData)
