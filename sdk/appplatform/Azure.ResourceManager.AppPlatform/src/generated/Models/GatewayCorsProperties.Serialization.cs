...
{
    public partial class GatewayCorsProperties : IUtf8JsonSerializable
    {
        ...
        internal static GatewayCorsProperties DeserializeGatewayCorsProperties(JsonElement element)
        {
            ...
            return new GatewayCorsProperties(Optional.ToList(allowedOrigins), Optional.ToList(allowedMethods), Optional.ToList(allowedHeaders), Optional.ToNullable(maxAge), Optional.ToNullable(allowCredentials), Optional.ToList(exposedHeaders));
        }
    }
}
