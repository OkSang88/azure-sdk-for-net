...
{
    public partial class NodeTypeDescription : IUtf8JsonSerializable
    {
        ...
        internal static NodeTypeDescription DeserializeNodeTypeDescription(JsonElement element)
        {
            string name = default;
            ...
            Optional<DurabilityLevel> durabilityLevel = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("durabilityLevel"))
                {
                    ...
                    durabilityLevel = new DurabilityLevel(property.Value.GetString());
                    continue;
                }
                if (property.NameEquals("applicationPorts"))
                {
                    ...
                    applicationPorts = EndpointRangeDescription.DeserializeEndpointRangeDescription(property.Value);
                    continue;
                }
                if (property.NameEquals("ephemeralPorts"))
                {
                    ...
                    ephemeralPorts = EndpointRangeDescription.DeserializeEndpointRangeDescription(property.Value);
                    continue;
                }
            ...
            return new NodeTypeDescription(name, Optional.ToDictionary(placementProperties), Optional.ToDictionary(capacities), clientConnectionEndpointPort, httpGatewayEndpointPort, Optional.ToNullable(durabilityLevel), applicationPorts.Value, ephemeralPorts.Value, isPrimary, vmInstanceCount, Optional.ToNullable(reverseProxyEndpointPort), Optional.ToNullable(isStateless), Optional.ToNullable(multipleAvailabilityZones));
        }
    }
}
