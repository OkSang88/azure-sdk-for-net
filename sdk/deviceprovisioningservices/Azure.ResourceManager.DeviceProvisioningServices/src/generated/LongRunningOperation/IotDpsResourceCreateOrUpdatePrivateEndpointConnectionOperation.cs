...
namespace IotDpsClient.Models
{
    ...
    public partial class IotDpsResourceCreateOrUpdatePrivateEndpointConnectionOperation : Operation<PrivateEndpointConnection>, IOperationSource<PrivateEndpointConnection>
    {
        private readonly OperationInternals<PrivateEndpointConnection> _operation;

        private readonly ArmResource _operationBase;

        /// <summary> Initializes a new instance of IotDpsResourceCreateOrUpdatePrivateEndpointConnectionOperation for mocking. </summary>
        protected IotDpsResourceCreateOrUpdatePrivateEndpointConnectionOperation()
        {
        }

        internal IotDpsResourceCreateOrUpdatePrivateEndpointConnectionOperation(ArmResource operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<PrivateEndpointConnection>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "IotDpsResourceCreateOrUpdatePrivateEndpointConnectionOperation");
