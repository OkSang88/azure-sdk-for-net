...
namespace Azure.ResourceManager.ChangeAnalysis
{
    internal partial class ResourceChangesRestOperations
    {
        ...
        public ResourceChangesRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ClientOptions options, Uri endpoint = null, string apiVersion = "2021-04-01")
        {
