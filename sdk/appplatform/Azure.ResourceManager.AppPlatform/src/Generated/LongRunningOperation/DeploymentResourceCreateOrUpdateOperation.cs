...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    public partial class DeploymentResourceCreateOrUpdateOperation : Operation<DeploymentResource>, IOperationSource<DeploymentResource>
    {
        private readonly OperationInternals<DeploymentResource> _operation;

        private readonly ArmResource _operationBase;

        /// <summary> Initializes a new instance of DeploymentResourceCreateOrUpdateOperation for mocking. </summary>
        protected DeploymentResourceCreateOrUpdateOperation()
        {
        }

        internal DeploymentResourceCreateOrUpdateOperation(ArmResource operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<DeploymentResource>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.AzureAsyncOperation, "DeploymentResourceCreateOrUpdateOperation");
        ...
        DeploymentResource IOperationSource<DeploymentResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            return new DeploymentResource(_operationBase, data);
        }
