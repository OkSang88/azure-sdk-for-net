...
namespace AppPlatformManagementClient.Models
{
    ...
    public partial class BindingResourceProperties
    {
        ...
        {
            BindingParameters = new ChangeTrackingDictionary<string, object>();
        }
        ...
        internal BindingResourceProperties(string resourceName, string resourceType, string resourceId, string key, IDictionary<string, object> bindingParameters, string generatedProperties, string createdAt, string updatedAt)
        {
        ...
        public IDictionary<string, object> BindingParameters { get; }
