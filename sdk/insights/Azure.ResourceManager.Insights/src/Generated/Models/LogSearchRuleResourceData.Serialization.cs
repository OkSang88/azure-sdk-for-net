...
namespace Insights
{
    public partial class LogSearchRuleResourceData : IUtf8JsonSerializable
    {
        ...
        internal static LogSearchRuleResourceData DeserializeLogSearchRuleResourceData(JsonElement element)
        {
            ...
            return new LogSearchRuleResourceData(id, name, type, tags, location, description.Value, Optional.ToNullable(enabled), Optional.ToNullable(lastUpdatedTime), Optional.ToNullable(provisioningState), source, schedule.Value, action);
        }
    }
}
