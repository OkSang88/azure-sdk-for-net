...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    public partial class ServiceResourceUpdateOperation : Operation<ServiceResource>, IOperationSource<ServiceResource>
    {
        private readonly OperationInternals<ServiceResource> _operation;

        private readonly ArmResource _operationBase;

        /// <summary> Initializes a new instance of ServiceResourceUpdateOperation for mocking. </summary>
        protected ServiceResourceUpdateOperation()
        {
        }

        internal ServiceResourceUpdateOperation(ArmResource operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<ServiceResource>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.AzureAsyncOperation, "ServiceResourceUpdateOperation");
