...
namespace SecurityInsights.Models
{
    ...
    public partial class Anomalies : SettingsData
    {
        /// <summary> Initializes a new instance of Anomalies. </summary>
        public Anomalies()
        {
        ...
        internal Anomalies(ResourceIdentifier id, string name, ResourceType type, SystemData systemData, string etag, SettingKind kind, bool? isEnabled) : base(id, name, type, systemData, etag, kind)
        {
            IsEnabled = isEnabled;
            Kind = kind;
        }
