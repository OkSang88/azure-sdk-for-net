...
namespace AppPlatformManagementClient.Models
{
    ...
    public partial class ConfigurationServiceValidateOperation : Operation<ConfigurationServiceSettingsValidateResult>, IOperationSource<ConfigurationServiceSettingsValidateResult>
    {
        private readonly OperationInternals<ConfigurationServiceSettingsValidateResult> _operation;

        /// <summary> Initializes a new instance of ConfigurationServiceValidateOperation for mocking. </summary>
        protected ConfigurationServiceValidateOperation()
        {
        }

        internal ConfigurationServiceValidateOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<ConfigurationServiceSettingsValidateResult>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "ConfigurationServiceValidateOperation");
        }
