...
namespace Azure.ResourceManager.Scheduler
{
    ...
    {
        private static JobCollectionsRestOperations GetJobCollectionsRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions clientOptions, Uri endpoint = null, string apiVersion = default)
        {
            return new JobCollectionsRestOperations(clientDiagnostics, pipeline, clientOptions, endpoint, apiVersion);
        }
        ...
        public static AsyncPageable<JobCollectionDefinition> GetJobCollectionDefinitionsAsync(this Subscription subscription, CancellationToken cancellationToken = default)
        {
            return subscription.UseClientContext((baseUri, credential, options, pipeline) =>
            {
                ...
                options.TryGetApiVersion(JobCollectionDefinition.ResourceType, out string apiVersion);
                JobCollectionsRestOperations restOperations = GetJobCollectionsRestOperations(clientDiagnostics, pipeline, options, baseUri, apiVersion);
