...
namespace Azure.ResourceManager.StorSimple8000Series.Tests.Mock
{
    ...
    public partial class DeviceMockTests : MockTestBase
    {
        ...
        {
            // Example: DevicesGet
            var deviceId = StorSimple8000Series.Device.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "ResourceGroupForSDKTest", "ManagerForSDKTest1", "Device001ForSDKTest");
        ...
        public async Task Update()
        {
            ...
            var deviceId = StorSimple8000Series.Device.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "ResourceGroupForSDKTest", "ManagerForSDKTest1", "Device001ForSDKTest");
            var device = GetArmClient().GetDevice(deviceId);
            StorSimple8000Series.Models.DevicePatch parameters = new StorSimple8000Series.Models.DevicePatch()
            {
        ...
        public async Task GetDevicePublicEncryptionKeyManager()
        {
            ...
            var deviceId = StorSimple8000Series.Device.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "ResourceGroupForSDKTest", "ManagerForSDKTest1", "sca01forsdktest");
            var device = GetArmClient().GetDevice(deviceId);
        ...
        public async Task SendTestEmailAlert()
        {
            ...
            var deviceId = StorSimple8000Series.Device.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "ResourceGroupForSDKTest", "ManagerForSDKTest1", "Device05ForSDKTest");
            var device = GetArmClient().GetDevice(deviceId);
            StorSimple8000Series.Models.SendTestAlertEmailRequest parameters = new StorSimple8000Series.Models.SendTestAlertEmailRequest(emailList: new List<string>()
{
"testemailid@contoso.com",});
        ...
        public async Task InstallUpdates()
        {
            ...
            var deviceId = StorSimple8000Series.Device.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "ResourceGroupForSDKTest", "ManagerForSDKTest1", "sugattdeviceforSDK");
            var device = GetArmClient().GetDevice(deviceId);
        ...
        public async Task Failover()
        {
            ...
            var deviceId = StorSimple8000Series.Device.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "ResourceGroupForSDKTest", "ManagerForSDKTest1", "default");
            var device = GetArmClient().GetDevice(deviceId);
            StorSimple8000Series.Models.FailoverRequest parameters = new StorSimple8000Series.Models.FailoverRequest()
            {
        ...
        public async Task GetFailoverTargets()
        {
            ...
            var deviceId = StorSimple8000Series.Device.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "ResourceGroupForSDKTest", "ManagerForSDKTest1", "default");
            var device = GetArmClient().GetDevice(deviceId);
            StorSimple8000Series.Models.ListFailoverTargetsRequest parameters = new StorSimple8000Series.Models.ListFailoverTargetsRequest();
...
"/subscriptions/4385cf00-2d3a-425a-832f-f4285b1c9dce/resourceGroups/ResourceGroupForSDKTest/providers/Microsoft.StorSimple/managers/ManagerForSDKTest1/accessControlRecords/ACR2",}, backupElement: new StorSimple8000Series.Models.BackupElement(elementId: "/subscriptions/4385cf00-2d3a-425a-832f-f4285b1c9dce/resourceGroups/ResourceGroupForSDKTest/providers/Microsoft.StorSimple/managers/ManagerForSDKTest1/devices/Device05ForSDKTest/backups/880e1774-94a8-4f3e-85e6-a61e6b94a8b7/elements/7e115577-4a3b-4921-bfd4-ee5a1b9bcbb5_0000000000000000", elementName: "7e115577-4a3b-4921-bfd4-ee5a1b9bcbb5_0000000000000000", elementType: "managers/devices/backups/elements", sizeInBytes: 10737418240, volumeName: "Clonedvolume1", volumeContainerId: "/subscriptions/4385cf00-2d3a-425a-832f-f4285b1c9dce/resourceGroups/ResourceGroupForSDKTest/providers/Microsoft.StorSimple/managers/ManagerForSDKTest1/devices/Device05ForSDKTest/volumeContainers/volumeContainerForSDKTest")
{
    VolumeType = StorSimple8000Series.Models.VolumeType.Tiered,
        ...
        public async Task ChangeControllerPowerStateHardwareComponentGroup()
        {
            ...
            StorSimple8000Series.Models.ControllerPowerStateChangeRequest parameters = new StorSimple8000Series.Models.ControllerPowerStateChangeRequest(action: StorSimple8000Series.Models.ControllerPowerStateAction.Start, activeController: StorSimple8000Series.Models.ControllerId.Controller0, controller0State: StorSimple8000Series.Models.ControllerStatus.Ok, controller1State: StorSimple8000Series.Models.ControllerStatus.NotPresent);
        ...
        public async Task UpdatesGet()
        {
            ...
            var updatesId = StorSimple8000Series.Updates.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "ResourceGroupForSDKTest", "ManagerForSDKTest1", "sugattdeviceforSDK");
        ...
        public async Task AlertSettingsGet()
        {
            ...
            var alertSettingsId = StorSimple8000Series.AlertSettings.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "ResourceGroupForSDKTest", "ManagerForSDKTest1", "Device05ForSDKTest");
