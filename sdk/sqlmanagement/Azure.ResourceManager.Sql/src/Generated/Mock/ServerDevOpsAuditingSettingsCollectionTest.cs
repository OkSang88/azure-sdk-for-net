...
namespace Azure.ResourceManager.Sql.Tests.Mock
{
    ...
    public partial class ServerDevOpsAuditingSettingsCollectionMockTests : MockTestBase
    {
        ...
        public async Task CreateOrUpdateAsync()
        {
            ...
            var collection = GetArmClient().GetSqlServer(new ResourceIdentifier("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/devAuditTestRG/providers/Microsoft.Sql/servers/devOpsAuditTestSvr")).GetServerDevOpsAuditingSettings();
