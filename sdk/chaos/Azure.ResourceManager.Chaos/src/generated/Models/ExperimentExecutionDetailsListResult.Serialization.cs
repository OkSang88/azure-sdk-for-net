...
namespace ChaosManagementClient.Models
{
    internal partial class ExperimentExecutionDetailsListResult
    {
        ...
        {
            Optional<IReadOnlyList<ExperimentExecutionDetailsData>> value = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("value"))
                {
                    ...
                    List<ExperimentExecutionDetailsData> array = new List<ExperimentExecutionDetailsData>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(ExperimentExecutionDetailsData.DeserializeExperimentExecutionDetailsData(item));
                    }
                    value = array;
                    continue;
                }
