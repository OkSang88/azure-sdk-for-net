...
{
    public partial class WatchlistData : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Optional.IsDefined(WatchlistItemsCount))
            {
                writer.WritePropertyName("watchlistItemsCount");
                writer.WriteNumberValue(WatchlistItemsCount.Value);
            }
            writer.WriteEndObject();
            writer.WriteEndObject();
        }

        internal static WatchlistData DeserializeWatchlistData(JsonElement element)
        {
            ...
            Optional<int> watchlistItemsCount = default;
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        {
                            watchlistId = property0.Value.GetString();
                            continue;
                        }
                        ...
                        if (property0.NameEquals("watchlistItemsCount"))
                        {
                            if (property0.Value.ValueKind == JsonValueKind.Null)
                            {
                                property0.ThrowNonNullablePropertyIsNull();
                            ...
                            watchlistItemsCount = property0.Value.GetInt32();
                            continue;
                        }
                    }
                    continue;
            ...
            return new WatchlistData(id, name, type, systemData, etag.Value, watchlistId.Value, displayName.Value, provider.Value, Optional.ToNullable(source), Optional.ToNullable(created), Optional.ToNullable(updated), createdBy.Value, updatedBy.Value, description.Value, watchlistType.Value, watchlistAlias.Value, Optional.ToNullable(isDeleted), Optional.ToList(labels), Optional.ToNullable(defaultDuration), tenantId.Value, Optional.ToNullable(numberOfLinesToSkip), rawContent.Value, itemsSearchKey.Value, contentType.Value, uploadStatus.Value, Optional.ToNullable(watchlistItemsCount));
        }
    }
}
