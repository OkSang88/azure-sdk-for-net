...
namespace Azure.ResourceManager.DataLakeStore.Samples
{
    public partial class Sample_DataLakeStoreAccountCollection
    {
        ...
        public async Task GetAll_ListsTheDataLakeStoreAccountsWithinASpecificResourceGroup()
        {
            ...
            bool? count = false;
            await foreach (DataLakeStoreAccountBasicData item in collection.GetAllAsync(filter: filter, top: top, skip: skip, select: select, orderBy: orderBy, count: count))
            {
...
["test_key"] = "test_value",
                ...
                FirewallRules =
{
new FirewallRuleForDataLakeStoreAccountCreateOrUpdateContent("test_rule",IPAddress.Parse("1.1.1.1"),IPAddress.Parse("2.2.2.2"))
},
