...
namespace Azure.ResourceManager.AppPlatform
{
    ...
    public partial class BuildCollection : ArmCollection, IEnumerable<Build>, IAsyncEnumerable<Build>
    {
        ...
        internal BuildCollection(ArmResource parent) : base(parent)
        {
            ...
            ClientOptions.TryGetApiVersion(Build.ResourceType, out string apiVersion);
        ...
        public virtual BuildCreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, string buildName, BuildData build, CancellationToken cancellationToken = default)
        {
            if (buildName == null)
            {
            ...
            try
            {
                ...
                var operation = new BuildCreateOrUpdateOperation(this, response);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="buildName"/> or <paramref name="build"/> is null. </exception>
        public async virtual Task<BuildCreateOrUpdateOperation> CreateOrUpdateAsync(bool waitForCompletion, string buildName, BuildData build, CancellationToken cancellationToken = default)
        {
            if (buildName == null)
            {
                throw new ArgumentNullException(nameof(buildName));
        ...
        public virtual Pageable<Build> GetAll(CancellationToken cancellationToken = default)
        {
            Page<Build> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    ...
                    return Page.FromValues(response.Value.Value.Select(value => new Build(this, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
