...
namespace Azure.ResourceManager.SqlVirtualMachine.Tests.Mock
{
    ...
    public partial class SqlVirtualMachineMockTests : MockTestBase
    {
        ...
        public async Task Get()
        {
            ...
            var sqlVirtualMachineId = SqlVirtualMachine.SqlVirtualMachine.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "testrg", "testvm");
        ...
        public async Task Delete()
        {
            ...
            var sqlVirtualMachineId = SqlVirtualMachine.SqlVirtualMachine.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "testrg", "testvm1");
            var sqlVirtualMachine = GetArmClient().GetSqlVirtualMachine(sqlVirtualMachineId);
        ...
        public async Task Update()
        {
            ...
            var sqlVirtualMachineId = SqlVirtualMachine.SqlVirtualMachine.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "testrg", "testvm");
            var sqlVirtualMachine = GetArmClient().GetSqlVirtualMachine(sqlVirtualMachineId);
            SqlVirtualMachine.Models.SqlVirtualMachineUpdate parameters = new SqlVirtualMachine.Models.SqlVirtualMachineUpdate();
