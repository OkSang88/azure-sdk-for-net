...
namespace Azure.ResourceManager.DataFactory.Models
{
    public partial class AzureBlobFSLinkedService : IUtf8JsonSerializable
    {
        ...
        internal static AzureBlobFSLinkedService DeserializeAzureBlobFSLinkedService(JsonElement element)
        {
            ...
            return new AzureBlobFSLinkedService(type, connectVia.Value, description.Value, Optional.ToDictionary(parameters), Optional.ToList(annotations), additionalProperties, url, accountKey.Value, servicePrincipalId.Value, servicePrincipalKey.Value, tenant.Value, azureCloudType.Value, encryptedCredential.Value, credential.Value);
        }
    }
}
