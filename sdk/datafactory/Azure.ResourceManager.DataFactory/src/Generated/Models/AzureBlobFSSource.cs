...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AzureBlobFSSource : CopySource
    {
        ...
        internal AzureBlobFSSource(string type, object sourceRetryCount, object sourceRetryWait, object maxConcurrentConnections, object disableMetricsCollection, IDictionary<string, object> additionalProperties, object treatEmptyAsNull, object skipHeaderLineCount, object recursive) : base(type, sourceRetryCount, sourceRetryWait, maxConcurrentConnections, disableMetricsCollection, additionalProperties)
        {
