...
namespace StorSimple8000SeriesManagementClient.Tests.Mock
{
    ...
    public partial class BackupScheduleCollectionMockTests : MockTestBase
    {
        ...
        public async Task CreateOrUpdate()
        {
            ...
            StorSimple8000SeriesManagementClient.BackupScheduleData parameters = new StorSimple8000SeriesManagementClient.BackupScheduleData(scheduleRecurrence: new StorSimple8000SeriesManagementClient.Models.ScheduleRecurrence(recurrenceType: StorSimple8000SeriesManagementClient.Models.RecurrenceType.Weekly, recurrenceValue: 1), backupType: StorSimple8000SeriesManagementClient.Models.BackupType.CloudSnapshot, retentionCount: 1, startTime: DateTimeOffset.Parse("2017-06-24T01:00:00Z"), scheduleStatus: StorSimple8000SeriesManagementClient.Models.ScheduleStatus.Enabled)
            {
                Kind = "Series8000",
            };

            var backupPolicyId = StorSimple8000SeriesManagementClient.BackupPolicy.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "ResourceGroupForSDKTest", "ManagerForSDKTest1", "Device05ForSDKTest", "BkUpPolicy01ForSDKTest");
