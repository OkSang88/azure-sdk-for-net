...
namespace Azure.ResourceManager.EventHubs.Tests.Mock
{
    ...
    public partial class PrivateEndpointConnectionMockTests : MockTestBase
    {
        ...
        public async Task Get()
        {
            ...
            var privateEndpointConnectionId = EventHubs.PrivateEndpointConnection.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "SDK-EventHub-4794", "sdk-Namespace-5828", "privateEndpointConnectionName");
        ...
        public async Task Delete()
        {
            ...
            var privateEndpointConnectionId = EventHubs.PrivateEndpointConnection.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "ArunMonocle", "sdk-Namespace-3285", "928c44d5-b7c6-423b-b6fa-811e0c27b3e0");
            var privateEndpointConnection = GetArmClient().GetPrivateEndpointConnection(privateEndpointConnectionId);
