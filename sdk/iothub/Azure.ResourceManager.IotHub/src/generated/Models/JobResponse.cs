...
namespace IotHubClient.Models
{
    ...
    public partial class JobResponse
    {
        ...
        internal JobResponse(string jobId, DateTimeOffset? startTimeUtc, DateTimeOffset? endTimeUtc, JobType? type, JobStatus? status, string failureReason, string statusMessage, string parentJobId)
        {
            JobId = jobId;
