...
namespace Insights
{
    /// <summary> A class representing the MetricAlertResource data model. </summary>
    public partial class MetricAlertResourceData : TrackedResource
    {
        /// <summary> Initializes a new instance of MetricAlertResourceData. </summary>
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="description"/> or <paramref name="criteria"/> is null. </exception>
        public MetricAlertResourceData(AzureLocation location, string description, int severity, bool enabled, TimeSpan evaluationFrequency, TimeSpan windowSize, MetricAlertCriteria criteria) : base(location)
        {
            if (description == null)
            {
