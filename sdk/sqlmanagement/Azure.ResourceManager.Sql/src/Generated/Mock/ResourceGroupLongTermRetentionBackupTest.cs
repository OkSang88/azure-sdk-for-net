...
namespace Azure.ResourceManager.Sql.Tests.Mock
{
    ...
    public partial class ResourceGroupLongTermRetentionBackupMockTests : MockTestBase
    {
        ...
        public async Task GetAsync()
        {
            ...
            var resourceGroupLongTermRetentionBackup = GetArmClient().GetResourceGroupLongTermRetentionBackup(new ResourceIdentifier("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/testResourceGroup/providers/Microsoft.Sql/locations/japaneast/longTermRetentionServers/testserver/longTermRetentionDatabases/testDatabase/longTermRetentionBackups/55555555-6666-7777-8888-999999999999;131637960820000000"));
        ...
        public async Task DeleteAsync()
        {
            ...
            await resourceGroupLongTermRetentionBackup.DeleteAsync();
        }

        [RecordedTest]
        public async Task CopyByResourceGroupAsync()
        {
            ...
            await resourceGroupLongTermRetentionBackup.CopyByResourceGroupAsync(parameters);
        }

        [RecordedTest]
        public async Task UpdateByResourceGroupAsync()
        {
            ...
            await resourceGroupLongTermRetentionBackup.UpdateByResourceGroupAsync(parameters);
        }
    }
}
