...
{
    public partial class ConfigurationServiceGitRepository : IUtf8JsonSerializable
    {
        ...
        internal static ConfigurationServiceGitRepository DeserializeConfigurationServiceGitRepository(JsonElement element)
        {
            string name = default;
            ...
            return new ConfigurationServiceGitRepository(name, patterns, uri, label, Optional.ToList(searchPaths), username.Value, password.Value, hostKey.Value, hostKeyAlgorithm.Value, privateKey.Value, Optional.ToNullable(strictHostKeyChecking));
        }
    }
}
