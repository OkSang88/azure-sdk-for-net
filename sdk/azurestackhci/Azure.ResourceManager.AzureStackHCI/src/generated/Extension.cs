...
using AzureStackHCIClient.Models;

namespace AzureStackHCIClient
{
    ...
    public partial class Extension : ArmResource
    {
        ...
        public async virtual Task<ExtensionUpdateOperation> UpdateAsync(bool waitForCompletion, ExtensionData extension, CancellationToken cancellationToken = default)
        {
            if (extension == null)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="extension"/> is null. </exception>
        public virtual ExtensionUpdateOperation Update(bool waitForCompletion, ExtensionData extension, CancellationToken cancellationToken = default)
        {
            if (extension == null)
            {
                throw new ArgumentNullException(nameof(extension));
