...
namespace AzureStackHCIClient
{
    ...
    public partial class ClusterCollection : ArmCollection, IEnumerable<Cluster>, IAsyncEnumerable<Cluster>
    {
        ...
        public virtual ClusterCreateOperation CreateOrUpdate(bool waitForCompletion, string clusterName, ClusterData cluster, CancellationToken cancellationToken = default)
        {
            if (clusterName == null)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="clusterName"/> or <paramref name="cluster"/> is null. </exception>
        public async virtual Task<ClusterCreateOperation> CreateOrUpdateAsync(bool waitForCompletion, string clusterName, ClusterData cluster, CancellationToken cancellationToken = default)
        {
            if (clusterName == null)
            {
                throw new ArgumentNullException(nameof(clusterName));
