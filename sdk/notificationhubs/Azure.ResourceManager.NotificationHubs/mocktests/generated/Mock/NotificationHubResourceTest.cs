...
namespace Azure.ResourceManager.NotificationHubs.Tests.Mock
{
    ...
    public partial class NotificationHubResourceMockTests : MockTestBase
    {
        ...
        public async Task Update()
        {
            ...
            var notificationHubResourceId = NotificationHubs.NotificationHubResource.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "sdkresourceGroup", "nh-sdk-ns", "sdk-notificationHubs-8708");
            var notificationHubResource = GetArmClient().GetNotificationHubResource(notificationHubResourceId);
            NotificationHubs.Models.NotificationHubPatchParameters parameters = new NotificationHubs.Models.NotificationHubPatchParameters(location: AzureLocation.WestUS);
