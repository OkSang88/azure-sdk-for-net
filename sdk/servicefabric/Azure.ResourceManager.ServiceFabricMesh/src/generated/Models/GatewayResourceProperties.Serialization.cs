...
{
    public partial class GatewayResourceProperties : IUtf8JsonSerializable
    {
        ...
        internal static GatewayResourceProperties DeserializeGatewayResourceProperties(JsonElement element)
        {
            ...
            return new GatewayResourceProperties(provisioningState.Value, description.Value, sourceNetwork, destinationNetwork, Optional.ToList(tcp), Optional.ToList(http), Optional.ToNullable(status), statusDetails.Value, ipAddress.Value);
        }
    }
}
