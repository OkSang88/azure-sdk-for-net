...
{
    public partial class Sample_LoadTestingCollection
    {
        ...
        public async Task GetAll_LoadTestsListByResourceGroup()
        {
            ...
            LoadTestingCollection collection = resourceGroupResource.GetLoadTestings();
        ...
        public async Task CreateOrUpdate_LoadTestsCreateOrUpdate()
        {
            ...
            // invoke the operation
            string loadTestName = "myLoadTest";
            LoadTestingData data = new LoadTestingData(new AzureLocation("westus"))
            {
