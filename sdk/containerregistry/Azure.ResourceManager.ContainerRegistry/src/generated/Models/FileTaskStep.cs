...
namespace ContainerRegistryManagementClient.Models
{
    ...
    public partial class FileTaskStep : TaskStepProperties
    {
        ...
        internal FileTaskStep(StepType type, IReadOnlyList<BaseImageDependency> baseImageDependencies, string contextPath, string contextAccessToken, string taskFilePath, string valuesFilePath, IList<SetValue> values) : base(type, baseImageDependencies, contextPath, contextAccessToken)
        {
            TaskFilePath = taskFilePath;
