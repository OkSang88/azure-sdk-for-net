...
namespace DataFactoryManagementClient.Models
{
    public partial class ExecuteWranglingDataflowActivity : IUtf8JsonSerializable
    {
        ...
        internal static ExecuteWranglingDataflowActivity DeserializeExecuteWranglingDataflowActivity(JsonElement element)
        {
            ...
            return new ExecuteWranglingDataflowActivity(name, type, description.Value, Optional.ToList(dependsOn), Optional.ToList(userProperties), additionalProperties, policy.Value, dataFlow, staging.Value, integrationRuntime.Value, compute.Value, traceLevel.Value, continueOnError.Value, runConcurrently.Value, Optional.ToDictionary(sinks), Optional.ToList(queries));
        }
    }
}
