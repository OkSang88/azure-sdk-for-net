...
namespace BatchManagementClient.Models
{
    public partial class StartTask : IUtf8JsonSerializable
    {
        ...
        internal static StartTask DeserializeStartTask(JsonElement element)
        {
            ...
            return new StartTask(commandLine.Value, Optional.ToList(resourceFiles), Optional.ToList(environmentSettings), userIdentity.Value, Optional.ToNullable(maxTaskRetryCount), Optional.ToNullable(waitForSuccess), containerSettings.Value);
        }
    }
}
