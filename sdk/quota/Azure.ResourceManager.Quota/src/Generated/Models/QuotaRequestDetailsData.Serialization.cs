...
namespace Azure.ResourceManager.Quota
{
    public partial class QuotaRequestDetailsData
    {
        internal static QuotaRequestDetailsData DeserializeQuotaRequestDetailsData(JsonElement element)
        {
            ...
            return new QuotaRequestDetailsData(id, name, type, Optional.ToNullable(provisioningState), message.Value, error.Value, Optional.ToNullable(requestSubmitTime), Optional.ToList(value));
        }
    }
}
