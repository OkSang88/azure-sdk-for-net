...
namespace DataFactoryManagementClient.Models
{
    ...
    public partial class ManagedIntegrationRuntimeError
    {
        ...
        internal ManagedIntegrationRuntimeError(DateTimeOffset? time, string code, IReadOnlyList<string> parameters, string message, IReadOnlyDictionary<string, object> additionalProperties)
        {
            Time = time;
            Code = code;
