...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AzureDataLakeStoreWriteSettings : StoreWriteSettings
    {
        ...
        internal AzureDataLakeStoreWriteSettings(string type, object maxConcurrentConnections, object disableMetricsCollection, object copyBehavior, IDictionary<string, object> additionalProperties, object expiryDateTime) : base(type, maxConcurrentConnections, disableMetricsCollection, copyBehavior, additionalProperties)
        {
