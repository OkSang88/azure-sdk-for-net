...
namespace IotHubClient.Models
{
    ...
    {
        /// <summary> Initializes a new instance of RoutingProperties. </summary>
        public RoutingProperties()
        {
            Routes = new ChangeTrackingList<RouteProperties>();
            Enrichments = new ChangeTrackingList<EnrichmentProperties>();
        }
        ...
        internal RoutingProperties(RoutingEndpoints endpoints, IList<RouteProperties> routes, FallbackRouteProperties fallbackRoute, IList<EnrichmentProperties> enrichments)
        {
            Endpoints = endpoints;
            Routes = routes;
        ...
        public IList<RouteProperties> Routes { get; }
        ...
        public IList<EnrichmentProperties> Enrichments { get; }
    }
}
