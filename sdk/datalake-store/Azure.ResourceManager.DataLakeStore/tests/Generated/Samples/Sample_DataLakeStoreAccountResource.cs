...
namespace Azure.ResourceManager.DataLakeStore.Samples
{
    public partial class Sample_DataLakeStoreAccountResource
    {
        ...
        public async Task GetAccounts_ListsTheDataLakeStoreAccountsWithinTheSubscription()
        {
            ...
            bool? count = false;
            await foreach (DataLakeStoreAccountBasicData item in subscriptionResource.GetAccountsAsync(filter: filter, top: top, skip: skip, select: select, orderBy: orderBy, count: count))
            {
