...
namespace AppPlatformManagementClient.Models
{
    ...
    public partial class GatewayApiMetadataProperties
    {
        ...
        /// <param name="serverUrl"> Base URL that API consumers will use to access APIs on the Gateway instance. </param>
        internal GatewayApiMetadataProperties(string title, string description, string documentation, string version, string serverUrl)
        {
            Title = title;
