...
namespace Azure.ResourceManager.Sql.Tests.Mock
{
    ...
    public partial class LogicalDatabaseTransparentDataEncryptionMockTests : MockTestBase
    {
        ...
        public async Task GetAsync()
        {
            ...
            var logicalDatabaseTransparentDataEncryption = GetArmClient().GetLogicalDatabaseTransparentDataEncryption(new ResourceIdentifier("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/security-tde-resourcegroup/providers/Microsoft.Sql/servers/securitytde/databases/testdb/transparentDataEncryption/current"));
