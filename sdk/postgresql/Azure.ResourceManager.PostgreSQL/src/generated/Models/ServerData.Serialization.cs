...
namespace PostgreSQLManagementClient
{
    public partial class ServerData : IUtf8JsonSerializable
    {
        ...
        internal static ServerData DeserializeServerData(JsonElement element)
        {
            ...
            return new ServerData(id, name, type, tags, location, sku.Value, systemData, administratorLogin.Value, administratorLoginPassword.Value, Optional.ToNullable(version), minorVersion.Value, Optional.ToNullable(state), fullyQualifiedDomainName.Value, storage.Value, backup.Value, network.Value, highAvailability.Value, maintenanceWindow.Value, sourceServerResourceId.Value, Optional.ToNullable(pointInTimeUTC), availabilityZone.Value, Optional.ToNullable(createMode));
        }
    }
}
