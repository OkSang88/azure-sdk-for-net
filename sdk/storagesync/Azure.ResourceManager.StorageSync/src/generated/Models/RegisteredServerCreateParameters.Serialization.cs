...
{
    public partial class RegisteredServerCreateParameters : IUtf8JsonSerializable
    {
        ...
        internal static RegisteredServerCreateParameters DeserializeRegisteredServerCreateParameters(JsonElement element)
        {
            ...
            return new RegisteredServerCreateParameters(id, name, type, serverCertificate.Value, agentVersion.Value, serverOSVersion.Value, lastHeartBeat.Value, serverRole.Value, clusterId.Value, clusterName.Value, serverId.Value, friendlyName.Value);
        }
    }
}
