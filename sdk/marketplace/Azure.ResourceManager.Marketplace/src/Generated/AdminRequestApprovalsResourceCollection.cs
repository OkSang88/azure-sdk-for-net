...
namespace Azure.ResourceManager.Marketplace
{
    ...
    public partial class AdminRequestApprovalsResourceCollection : ArmCollection, IEnumerable<AdminRequestApprovalsResource>, IAsyncEnumerable<AdminRequestApprovalsResource>
    {
        ...
        internal AdminRequestApprovalsResourceCollection(ArmResource parent) : base(parent)
        {
            ...
            ClientOptions.TryGetApiVersion(AdminRequestApprovalsResource.ResourceType, out string apiVersion);
        ...
        public virtual AdminRequestApprovalsResourceCreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, string adminRequestApprovalId, AdminRequestApprovalsResourceData payload = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new AdminRequestApprovalsResourceCreateOrUpdateOperation(this, response);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="adminRequestApprovalId"/> is null. </exception>
        public async virtual Task<AdminRequestApprovalsResourceCreateOrUpdateOperation> CreateOrUpdateAsync(bool waitForCompletion, string adminRequestApprovalId, AdminRequestApprovalsResourceData payload = null, CancellationToken cancellationToken = default)
        {
            if (adminRequestApprovalId == null)
            {
                throw new ArgumentNullException(nameof(adminRequestApprovalId));
        ...
        public virtual Pageable<AdminRequestApprovalsResource> GetAll(CancellationToken cancellationToken = default)
        {
            Page<AdminRequestApprovalsResource> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    ...
                    return Page.FromValues(response.Value.Value.Select(value => new AdminRequestApprovalsResource(this, value)), null, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
