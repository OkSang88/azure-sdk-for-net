...
namespace Azure.ResourceManager.Sql.Tests.Mock
{
    ...
    public partial class SubscriptionLongTermRetentionManagedInstanceBackupCollectionMockTests : MockTestBase
    {
        ...
        public async Task Get()
        {
            ...
            var collection = GetArmClient().GetSubscription(new ResourceIdentifier("/subscriptions/00000000-0000-0000-0000-000000000000")).GetSubscriptionLongTermRetentionManagedInstanceBackups(locationName, managedInstanceName, databaseName);
