...
namespace Azure.ResourceManager.SecurityInsights
{
    internal partial class SentinelOnboardingStatesRestOperations
    {
        ...
        public SentinelOnboardingStatesRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ClientOptions options, Uri endpoint = null, string apiVersion = "2021-09-01-preview")
        {
        ...
        public async Task<Response<SentinelOnboardingStateData>> GetAsync(string subscriptionId, string resourceGroupName, string workspaceName, string sentinelOnboardingStateName, CancellationToken cancellationToken = default)
        {
            ...
            switch (message.Response.Status)
            {
                case 200:
                    {
                        SentinelOnboardingStateData value = default;
                        using var document = await JsonDocument.ParseAsync(message.Response.ContentStream, default, cancellationToken).ConfigureAwait(false);
                        value = SentinelOnboardingStateData.DeserializeSentinelOnboardingStateData(document.RootElement);
                        return Response.FromValue(value, message.Response);
                    }
                case 404:
                    return Response.FromValue((SentinelOnboardingStateData)null, message.Response);
                default:
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="subscriptionId"/>, <paramref name="resourceGroupName"/>, <paramref name="workspaceName"/>, or <paramref name="sentinelOnboardingStateName"/> is null. </exception>
        public Response<SentinelOnboardingStateData> Get(string subscriptionId, string resourceGroupName, string workspaceName, string sentinelOnboardingStateName, CancellationToken cancellationToken = default)
        {
            if (subscriptionId == null)
            {
                throw new ArgumentNullException(nameof(subscriptionId));
        ...
        internal HttpMessage CreateCreateRequest(string subscriptionId, string resourceGroupName, string workspaceName, string sentinelOnboardingStateName, SentinelOnboardingStateData sentinelOnboardingStateParameter)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            ...
            if (sentinelOnboardingStateParameter != null)
            {
                ...
                content.JsonWriter.WriteObjectValue(sentinelOnboardingStateParameter);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="subscriptionId"/>, <paramref name="resourceGroupName"/>, <paramref name="workspaceName"/>, or <paramref name="sentinelOnboardingStateName"/> is null. </exception>
        public async Task<Response<SentinelOnboardingStateData>> CreateAsync(string subscriptionId, string resourceGroupName, string workspaceName, string sentinelOnboardingStateName, SentinelOnboardingStateData sentinelOnboardingStateParameter = null, CancellationToken cancellationToken = default)
        {
            if (subscriptionId == null)
            {
                throw new ArgumentNullException(nameof(subscriptionId));
            ...
            using var message = CreateCreateRequest(subscriptionId, resourceGroupName, workspaceName, sentinelOnboardingStateName, sentinelOnboardingStateParameter);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="subscriptionId"/>, <paramref name="resourceGroupName"/>, <paramref name="workspaceName"/>, or <paramref name="sentinelOnboardingStateName"/> is null. </exception>
        public Response<SentinelOnboardingStateData> Create(string subscriptionId, string resourceGroupName, string workspaceName, string sentinelOnboardingStateName, SentinelOnboardingStateData sentinelOnboardingStateParameter = null, CancellationToken cancellationToken = default)
        {
            if (subscriptionId == null)
            {
                throw new ArgumentNullException(nameof(subscriptionId));
