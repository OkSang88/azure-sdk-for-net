        ...
        internal static JobResponse DeserializeJobResponse(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("type"))
                {
                    ...
                    type = new JobType(property.Value.GetString());
                    continue;
                }
            ...
            return new JobResponse(jobId.Value, Optional.ToNullable(startTimeUtc), Optional.ToNullable(endTimeUtc), Optional.ToNullable(type), Optional.ToNullable(status), failureReason.Value, statusMessage.Value, parentJobId.Value);
        }
    }
}
