...
{
    public partial class DockerBuildRequest : IUtf8JsonSerializable
    {
        ...
        internal static DockerBuildRequest DeserializeDockerBuildRequest(JsonElement element)
        {
            ...
            return new DockerBuildRequest(type, Optional.ToNullable(isArchiveEnabled), agentPoolName.Value, logTemplate.Value, Optional.ToList(imageNames), Optional.ToNullable(isPushEnabled), Optional.ToNullable(noCache), dockerFilePath, target.Value, Optional.ToList(arguments), Optional.ToNullable(timeout), platform, agentConfiguration.Value, sourceLocation.Value, credentials.Value);
        }
    }
}
