...
namespace Azure.ResourceManager.FrontDoor.Models
{
    ...
    public partial class LoadBalancingSettingsModel : SubResource
    {
        ...
        internal LoadBalancingSettingsModel(string id, string name, string type, int? sampleSize, int? successfulSamplesRequired, int? additionalLatencyMilliseconds, FrontDoorResourceState? resourceState) : base(id)
        {
            Name = name;
            Type = type;
