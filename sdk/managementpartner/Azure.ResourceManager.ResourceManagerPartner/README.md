# Azure ResourceManagerPartner Management client library for .NET
...
Install the Azure ResourceManagerPartner management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.ResourceManagerPartner -Version 1.0.0-preview.1 
```
