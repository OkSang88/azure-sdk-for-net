    ...
    public partial class ServiceResource : ArmResource
    {
        ...
        public async virtual Task<ServiceDeleteOperation> DeleteAsync(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ServiceDeleteOperation(_clientDiagnostics, Pipeline, _servicesRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name).Request, response);
        ...
        public async virtual Task<ServiceUpdateOperation> UpdateAsync(bool waitForCompletion, ServiceResourceUpdate parameters, CancellationToken cancellationToken = default)
        {
            if (parameters == null)
            {
            ...
            try
            {
                ...
                var operation = new ServiceUpdateOperation(this, _clientDiagnostics, Pipeline, _servicesRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, parameters).Request, response);
                if (waitForCompletion)
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="parameters"/> is null. </exception>
        public virtual ServiceUpdateOperation Update(bool waitForCompletion, ServiceResourceUpdate parameters, CancellationToken cancellationToken = default)
        {
            if (parameters == null)
            {
                throw new ArgumentNullException(nameof(parameters));
