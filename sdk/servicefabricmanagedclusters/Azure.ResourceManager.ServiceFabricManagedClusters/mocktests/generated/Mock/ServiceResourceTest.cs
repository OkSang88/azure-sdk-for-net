...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Tests.Mock.Tests.Mock
{
    ...
    public partial class ServiceResourceMockTests : MockTestBase
    {
        ...
        public async Task Get()
        {
            ...
            var serviceResourceId = ServiceFabricManagedClusters.Tests.Mock.ServiceResource.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "resRg", "myCluster", "myApp", "myService");
        ...
        public async Task Update()
        {
            ...
            var serviceResourceId = ServiceFabricManagedClusters.Tests.Mock.ServiceResource.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "resRg", "myCluster", "myApp", "myService");
            var serviceResource = GetArmClient().GetServiceResource(serviceResourceId);
            ServiceFabricManagedClusters.Tests.Mock.Models.ServiceUpdateParameters parameters = new ServiceFabricManagedClusters.Tests.Mock.Models.ServiceUpdateParameters();
