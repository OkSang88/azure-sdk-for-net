# Azure ApiResourceManager Management client library for .NET
...
Install the Azure ApiResourceManager management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.ApiResourceManager -Version 1.0.0-preview.1 
```
