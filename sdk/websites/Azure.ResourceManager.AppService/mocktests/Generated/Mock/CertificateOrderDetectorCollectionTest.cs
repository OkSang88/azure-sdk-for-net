...
namespace Azure.ResourceManager.AppService.Tests.Mock
{
    ...
    public partial class CertificateOrderDetectorCollectionMockTests : MockTestBase
    {
        ...
        public async Task GetAsync()
        {
            ...
            var collection = GetArmClient().GetAppServiceCertificateOrder(new ResourceIdentifier("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/Sample-WestUSResourceGroup/providers/Microsoft.CertificateRegistration/certificateOrders/SampleCertificateOrderName")).GetCertificateOrderDetectors();
