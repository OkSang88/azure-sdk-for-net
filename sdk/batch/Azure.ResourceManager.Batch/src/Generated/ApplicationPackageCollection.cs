...
namespace Azure.ResourceManager.Batch
{
    ...
    public partial class ApplicationPackageCollection : ArmCollection, IEnumerable<ApplicationPackage>, IAsyncEnumerable<ApplicationPackage>
    {
        ...
        internal ApplicationPackageCollection(ArmResource parent) : base(parent)
        {
            ...
            ClientOptions.TryGetApiVersion(ApplicationPackage.ResourceType, out string apiVersion);
        ...
        public virtual ApplicationPackageCreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, string versionName, ApplicationPackageData parameters = null, CancellationToken cancellationToken = default)
        {
            if (versionName == null)
            {
            ...
            try
            {
                ...
                var operation = new ApplicationPackageCreateOrUpdateOperation(this, response);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="versionName"/> is null. </exception>
        public async virtual Task<ApplicationPackageCreateOrUpdateOperation> CreateOrUpdateAsync(bool waitForCompletion, string versionName, ApplicationPackageData parameters = null, CancellationToken cancellationToken = default)
        {
            if (versionName == null)
            {
                throw new ArgumentNullException(nameof(versionName));
        ...
        public virtual Pageable<ApplicationPackage> GetAll(int? maxresults = null, CancellationToken cancellationToken = default)
        {
            Page<ApplicationPackage> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    ...
                    return Page.FromValues(response.Value.Value.Select(value => new ApplicationPackage(this, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
