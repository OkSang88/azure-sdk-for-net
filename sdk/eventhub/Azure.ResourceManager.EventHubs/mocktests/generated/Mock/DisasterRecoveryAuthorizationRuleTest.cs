...
namespace Azure.ResourceManager.EventHubs.Tests.Mock
{
    ...
    public partial class DisasterRecoveryAuthorizationRuleMockTests : MockTestBase
    {
        ...
        public async Task GetKeysAsync()
        {
            ...
            var disasterRecoveryAuthorizationRule = GetArmClient().GetDisasterRecoveryAuthorizationRule(new ResourceIdentifier("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/exampleResourceGroup/providers/Microsoft.EventHub/namespaces/sdk-Namespace-2702/disasterRecoveryConfigs/sdk-DisasterRecovery-4047/authorizationRules/sdk-Authrules-1746"));
