...
namespace ServiceFabricManagedClustersManagementClient.Models
{
    public partial class StatefulServiceProperties : IUtf8JsonSerializable
    {
        ...
        internal static StatefulServiceProperties DeserializeStatefulServiceProperties(JsonElement element)
        {
            ...
            Optional<string> replicaRestartWaitDuration = default;
            Optional<string> quorumLossWaitDuration = default;
            Optional<string> standByReplicaKeepDuration = default;
            Optional<string> servicePlacementTimeLimit = default;
