# Azure VideoAnalyzer Management client library for .NET
...
Install the Azure VideoAnalyzer management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.VideoAnalyzer -Version 1.0.0-preview.1 
```
