...
namespace NotificationHubsManagementClient.Models
{
    ...
    {
        internal static ResourceListKeys DeserializeResourceListKeys(JsonElement element)
        {
            ...
            return new ResourceListKeys(primaryConnectionString.Value, secondaryConnectionString.Value, primaryKey.Value, secondaryKey.Value, keyName.Value);
        }
    }
}
