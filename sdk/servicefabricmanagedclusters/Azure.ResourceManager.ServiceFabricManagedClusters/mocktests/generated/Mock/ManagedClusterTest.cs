...
namespace ServiceFabricManagedClustersManagementClient.Tests.Mock
{
    ...
    public partial class ManagedClusterMockTests : MockTestBase
    {
        ...
        public async Task Update()
        {
            ...
            var managedClusterId = ServiceFabricManagedClustersManagementClient.ManagedCluster.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "resRg", "myCluster");
            var managedCluster = GetArmClient().GetManagedCluster(managedClusterId);
            ServiceFabricManagedClustersManagementClient.Models.ManagedClusterUpdateParameters parameters = new ServiceFabricManagedClustersManagementClient.Models.ManagedClusterUpdateParameters();
