...
namespace Azure.ResourceManager.KubernetesConfiguration.Tests.Mock
{
    ...
    public partial class FluxConfigurationMockTests : MockTestBase
    {
        ...
        public async Task Get()
        {
            ...
            var fluxConfigurationId = KubernetesConfiguration.FluxConfiguration.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "rg1", "Microsoft.Kubernetes", "connectedClusters", "clusterName1", "srs-fluxconfig");
        ...
        public async Task Update()
        {
            ...
            var fluxConfigurationId = KubernetesConfiguration.FluxConfiguration.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "rg1", "Microsoft.Kubernetes", "connectedClusters", "clusterName1", "srs-fluxconfig");
            var fluxConfiguration = GetArmClient().GetFluxConfiguration(fluxConfigurationId);
            KubernetesConfiguration.Models.FluxConfigurationPatch fluxConfigurationPatch = new KubernetesConfiguration.Models.FluxConfigurationPatch()
            {
                Suspend = true,
                GitRepository = new KubernetesConfiguration.Models.GitRepositoryPatchDefinition()
                {
                    Url = "https://github.com/jonathan-innis/flux2-kustomize-helm-example.git",
                },
                Kustomizations = new Dictionary<string, KubernetesConfiguration.Models.KustomizationPatchDefinition>()
                {
                    ["srs-kustomization1"] = new KubernetesConfiguration.Models.KustomizationPatchDefinition(),
                    ["srs-kustomization2"] = new KubernetesConfiguration.Models.KustomizationPatchDefinition()
                    {
                        Path = "./test/alt-path",
                    ...
                    ["srs-kustomization3"] = new KubernetesConfiguration.Models.KustomizationPatchDefinition()
                    {
