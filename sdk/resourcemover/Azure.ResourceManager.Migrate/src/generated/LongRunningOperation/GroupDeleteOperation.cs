...
namespace AzureMigrateV2.Models
{
    ...
    /// 
    /// </summary>
    public partial class GroupDeleteOperation : Operation
    {
        private readonly OperationOrResponseInternals _operation;

        /// <summary> Initializes a new instance of GroupDeleteOperation for mocking. </summary>
        protected GroupDeleteOperation()
        {
        }

        internal GroupDeleteOperation(Response response)
        {
