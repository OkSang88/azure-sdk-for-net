...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class SftpWriteSettings : StoreWriteSettings
    {
        ...
        internal SftpWriteSettings(string type, object maxConcurrentConnections, object disableMetricsCollection, object copyBehavior, IDictionary<string, object> additionalProperties, object operationTimeout, object useTempFileRename) : base(type, maxConcurrentConnections, disableMetricsCollection, copyBehavior, additionalProperties)
        {
