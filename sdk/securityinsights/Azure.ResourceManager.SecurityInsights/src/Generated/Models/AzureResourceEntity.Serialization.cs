...
{
    public partial class AzureResourceEntity : IUtf8JsonSerializable
    {
        ...
        internal static AzureResourceEntity DeserializeAzureResourceEntity(JsonElement element)
        {
            ...
            return new AzureResourceEntity(id, name, type, systemData, kind, Optional.ToDictionary(additionalData), friendlyName.Value, resourceId.Value, subscriptionId.Value);
        }
    }
}
