...
namespace Insights
{
    ...
    public partial class AutoscaleSettingResourceCollection : ArmCollection, IEnumerable<AutoscaleSettingResource>, IAsyncEnumerable<AutoscaleSettingResource>
    {
        ...
        public virtual AutoscaleSettingCreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, string autoscaleSettingName, AutoscaleSettingResourceData parameters, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="autoscaleSettingName"/> or <paramref name="parameters"/> is null. </exception>
        public async virtual Task<AutoscaleSettingCreateOrUpdateOperation> CreateOrUpdateAsync(bool waitForCompletion, string autoscaleSettingName, AutoscaleSettingResourceData parameters, CancellationToken cancellationToken = default)
        {
            if (autoscaleSettingName == null)
            {
                throw new ArgumentNullException(nameof(autoscaleSettingName));
