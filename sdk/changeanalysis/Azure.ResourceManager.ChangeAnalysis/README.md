# Azure ChangeAnalysis Management client library for .NET
...
Install the Azure ChangeAnalysis management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.ChangeAnalysis -Version 1.0.0-preview.1 
```
