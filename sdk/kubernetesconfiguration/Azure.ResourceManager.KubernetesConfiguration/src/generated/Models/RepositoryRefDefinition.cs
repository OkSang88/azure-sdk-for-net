...
namespace SourceControlConfigurationClient.Models
{
    ...
    {
        /// <summary> Initializes a new instance of RepositoryRefDefinition. </summary>
        ...
        internal RepositoryRefDefinition(string branch, string tag, string semver, string commit)
        {
            Branch = branch;
            Tag = tag;
            Semver = semver;
