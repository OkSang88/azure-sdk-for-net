...
namespace Azure.ResourceManager.KubernetesConfiguration
{
    ...
    public partial class ExtensionCollection : ArmCollection, IEnumerable<Extension>, IAsyncEnumerable<Extension>
    {
        ...
        internal ExtensionCollection(ArmResource parent, Enum0 clusterRp, Enum1 clusterResourceName, string clusterName) : base(parent)
        {
        ...
        public virtual ExtensionCreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, string extensionName, ExtensionData extension, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _extensionsRestClient.Create(Id.SubscriptionId, Id.ResourceGroupName, _clusterRp, _clusterResourceName, _clusterName, extensionName, extension, cancellationToken);
                var operation = new ExtensionCreateOrUpdateOperation(this, _clientDiagnostics, Pipeline, _extensionsRestClient.CreateCreateRequest(Id.SubscriptionId, Id.ResourceGroupName, _clusterRp, _clusterResourceName, _clusterName, extensionName, extension).Request, response);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="extensionName"/> or <paramref name="extension"/> is null. </exception>
        public async virtual Task<ExtensionCreateOrUpdateOperation> CreateOrUpdateAsync(bool waitForCompletion, string extensionName, ExtensionData extension, CancellationToken cancellationToken = default)
        {
            if (extensionName == null)
            {
                throw new ArgumentNullException(nameof(extensionName));
            ...
            try
            {
                var response = await _extensionsRestClient.CreateAsync(Id.SubscriptionId, Id.ResourceGroupName, _clusterRp, _clusterResourceName, _clusterName, extensionName, extension, cancellationToken).ConfigureAwait(false);
                var operation = new ExtensionCreateOrUpdateOperation(this, _clientDiagnostics, Pipeline, _extensionsRestClient.CreateCreateRequest(Id.SubscriptionId, Id.ResourceGroupName, _clusterRp, _clusterResourceName, _clusterName, extensionName, extension).Request, response);
                if (waitForCompletion)
        ...
        public virtual Response<Extension> Get(string extensionName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _extensionsRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, _clusterRp, _clusterResourceName, _clusterName, extensionName, cancellationToken);
        ...
        public async virtual Task<Response<Extension>> GetAsync(string extensionName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _extensionsRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, _clusterRp, _clusterResourceName, _clusterName, extensionName, cancellationToken).ConfigureAwait(false);
                if (response.Value == null)
        ...
        public virtual Response<Extension> GetIfExists(string extensionName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _extensionsRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, _clusterRp, _clusterResourceName, _clusterName, extensionName, cancellationToken: cancellationToken);
                if (response.Value == null)
        ...
        public async virtual Task<Response<Extension>> GetIfExistsAsync(string extensionName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _extensionsRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, _clusterRp, _clusterResourceName, _clusterName, extensionName, cancellationToken: cancellationToken).ConfigureAwait(false);
                if (response.Value == null)
                    return Response.FromValue<Extension>(null, response.GetRawResponse());
                return Response.FromValue(new Extension(this, response.Value), response.GetRawResponse());
            }
        ...
        public virtual Pageable<Extension> GetAll(CancellationToken cancellationToken = default)
        {
            Page<Extension> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _extensionsRestClient.List(Id.SubscriptionId, Id.ResourceGroupName, _clusterRp, _clusterResourceName, _clusterName, cancellationToken: cancellationToken);
            ...
            Page<Extension> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _extensionsRestClient.ListNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, _clusterRp, _clusterResourceName, _clusterName, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new Extension(this, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual AsyncPageable<Extension> GetAllAsync(CancellationToken cancellationToken = default)
        {
            async Task<Page<Extension>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _extensionsRestClient.ListAsync(Id.SubscriptionId, Id.ResourceGroupName, _clusterRp, _clusterResourceName, _clusterName, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new Extension(this, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            async Task<Page<Extension>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _extensionsRestClient.ListNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, _clusterRp, _clusterResourceName, _clusterName, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new Extension(this, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        /// <summary> Filters the list of <see cref="Extension" /> for this resource group represented as generic resources. </summary>
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("ExtensionCollection.GetAllAsGenericResources");
            scope.Start();
            try
            {
                var filters = new ResourceFilterCollection(Extension.ResourceType);
