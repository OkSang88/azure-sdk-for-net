...
namespace Azure.ResourceManager.StorSimple8000Series.Tests.Mock
{
    ...
    public partial class BackupScheduleCollectionMockTests : MockTestBase
    {
        ...
        public async Task CreateOrUpdate()
        {
            ...
            StorSimple8000Series.BackupScheduleData parameters = new StorSimple8000Series.BackupScheduleData(scheduleRecurrence: new StorSimple8000Series.Models.ScheduleRecurrence(recurrenceType: StorSimple8000Series.Models.RecurrenceType.Weekly, recurrenceValue: 1), backupType: StorSimple8000Series.Models.BackupType.CloudSnapshot, retentionCount: 1, startTime: DateTimeOffset.Parse("2017-06-24T01:00:00Z"), scheduleStatus: StorSimple8000Series.Models.ScheduleStatus.Enabled)
            {
                Kind = "Series8000",
            };
