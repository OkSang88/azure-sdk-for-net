...
namespace Azure.ResourceManager.ServiceFabricMesh
{
    ...
    public partial class SecretValueResourceDescriptionCollection : ArmCollection, IEnumerable<SecretValueResourceDescription>, IAsyncEnumerable<SecretValueResourceDescription>
    {
        ...
        public virtual SecretValueCreateOperation CreateOrUpdate(bool waitForCompletion, string secretValueResourceName, SecretValueResourceDescriptionData secretValueResourceDescription, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new SecretValueCreateOperation(Parent, response);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="secretValueResourceName"/> or <paramref name="secretValueResourceDescription"/> is null. </exception>
        public async virtual Task<SecretValueCreateOperation> CreateOrUpdateAsync(bool waitForCompletion, string secretValueResourceName, SecretValueResourceDescriptionData secretValueResourceDescription, CancellationToken cancellationToken = default)
        {
            if (secretValueResourceName == null)
            {
                throw new ArgumentNullException(nameof(secretValueResourceName));
        ...
        public virtual Response<SecretValueResourceDescription> Get(string secretValueResourceName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new SecretValueResourceDescription(Parent, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual Pageable<SecretValueResourceDescription> GetAll(CancellationToken cancellationToken = default)
        {
            Page<SecretValueResourceDescription> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    ...
                    return Page.FromValues(response.Value.Value.Select(value => new SecretValueResourceDescription(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
