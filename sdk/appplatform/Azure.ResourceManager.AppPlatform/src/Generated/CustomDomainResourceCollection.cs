...
namespace Azure.ResourceManager.AppPlatform
{
    ...
    public partial class CustomDomainResourceCollection : ArmCollection, IEnumerable<CustomDomainResource>, IAsyncEnumerable<CustomDomainResource>
    {
        ...
        public virtual CustomDomainCreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, string domainName, CustomDomainResourceData domainResource, CancellationToken cancellationToken = default)
        {
            if (domainName == null)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="domainName"/> or <paramref name="domainResource"/> is null. </exception>
        public async virtual Task<CustomDomainCreateOrUpdateOperation> CreateOrUpdateAsync(bool waitForCompletion, string domainName, CustomDomainResourceData domainResource, CancellationToken cancellationToken = default)
        {
            if (domainName == null)
            {
                throw new ArgumentNullException(nameof(domainName));
