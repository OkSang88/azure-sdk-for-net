...
namespace Azure.ResourceManager.DataFactory.Tests.Mock
{
    ...
    public partial class ManagedPrivateEndpointResourceCollectionMockTests : MockTestBase
    {
        ...
        public async Task CreateOrUpdate()
        {
            ...
            DataFactory.ManagedPrivateEndpointResourceData managedPrivateEndpoint = new DataFactory.ManagedPrivateEndpointResourceData(properties: new DataFactory.Models.ManagedPrivateEndpoint()
            {
                GroupId = "blob",
            ...
            var managedVirtualNetworkResourceId = DataFactory.ManagedVirtualNetworkResource.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "exampleResourceGroup", "exampleFactoryName", "exampleManagedVirtualNetworkName");
