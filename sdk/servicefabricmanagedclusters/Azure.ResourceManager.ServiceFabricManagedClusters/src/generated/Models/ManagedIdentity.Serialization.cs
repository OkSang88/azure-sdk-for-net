        ...
        internal static ManagedIdentity DeserializeManagedIdentity(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("type"))
                {
                    ...
                    type = property.Value.GetString().ToManagedIdentityType();
                    continue;
                }
            ...
            return new ManagedIdentity(principalId.Value, tenantId.Value, Optional.ToNullable(type), Optional.ToDictionary(userAssignedIdentities));
        }
    }
}
