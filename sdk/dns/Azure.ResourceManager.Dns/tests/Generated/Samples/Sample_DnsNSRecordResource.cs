...
{
    public partial class Sample_DnsNSRecordResource
    {
        // Patch A recordset
        ...
        public async Task Update_PatchARecordset()
        {
            ...
            // this example assumes you already have this DnsNSRecordResource created on azure
            // for more information of creating DnsNSRecordResource, please refer to the document of DnsNSRecordResource
            string subscriptionId = "subid";
            string resourceGroupName = "rg1";
            string zoneName = "zone1";
            string relativeRecordSetName = "record1";
            ResourceIdentifier dnsNSRecordResourceId = DnsNSRecordResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, zoneName, relativeRecordSetName);
            DnsNSRecordResource dnsNSRecord = client.GetDnsNSRecordResource(dnsNSRecordResourceId);
...
["key2"] = "value2",
            ...
            DnsNSRecordResource result = await dnsNSRecord.UpdateAsync(data);
...
["key2"] = "value2",
        ...
        public async Task Delete_DeleteARecordset()
        {
            ...
            // invoke the operation
            await dnsNSRecord.DeleteAsync(WaitUntil.Completed);
        ...
        public async Task Get_GetARecordset()
        {
            ...
            // invoke the operation
            DnsNSRecordResource result = await dnsNSRecord.GetAsync();
