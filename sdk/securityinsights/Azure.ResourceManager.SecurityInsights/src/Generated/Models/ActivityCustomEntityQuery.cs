...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class ActivityCustomEntityQuery : CustomEntityQuery
    {
        ...
        internal ActivityCustomEntityQuery(ResourceIdentifier id, string name, ResourceType type, SystemData systemData, string etag, CustomEntityQueryKind kind, string title, string content, string description, ActivityEntityQueriesPropertiesQueryDefinitions queryDefinitions, EntityType? inputEntityType, IList<IList<string>> requiredInputFieldsSets, IDictionary<string, IList<string>> entitiesFilter, string templateName, bool? enabled, DateTimeOffset? createdTimeUtc, DateTimeOffset? lastModifiedTimeUtc) : base(id, name, type, systemData, etag, kind)
        {
            Title = title;
            Content = content;
