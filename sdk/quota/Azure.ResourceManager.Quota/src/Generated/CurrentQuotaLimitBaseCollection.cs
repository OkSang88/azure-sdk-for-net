...
namespace Azure.ResourceManager.Quota
{
    ...
    public partial class CurrentQuotaLimitBaseCollection : ArmCollection, IEnumerable<CurrentQuotaLimitBase>, IAsyncEnumerable<CurrentQuotaLimitBase>
    {
        ...
        internal CurrentQuotaLimitBaseCollection(ArmResource parent) : base(parent)
        {
            ...
            ClientOptions.TryGetApiVersion(CurrentQuotaLimitBase.ResourceType, out string apiVersion);
        ...
        public virtual CurrentQuotaLimitBaseCreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, string resourceName, CurrentQuotaLimitBaseData createQuotaRequest, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new CurrentQuotaLimitBaseCreateOrUpdateOperation(this, _clientDiagnostics, Pipeline, _quotaRestClient.CreateCreateOrUpdateRequest(Id, resourceName, createQuotaRequest).Request, response);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceName"/> or <paramref name="createQuotaRequest"/> is null. </exception>
        public async virtual Task<CurrentQuotaLimitBaseCreateOrUpdateOperation> CreateOrUpdateAsync(bool waitForCompletion, string resourceName, CurrentQuotaLimitBaseData createQuotaRequest, CancellationToken cancellationToken = default)
        {
            if (resourceName == null)
            {
                throw new ArgumentNullException(nameof(resourceName));
        ...
        public virtual Pageable<CurrentQuotaLimitBase> GetAll(CancellationToken cancellationToken = default)
        {
            Page<CurrentQuotaLimitBase> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    ...
                    return Page.FromValues(response.Value.Value.Select(value => new CurrentQuotaLimitBase(this, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
