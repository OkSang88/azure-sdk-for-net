...
{
    public partial class NotificationHubCreateOrUpdateParameters : IUtf8JsonSerializable
    {
        ...
        internal static NotificationHubCreateOrUpdateParameters DeserializeNotificationHubCreateOrUpdateParameters(JsonElement element)
        {
            ...
            return new NotificationHubCreateOrUpdateParameters(id, name, type, tags, location, sku.Value, name0.Value, registrationTtl.Value, Optional.ToList(authorizationRules), apnsCredential.Value, wnsCredential.Value, gcmCredential.Value, mpnsCredential.Value, admCredential.Value, baiduCredential.Value);
        }
    }
}
