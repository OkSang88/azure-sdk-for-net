...
namespace DataFactoryManagementClient.Models
{
    ...
    public partial class AzureDataExplorerSink : CopySink
    {
        ...
        internal AzureDataExplorerSink(string type, object writeBatchSize, object writeBatchTimeout, object sinkRetryCount, object sinkRetryWait, object maxConcurrentConnections, object disableMetricsCollection, IDictionary<string, object> additionalProperties, object ingestionMappingName, object ingestionMappingAsJson, object flushImmediately) : base(type, writeBatchSize, writeBatchTimeout, sinkRetryCount, sinkRetryWait, maxConcurrentConnections, disableMetricsCollection, additionalProperties)
        {
