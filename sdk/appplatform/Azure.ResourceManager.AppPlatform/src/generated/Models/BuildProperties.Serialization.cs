...
{
    public partial class BuildProperties : IUtf8JsonSerializable
    {
        ...
        internal static BuildProperties DeserializeBuildProperties(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("provisioningState"))
                {
                    ...
                    provisioningState = new BuildProvisioningState(property.Value.GetString());
                    continue;
                }
            ...
            return new BuildProperties(relativePath.Value, builder.Value, agentPool.Value, Optional.ToNullable(provisioningState), Optional.ToDictionary(env), triggeredBuildResult);
        }
    }
}
