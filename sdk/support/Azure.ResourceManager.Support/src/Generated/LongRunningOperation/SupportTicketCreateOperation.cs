...
namespace Azure.ResourceManager.Support.Models
{
    ...
    public partial class SupportTicketCreateOperation : Operation<SupportTicketDetails>, IOperationSource<SupportTicketDetails>
    {
        private readonly OperationInternals<SupportTicketDetails> _operation;

        private readonly ArmResource _operationBase;

        /// <summary> Initializes a new instance of SupportTicketCreateOperation for mocking. </summary>
        protected SupportTicketCreateOperation()
        {
        }

        internal SupportTicketCreateOperation(ArmResource operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<SupportTicketDetails>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.AzureAsyncOperation, "SupportTicketCreateOperation");
