...
namespace SqlVirtualMachineManagementClient.Models
{
    public partial class StorageConfigurationSettings : IUtf8JsonSerializable
    {
        ...
        internal static StorageConfigurationSettings DeserializeStorageConfigurationSettings(JsonElement element)
        {
            ...
            Optional<SQLStorageSettings> sqlTempDbSettings = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("sqlTempDbSettings"))
                {
                    ...
                    sqlTempDbSettings = SQLStorageSettings.DeserializeSQLStorageSettings(property.Value);
                    continue;
                }
            ...
            return new StorageConfigurationSettings(sqlDataSettings.Value, sqlLogSettings.Value, sqlTempDbSettings.Value, Optional.ToNullable(diskConfigurationType), Optional.ToNullable(storageWorkloadType));
        }
    }
}
