...
namespace Azure.ResourceManager.PowerBIDedicated
{
    internal partial class AutoScaleVCoresRestOperations
    {
        ...
        public AutoScaleVCoresRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, Uri endpoint = null, string apiVersion = default)
        {
