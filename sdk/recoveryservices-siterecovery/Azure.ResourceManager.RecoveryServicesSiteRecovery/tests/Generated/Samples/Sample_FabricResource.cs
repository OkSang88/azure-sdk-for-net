...
{
    public partial class Sample_FabricResource
    {
        ...
        public async Task Get_GetsTheDetailsOfAnASRFabric()
        {
            ...
            FabricResource result = await fabric.GetAsync();
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task Update_CreatesAnAzureSiteRecoveryFabric()
        {
            ...
            ArmOperation<FabricResource> lro = await fabric.UpdateAsync(WaitUntil.Completed, content);
        ...
        {
            // Generated from example definition: specification/recoveryservicessiterecovery/resource-manager/Microsoft.RecoveryServices/stable/2022-08-01/examples/ReplicationFabrics_CheckConsistency.json
            ...
            // invoke the operation
            ArmOperation<FabricResource> lro = await fabric.CheckConsistencyAsync(WaitUntil.Completed);
            FabricResource result = lro.Value;
        ...
        {
            // Generated from example definition: specification/recoveryservicessiterecovery/resource-manager/Microsoft.RecoveryServices/stable/2022-08-01/examples/ReplicationFabrics_MigrateToAad.json
            ...
            // invoke the operation
            await fabric.MigrateToAadAsync(WaitUntil.Completed);
        ...
        {
            // Generated from example definition: specification/recoveryservicessiterecovery/resource-manager/Microsoft.RecoveryServices/stable/2022-08-01/examples/ReplicationFabrics_ReassociateGateway.json
...
"Vm1","Vm2"
            ...
            ArmOperation<FabricResource> lro = await fabric.ReassociateGatewayAsync(WaitUntil.Completed, content);
            FabricResource result = lro.Value;
        ...
        {
            // Generated from example definition: specification/recoveryservicessiterecovery/resource-manager/Microsoft.RecoveryServices/stable/2022-08-01/examples/ReplicationFabrics_Delete.json
            ...
            // invoke the operation
            await fabric.DeleteAsync(WaitUntil.Completed);
        ...
        {
            // Generated from example definition: specification/recoveryservicessiterecovery/resource-manager/Microsoft.RecoveryServices/stable/2022-08-01/examples/ReplicationFabrics_RenewCertificate.json
            ...
            ArmOperation<FabricResource> lro = await fabric.RenewCertificateAsync(WaitUntil.Completed, content);
            FabricResource result = lro.Value;
