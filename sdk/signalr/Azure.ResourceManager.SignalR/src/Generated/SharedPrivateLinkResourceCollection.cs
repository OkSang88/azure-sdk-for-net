...
namespace Azure.ResourceManager.SignalR
{
    ...
    public partial class SharedPrivateLinkResourceCollection : ArmCollection, IEnumerable<SharedPrivateLinkResource>, IAsyncEnumerable<SharedPrivateLinkResource>
    {
        ...
        internal SharedPrivateLinkResourceCollection(ArmResource parent) : base(parent)
        {
            ...
            ClientOptions.TryGetApiVersion(SharedPrivateLinkResource.ResourceType, out string apiVersion);
            _signalRSharedPrivateLinkResourcesRestClient = new SignalRSharedPrivateLinkResourcesRestOperations(_clientDiagnostics, Pipeline, ClientOptions, BaseUri, apiVersion);
#if DEBUG
        ...
        public virtual SharedPrivateLinkResourceCreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, string sharedPrivateLinkResourceName, SharedPrivateLinkResourceData parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new SharedPrivateLinkResourceCreateOrUpdateOperation(this, _clientDiagnostics, Pipeline, _signalRSharedPrivateLinkResourcesRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, sharedPrivateLinkResourceName, parameters).Request, response);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="sharedPrivateLinkResourceName"/> or <paramref name="parameters"/> is null. </exception>
        public async virtual Task<SharedPrivateLinkResourceCreateOrUpdateOperation> CreateOrUpdateAsync(bool waitForCompletion, string sharedPrivateLinkResourceName, SharedPrivateLinkResourceData parameters, CancellationToken cancellationToken = default)
        {
            if (sharedPrivateLinkResourceName == null)
            {
                throw new ArgumentNullException(nameof(sharedPrivateLinkResourceName));
        ...
        public virtual Pageable<SharedPrivateLinkResource> GetAll(CancellationToken cancellationToken = default)
        {
            Page<SharedPrivateLinkResource> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    ...
                    return Page.FromValues(response.Value.Value.Select(value => new SharedPrivateLinkResource(this, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
