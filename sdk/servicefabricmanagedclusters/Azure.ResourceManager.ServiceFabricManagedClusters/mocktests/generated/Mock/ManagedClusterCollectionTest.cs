...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Tests.Mock
{
    ...
    public partial class ManagedClusterCollectionMockTests : MockTestBase
    {
        ...
        public async Task CreateOrUpdate()
        {
            ...
            ServiceFabricManagedClusters.ManagedClusterData parameters = new ServiceFabricManagedClusters.ManagedClusterData(location: "eastus")
            {
                Sku = new ServiceFabricManagedClusters.Models.Sku(name: new ServiceFabricManagedClusters.Models.SkuName("Basic")),
                DnsName = "myCluster",
                ...
                ClusterUpgradeMode = new ServiceFabricManagedClusters.Models.ClusterUpgradeMode("Manual"),
                EnableAutoOSUpgrade = true,
                ZonalResiliency = true,
                ApplicationTypeVersionsCleanupPolicy = new ServiceFabricManagedClusters.Models.ApplicationTypeVersionsCleanupPolicy(maxUnusedVersionsToKeep: 3),
                EnableIpv6 = true,
            };
        ...
        public async Task CreateOrUpdate2()
        {
            ...
            ServiceFabricManagedClusters.ManagedClusterData parameters = new ServiceFabricManagedClusters.ManagedClusterData(location: "eastus")
            {
                ...
                AdminUserName = "vmadmin",
                AdminPassword = "{vm-password}",
                ClusterUpgradeMode = new ServiceFabricManagedClusters.Models.ClusterUpgradeMode("Automatic"),
                ClusterUpgradeCadence = new ServiceFabricManagedClusters.Models.ClusterUpgradeCadence("Wave1"),
            };
