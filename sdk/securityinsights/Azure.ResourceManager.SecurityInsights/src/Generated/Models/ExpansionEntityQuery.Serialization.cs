...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    public partial class ExpansionEntityQuery : IUtf8JsonSerializable
    {
        ...
        internal static ExpansionEntityQuery DeserializeExpansionEntityQuery(JsonElement element)
        {
            ...
            return new ExpansionEntityQuery(id, name, type, systemData, etag.Value, kind, Optional.ToList(dataSources), displayName.Value, Optional.ToNullable(inputEntityType), Optional.ToList(inputFields), Optional.ToList(outputEntityTypes), queryTemplate.Value);
        }
    }
}
