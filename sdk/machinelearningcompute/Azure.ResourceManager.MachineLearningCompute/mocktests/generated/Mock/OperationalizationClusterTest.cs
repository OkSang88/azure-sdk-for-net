...
namespace Azure.ResourceManager.MachineLearningCompute.Tests.Mock
{
    ...
    public partial class OperationalizationClusterMockTests : MockTestBase
    {
        ...
        public async Task Get()
        {
            ...
            var operationalizationClusterId = MachineLearningCompute.OperationalizationCluster.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "myResourceGroup", "myCluster");
        ...
        public async Task Update()
        {
            ...
            var operationalizationClusterId = MachineLearningCompute.OperationalizationCluster.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "myResourceGroup", "myCluster");
            var operationalizationCluster = GetArmClient().GetOperationalizationCluster(operationalizationClusterId);
            MachineLearningCompute.Models.OperationalizationClusterUpdateParameters parameters = new MachineLearningCompute.Models.OperationalizationClusterUpdateParameters();
