...
namespace WorkloadMonitorAPI
{
    ...
    public partial class HealthMonitorData : Resource
    {
        ...
        internal HealthMonitorData(ResourceIdentifier id, string name, ResourceType type, string monitorName, string monitorType, string monitoredObject, string parentMonitorName, HealthState? previousMonitorState, HealthState? currentMonitorState, string evaluationTimestamp, string currentStateFirstObservedTimestamp, string lastReportedTimestamp, object evidence, object monitorConfiguration) : base(id, name, type)
        {
