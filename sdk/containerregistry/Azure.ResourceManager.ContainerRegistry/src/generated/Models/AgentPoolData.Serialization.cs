...
namespace ContainerRegistryManagementClient
{
    public partial class AgentPoolData : IUtf8JsonSerializable
    {
        ...
        internal static AgentPoolData DeserializeAgentPoolData(JsonElement element)
        {
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("os"))
                        {
                            ...
                            os = new OS(property0.Value.GetString());
                            continue;
                        }
            ...
            return new AgentPoolData(id, name, type, tags, location, systemData.Value, Optional.ToNullable(count), tier.Value, Optional.ToNullable(os), virtualNetworkSubnetResourceId.Value, Optional.ToNullable(provisioningState));
        }
    }
}
