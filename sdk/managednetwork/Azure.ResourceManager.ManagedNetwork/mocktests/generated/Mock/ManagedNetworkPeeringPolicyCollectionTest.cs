...
namespace Azure.ResourceManager.ManagedNetwork.Tests.Mock
{
    ...
    public partial class ManagedNetworkPeeringPolicyCollectionMockTests : MockTestBase
    {
        ...
        public async Task CreateOrUpdate()
        {
            ...
            ManagedNetwork.ManagedNetworkPeeringPolicyData managedNetworkPolicy = new ManagedNetwork.ManagedNetworkPeeringPolicyData()
            {
                Properties = new ManagedNetwork.Models.ManagedNetworkPeeringPolicyProperties(type: new ManagedNetwork.Models.Type("HubAndSpokeTopology"))
                {
