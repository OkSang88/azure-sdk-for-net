...
namespace Azure.ResourceManager.AppPlatform
{
    ...
    public partial class DeploymentResource : ArmResource
    {
        ...
        public async virtual Task<DeploymentUpdateOperation> UpdateAsync(bool waitForCompletion, DeploymentResourceData deploymentResource, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="deploymentResource"/> is null. </exception>
        public virtual DeploymentUpdateOperation Update(bool waitForCompletion, DeploymentResourceData deploymentResource, CancellationToken cancellationToken = default)
        {
            if (deploymentResource == null)
            {
                throw new ArgumentNullException(nameof(deploymentResource));
        ...
        /// <param name="waitForCompletion"> Waits for the completion of the long running operations. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async virtual Task<DeploymentStartOperation> StartAsync(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="waitForCompletion"> Waits for the completion of the long running operations. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual DeploymentStartOperation Start(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("DeploymentResource.Start");
            scope.Start();
            try
        ...
        /// <param name="waitForCompletion"> Waits for the completion of the long running operations. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async virtual Task<DeploymentStopOperation> StopAsync(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="waitForCompletion"> Waits for the completion of the long running operations. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual DeploymentStopOperation Stop(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("DeploymentResource.Stop");
            scope.Start();
            try
        ...
        /// <param name="waitForCompletion"> Waits for the completion of the long running operations. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async virtual Task<DeploymentRestartOperation> RestartAsync(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="waitForCompletion"> Waits for the completion of the long running operations. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual DeploymentRestartOperation Restart(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("DeploymentResource.Restart");
            scope.Start();
            try
        ...
        public async virtual Task<DeploymentGenerateHeapDumpOperation> GenerateHeapDumpAsync(bool waitForCompletion, DiagnosticParameters diagnosticParameters, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="diagnosticParameters"/> is null. </exception>
        public virtual DeploymentGenerateHeapDumpOperation GenerateHeapDump(bool waitForCompletion, DiagnosticParameters diagnosticParameters, CancellationToken cancellationToken = default)
        {
            if (diagnosticParameters == null)
            {
                throw new ArgumentNullException(nameof(diagnosticParameters));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="diagnosticParameters"/> is null. </exception>
        public async virtual Task<DeploymentGenerateThreadDumpOperation> GenerateThreadDumpAsync(bool waitForCompletion, DiagnosticParameters diagnosticParameters, CancellationToken cancellationToken = default)
        {
            if (diagnosticParameters == null)
            {
                throw new ArgumentNullException(nameof(diagnosticParameters));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="diagnosticParameters"/> is null. </exception>
        public virtual DeploymentGenerateThreadDumpOperation GenerateThreadDump(bool waitForCompletion, DiagnosticParameters diagnosticParameters, CancellationToken cancellationToken = default)
        {
            if (diagnosticParameters == null)
            {
                throw new ArgumentNullException(nameof(diagnosticParameters));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="diagnosticParameters"/> is null. </exception>
        public async virtual Task<DeploymentStartJFROperation> StartJFRAsync(bool waitForCompletion, DiagnosticParameters diagnosticParameters, CancellationToken cancellationToken = default)
        {
            if (diagnosticParameters == null)
            {
                throw new ArgumentNullException(nameof(diagnosticParameters));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="diagnosticParameters"/> is null. </exception>
        public virtual DeploymentStartJFROperation StartJFR(bool waitForCompletion, DiagnosticParameters diagnosticParameters, CancellationToken cancellationToken = default)
        {
            if (diagnosticParameters == null)
            {
                throw new ArgumentNullException(nameof(diagnosticParameters));
