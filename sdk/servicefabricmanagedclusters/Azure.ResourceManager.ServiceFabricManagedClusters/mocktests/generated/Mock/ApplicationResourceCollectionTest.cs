...
namespace ServiceFabricManagedClustersManagementClient.Tests.Mock
{
    ...
    public partial class ApplicationResourceCollectionMockTests : MockTestBase
    {
        ...
        public async Task CreateOrUpdate()
        {
            ...
            ServiceFabricManagedClustersManagementClient.ApplicationResourceData parameters = new ServiceFabricManagedClustersManagementClient.ApplicationResourceData(location: "eastus")
            {
                ...
                UpgradePolicy = new ServiceFabricManagedClustersManagementClient.Models.ApplicationUpgradePolicy()
                {
                    ApplicationHealthPolicy = new ServiceFabricManagedClustersManagementClient.Models.ApplicationHealthPolicy(considerWarningAsError: true, maxPercentUnhealthyDeployedApplications: 0)
                    {
                        DefaultServiceTypeHealthPolicy = new ServiceFabricManagedClustersManagementClient.Models.ServiceTypeHealthPolicy(maxPercentUnhealthyServices: 0, maxPercentUnhealthyPartitionsPerService: 0, maxPercentUnhealthyReplicasPerPartition: 0),
                    },
                    ForceRestart = false,
                    RollingUpgradeMonitoringPolicy = new ServiceFabricManagedClustersManagementClient.Models.RollingUpgradeMonitoringPolicy(failureAction: new ServiceFabricManagedClustersManagementClient.Models.FailureAction("Rollback"), healthCheckWaitDuration: "00:02:00", healthCheckStableDuration: "00:05:00", healthCheckRetryTimeout: "00:10:00", upgradeTimeout: "01:00:00", upgradeDomainTimeout: "00:15:00"),
                    InstanceCloseDelayDuration = 600,
                    UpgradeMode = new ServiceFabricManagedClustersManagementClient.Models.RollingUpgradeMode("UnmonitoredAuto"),
