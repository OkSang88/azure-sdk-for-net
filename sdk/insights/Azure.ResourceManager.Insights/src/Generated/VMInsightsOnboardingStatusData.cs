...
namespace Insights
{
    ...
    public partial class VMInsightsOnboardingStatusData : Resource
    {
        ...
        internal VMInsightsOnboardingStatusData(ResourceIdentifier id, string name, ResourceType type, string resourceId, OnboardingStatus? onboardingStatus, DataStatus? dataStatus, IReadOnlyList<DataContainer> data) : base(id, name, type)
        {
