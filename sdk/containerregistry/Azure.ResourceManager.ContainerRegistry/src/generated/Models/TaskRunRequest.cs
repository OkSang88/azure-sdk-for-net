...
namespace ContainerRegistryManagementClient.Models
{
    ...
    public partial class TaskRunRequest : RunRequest
    {
        ...
        internal TaskRunRequest(string type, bool? isArchiveEnabled, string agentPoolName, string logTemplate, string taskId, OverrideTaskStepProperties overrideTaskStepProperties) : base(type, isArchiveEnabled, agentPoolName, logTemplate)
        {
            TaskId = taskId;
