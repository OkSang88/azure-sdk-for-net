...
namespace Azure.ResourceManager.Marketplace
{
    ...
    public partial class CollectionCollection : ArmCollection, IEnumerable<Collection>, IAsyncEnumerable<Collection>
    {
        ...
        internal CollectionCollection(ArmResource parent) : base(parent)
        {
            ...
            ClientOptions.TryGetApiVersion(Collection.ResourceType, out string apiVersion);
        ...
        public virtual CollectionCreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, string collectionId, CollectionData payload = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new CollectionCreateOrUpdateOperation(this, response);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="collectionId"/> is null. </exception>
        public async virtual Task<CollectionCreateOrUpdateOperation> CreateOrUpdateAsync(bool waitForCompletion, string collectionId, CollectionData payload = null, CancellationToken cancellationToken = default)
        {
            if (collectionId == null)
            {
                throw new ArgumentNullException(nameof(collectionId));
        ...
        public virtual Pageable<Collection> GetAll(CancellationToken cancellationToken = default)
        {
            Page<Collection> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    ...
                    return Page.FromValues(response.Value.Value.Select(value => new Collection(this, value)), null, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
