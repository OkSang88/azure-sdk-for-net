...
namespace Azure.ResourceManager.Marketplace
{
    ...
    public partial class OfferData : Resource
    {
        ...
        internal OfferData(ResourceIdentifier id, string name, ResourceType type, SystemData systemData, string uniqueOfferId, string offerDisplayName, string publisherDisplayName, string eTag, string privateStoreId, string createdAt, string modifiedAt, IList<string> specificPlanIdsLimitation, bool? updateSuppressedDueIdempotence, IDictionary<string, string> iconFileUris, IList<Plan> plans) : base(id, name, type, systemData)
        {
