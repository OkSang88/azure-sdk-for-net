...
namespace Azure.ResourceManager.AppPlatform
{
    ...
    public partial class AppResourceData : ProxyResource
    {
        ...
        internal AppResourceData(ResourceIdentifier id, string name, ResourceType type, SystemData systemData, AppResourceProperties properties, ManagedIdentityProperties identity, string location) : base(id, name, type, systemData)
        {
