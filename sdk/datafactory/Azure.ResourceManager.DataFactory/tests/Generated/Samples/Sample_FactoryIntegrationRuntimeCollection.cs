...
{
    public partial class Sample_FactoryIntegrationRuntimeCollection
    {
        ...
        public async Task GetAll_IntegrationRuntimesListByFactory()
        {
            ...
            await foreach (FactoryIntegrationRuntimeResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                FactoryIntegrationRuntimeData resourceData = item.Data;
        ...
        public async Task Get_IntegrationRuntimesGet()
        {
            ...
            // invoke the operation
            string integrationRuntimeName = "exampleIntegrationRuntime";
            FactoryIntegrationRuntimeResource result = await collection.GetAsync(integrationRuntimeName);
