# Azure NotificationHubs Management client library for .NET
...
Install the Azure NotificationHubs management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.NotificationHubs -Version 1.0.0-preview.1 
```
