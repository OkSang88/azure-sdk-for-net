...
namespace BatchManagementClient.Models
{
    ...
    public partial class StartTask
    {
        ...
        internal StartTask(string commandLine, IList<ResourceFile> resourceFiles, IList<EnvironmentSetting> environmentSettings, UserIdentity userIdentity, int? maxTaskRetryCount, bool? waitForSuccess, TaskContainerSettings containerSettings)
        {
