...
{
    public partial class ASCDataConnector : IUtf8JsonSerializable
    {
        ...
        internal static ASCDataConnector DeserializeASCDataConnector(JsonElement element)
        {
            ...
            return new ASCDataConnector(id, name, type, systemData, etag.Value, kind, dataTypes.Value, subscriptionId.Value);
        }
    }
}
