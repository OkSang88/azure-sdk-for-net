# Azure ServiceFabricManagedClusters Management client library for .NET
...
Install the Azure ServiceFabricManagedClusters management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.ServiceFabricManagedClusters -Version 1.0.0-preview.1 
```
