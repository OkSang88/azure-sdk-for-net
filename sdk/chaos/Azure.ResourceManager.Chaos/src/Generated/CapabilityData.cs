...
namespace Azure.ResourceManager.Chaos
{
    ...
    public partial class CapabilityData : Resource
    {
        ...
        /// <param name="systemData"> The standard system metadata of a resource type. </param>
        ...
        internal CapabilityData(ResourceIdentifier id, string name, ResourceType type, SystemData systemData, string publisher, string targetType, string description, string parametersSchema, string urn) : base(id, name, type)
        {
