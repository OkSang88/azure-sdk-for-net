# Azure ResourceGraph Management client library for .NET
...
Install the Azure ResourceGraph management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.ResourceGraph -Version 1.0.0-preview.1 
```
