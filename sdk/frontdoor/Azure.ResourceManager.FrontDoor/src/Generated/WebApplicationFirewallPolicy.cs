    ...
    public partial class WebApplicationFirewallPolicy : ArmResource
    {
        ...
        public async virtual Task<PolicyDeleteOperation> DeleteAsync(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new PolicyDeleteOperation(_clientDiagnostics, Pipeline, _policiesRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name).Request, response);
