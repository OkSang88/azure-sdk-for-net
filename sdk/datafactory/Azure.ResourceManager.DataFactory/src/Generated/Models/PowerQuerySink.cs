...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class PowerQuerySink : DataFlowSink
    {
        ...
        internal PowerQuerySink(string name, string description, DatasetReference dataset, LinkedServiceReference linkedService, DataFlowReference flowlet, LinkedServiceReference schemaLinkedService, string script) : base(name, description, dataset, linkedService, flowlet, schemaLinkedService)
        {
            Script = script;
        }
