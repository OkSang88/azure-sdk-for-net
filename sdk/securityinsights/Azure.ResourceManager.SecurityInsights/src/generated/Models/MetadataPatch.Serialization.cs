...
{
    public partial class MetadataPatch : IUtf8JsonSerializable
    {
        ...
        internal static MetadataPatch DeserializeMetadataPatch(JsonElement element)
        {
            ...
            return new MetadataPatch(id, name, type, systemData, etag.Value, contentId.Value, parentId.Value, version.Value, Optional.ToNullable(kind), source.Value, author.Value, support.Value, dependencies.Value, categories.Value, Optional.ToList(providers), Optional.ToNullable(firstPublishDate), Optional.ToNullable(lastPublishDate));
        }
    }
}
