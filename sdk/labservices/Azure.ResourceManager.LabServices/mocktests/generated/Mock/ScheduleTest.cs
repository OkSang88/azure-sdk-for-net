...
namespace Azure.ResourceManager.LabServices.Tests.Mock
{
    ...
    public partial class ScheduleMockTests : MockTestBase
    {
        ...
        {
            // Example: getSchedule
            var scheduleId = LabServices.Schedule.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "testrg123", "testlab", "schedule1");
        ...
        public async Task Update()
        {
            ...
            var scheduleId = LabServices.Schedule.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "testrg123", "testlab", "schedule1");
            var schedule = GetArmClient().GetSchedule(scheduleId);
            LabServices.Models.ScheduleUpdate body = new LabServices.Models.ScheduleUpdate()
            {
                RecurrencePattern = new LabServices.Models.RecurrencePattern(frequency: LabServices.Models.RecurrenceFrequency.Daily, expirationDate: DateTimeOffset.Parse("2020-08-14"))
                {
                    Interval = 2,
                },
            };
