...
namespace Azure.ResourceManager.FrontDoor
{
    ...
    public partial class FrontDoor : ArmResource
    {
        ...
        internal FrontDoor(ArmResource options, FrontDoorData data) : base(options, data.Id)
        {
            ...
            _endpointsRestClient = new EndpointsRestOperations(_clientDiagnostics, Pipeline, ClientOptions, BaseUri);
#if DEBUG
        ...
        public async virtual Task<EndpointPurgeContentOperation> PurgeContentEndpointAsync(bool waitForCompletion, PurgeParameters contentFilePaths, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new EndpointPurgeContentOperation(_clientDiagnostics, Pipeline, _endpointsRestClient.CreatePurgeContentRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, contentFilePaths).Request, response);
                if (waitForCompletion)
                    await operation.WaitForCompletionResponseAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="contentFilePaths"/> is null. </exception>
        public virtual EndpointPurgeContentOperation PurgeContentEndpoint(bool waitForCompletion, PurgeParameters contentFilePaths, CancellationToken cancellationToken = default)
        {
            if (contentFilePaths == null)
            {
                throw new ArgumentNullException(nameof(contentFilePaths));
