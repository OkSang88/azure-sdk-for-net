...
namespace BatchManagementClient.Models
{
    ...
    public partial class PrivateEndpointConnectionUpdateOperation : Operation<PrivateEndpointConnection>, IOperationSource<PrivateEndpointConnection>
    {
        private readonly OperationInternals<PrivateEndpointConnection> _operation;

        private readonly ArmResource _operationBase;

        /// <summary> Initializes a new instance of PrivateEndpointConnectionUpdateOperation for mocking. </summary>
        protected PrivateEndpointConnectionUpdateOperation()
        {
        }

        internal PrivateEndpointConnectionUpdateOperation(ArmResource operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<PrivateEndpointConnection>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.AzureAsyncOperation, "PrivateEndpointConnectionUpdateOperation");
