...
namespace NotificationHubsManagementClient.Tests.Mock
{
    ...
    public partial class NamespaceResourceMockTests : MockTestBase
    {
        ...
        public async Task Update()
        {
            ...
            var namespaceResourceId = NotificationHubsManagementClient.NamespaceResource.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "5ktrial", "nh-sdk-ns");
            var namespaceResource = GetArmClient().GetNamespaceResource(namespaceResourceId);
            NotificationHubsManagementClient.Models.NamespacePatchParameters parameters = new NotificationHubsManagementClient.Models.NamespacePatchParameters()
            {
        ...
        public async Task CheckNotificationHubAvailabilityNotificationHub()
        {
            ...
            var namespaceResourceId = NotificationHubsManagementClient.NamespaceResource.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "5ktrial", "locp-newns");
            var namespaceResource = GetArmClient().GetNamespaceResource(namespaceResourceId);
            NotificationHubsManagementClient.Models.CheckAvailabilityParameters parameters = new NotificationHubsManagementClient.Models.CheckAvailabilityParameters(location: "West Europe");
