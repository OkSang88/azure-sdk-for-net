# Azure StorageSync Management client library for .NET
...
Install the Azure StorageSync management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.StorageSync -Version 1.0.0-preview.1 
```
