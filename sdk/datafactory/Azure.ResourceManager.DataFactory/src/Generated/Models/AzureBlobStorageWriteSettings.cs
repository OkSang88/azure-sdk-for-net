...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AzureBlobStorageWriteSettings : StoreWriteSettings
    {
        ...
        internal AzureBlobStorageWriteSettings(string type, object maxConcurrentConnections, object disableMetricsCollection, object copyBehavior, IDictionary<string, object> additionalProperties, object blockSizeInMB) : base(type, maxConcurrentConnections, disableMetricsCollection, copyBehavior, additionalProperties)
        {
