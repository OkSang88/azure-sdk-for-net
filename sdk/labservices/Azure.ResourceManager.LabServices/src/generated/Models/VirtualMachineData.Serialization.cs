...
namespace LabServicesClient
{
    public partial class VirtualMachineData : IUtf8JsonSerializable
    {
        ...
        internal static VirtualMachineData DeserializeVirtualMachineData(JsonElement element)
        {
            ...
            return new VirtualMachineData(id, name, type, systemData, Optional.ToNullable(provisioningState), Optional.ToNullable(state), connectionProfile.Value, claimedByUserId.Value, Optional.ToNullable(vmType));
        }
    }
}
