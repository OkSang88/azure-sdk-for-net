...
{
    public partial class Sample_SubscriptionGovernanceRuleCollection
    {
        // List security governanceRules by subscription level scope
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task GetAll_ListSecurityGovernanceRulesBySubscriptionLevelScope()
        {
            ...
            // this example is just showing the usage of "GovernanceRule_List" operation, for the dependent resources, they will have to be created separately.
            ...
            // get the collection of this SubscriptionGovernanceRuleResource
            SubscriptionGovernanceRuleCollection collection = subscriptionResource.GetSubscriptionGovernanceRules();

            // invoke the operation and iterate over the result
            await foreach (SubscriptionGovernanceRuleResource item in collection.GetAllAsync())
            {
        ...
        public async Task Get_GetSecurityGovernanceRulesBySpecificGovernanceRuleId()
        {
            ...
            SubscriptionGovernanceRuleResource result = await collection.GetAsync(ruleId);
...
["value"] = "[\"b1cd27e0-4ecc-4246-939f-49c426d9d72f\", \"fe83f80b-073d-4ccf-93d9-6797eb870201\"]"} }})
            ...
            ArmOperation<SubscriptionGovernanceRuleResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, ruleId, data);
