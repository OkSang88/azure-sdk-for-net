...
namespace Azure.ResourceManager.Migrate
{
    ...
    public partial class AssessmentCollection : ArmCollection, IEnumerable<Assessment>, IAsyncEnumerable<Assessment>
    {
        ...
        internal AssessmentCollection(ArmResource parent) : base(parent)
        {
            ...
            ClientOptions.TryGetApiVersion(Assessment.ResourceType, out string apiVersion);
        ...
        public virtual AssessmentCreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, string assessmentName, AssessmentData assessment = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new AssessmentCreateOrUpdateOperation(this, response);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="assessmentName"/> is null. </exception>
        public async virtual Task<AssessmentCreateOrUpdateOperation> CreateOrUpdateAsync(bool waitForCompletion, string assessmentName, AssessmentData assessment = null, CancellationToken cancellationToken = default)
        {
            if (assessmentName == null)
            {
                throw new ArgumentNullException(nameof(assessmentName));
        ...
        public virtual Pageable<Assessment> GetAll(CancellationToken cancellationToken = default)
        {
            Page<Assessment> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    ...
                    return Page.FromValues(response.Value.Value.Select(value => new Assessment(this, value)), null, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
