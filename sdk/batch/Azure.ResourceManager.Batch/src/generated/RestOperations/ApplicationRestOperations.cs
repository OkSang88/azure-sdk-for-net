...
namespace BatchManagementClient
{
    internal partial class ApplicationRestOperations
    {
        ...
        public ApplicationRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ClientOptions options, Uri endpoint = null, string apiVersion = "2021-06-01")
        {
