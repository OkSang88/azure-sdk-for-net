...
namespace MicrosoftStorageSync
{
    public partial class CloudEndpointData : IUtf8JsonSerializable
    {
        ...
        internal static CloudEndpointData DeserializeCloudEndpointData(JsonElement element)
        {
            ...
            return new CloudEndpointData(id, name, type, storageAccountResourceId.Value, azureFileShareName.Value, storageAccountTenantId.Value, partnershipId.Value, friendlyName.Value, backupEnabled.Value, provisioningState.Value, lastWorkflowId.Value, lastOperationName.Value, changeEnumerationStatus.Value);
        }
    }
}
