# Azure StorSimple8000Series Management client library for .NET
...
Install the Azure StorSimple8000Series management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.StorSimple8000Series -Version 1.0.0-preview.1 
```
