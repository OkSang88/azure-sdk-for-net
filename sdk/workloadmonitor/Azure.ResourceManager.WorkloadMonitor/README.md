# Azure WorkloadMonitor Management client library for .NET
...
Install the Azure WorkloadMonitor management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.WorkloadMonitor -Version 1.0.0-preview.1 
```
