...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    public partial class CloudApplicationEntity : IUtf8JsonSerializable
    {
        ...
        internal static CloudApplicationEntity DeserializeCloudApplicationEntity(JsonElement element)
        {
            ...
            return new CloudApplicationEntity(id, name, type, systemData, kind, Optional.ToDictionary(additionalData), friendlyName.Value, Optional.ToNullable(appId), appName.Value, instanceName.Value);
        }
    }
}
