...
namespace MicrosoftLogz.Models
{
    public partial class MonitoredResource
    {
        internal static MonitoredResource DeserializeMonitoredResource(JsonElement element)
        {
            ...
            return new MonitoredResource(id.Value, Optional.ToNullable(sendingMetrics), reasonForMetricsStatus.Value, Optional.ToNullable(sendingLogs), systemData, reasonForLogsStatus.Value);
        }
    }
}
