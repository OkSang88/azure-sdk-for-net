...
namespace DataFactoryManagementClient.Models
{
    ...
    public partial class AzureMLExecutePipelineActivity : ExecutionActivity
    {
        ...
        internal AzureMLExecutePipelineActivity(string name, string type, string description, IList<ActivityDependency> dependsOn, IList<UserProperty> userProperties, IDictionary<string, object> additionalProperties, LinkedServiceReference linkedServiceName, ActivityPolicy policy, object mlPipelineId, object mlPipelineEndpointId, object version, object experimentName, object mlPipelineParameters, object dataPathAssignments, object mlParentRunId, object continueOnStepFailure) : base(name, type, description, dependsOn, userProperties, additionalProperties, linkedServiceName, policy)
        {
