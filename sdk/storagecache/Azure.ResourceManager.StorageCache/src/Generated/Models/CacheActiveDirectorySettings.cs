...
namespace Azure.ResourceManager.StorageCache.Models
{
    ...
    {
        /// <summary> Initializes a new instance of CacheActiveDirectorySettings. </summary>
        ...
        internal CacheActiveDirectorySettings(string primaryDnsIpAddress, string secondaryDnsIpAddress, string domainName, string domainNetBiosName, string cacheNetBiosName, DomainJoinedType? domainJoined, CacheActiveDirectorySettingsCredentials credentials)
        {
            PrimaryDnsIpAddress = primaryDnsIpAddress;
