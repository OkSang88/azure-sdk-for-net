# Azure CostResourceManager Management client library for .NET
...
Install the Azure CostResourceManager management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.CostResourceManager -Version 1.0.0-preview.1 
```
