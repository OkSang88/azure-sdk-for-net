...
namespace LabServicesClient.Models
{
    ...
    public partial class RecurrencePattern
    {
        ...
        /// <param name="expirationDate"> When the recurrence will expire. This date is inclusive. </param>
        public RecurrencePattern(RecurrenceFrequency frequency, DateTimeOffset expirationDate)
        {
            Frequency = frequency;
        ...
        /// <param name="expirationDate"> When the recurrence will expire. This date is inclusive. </param>
        internal RecurrencePattern(RecurrenceFrequency frequency, IList<WeekDay> weekDays, int? interval, DateTimeOffset expirationDate)
        {
            Frequency = frequency;
            WeekDays = weekDays;
            Interval = interval;
