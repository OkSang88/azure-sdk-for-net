# Azure ContainerService Management client library for .NET
...
Install the Azure ContainerService management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.ContainerService -Version 1.0.0-preview.1 
```
