...
{
    public partial class SavedSearchData : IUtf8JsonSerializable
    {
        ...
        internal static SavedSearchData DeserializeSavedSearchData(JsonElement element)
        {
            ...
            return new SavedSearchData(id, name, type, etag.Value, category, displayName, query, functionAlias.Value, functionParameters.Value, Optional.ToNullable(version), Optional.ToList(tags));
        }
    }
}
