...
namespace SecurityInsights.Models
{
    ...
    public partial class BookmarkTimelineItem : EntityTimelineItem
    {
        ...
        internal BookmarkTimelineItem(EntityTimelineKind kind, string azureResourceId, string displayName, string notes, DateTimeOffset? endTimeUtc, DateTimeOffset? startTimeUtc, DateTimeOffset? eventTime, UserInfo createdBy, IReadOnlyList<string> labels) : base(kind)
        {
            AzureResourceId = azureResourceId;
