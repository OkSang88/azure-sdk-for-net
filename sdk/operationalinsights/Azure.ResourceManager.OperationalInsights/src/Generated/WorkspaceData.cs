...
namespace Azure.ResourceManager.OperationalInsights
{
    ...
    public partial class WorkspaceData : TrackedResource
    {
        ...
        internal WorkspaceData(ResourceIdentifier id, string name, ResourceType type, IDictionary<string, string> tags, AzureLocation location, string eTag, WorkspaceEntityStatus? provisioningState, string customerId, WorkspaceSku sku, int? retentionInDays, WorkspaceCapping workspaceCapping, string createdDate, string modifiedDate, PublicNetworkAccessType? publicNetworkAccessForIngestion, PublicNetworkAccessType? publicNetworkAccessForQuery, bool? forceCmkForQuery, IReadOnlyList<PrivateLinkScopedResource> privateLinkScopedResources, WorkspaceFeatures features) : base(id, name, type, tags, location)
        {
            ETag = eTag;
