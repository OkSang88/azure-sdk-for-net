# Azure Kubernetes Management client library for .NET
...
Install the Azure Kubernetes management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.Kubernetes -Version 1.0.0-preview.1 
```
