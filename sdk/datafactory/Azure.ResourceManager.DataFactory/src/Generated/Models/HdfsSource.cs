...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class HdfsSource : CopySource
    {
        ...
        internal HdfsSource(string type, object sourceRetryCount, object sourceRetryWait, object maxConcurrentConnections, object disableMetricsCollection, IDictionary<string, object> additionalProperties, object recursive, DistcpSettings distcpSettings) : base(type, sourceRetryCount, sourceRetryWait, maxConcurrentConnections, disableMetricsCollection, additionalProperties)
        {
            Recursive = recursive;
