...
namespace SecurityInsights.Models
{
    ...
    public partial class MailboxEntity : EntityData
    {
        ...
        internal MailboxEntity(ResourceIdentifier id, string name, ResourceType type, SystemData systemData, EntityKind kind, IReadOnlyDictionary<string, object> additionalData, string friendlyName, string mailboxPrimaryAddress, string displayName, string upn, Guid? externalDirectoryObjectId) : base(id, name, type, systemData, kind)
        {
