...
namespace Azure.ResourceManager.AppPlatform
{
    ...
    public partial class DeploymentResourceCollection : ArmCollection, IEnumerable<DeploymentResource>, IAsyncEnumerable<DeploymentResource>
    {
        ...
        internal DeploymentResourceCollection(ArmResource parent) : base(parent)
        {
            ...
            ClientOptions.TryGetApiVersion(DeploymentResource.ResourceType, out string apiVersion);
        ...
        public virtual DeploymentResourceCreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, string deploymentName, DeploymentResourceData deploymentResource, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new DeploymentResourceCreateOrUpdateOperation(this, _clientDiagnostics, Pipeline, _deploymentsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, deploymentName, deploymentResource).Request, response);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="deploymentName"/> or <paramref name="deploymentResource"/> is null. </exception>
        public async virtual Task<DeploymentResourceCreateOrUpdateOperation> CreateOrUpdateAsync(bool waitForCompletion, string deploymentName, DeploymentResourceData deploymentResource, CancellationToken cancellationToken = default)
        {
            if (deploymentName == null)
            {
                throw new ArgumentNullException(nameof(deploymentName));
        ...
        public virtual Response<bool> Exists(string deploymentName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("DeploymentResourceCollection.Exists");
            scope.Start();
            try
            {
        ...
        public virtual Pageable<DeploymentResource> GetAll(IEnumerable<string> version = null, CancellationToken cancellationToken = default)
        {
            Page<DeploymentResource> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    ...
                    return Page.FromValues(response.Value.Value.Select(value => new DeploymentResource(this, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
        ...
        // Builders.
        // public ArmBuilder<Azure.Core.ResourceIdentifier, DeploymentResource, DeploymentResourceData> Construct() { }
    }
}
