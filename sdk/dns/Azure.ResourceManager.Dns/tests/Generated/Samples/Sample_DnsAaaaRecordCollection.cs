...
{
    public partial class Sample_DnsAaaaRecordCollection
    {
        // Create A recordset
        ...
        public async Task CreateOrUpdate_CreateARecordset()
        {
            ...
            // get the collection of this DnsAaaaRecordResource
            DnsAaaaRecordCollection collection = dnsZone.GetDnsAaaaRecords();
...
IPv4Address = "127.0.0.1",
            ...
            ArmOperation<DnsAaaaRecordResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, relativeRecordSetName, data);
            DnsAaaaRecordResource result = lro.Value;
...
"string1","string2"
        ...
        public async Task Get_GetARecordset()
        {
            ...
            // invoke the operation
            string relativeRecordSetName = "record1";
            DnsAaaaRecordResource result = await collection.GetAsync(relativeRecordSetName);
        ...
        public async Task GetAll_ListARecordsets()
        {
            ...
            await foreach (DnsAaaaRecordResource item in collection.GetAllAsync())
            {
