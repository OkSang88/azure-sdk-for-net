...
namespace LabServicesClient
{
    public partial class LabPlanData : IUtf8JsonSerializable
    {
        ...
        internal static LabPlanData DeserializeLabPlanData(JsonElement element)
        {
            ...
            return new LabPlanData(id, name, type, tags, location, systemData, defaultConnectionProfile.Value, defaultAutoShutdownProfile.Value, defaultNetworkProfile.Value, Optional.ToList(allowedRegions), sharedGalleryId.Value, supportInfo.Value, linkedLmsInstance.Value, Optional.ToNullable(provisioningState));
        }
    }
}
