...
namespace BatchManagementClient.Models
{
    ...
    public partial class CertificateCreateOperation : Operation<Certificate>
    {
        private readonly OperationOrResponseInternals<Certificate> _operation;

        /// <summary> Initializes a new instance of CertificateCreateOperation for mocking. </summary>
        protected CertificateCreateOperation()
        {
        }

        internal CertificateCreateOperation(ArmResource operationsBase, Response<CertificateData> response)
        {
