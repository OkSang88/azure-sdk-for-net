...
namespace Azure.ResourceManager.DataFactory.Tests.Mock.Tests.Mock
{
    ...
    public partial class PipelineResourceCollectionMockTests : MockTestBase
    {
        ...
        public async Task CreateOrUpdate()
        {
            ...
            DataFactory.Tests.Mock.PipelineResourceData pipeline = new DataFactory.Tests.Mock.PipelineResourceData()
            {
                Policy = new DataFactory.Tests.Mock.Models.PipelinePolicy()
                {
                    ElapsedTimeMetric = new DataFactory.Tests.Mock.Models.PipelineElapsedTimeMetricPolicy()
                    {
                        Duration = "0.00:10:00",
                    },
                },
