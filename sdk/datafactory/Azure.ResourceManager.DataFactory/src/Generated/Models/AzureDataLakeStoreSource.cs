...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class AzureDataLakeStoreSource : CopySource
    {
        ...
        internal AzureDataLakeStoreSource(string type, object sourceRetryCount, object sourceRetryWait, object maxConcurrentConnections, object disableMetricsCollection, IDictionary<string, object> additionalProperties, object recursive) : base(type, sourceRetryCount, sourceRetryWait, maxConcurrentConnections, disableMetricsCollection, additionalProperties)
        {
            Recursive = recursive;
