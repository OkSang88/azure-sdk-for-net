...
namespace Azure.ResourceManager.Batch
{
    ...
    public partial class PoolData : ProxyResource
    {
        ...
        /// <param name="provisioningStateTransitionTime"> The time at which the pool entered its current state. </param>
        ...
        /// <param name="currentLowPriorityNodes"> The number of low-priority compute nodes currently in the pool. </param>
        ...
        internal PoolData(ResourceIdentifier id, string name, ResourceType type, string etag, BatchPoolIdentity identity, string displayName, DateTimeOffset? lastModified, DateTimeOffset? creationTime, PoolProvisioningState? provisioningState, DateTimeOffset? provisioningStateTransitionTime, AllocationState? allocationState, DateTimeOffset? allocationStateTransitionTime, string vmSize, DeploymentConfiguration deploymentConfiguration, int? currentDedicatedNodes, int? currentLowPriorityNodes, ScaleSettings scaleSettings, AutoScaleRun autoScaleRun, InterNodeCommunicationState? interNodeCommunication, NetworkConfiguration networkConfiguration, int? taskSlotsPerNode, TaskSchedulingPolicy taskSchedulingPolicy, IList<UserAccount> userAccounts, IList<MetadataItem> metadata, StartTask startTask, IList<CertificateReference> certificates, IList<ApplicationPackageReference> applicationPackages, IList<string> applicationLicenses, ResizeOperationStatus resizeOperationStatus, IList<MountConfiguration> mountConfiguration) : base(id, name, type, etag)
        {
            Identity = identity;
