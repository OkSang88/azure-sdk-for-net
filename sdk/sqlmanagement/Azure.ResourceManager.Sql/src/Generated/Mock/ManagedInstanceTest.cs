...
namespace Azure.ResourceManager.Sql.Tests.Mock
{
    ...
    public partial class ManagedInstanceMockTests : MockTestBase
    {
        ...
        public async Task GetAsync()
        {
            ...
            var managedInstance = GetArmClient().GetManagedInstance(new ResourceIdentifier("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/testrg/providers/Microsoft.Sql/managedInstances/testinstance"));
            string expand = null;
        ...
        [RecordedTest]
        public void GetInaccessibleManagedDatabasesAsync()
        {
            // Example: List inaccessible managed databases by managed instances
            var managedInstance = GetArmClient().GetManagedInstance(new ResourceIdentifier("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/testrg/providers/Microsoft.Sql/managedInstances/testcl"));

            managedInstance.GetInaccessibleManagedDatabasesAsync();
        }

        [RecordedTest]
        public void GetTopQueriesAsync()
        {
            // Example: Obtain list of instance's top resource consuming queries.
            var managedInstance = GetArmClient().GetManagedInstance(new ResourceIdentifier("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/sqlcrudtest-7398/providers/Microsoft.Sql/managedInstances/sqlcrudtest-4645"));
        ...
        [RecordedTest]
        public void GetTopQueriesAsync2()
        {
        ...
        [RecordedTest]
        public void GetTopQueriesAsync3()
        {
        ...
        public async Task FailoverAsync()
        {
            ...
            var managedInstance = GetArmClient().GetManagedInstance(new ResourceIdentifier("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/group1/providers/Microsoft.Sql/managedInstances/instanceName"));
        ...
        public async Task CreateManagedInstanceTdeCertificateAsync()
        {
            ...
            var managedInstance = GetArmClient().GetManagedInstance(new ResourceIdentifier("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/testtdecert/providers/Microsoft.Sql/managedInstances/testtdecert"));
        ...
        [RecordedTest]
        public void GetServerTrustGroupsAsync()
        {
            // Example: List server trust groups by managed instance
            var managedInstance = GetArmClient().GetManagedInstance(new ResourceIdentifier("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/Default-SQL-SouthEastAsia/providers/Microsoft.Sql/managedInstances/managedInstance-1"));
