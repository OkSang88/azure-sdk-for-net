    ...
    public partial class AzureMLExecutePipelineActivity : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Optional.IsDefined(MlPipelineEndpointId))
            {
                ...
                writer.WriteObjectValue(MlPipelineEndpointId);
            }
            ...
            if (Optional.IsDefined(DataPathAssignments))
            {
                ...
                writer.WriteObjectValue(DataPathAssignments);
            }
        ...
        internal static AzureMLExecutePipelineActivity DeserializeAzureMLExecutePipelineActivity(JsonElement element)
        {
            ...
            Optional<object> mlPipelineId = default;
            Optional<object> mlPipelineEndpointId = default;
            Optional<object> version = default;
            Optional<object> experimentName = default;
            Optional<object> mlPipelineParameters = default;
            Optional<object> dataPathAssignments = default;
                ...
                if (property.NameEquals("typeProperties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("mlPipelineEndpointId"))
                        {
                            ...
                            mlPipelineEndpointId = property0.Value.GetObject();
                            continue;
                        }
                        ...
                        if (property0.NameEquals("dataPathAssignments"))
                        {
                            ...
                            dataPathAssignments = property0.Value.GetObject();
                            continue;
                        }
