# Azure AgriFood Management client library for .NET
...
Install the Azure AgriFood management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.AgriFood -Version 1.0.0-preview.1 
```
