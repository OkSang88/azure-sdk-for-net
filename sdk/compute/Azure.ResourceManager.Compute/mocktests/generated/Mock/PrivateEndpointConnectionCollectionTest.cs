...
namespace Azure.ResourceManager.Compute.Tests.Mock
{
    ...
    public partial class PrivateEndpointConnectionCollectionMockTests : MockTestBase
    {
        ...
        public async Task CreateOrUpdateAsync()
        {
            ...
            var collection = GetArmClient().GetDiskAccess(new ResourceIdentifier("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/myResourceGroup/providers/Microsoft.Compute/diskAccesses/myDiskAccess")).GetPrivateEndpointConnections();
