...
{
    public partial class CustomContainer : IUtf8JsonSerializable
    {
        ...
        internal static CustomContainer DeserializeCustomContainer(JsonElement element)
        {
            ...
            return new CustomContainer(server.Value, containerImage.Value, Optional.ToList(command), Optional.ToList(args), imageRegistryCredential.Value);
        }
    }
}
