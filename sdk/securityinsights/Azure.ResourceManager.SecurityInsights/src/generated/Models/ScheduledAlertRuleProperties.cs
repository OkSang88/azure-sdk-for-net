...
namespace SecurityInsights.Models
{
    ...
    {
        /// <summary> Initializes a new instance of ScheduledAlertRuleProperties. </summary>
        ...
        internal ScheduledAlertRuleProperties(string displayName, bool enabled, TimeSpan suppressionDuration, bool suppressionEnabled)
        {
            if (displayName == null)
            {
