...
namespace Azure.ResourceManager.SqlVirtualMachine.Tests.Mock.Tests.Mock
{
    ...
    public partial class SqlVirtualMachineGroupCollectionMockTests : MockTestBase
    {
        ...
        public async Task CreateOrUpdate()
        {
            ...
            SqlVirtualMachine.Tests.Mock.SqlVirtualMachineGroupData parameters = new SqlVirtualMachine.Tests.Mock.SqlVirtualMachineGroupData(location: "northeurope")
            {
                SqlImageOffer = "SQL2016-WS2016",
                SqlImageSku = new SqlVirtualMachine.Tests.Mock.Models.SqlVmGroupImageSku("Enterprise"),
                WsfcDomainProfile = new SqlVirtualMachine.Tests.Mock.Models.WsfcDomainProfile()
                {
