...
namespace SecurityInsights.Models
{
    public partial class HuntingBookmark : IUtf8JsonSerializable
    {
        ...
        internal static HuntingBookmark DeserializeHuntingBookmark(JsonElement element)
        {
            ...
            return new HuntingBookmark(id, name, type, systemData, kind, Optional.ToDictionary(additionalData), friendlyName.Value, Optional.ToNullable(created), createdBy.Value, displayName.Value, Optional.ToNullable(eventTime), Optional.ToList(labels), notes.Value, query.Value, queryResult.Value, Optional.ToNullable(updated), updatedBy.Value, incidentInfo.Value);
        }
    }
}
