...
namespace Azure.ResourceManager.AppPlatform
{
    ...
    public partial class ServiceResource : ArmResource
    {
        ...
        internal ServiceResource(ArmResource options, ServiceResourceData data) : base(options, data.Id)
        {
            ...
            _configServersRestClient = new ConfigServersRestOperations(_clientDiagnostics, Pipeline, ClientOptions, BaseUri, apiVersion);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async virtual Task<ServiceResourceDeleteOperation> DeleteAsync(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ServiceResourceDeleteOperation(_clientDiagnostics, Pipeline, _servicesRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name).Request, response);
        ...
        /// <param name="waitForCompletion"> Waits for the completion of the long running operations. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual ServiceResourceDeleteOperation Delete(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ServiceResource.Delete");
            scope.Start();
            try
        ...
        public async virtual Task<ServiceResourceUpdateOperation> UpdateAsync(bool waitForCompletion, ServiceResourceData resource, CancellationToken cancellationToken = default)
        {
            if (resource == null)
            {
            ...
            try
            {
                ...
                var operation = new ServiceResourceUpdateOperation(this, _clientDiagnostics, Pipeline, _servicesRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, resource).Request, response);
                if (waitForCompletion)
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resource"/> is null. </exception>
        public virtual ServiceResourceUpdateOperation Update(bool waitForCompletion, ServiceResourceData resource, CancellationToken cancellationToken = default)
        {
            if (resource == null)
            {
                throw new ArgumentNullException(nameof(resource));
        ...
        /// <param name="waitForCompletion"> Waits for the completion of the long running operations. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async virtual Task<ServiceResourceStopOperation> StopAsync(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ServiceResourceStopOperation(_clientDiagnostics, Pipeline, _servicesRestClient.CreateStopRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name).Request, response);
                if (waitForCompletion)
                    await operation.WaitForCompletionResponseAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        /// <param name="waitForCompletion"> Waits for the completion of the long running operations. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual ServiceResourceStopOperation Stop(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ServiceResource.Stop");
            scope.Start();
            try
        ...
        /// <param name="waitForCompletion"> Waits for the completion of the long running operations. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async virtual Task<ServiceResourceStartOperation> StartAsync(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ServiceResourceStartOperation(_clientDiagnostics, Pipeline, _servicesRestClient.CreateStartRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name).Request, response);
                if (waitForCompletion)
                    await operation.WaitForCompletionResponseAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        /// <param name="waitForCompletion"> Waits for the completion of the long running operations. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual ServiceResourceStartOperation Start(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ServiceResource.Start");
            scope.Start();
            try
        ...
        public async virtual Task<ServiceResourceValidateConfigServerOperation> ValidateConfigServerAsync(bool waitForCompletion, ConfigServerSettings configServerSettings, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ServiceResourceValidateConfigServerOperation(_clientDiagnostics, Pipeline, _configServersRestClient.CreateValidateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, configServerSettings).Request, response);
                if (waitForCompletion)
                    await operation.WaitForCompletionAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="configServerSettings"/> is null. </exception>
        public virtual ServiceResourceValidateConfigServerOperation ValidateConfigServer(bool waitForCompletion, ConfigServerSettings configServerSettings, CancellationToken cancellationToken = default)
        {
            if (configServerSettings == null)
            {
                throw new ArgumentNullException(nameof(configServerSettings));
