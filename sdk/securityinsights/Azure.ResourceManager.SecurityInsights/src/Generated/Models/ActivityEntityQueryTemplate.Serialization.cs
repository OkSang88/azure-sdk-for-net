...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    public partial class ActivityEntityQueryTemplate : IUtf8JsonSerializable
    {
        ...
        internal static ActivityEntityQueryTemplate DeserializeActivityEntityQueryTemplate(JsonElement element)
        {
            ...
            return new ActivityEntityQueryTemplate(id, name, type, systemData, kind, title.Value, content.Value, description.Value, queryDefinitions.Value, Optional.ToList(dataTypes), Optional.ToNullable(inputEntityType), Optional.ToList(requiredInputFieldsSets), Optional.ToDictionary(entitiesFilter));
        }
    }
}
