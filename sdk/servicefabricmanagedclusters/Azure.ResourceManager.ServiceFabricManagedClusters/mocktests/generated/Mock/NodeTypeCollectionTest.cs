...
namespace ServiceFabricManagedClustersManagementClient.Tests.Mock
{
    ...
    public partial class NodeTypeCollectionMockTests : MockTestBase
    {
        ...
        public async Task CreateOrUpdate()
        {
            ...
            ServiceFabricManagedClustersManagementClient.NodeTypeData parameters = new ServiceFabricManagedClustersManagementClient.NodeTypeData()
            {
                IsPrimary = false,
                VmInstanceCount = -1,
                DataDiskSizeGB = 200,
                DataDiskType = new ServiceFabricManagedClustersManagementClient.Models.DiskType("Premium_LRS"),
                VmSize = "Standard_DS3",
                VmImagePublisher = "MicrosoftWindowsServer",
                VmImageOffer = "WindowsServer",
                VmImageSku = "2016-Datacenter-Server-Core",
                VmImageVersion = "latest",
                VmManagedIdentity = new ServiceFabricManagedClustersManagementClient.Models.VmManagedIdentity(),
                IsStateless = true,
