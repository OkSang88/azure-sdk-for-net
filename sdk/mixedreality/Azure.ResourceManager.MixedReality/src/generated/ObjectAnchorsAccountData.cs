...
namespace MixedRealityClient
{
    ...
    public partial class ObjectAnchorsAccountData : TrackedResource
    {
        ...
        /// <param name="systemData"> The system metadata related to an object anchors account. </param>
