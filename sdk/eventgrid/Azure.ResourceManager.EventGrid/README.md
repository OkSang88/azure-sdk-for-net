# Azure EventGrid Management client library for .NET
...
Install the Azure EventGrid management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.EventGrid -Version 1.0.0-preview.1 
```
