...
namespace Azure.ResourceManager.ServiceFabric
{
    public partial class ApplicationResourceData : IUtf8JsonSerializable
    {
        ...
        internal static ApplicationResourceData DeserializeApplicationResourceData(JsonElement element)
        {
            ...
            return new ApplicationResourceData(id, name, type, tags, location, etag.Value, systemData, identity.Value, typeVersion.Value, Optional.ToDictionary(parameters), upgradePolicy.Value, Optional.ToNullable(minimumNodes), Optional.ToNullable(maximumNodes), Optional.ToNullable(removeApplicationCapacity), Optional.ToList(metrics), Optional.ToList(managedIdentities), provisioningState.Value, typeName.Value);
        }
    }
}
