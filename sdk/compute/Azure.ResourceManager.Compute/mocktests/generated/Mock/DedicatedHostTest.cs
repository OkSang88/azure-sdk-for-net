...
namespace Azure.ResourceManager.Compute.Tests.Mock
{
    ...
    public partial class DedicatedHostMockTests : MockTestBase
    {
        ...
        public async Task Get()
        {
            ...
            var dedicatedHostId = Compute.DedicatedHost.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "myResourceGroup", "myDedicatedHostGroup", "myHost");
            var dedicatedHost = GetArmClient().GetDedicatedHost(dedicatedHostId);
