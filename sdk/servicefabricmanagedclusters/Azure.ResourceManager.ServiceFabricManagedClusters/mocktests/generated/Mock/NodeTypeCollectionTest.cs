...
namespace Azure.ResourceManager.ServiceFabricManagedClusters.Tests.Mock.Tests.Mock
{
    ...
    public partial class NodeTypeCollectionMockTests : MockTestBase
    {
        ...
        public async Task CreateOrUpdate()
        {
            ...
            ServiceFabricManagedClusters.Tests.Mock.NodeTypeData parameters = new ServiceFabricManagedClusters.Tests.Mock.NodeTypeData()
            {
                IsPrimary = false,
                VmInstanceCount = -1,
                DataDiskSizeGB = 200,
                DataDiskType = new ServiceFabricManagedClusters.Tests.Mock.Models.DiskType("Premium_LRS"),
                VmSize = "Standard_DS3",
                VmImagePublisher = "MicrosoftWindowsServer",
                VmImageOffer = "WindowsServer",
                VmImageSku = "2016-Datacenter-Server-Core",
                VmImageVersion = "latest",
                VmManagedIdentity = new ServiceFabricManagedClusters.Tests.Mock.Models.VmManagedIdentity(),
                IsStateless = true,
