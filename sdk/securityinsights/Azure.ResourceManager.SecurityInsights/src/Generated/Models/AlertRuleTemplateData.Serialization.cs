...
{
    public partial class AlertRuleTemplateData : IUtf8JsonSerializable
    {
        ...
        internal static AlertRuleTemplateData DeserializeAlertRuleTemplateData(JsonElement element)
        {
            if (element.TryGetProperty("kind", out JsonElement discriminator))
            {
                switch (discriminator.GetString())
                {
                    case "Fusion": return FusionAlertRuleTemplate.DeserializeFusionAlertRuleTemplate(element);
            ...
            return new AlertRuleTemplateData(id, name, type, systemData, kind);
        }
    }
}
