...
{
    public partial class Sample_NetworkCollection
    {
        ...
        {
            // Generated from example definition: specification/recoveryservicessiterecovery/resource-manager/Microsoft.RecoveryServices/stable/2022-08-01/examples/ReplicationNetworks_ListByReplicationFabrics.json
            ...
            // get the collection of this NetworkResource
            NetworkCollection collection = fabric.GetNetworks();

            // invoke the operation and iterate over the result
            await foreach (NetworkResource item in collection.GetAllAsync())
            {
        ...
        public async Task Get_GetsANetworkWithSpecifiedServerIdAndNetworkName()
        {
            ...
            NetworkResource result = await collection.GetAsync(networkName);
