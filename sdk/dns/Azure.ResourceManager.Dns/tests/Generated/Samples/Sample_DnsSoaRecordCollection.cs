...
{
    public partial class Sample_DnsSoaRecordCollection
    {
        // Create A recordset
        ...
        public async Task CreateOrUpdate_CreateARecordset()
        {
            ...
            // get the collection of this DnsSoaRecordResource
            DnsSoaRecordCollection collection = dnsZone.GetDnsSoaRecords();
...
IPv4Address = "127.0.0.1",
            ...
            ArmOperation<DnsSoaRecordResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, relativeRecordSetName, data);
            DnsSoaRecordResource result = lro.Value;
...
"string1","string2"
        ...
        public async Task Get_GetARecordset()
        {
            ...
            // invoke the operation
            string relativeRecordSetName = "record1";
            DnsSoaRecordResource result = await collection.GetAsync(relativeRecordSetName);
        ...
        public async Task GetAll_ListARecordsets()
        {
            ...
            await foreach (DnsSoaRecordResource item in collection.GetAllAsync())
            {
