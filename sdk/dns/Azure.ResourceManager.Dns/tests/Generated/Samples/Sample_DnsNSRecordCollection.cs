...
{
    public partial class Sample_DnsNSRecordCollection
    {
        // Create A recordset
        ...
        public async Task CreateOrUpdate_CreateARecordset()
        {
            ...
            // get the collection of this DnsNSRecordResource
            DnsNSRecordCollection collection = dnsZone.GetDnsNSRecords();
...
IPv4Address = "127.0.0.1",
            ...
            ArmOperation<DnsNSRecordResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, relativeRecordSetName, data);
            DnsNSRecordResource result = lro.Value;
...
"string1","string2"
        ...
        public async Task Get_GetARecordset()
        {
            ...
            // invoke the operation
            string relativeRecordSetName = "record1";
            DnsNSRecordResource result = await collection.GetAsync(relativeRecordSetName);
        ...
        public async Task GetAll_ListARecordsets()
        {
            ...
            await foreach (DnsNSRecordResource item in collection.GetAllAsync())
            {
