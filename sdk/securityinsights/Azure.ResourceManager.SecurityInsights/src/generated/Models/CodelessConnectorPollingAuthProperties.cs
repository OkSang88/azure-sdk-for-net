...
namespace SecurityInsights.Models
{
    ...
    public partial class CodelessConnectorPollingAuthProperties
    {
        ...
        internal CodelessConnectorPollingAuthProperties(string authType, string apiKeyName, string apiKeyIdentifier, string isApiKeyInPostPayload, string flowName, string tokenEndpoint, string authorizationEndpoint, object authorizationEndpointQueryParameters, string redirectionEndpoint, object tokenEndpointHeaders, object tokenEndpointQueryParameters, bool? isClientSecretInHeader, string scope)
        {
            AuthType = authType;
