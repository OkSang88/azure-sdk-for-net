...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    public partial class MonitoringSettingResourceCreateOrUpdateOperation : Operation<MonitoringSettingResource>, IOperationSource<MonitoringSettingResource>
    {
        private readonly OperationInternals<MonitoringSettingResource> _operation;

        private readonly ArmResource _operationBase;

        /// <summary> Initializes a new instance of MonitoringSettingResourceCreateOrUpdateOperation for mocking. </summary>
        protected MonitoringSettingResourceCreateOrUpdateOperation()
        {
        }

        internal MonitoringSettingResourceCreateOrUpdateOperation(ArmResource operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<MonitoringSettingResource>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.AzureAsyncOperation, "MonitoringSettingResourceCreateOrUpdateOperation");
