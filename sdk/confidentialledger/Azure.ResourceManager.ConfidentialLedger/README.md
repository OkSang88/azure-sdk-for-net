# Azure ConfidentialLedger Management client library for .NET
...
Install the Azure ConfidentialLedger management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.ConfidentialLedger -Version 1.0.0-preview.1 
```
