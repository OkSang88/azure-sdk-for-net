...
namespace Azure.ResourceManager.ContainerRegistry
{
    public partial class WebhookData : IUtf8JsonSerializable
    {
        ...
        internal static WebhookData DeserializeWebhookData(JsonElement element)
        {
            ...
            return new WebhookData(id, name, type, tags, location, systemData.Value, Optional.ToNullable(status), scope.Value, Optional.ToList(actions), Optional.ToNullable(provisioningState));
        }
    }
}
