...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class AppServiceDetectorData : ResourceData
    {
        ...
        internal AppServiceDetectorData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, DetectorInfo metadata, IList<DiagnosticData> dataset, OperationStatus status, IList<DataProviderMetadata> dataProvidersMetadata, QueryUtterancesResults suggestedUtterances, string kind) : base(id, name, resourceType, systemData)
        {
            Metadata = metadata;
            Dataset = dataset;
            Status = status;
