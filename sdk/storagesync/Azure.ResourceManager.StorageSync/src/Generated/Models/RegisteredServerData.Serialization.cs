    ...
    public partial class RegisteredServerData : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Optional.IsDefined(DiscoveryEndpointUri))
            {
                ...
                writer.WriteStringValue(DiscoveryEndpointUri);
            }
            ...
            if (Optional.IsDefined(ManagementEndpointUri))
            {
                ...
                writer.WriteStringValue(ManagementEndpointUri);
            }
            if (Optional.IsDefined(MonitoringEndpointUri))
            {
                writer.WritePropertyName("monitoringEndpointUri");
                writer.WriteStringValue(MonitoringEndpointUri);
            }
        ...
        internal static RegisteredServerData DeserializeRegisteredServerData(JsonElement element)
        {
            ...
            Optional<string> discoveryEndpointUri = default;
            Optional<string> resourceLocation = default;
            Optional<string> serviceLocation = default;
            Optional<string> friendlyName = default;
            Optional<string> managementEndpointUri = default;
            Optional<string> monitoringEndpointUri = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        {
                            discoveryEndpointUri = property0.Value.GetString();
                            continue;
                        }
                        ...
                        {
                            managementEndpointUri = property0.Value.GetString();
                            continue;
                        }
                        if (property0.NameEquals("monitoringEndpointUri"))
                        {
                            monitoringEndpointUri = property0.Value.GetString();
                            continue;
                        }
