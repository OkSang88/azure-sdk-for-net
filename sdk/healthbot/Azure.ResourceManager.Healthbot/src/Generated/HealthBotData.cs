...
namespace Azure.ResourceManager.Healthbot
{
    ...
    public partial class HealthBotData : TrackedResource
    {
        ...
        public HealthBotData(string location, Models.Sku sku) : base(location)
        {
            if (location == null)
            {
        ...
        internal HealthBotData(ResourceIdentifier id, string name, ResourceType type, SystemData systemData, IDictionary<string, string> tags, string location, Models.Sku sku, ResourceIdentity identity, HealthBotProperties properties) : base(id, name, type, systemData, tags, location)
        {
            Sku = sku;
            Identity = identity;
