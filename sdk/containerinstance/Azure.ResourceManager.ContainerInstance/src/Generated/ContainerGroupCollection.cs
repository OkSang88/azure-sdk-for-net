...
namespace Azure.ResourceManager.ContainerInstance
{
    ...
    public partial class ContainerGroupCollection : ArmCollection, IEnumerable<ContainerGroup>, IAsyncEnumerable<ContainerGroup>
    {
        ...
        internal ContainerGroupCollection(ArmResource parent) : base(parent)
        {
            ...
            ClientOptions.TryGetApiVersion(ContainerGroup.ResourceType, out string apiVersion);
            _containerGroupsRestClient = new ContainerGroupsRestOperations(_clientDiagnostics, Pipeline, ClientOptions, BaseUri, apiVersion);
#if DEBUG
        ...
        public virtual ContainerGroupCreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, string containerGroupName, ContainerGroupData containerGroup, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ContainerGroupCreateOrUpdateOperation(this, _clientDiagnostics, Pipeline, _containerGroupsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, containerGroupName, containerGroup).Request, response);
        ...
        public virtual Pageable<ContainerGroup> GetAll(CancellationToken cancellationToken = default)
        {
            Page<ContainerGroup> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    ...
                    return Page.FromValues(response.Value.Value.Select(value => new ContainerGroup(this, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
