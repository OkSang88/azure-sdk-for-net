...
namespace Insights
{
    /// <summary> A class representing the LogProfileResource data model. </summary>
    public partial class LogProfileResourceData : TrackedResource
    {
        /// <summary> Initializes a new instance of LogProfileResourceData. </summary>
        ...
        public LogProfileResourceData(AzureLocation location, IEnumerable<string> locations, IEnumerable<string> categories, RetentionPolicy retentionPolicy) : base(location)
        {
            if (locations == null)
            {
        ...
        /// <param name="categories"> the categories of the logs. These categories are created as is convenient to the user. Some values are: &apos;Write&apos;, &apos;Delete&apos;, and/or &apos;Action.&apos;. </param>
        /// <param name="retentionPolicy"> the retention policy for the events in the log. </param>
        internal LogProfileResourceData(ResourceIdentifier id, string name, ResourceType type, IDictionary<string, string> tags, AzureLocation location, string storageAccountId, string serviceBusRuleId, IList<string> locations, IList<string> categories, RetentionPolicy retentionPolicy) : base(id, name, type, tags, location)
        {
