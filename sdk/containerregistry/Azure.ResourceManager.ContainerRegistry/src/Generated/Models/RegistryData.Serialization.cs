...
{
    public partial class RegistryData : IUtf8JsonSerializable
    {
        ...
        internal static RegistryData DeserializeRegistryData(JsonElement element)
        {
            ...
            Optional<Policies> policies = default;
            ...
            Optional<NetworkRuleBypassOptions> networkRuleBypassOptions = default;
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("status"))
                        {
                            ...
                            status = Status.DeserializeStatus(property0.Value);
                            continue;
                        }
                        ...
                        if (property0.NameEquals("networkRuleBypassOptions"))
                        {
                            ...
                            networkRuleBypassOptions = new NetworkRuleBypassOptions(property0.Value.GetString());
                            continue;
                        }
                        if (property0.NameEquals("zoneRedundancy"))
                        {
                            ...
                            zoneRedundancy = new ZoneRedundancy(property0.Value.GetString());
                            continue;
                        }
                    }
                    continue;
            ...
            return new RegistryData(id, name, type, tags, location, systemData.Value, sku, identity, loginServer.Value, Optional.ToNullable(creationDate), Optional.ToNullable(provisioningState), status.Value, Optional.ToNullable(adminUserEnabled), networkRuleSet.Value, policies.Value, encryption.Value, Optional.ToNullable(dataEndpointEnabled), Optional.ToList(dataEndpointHostNames), Optional.ToList(privateEndpointConnections), Optional.ToNullable(publicNetworkAccess), Optional.ToNullable(networkRuleBypassOptions), Optional.ToNullable(zoneRedundancy));
        }
    }
}
