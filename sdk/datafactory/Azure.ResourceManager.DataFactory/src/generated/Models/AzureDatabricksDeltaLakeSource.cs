...
namespace DataFactoryManagementClient.Models
{
    ...
    public partial class AzureDatabricksDeltaLakeSource : CopySource
    {
        ...
        internal AzureDatabricksDeltaLakeSource(string type, object sourceRetryCount, object sourceRetryWait, object maxConcurrentConnections, object disableMetricsCollection, IDictionary<string, object> additionalProperties, object query, AzureDatabricksDeltaLakeExportCommand exportSettings) : base(type, sourceRetryCount, sourceRetryWait, maxConcurrentConnections, disableMetricsCollection, additionalProperties)
        {
            Query = query;
