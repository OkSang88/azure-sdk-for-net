...
namespace Azure.ResourceManager.Sql.Tests.Mock
{
    ...
    public partial class ServerAzureADOnlyAuthenticationMockTests : MockTestBase
    {
        ...
        public async Task GetAsync()
        {
            ...
            var serverAzureADOnlyAuthentication = GetArmClient().GetServerAzureADOnlyAuthentication(new ResourceIdentifier("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/sqlcrudtest-4799/providers/Microsoft.Sql/servers/sqlcrudtest-6440/azureADOnlyAuthentications/Default"));
