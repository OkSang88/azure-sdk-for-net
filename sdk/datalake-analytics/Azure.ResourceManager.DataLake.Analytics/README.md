# Azure DataLake.Analytics Management client library for .NET
...
Install the Azure DataLake.Analytics management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.DataLake.Analytics -Version 1.0.0-preview.1 
```
