...
namespace DataFactoryManagementClient.Models
{
    ...
    public partial class AmazonS3CompatibleLinkedService : LinkedService
    {
        ...
        /// <param name="serviceUrl"> This value specifies the endpoint to access with the Amazon S3 Compatible Connector. This is an optional property; change it only if you want to try a different service endpoint or want to switch between https and http. Type: string (or Expression with resultType string). </param>
