# Azure AzureStack Management client library for .NET
...
Install the Azure AzureStack management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.AzureStack -Version 1.0.0-preview.1 
```
