...
namespace Azure.ResourceManager.AppPlatform.Models
{
    ...
    public partial class DeploymentResourceUpdateOperation : Operation<DeploymentResource>, IOperationSource<DeploymentResource>
    {
        private readonly OperationInternals<DeploymentResource> _operation;

        private readonly ArmResource _operationBase;

        /// <summary> Initializes a new instance of DeploymentResourceUpdateOperation for mocking. </summary>
        protected DeploymentResourceUpdateOperation()
        {
        }

        internal DeploymentResourceUpdateOperation(ArmResource operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<DeploymentResource>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.AzureAsyncOperation, "DeploymentResourceUpdateOperation");
