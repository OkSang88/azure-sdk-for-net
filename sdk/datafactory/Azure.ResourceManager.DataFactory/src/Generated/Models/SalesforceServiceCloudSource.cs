...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class SalesforceServiceCloudSource : CopySource
    {
        ...
        internal SalesforceServiceCloudSource(string type, object sourceRetryCount, object sourceRetryWait, object maxConcurrentConnections, object disableMetricsCollection, IDictionary<string, object> additionalProperties, object query, SalesforceSourceReadBehavior? readBehavior, object additionalColumns) : base(type, sourceRetryCount, sourceRetryWait, maxConcurrentConnections, disableMetricsCollection, additionalProperties)
        {
            Query = query;
