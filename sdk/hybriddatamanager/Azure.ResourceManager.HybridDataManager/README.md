# Azure HybridDataManager Management client library for .NET
...
Install the Azure HybridDataManager management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.HybridDataManager -Version 1.0.0-preview.1 
```
