...
namespace Azure.ResourceManager.FrontDoor
{
    ...
    public partial class WebApplicationFirewallPolicyData : TrackedResource
    {
        ...
        internal WebApplicationFirewallPolicyData(ResourceIdentifier id, string name, Azure.Core.ResourceType type, IDictionary<string, string> tags, AzureLocation location, string etag, Models.Sku sku, PolicySettings policySettings, CustomRuleList customRules, ManagedRuleSetList managedRules, IReadOnlyList<Resources.Models.SubResource> frontendEndpointLinks, IReadOnlyList<Resources.Models.SubResource> routingRuleLinks, IReadOnlyList<Resources.Models.SubResource> securityPolicyLinks, string provisioningState, PolicyResourceState? resourceState) : base(id, name, type, tags, location)
        {
            Etag = etag;
            Sku = sku;
