...
namespace Insights.Models
{
    ...
    public partial class ActivityLogAlertDeleteOperation : Operation
    {
        private readonly OperationOrResponseInternals _operation;

        /// <summary> Initializes a new instance of ActivityLogAlertDeleteOperation for mocking. </summary>
        protected ActivityLogAlertDeleteOperation()
        {
        }

        internal ActivityLogAlertDeleteOperation(Azure.Response response)
        {
