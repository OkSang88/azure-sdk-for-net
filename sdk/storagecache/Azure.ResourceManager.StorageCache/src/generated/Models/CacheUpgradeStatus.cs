...
namespace StorageCacheManagementClient.Models
{
    ...
    {
        /// <summary> Initializes a new instance of CacheUpgradeStatus. </summary>
        ...
        internal CacheUpgradeStatus(string currentFirmwareVersion, FirmwareStatusType? firmwareUpdateStatus, DateTimeOffset? firmwareUpdateDeadline, DateTimeOffset? lastFirmwareUpdate, string pendingFirmwareVersion)
        {
        ...
        public FirmwareStatusType? FirmwareUpdateStatus { get; }
