...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class TriggerRun
    {
        ...
        internal TriggerRun()
        {
            ...
            DependencyStatus = new ChangeTrackingDictionary<string, object>();
        ...
        internal TriggerRun(string triggerRunId, string triggerName, string triggerType, DateTimeOffset? triggerRunTimestamp, TriggerRunStatus? status, string message, IReadOnlyDictionary<string, string> properties, IReadOnlyDictionary<string, string> triggeredPipelines, IReadOnlyDictionary<string, string> runDimension, IReadOnlyDictionary<string, object> dependencyStatus, IReadOnlyDictionary<string, object> additionalProperties)
        {
        ...
        public IReadOnlyDictionary<string, object> DependencyStatus { get; }
