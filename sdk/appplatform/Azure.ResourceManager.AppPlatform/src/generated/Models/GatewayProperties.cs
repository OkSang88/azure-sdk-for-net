...
namespace AppPlatformManagementClient.Models
{
    ...
    public partial class GatewayProperties
    {
        ...
        /// <param name="url"> URL of the Spring Cloud Gateway, exposed when &apos;public&apos; is true. </param>
        ...
        internal GatewayProperties(GatewayProvisioningState? provisioningState, bool? @public, string url, bool? httpsOnly, SsoProperties ssoProperties, GatewayApiMetadataProperties apiMetadataProperties, GatewayCorsProperties corsProperties, GatewayResourceRequests resourceRequests, IReadOnlyList<GatewayInstance> instances, GatewayOperatorProperties operatorProperties)
        {
