...
namespace Azure.ResourceManager.Maps.Tests.Mock
{
    ...
    public partial class MapsAccountCollectionMockTests : MockTestBase
    {
        ...
        public async Task CreateOrUpdate()
        {
            ...
            Maps.MapsAccountData mapsAccount = new Maps.MapsAccountData(location: "eastus", sku: new Maps.Models.Sku(name: new Maps.Models.Name("G2")))
            {
                Kind = new Maps.Models.Kind("Gen2"),
                Identity = new ResourceIdentity(),
                Properties = new Maps.Models.MapsAccountProperties()
                {
        ...
        public async Task CreateOrUpdate2()
        {
            ...
            string accountName = "myMapsAccount";
            Maps.MapsAccountData mapsAccount = new Maps.MapsAccountData(location: "eastus", sku: new Maps.Models.Sku(name: new Maps.Models.Name("S0")))
            {
                Kind = new Maps.Models.Kind("Gen1"),
                Properties = new Maps.Models.MapsAccountProperties()
                {
                    DisableLocalAuth = false,
                    Cors = new Maps.Models.CorsRules(),
                },
            };
            mapsAccount.Tags.ReplaceWith(new Dictionary<string, string>()
            {
