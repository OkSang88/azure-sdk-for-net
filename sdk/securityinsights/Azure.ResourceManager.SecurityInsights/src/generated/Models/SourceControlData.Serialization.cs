...
namespace SecurityInsights
{
    public partial class SourceControlData : IUtf8JsonSerializable
    {
        ...
        internal static SourceControlData DeserializeSourceControlData(JsonElement element)
        {
            ...
            return new SourceControlData(id, name, type, systemData, etag.Value, id0.Value, displayName.Value, description.Value, Optional.ToNullable(repoType), Optional.ToList(contentTypes), repository.Value);
        }
    }
}
