...
{
    public partial class GitRepoVolume : IUtf8JsonSerializable
    {
        ...
        internal static GitRepoVolume DeserializeGitRepoVolume(JsonElement element)
        {
            ...
            return new GitRepoVolume(directory.Value, repository, revision.Value);
        }
    }
}
