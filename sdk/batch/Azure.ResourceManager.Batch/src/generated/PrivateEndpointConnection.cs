...
namespace BatchManagementClient
{
    ...
    public partial class PrivateEndpointConnection : ArmResource
    {
        ...
        public async virtual Task<PrivateEndpointConnectionUpdateOperation> UpdateAsync(bool waitForCompletion, PrivateEndpointConnectionData parameters, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            if (parameters == null)
            {
            ...
            using var scope = _clientDiagnostics.CreateScope("PrivateEndpointConnection.Update");
            scope.Start();
            try
            {
                var response = await _privateEndpointConnectionRestClient.UpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, parameters, ifMatch, cancellationToken).ConfigureAwait(false);
                var operation = new PrivateEndpointConnectionUpdateOperation(this, _clientDiagnostics, Pipeline, _privateEndpointConnectionRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, parameters, ifMatch).Request, response);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="parameters"/> is null. </exception>
        public virtual PrivateEndpointConnectionUpdateOperation Update(bool waitForCompletion, PrivateEndpointConnectionData parameters, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            if (parameters == null)
            {
                throw new ArgumentNullException(nameof(parameters));
            ...
            try
            {
                var response = _privateEndpointConnectionRestClient.Update(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, parameters, ifMatch, cancellationToken);
                var operation = new PrivateEndpointConnectionUpdateOperation(this, _clientDiagnostics, Pipeline, _privateEndpointConnectionRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, parameters, ifMatch).Request, response);
                if (waitForCompletion)
