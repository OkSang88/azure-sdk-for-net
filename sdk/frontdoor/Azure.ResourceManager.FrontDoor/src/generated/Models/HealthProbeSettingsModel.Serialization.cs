...
{
    public partial class HealthProbeSettingsModel : IUtf8JsonSerializable
    {
        ...
        internal static HealthProbeSettingsModel DeserializeHealthProbeSettingsModel(JsonElement element)
        {
            ...
            return new HealthProbeSettingsModel(id.Value, name.Value, type.Value, path.Value, Optional.ToNullable(protocol), Optional.ToNullable(intervalInSeconds), Optional.ToNullable(healthProbeMethod), Optional.ToNullable(enabledState), Optional.ToNullable(resourceState));
        }
    }
}
