...
namespace Azure.ResourceManager.ServiceFabricMesh.Models
{
    ...
    public partial class SecretValueDeleteOperation : Operation
    {
        private readonly OperationOrResponseInternals _operation;

        /// <summary> Initializes a new instance of SecretValueDeleteOperation for mocking. </summary>
        protected SecretValueDeleteOperation()
        {
        }

        internal SecretValueDeleteOperation(Response response)
        {
