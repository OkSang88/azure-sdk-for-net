...
namespace Azure.ResourceManager.Redis
{
    ...
    public partial class RedisFirewallRuleData : Resource
    {
        ...
        /// <param name="startIP"> lowest IP address included in the range. </param>
        /// <param name="endIP"> highest IP address included in the range. </param>
        internal RedisFirewallRuleData(ResourceIdentifier id, string name, ResourceType type, string startIP, string endIP) : base(id, name, type)
        {
            StartIP = startIP;
            EndIP = endIP;
        }
