...
namespace Azure.ResourceManager.OperationalInsights
{
    ...
    public partial class DataExportData : Resource
    {
        ...
        internal DataExportData(ResourceIdentifier id, string name, ResourceType type, string dataExportId, IList<string> tableNames, bool? enable, string createdDate, string lastModifiedDate, string resourceId, Type? typePropertiesDestinationType, string eventHubName) : base(id, name, type)
        {
