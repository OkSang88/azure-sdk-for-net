...
namespace ServiceFabricManagementClient.Models
{
    ...
    public partial class NodeTypeDescription
    {
        ...
        internal NodeTypeDescription(string name, IDictionary<string, string> placementProperties, IDictionary<string, string> capacities, int clientConnectionEndpointPort, int httpGatewayEndpointPort, DurabilityLevel? durabilityLevel, EndpointRangeDescription applicationPorts, EndpointRangeDescription ephemeralPorts, bool isPrimary, int vmInstanceCount, int? reverseProxyEndpointPort, bool? isStateless, bool? multipleAvailabilityZones)
        {
            Name = name;
