...
namespace ContainerRegistryManagementClient.Models
{
    ...
    public partial class SystemData
    {
        ...
        /// <param name="lastModifiedAt"> The timestamp of resource modification (UTC). </param>
        internal SystemData(string createdBy, CreatedByType? createdByType, DateTimeOffset? createdAt, string lastModifiedBy, LastModifiedByType? lastModifiedByType, DateTimeOffset? lastModifiedAt)
        {
            CreatedBy = createdBy;
