...
{
    public partial class GatewayResourceRequests : IUtf8JsonSerializable
    {
        ...
        internal static GatewayResourceRequests DeserializeGatewayResourceRequests(JsonElement element)
        {
            ...
            return new GatewayResourceRequests(cpu.Value, memory.Value);
        }
    }
}
