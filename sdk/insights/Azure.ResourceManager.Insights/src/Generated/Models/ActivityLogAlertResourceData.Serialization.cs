...
namespace Insights
{
    public partial class ActivityLogAlertResourceData : IUtf8JsonSerializable
    {
        ...
        internal static ActivityLogAlertResourceData DeserializeActivityLogAlertResourceData(JsonElement element)
        {
            ...
            return new ActivityLogAlertResourceData(id, name, type, tags, location, Optional.ToList(scopes), Optional.ToNullable(enabled), condition.Value, actions.Value, description.Value);
        }
    }
}
