# Azure CognitiveServices Management client library for .NET
...
Install the Azure CognitiveServices management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.CognitiveServices -Version 1.0.0-preview.1 
```
