...
namespace NotificationHubsManagementClient
{
    internal partial class NamespacesRestOperations
    {
        ...
        public NamespacesRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ClientOptions options, Uri endpoint = null, string apiVersion = "2017-04-01")
        {
