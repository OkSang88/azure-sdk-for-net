...
namespace Azure.ResourceManager.OperationalInsights.Models
{
    ...
    public partial class SearchMetadata
    {
        ...
        internal SearchMetadata(string searchId, string resultType, long? total, long? top, string id, IReadOnlyList<CoreSummary> coreSummaries, string status, DateTimeOffset? startTime, DateTimeOffset? lastUpdated, string eTag, IReadOnlyList<SearchSort> sort, long? requestTime, string aggregatedValueField, string aggregatedGroupingFields, long? sum, long? max, SearchMetadataSchema schema)
        {
            SearchId = searchId;
