...
namespace BatchManagementClient.Models
{
    ...
    public partial class ResizeOperationStatus
    {
        ...
        /// <param name="targetLowPriorityNodes"> The desired number of low-priority compute nodes in the pool. </param>
        ...
        /// <param name="startTime"> The time when this resize operation was started. </param>
        ...
        internal ResizeOperationStatus(int? targetDedicatedNodes, int? targetLowPriorityNodes, TimeSpan? resizeTimeout, ComputeNodeDeallocationOption? nodeDeallocationOption, DateTimeOffset? startTime, IReadOnlyList<ResizeError> errors)
        {
