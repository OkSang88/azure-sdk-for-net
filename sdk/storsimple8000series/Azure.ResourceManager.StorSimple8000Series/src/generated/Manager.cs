...
namespace StorSimple8000SeriesManagementClient
{
    ...
    public partial class Manager : ArmResource
    {
        ...
        internal Manager(ArmResource options, ManagerData data) : base(options, data.Id)
        {
            ...
            _cloudAppliancesRestClient = new CloudAppliancesRestOperations(_clientDiagnostics, Pipeline, ClientOptions, BaseUri);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="parameters"/> is null. </exception>
        public async virtual Task<CloudApplianceProvisionOperation> ProvisionCloudApplianceAsync(bool waitForCompletion, CloudAppliance parameters, CancellationToken cancellationToken = default)
        {
            if (parameters == null)
            {
                throw new ArgumentNullException(nameof(parameters));
            ...
            try
            {
                ...
                var operation = new CloudApplianceProvisionOperation(_clientDiagnostics, Pipeline, _cloudAppliancesRestClient.CreateProvisionRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, parameters).Request, response);
                if (waitForCompletion)
                    await operation.WaitForCompletionResponseAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="parameters"/> is null. </exception>
        public virtual CloudApplianceProvisionOperation ProvisionCloudAppliance(bool waitForCompletion, CloudAppliance parameters, CancellationToken cancellationToken = default)
        {
            if (parameters == null)
            {
                throw new ArgumentNullException(nameof(parameters));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="parameters"/> is null. </exception>
        public async virtual Task<DeviceConfigureOperation> ConfigureDeviceAsync(bool waitForCompletion, ConfigureDeviceRequest parameters, CancellationToken cancellationToken = default)
        {
            if (parameters == null)
            {
                throw new ArgumentNullException(nameof(parameters));
            ...
            try
            {
                ...
                var operation = new DeviceConfigureOperation(_clientDiagnostics, Pipeline, _devicesRestClient.CreateConfigureRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, parameters).Request, response);
                if (waitForCompletion)
                    await operation.WaitForCompletionResponseAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="parameters"/> is null. </exception>
        public virtual DeviceConfigureOperation ConfigureDevice(bool waitForCompletion, ConfigureDeviceRequest parameters, CancellationToken cancellationToken = default)
        {
            if (parameters == null)
            {
                throw new ArgumentNullException(nameof(parameters));
