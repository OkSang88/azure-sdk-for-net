...
{
    public partial class UrlEntity : IUtf8JsonSerializable
    {
        ...
        internal static UrlEntity DeserializeUrlEntity(JsonElement element)
        {
            ...
            return new UrlEntity(id, name, type, systemData, kind, Optional.ToDictionary(additionalData), friendlyName.Value, url.Value);
        }
    }
}
