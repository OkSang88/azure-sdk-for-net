...
namespace SecurityInsights.Models
{
    ...
    {
        /// <summary> Initializes a new instance of IncidentOwnerInfo. </summary>
        ...
        internal IncidentOwnerInfo(string email, string assignedTo, Guid? objectId, string userPrincipalName, OwnerType? ownerType)
        {
            Email = email;
