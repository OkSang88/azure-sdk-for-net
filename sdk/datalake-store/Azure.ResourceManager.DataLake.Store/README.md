# Azure DataLake.Store Management client library for .NET
...
Install the Azure DataLake.Store management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.DataLake.Store -Version 1.0.0-preview.1 
```
