...
namespace Azure.ResourceManager.Batch.Tests.Mock
{
    ...
    public partial class PoolMockTests : MockTestBase
    {
        ...
        {
            // Example: GetPool
            var poolId = Batch.Pool.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "default-azurebatch-japaneast", "sampleacct", "testpool");
        ...
        public async Task Update()
        {
            ...
            Batch.PoolData parameters = new Batch.PoolData()
            {
                ...
                {
                    AutoScale = new Batch.Models.AutoScaleSettings(formula: "$TargetDedicatedNodes=34"),
                },
            };
            string ifMatch = null;
