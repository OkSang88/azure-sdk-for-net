...
namespace StorSimple8000SeriesManagementClient.Tests.Mock
{
    ...
    public partial class DeviceMockTests : MockTestBase
    {
        ...
        {
            // Example: DevicesGet
            var deviceId = StorSimple8000SeriesManagementClient.Device.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "ResourceGroupForSDKTest", "ManagerForSDKTest1", "Device001ForSDKTest");
        ...
        public async Task Update()
        {
            ...
            var deviceId = StorSimple8000SeriesManagementClient.Device.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "ResourceGroupForSDKTest", "ManagerForSDKTest1", "Device001ForSDKTest");
            var device = GetArmClient().GetDevice(deviceId);
            StorSimple8000SeriesManagementClient.Models.DevicePatch parameters = new StorSimple8000SeriesManagementClient.Models.DevicePatch()
            {
        ...
        public async Task GetDevicePublicEncryptionKeyManager()
        {
            ...
            var deviceId = StorSimple8000SeriesManagementClient.Device.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "ResourceGroupForSDKTest", "ManagerForSDKTest1", "sca01forsdktest");
            var device = GetArmClient().GetDevice(deviceId);
        ...
        public async Task SendTestEmailAlert()
        {
            ...
            var device = GetArmClient().GetDevice(deviceId);
            StorSimple8000SeriesManagementClient.Models.SendTestAlertEmailRequest parameters = new StorSimple8000SeriesManagementClient.Models.SendTestAlertEmailRequest(emailList: new List<string>()
{
"testemailid@contoso.com",});
        ...
        public async Task InstallUpdates()
        {
            ...
            var deviceId = StorSimple8000SeriesManagementClient.Device.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "ResourceGroupForSDKTest", "ManagerForSDKTest1", "sugattdeviceforSDK");
            var device = GetArmClient().GetDevice(deviceId);
        ...
        public async Task Failover()
        {
            ...
            var deviceId = StorSimple8000SeriesManagementClient.Device.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "ResourceGroupForSDKTest", "ManagerForSDKTest1", "default");
            var device = GetArmClient().GetDevice(deviceId);
            StorSimple8000SeriesManagementClient.Models.FailoverRequest parameters = new StorSimple8000SeriesManagementClient.Models.FailoverRequest()
            {
        ...
        public async Task GetFailoverTargets()
        {
            ...
            var deviceId = StorSimple8000SeriesManagementClient.Device.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "ResourceGroupForSDKTest", "ManagerForSDKTest1", "default");
            var device = GetArmClient().GetDevice(deviceId);
            StorSimple8000SeriesManagementClient.Models.ListFailoverTargetsRequest parameters = new StorSimple8000SeriesManagementClient.Models.ListFailoverTargetsRequest();
...
"/subscriptions/4385cf00-2d3a-425a-832f-f4285b1c9dce/resourceGroups/ResourceGroupForSDKTest/providers/Microsoft.StorSimple/managers/ManagerForSDKTest1/accessControlRecords/ACR2",}, backupElement: new StorSimple8000SeriesManagementClient.Models.BackupElement(elementId: "/subscriptions/4385cf00-2d3a-425a-832f-f4285b1c9dce/resourceGroups/ResourceGroupForSDKTest/providers/Microsoft.StorSimple/managers/ManagerForSDKTest1/devices/Device05ForSDKTest/backups/880e1774-94a8-4f3e-85e6-a61e6b94a8b7/elements/7e115577-4a3b-4921-bfd4-ee5a1b9bcbb5_0000000000000000", elementName: "7e115577-4a3b-4921-bfd4-ee5a1b9bcbb5_0000000000000000", elementType: "managers/devices/backups/elements", sizeInBytes: 10737418240, volumeName: "Clonedvolume1", volumeContainerId: "/subscriptions/4385cf00-2d3a-425a-832f-f4285b1c9dce/resourceGroups/ResourceGroupForSDKTest/providers/Microsoft.StorSimple/managers/ManagerForSDKTest1/devices/Device05ForSDKTest/volumeContainers/volumeContainerForSDKTest")
{
    VolumeType = StorSimple8000SeriesManagementClient.Models.VolumeType.Tiered,
        ...
        public async Task ChangeControllerPowerStateHardwareComponentGroup()
        {
            ...
            StorSimple8000SeriesManagementClient.Models.ControllerPowerStateChangeRequest parameters = new StorSimple8000SeriesManagementClient.Models.ControllerPowerStateChangeRequest(action: StorSimple8000SeriesManagementClient.Models.ControllerPowerStateAction.Start, activeController: StorSimple8000SeriesManagementClient.Models.ControllerId.Controller0, controller0State: StorSimple8000SeriesManagementClient.Models.ControllerStatus.Ok, controller1State: StorSimple8000SeriesManagementClient.Models.ControllerStatus.NotPresent);
        ...
        public async Task UpdatesGet()
        {
            ...
            var updatesId = StorSimple8000SeriesManagementClient.Updates.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "ResourceGroupForSDKTest", "ManagerForSDKTest1", "sugattdeviceforSDK");
        ...
        public async Task AlertSettingsGet()
        {
            ...
            var alertSettingsId = StorSimple8000SeriesManagementClient.AlertSettings.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "ResourceGroupForSDKTest", "ManagerForSDKTest1", "Device05ForSDKTest");
        ...
        public async Task SecuritySettingsGet()
        {
            ...
            var securitySettingsId = StorSimple8000SeriesManagementClient.SecuritySettings.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "ResourceGroupForSDKTest", "ManagerForSDKTest1", "Device05ForSDKTest");
        ...
        public async Task SecuritySettingsUpdate()
        {
            ...
            var securitySettingsId = StorSimple8000SeriesManagementClient.SecuritySettings.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "ResourceGroupForSDKTest", "ManagerForSDKTest1", "Device05ForSDKTest");
            var securitySettings = GetArmClient().GetSecuritySettings(securitySettingsId);
            StorSimple8000SeriesManagementClient.Models.SecuritySettingsPatch parameters = new StorSimple8000SeriesManagementClient.Models.SecuritySettingsPatch()
            {
                RemoteManagementSettings = new StorSimple8000SeriesManagementClient.Models.RemoteManagementSettingsPatch(remoteManagementMode: StorSimple8000SeriesManagementClient.Models.RemoteManagementModeConfiguration.HttpsAndHttpEnabled),
                DeviceAdminPassword = new StorSimple8000SeriesManagementClient.Models.AsymmetricEncryptedSecret(value: "<value>", encryptionAlgorithm: StorSimple8000SeriesManagementClient.Models.EncryptionAlgorithm.RsaesPkcs1V15)
                {
                    EncryptionCertThumbprint = "A872A2DF196AC7682EE24791E7DE2E2A360F5926",
                },
                SnapshotPassword = new StorSimple8000SeriesManagementClient.Models.AsymmetricEncryptedSecret(value: "<value>", encryptionAlgorithm: StorSimple8000SeriesManagementClient.Models.EncryptionAlgorithm.RsaesPkcs1V15)
                {
                    EncryptionCertThumbprint = "A872A2DF196AC7682EE24791E7DE2E2A360F5926",
                },
                ChapSettings = new StorSimple8000SeriesManagementClient.Models.ChapSettings()
                {
                    InitiatorUser = "test-initiator-user",
                    InitiatorSecret = new StorSimple8000SeriesManagementClient.Models.AsymmetricEncryptedSecret(value: "", encryptionAlgorithm: StorSimple8000SeriesManagementClient.Models.EncryptionAlgorithm.RsaesPkcs1V15)
                    {
                        EncryptionCertThumbprint = "A872A2DF196AC7682EE24791E7DE2E2A360F5926",
                    },
                    TargetUser = "test-target-user",
                    TargetSecret = new StorSimple8000SeriesManagementClient.Models.AsymmetricEncryptedSecret(value: "", encryptionAlgorithm: StorSimple8000SeriesManagementClient.Models.EncryptionAlgorithm.RsaesPkcs1V15)
                    {
                        EncryptionCertThumbprint = "A872A2DF196AC7682EE24791E7DE2E2A360F5926",
                    },
                },
        ...
        public async Task TimeSettingsGet()
        {
            ...
            var timeSettingsId = StorSimple8000SeriesManagementClient.TimeSettings.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "ResourceGroupForSDKTest", "ManagerForSDKTest1", "Device05ForSDKTest");
