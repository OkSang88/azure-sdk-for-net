# Azure DataShare Management client library for .NET
...
Install the Azure DataShare management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.DataShare -Version 1.0.0-preview.1 
```
