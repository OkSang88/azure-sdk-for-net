...
namespace AppPlatformManagementClient.Models
{
    ...
    {
        /// <summary> Initializes a new instance of GatewayRouteConfigResourceCollection. </summary>
        internal GatewayRouteConfigResourceCollection()
        {
        ...
        /// </param>
        internal GatewayRouteConfigResourceCollection(IReadOnlyList<GatewayRouteConfigResourceData> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
