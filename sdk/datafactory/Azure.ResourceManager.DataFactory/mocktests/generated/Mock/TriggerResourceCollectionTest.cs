...
namespace Azure.ResourceManager.DataFactory.Tests.Mock.Tests.Mock
{
    ...
    public partial class TriggerResourceCollectionMockTests : MockTestBase
    {
        ...
        public async Task CreateOrUpdate()
        {
            ...
            DataFactory.Tests.Mock.TriggerResourceData trigger = new DataFactory.Tests.Mock.TriggerResourceData(properties: new DataFactory.Tests.Mock.Models.ScheduleTrigger(recurrence: new DataFactory.Tests.Mock.Models.ScheduleTriggerRecurrence()
            {
                Frequency = new DataFactory.Tests.Mock.Models.RecurrenceFrequency("Minute"),
                Interval = 4,
