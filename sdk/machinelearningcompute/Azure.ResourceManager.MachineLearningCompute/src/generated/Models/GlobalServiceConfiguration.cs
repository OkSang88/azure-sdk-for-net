...
namespace MachineLearningComputeManagementClient.Models
{
    ...
    public partial class GlobalServiceConfiguration
    {
        ...
        internal GlobalServiceConfiguration(string etag, SslConfiguration ssl, ServiceAuthConfiguration serviceAuth, AutoScaleConfiguration autoScale, IDictionary<string, object> additionalProperties)
        {
            Etag = etag;
            Ssl = ssl;
