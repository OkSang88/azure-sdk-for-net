...
namespace AzureAnalysisServices.Models
{
    public partial class ErrorDetail
    {
        internal static ErrorDetail DeserializeErrorDetail(JsonElement element)
        {
            ...
            return new ErrorDetail(code.Value, message.Value, target.Value, Optional.ToNullable(subCode), Optional.ToNullable(httpStatusCode), timeStamp.Value, Optional.ToList(details), Optional.ToList(additionalInfo));
        }
    }
}
