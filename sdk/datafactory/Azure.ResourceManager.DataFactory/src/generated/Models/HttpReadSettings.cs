...
namespace DataFactoryManagementClient.Models
{
    ...
    public partial class HttpReadSettings : StoreReadSettings
    {
        ...
        internal HttpReadSettings(string type, object maxConcurrentConnections, object disableMetricsCollection, IDictionary<string, object> additionalProperties, object requestMethod, object requestBody, object additionalHeaders, object requestTimeout, bool? enablePartitionDiscovery, object partitionRootPath) : base(type, maxConcurrentConnections, disableMetricsCollection, additionalProperties)
        {
