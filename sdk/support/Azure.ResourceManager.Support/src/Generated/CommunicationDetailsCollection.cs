...
namespace Azure.ResourceManager.Support
{
    ...
    public partial class CommunicationDetailsCollection : ArmCollection, IEnumerable<CommunicationDetails>, IAsyncEnumerable<CommunicationDetails>
    {
        ...
        public virtual CommunicationCreateOperation CreateOrUpdate(bool waitForCompletion, string communicationName, CommunicationDetailsData createCommunicationParameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new CommunicationCreateOperation(Parent, _clientDiagnostics, Pipeline, _communicationsRestClient.CreateCreateRequest(Id.SubscriptionId, Id.Name, communicationName, createCommunicationParameters).Request, response);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="communicationName"/> or <paramref name="createCommunicationParameters"/> is null. </exception>
        public async virtual Task<CommunicationCreateOperation> CreateOrUpdateAsync(bool waitForCompletion, string communicationName, CommunicationDetailsData createCommunicationParameters, CancellationToken cancellationToken = default)
        {
            if (communicationName == null)
            {
                throw new ArgumentNullException(nameof(communicationName));
        ...
        public virtual Response<CommunicationDetails> Get(string communicationName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new CommunicationDetails(Parent, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual Pageable<CommunicationDetails> GetAll(int? top = null, string filter = null, CancellationToken cancellationToken = default)
        {
            Page<CommunicationDetails> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    ...
                    return Page.FromValues(response.Value.Value.Select(value => new CommunicationDetails(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
