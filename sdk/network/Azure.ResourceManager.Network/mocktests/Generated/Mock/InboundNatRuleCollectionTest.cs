...
namespace Azure.ResourceManager.Network.Tests.Mock
{
    ...
    public partial class InboundNatRuleCollectionMockTests : MockTestBase
    {
        ...
        public async Task CreateOrUpdateAsync()
        {
            ...
            var collection = GetArmClient().GetLoadBalancer(new ResourceIdentifier("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/testrg/providers/Microsoft.Network/loadBalancers/lb1")).GetInboundNatRules();
