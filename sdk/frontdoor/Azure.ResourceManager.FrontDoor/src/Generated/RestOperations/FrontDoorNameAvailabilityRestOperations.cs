...
namespace Azure.ResourceManager.FrontDoor
{
    internal partial class FrontDoorNameAvailabilityRestOperations
    {
        ...
        public FrontDoorNameAvailabilityRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, Uri endpoint = null, string apiVersion = default)
        {
        ...
        internal HttpMessage CreateCheckRequest(CheckNameAvailabilityInput checkFrontDoorNameAvailabilityInput)
        {
        ...
        public async Task<Response<CheckNameAvailabilityOutput>> CheckAsync(CheckNameAvailabilityInput checkFrontDoorNameAvailabilityInput, CancellationToken cancellationToken = default)
        {
            ...
            using var message = CreateCheckRequest(checkFrontDoorNameAvailabilityInput);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="checkFrontDoorNameAvailabilityInput"/> is null. </exception>
        public Response<CheckNameAvailabilityOutput> Check(CheckNameAvailabilityInput checkFrontDoorNameAvailabilityInput, CancellationToken cancellationToken = default)
        {
            if (checkFrontDoorNameAvailabilityInput == null)
            {
                throw new ArgumentNullException(nameof(checkFrontDoorNameAvailabilityInput));
