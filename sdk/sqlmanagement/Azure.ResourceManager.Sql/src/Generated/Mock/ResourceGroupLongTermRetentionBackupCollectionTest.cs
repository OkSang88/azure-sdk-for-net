...
namespace Azure.ResourceManager.Sql.Tests.Mock
{
    ...
    public partial class ResourceGroupLongTermRetentionBackupCollectionMockTests : MockTestBase
    {
        ...
        public async Task Get()
        {
            ...
            var collection = GetArmClient().GetResourceGroup(new ResourceIdentifier("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/testResourceGroup")).GetResourceGroupLongTermRetentionBackups(locationName, longTermRetentionServerName, longTermRetentionDatabaseName);
