...
namespace LabServicesClient.Models
{
    public partial class OperationResult
    {
        internal static OperationResult DeserializeOperationResult(JsonElement element)
        {
            ...
            return new OperationResult(id.Value, name.Value, status, Optional.ToNullable(startTime), Optional.ToNullable(endTime), Optional.ToNullable(percentComplete), error);
        }
    }
}
