...
namespace Azure.ResourceManager.StorageSync.Tests.Mock
{
    ...
    public partial class ServerEndpointCollectionMockTests : MockTestBase
    {
        ...
        public async Task CreateOrUpdate()
        {
            ...
            StorageSync.Models.ServerEndpointCreateParameters parameters = new StorageSync.Models.ServerEndpointCreateParameters()
            {
                ...
                OfflineDataTransfer = new StorageSync.Models.FeatureStatus("on"),
                OfflineDataTransferShareName = "myfileshare",
                InitialDownloadPolicy = new StorageSync.Models.InitialDownloadPolicy("NamespaceThenModifiedFiles"),
                LocalCacheMode = new StorageSync.Models.LocalCacheMode("UpdateLocallyCachedFiles"),
                InitialUploadPolicy = new StorageSync.Models.InitialUploadPolicy("ServerAuthoritative"),
            };
