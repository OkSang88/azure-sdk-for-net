...
namespace ContainerRegistryManagementClient.Models
{
    ...
    public partial class PrivateEndpointConnectionCreateOrUpdateOperation : Operation<PrivateEndpointConnection>, IOperationSource<PrivateEndpointConnection>
    {
        ...
        internal PrivateEndpointConnectionCreateOrUpdateOperation(ArmResource operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Azure.Core.Request request, Response response)
        {
