...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class TriggerUnsubscribeFromEventsOperation : Operation<TriggerSubscriptionOperationStatus>, IOperationSource<TriggerSubscriptionOperationStatus>
    {
        private readonly OperationInternals<TriggerSubscriptionOperationStatus> _operation;

        /// <summary> Initializes a new instance of TriggerUnsubscribeFromEventsOperation for mocking. </summary>
        protected TriggerUnsubscribeFromEventsOperation()
        {
        }

        internal TriggerUnsubscribeFromEventsOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<TriggerSubscriptionOperationStatus>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "TriggerUnsubscribeFromEventsOperation");
        }
