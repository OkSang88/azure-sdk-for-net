...
namespace ServiceFabricManagedClustersManagementClient.Models
{
    ...
    public partial class RollingUpgradeMonitoringPolicy
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="healthCheckWaitDuration"/>, <paramref name="healthCheckStableDuration"/>, <paramref name="healthCheckRetryTimeout"/>, <paramref name="upgradeTimeout"/>, or <paramref name="upgradeDomainTimeout"/> is null. </exception>
        public RollingUpgradeMonitoringPolicy(FailureAction failureAction, string healthCheckWaitDuration, string healthCheckStableDuration, string healthCheckRetryTimeout, string upgradeTimeout, string upgradeDomainTimeout)
        {
