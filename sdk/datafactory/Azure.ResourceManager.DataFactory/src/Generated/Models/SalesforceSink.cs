...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class SalesforceSink : CopySink
    {
        ...
        internal SalesforceSink(string type, object writeBatchSize, object writeBatchTimeout, object sinkRetryCount, object sinkRetryWait, object maxConcurrentConnections, object disableMetricsCollection, IDictionary<string, object> additionalProperties, SalesforceSinkWriteBehavior? writeBehavior, object externalIdFieldName, object ignoreNullValues) : base(type, writeBatchSize, writeBatchTimeout, sinkRetryCount, sinkRetryWait, maxConcurrentConnections, disableMetricsCollection, additionalProperties)
        {
