...
namespace Azure.ResourceManager.ServiceFabric.Tests.Mock.Tests.Mock
{
    ...
    public partial class ServiceResourceMockTests : MockTestBase
    {
        ...
        public async Task Get()
        {
            ...
            var serviceResourceId = ServiceFabric.Tests.Mock.ServiceResource.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "resRg", "myCluster", "myApp", "myService");
        ...
        public async Task Update()
        {
            ...
            var serviceResourceId = ServiceFabric.Tests.Mock.ServiceResource.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "resRg", "myCluster", "myApp", "myService");
            var serviceResource = GetArmClient().GetServiceResource(serviceResourceId);
            ServiceFabric.Tests.Mock.Models.ServiceResourceUpdate parameters = new ServiceFabric.Tests.Mock.Models.ServiceResourceUpdate(location: AzureLocation.WestUS)
            {
