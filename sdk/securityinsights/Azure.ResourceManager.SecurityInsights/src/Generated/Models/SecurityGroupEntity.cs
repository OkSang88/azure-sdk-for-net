...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class SecurityGroupEntity : EntityData
    {
        ...
        internal SecurityGroupEntity(ResourceIdentifier id, string name, ResourceType type, SystemData systemData, EntityKind kind, IReadOnlyDictionary<string, object> additionalData, string friendlyName, string distinguishedName, Guid? objectGuid, string sid) : base(id, name, type, systemData, kind)
        {
