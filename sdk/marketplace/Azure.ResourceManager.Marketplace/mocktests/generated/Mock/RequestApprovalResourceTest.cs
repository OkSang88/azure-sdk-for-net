...
namespace Azure.ResourceManager.Marketplace.Tests.Mock
{
    ...
    public partial class RequestApprovalResourceMockTests : MockTestBase
    {
        ...
        public async Task Get()
        {
            ...
            var requestApprovalResourceId = Marketplace.RequestApprovalResource.CreateResourceIdentifier("a0e28e55-90c4-41d8-8e34-bb7ef7775406", "marketplacetestthirdparty.md-test-third-party-2");
        ...
        public async Task QueryRequestApproval()
        {
            ...
            var requestApprovalResourceId = Marketplace.RequestApprovalResource.CreateResourceIdentifier("a0e28e55-90c4-41d8-8e34-bb7ef7775406", "marketplacetestthirdparty.md-test-third-party-2");
            var requestApprovalResource = GetArmClient().GetRequestApprovalResource(requestApprovalResourceId);
            Marketplace.Models.QueryRequestApprovalProperties payload = new Marketplace.Models.QueryRequestApprovalProperties()
            {
                Properties = new Marketplace.Models.RequestDetails()
                {
        ...
        public async Task WithdrawPlan()
        {
            ...
            var requestApprovalResourceId = Marketplace.RequestApprovalResource.CreateResourceIdentifier("a0e28e55-90c4-41d8-8e34-bb7ef7775406", "marketplacetestthirdparty.md-test-third-party-2");
            var requestApprovalResource = GetArmClient().GetRequestApprovalResource(requestApprovalResourceId);
            Marketplace.Models.WithdrawProperties payload = new Marketplace.Models.WithdrawProperties()
            {
                PlanId = "*",
                PublisherId = "marketplacetestthirdparty",
            };
