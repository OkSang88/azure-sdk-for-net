...
namespace Azure.ResourceManager.PowerBIDedicated
{
    ...
    public partial class DedicatedCapacity : ArmResource
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async virtual Task<DedicatedCapacityDeleteOperation> DeleteAsync(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new DedicatedCapacityDeleteOperation(_clientDiagnostics, Pipeline, _capacitiesRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name).Request, response);
        ...
        /// <param name="waitForCompletion"> Waits for the completion of the long running operations. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual DedicatedCapacityDeleteOperation Delete(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("DedicatedCapacity.Delete");
            scope.Start();
            try
        ...
        public async virtual Task<DedicatedCapacityUpdateOperation> UpdateAsync(bool waitForCompletion, DedicatedCapacityUpdateParameters capacityUpdateParameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new DedicatedCapacityUpdateOperation(this, _clientDiagnostics, Pipeline, _capacitiesRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, capacityUpdateParameters).Request, response);
                if (waitForCompletion)
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="capacityUpdateParameters"/> is null. </exception>
        public virtual DedicatedCapacityUpdateOperation Update(bool waitForCompletion, DedicatedCapacityUpdateParameters capacityUpdateParameters, CancellationToken cancellationToken = default)
        {
            if (capacityUpdateParameters == null)
            {
                throw new ArgumentNullException(nameof(capacityUpdateParameters));
        ...
        /// <param name="waitForCompletion"> Waits for the completion of the long running operations. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async virtual Task<DedicatedCapacitySuspendOperation> SuspendAsync(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new DedicatedCapacitySuspendOperation(_clientDiagnostics, Pipeline, _capacitiesRestClient.CreateSuspendRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name).Request, response);
                if (waitForCompletion)
                    await operation.WaitForCompletionResponseAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        /// <param name="waitForCompletion"> Waits for the completion of the long running operations. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual DedicatedCapacitySuspendOperation Suspend(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("DedicatedCapacity.Suspend");
            scope.Start();
            try
        ...
        /// <param name="waitForCompletion"> Waits for the completion of the long running operations. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async virtual Task<DedicatedCapacityResumeOperation> ResumeAsync(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new DedicatedCapacityResumeOperation(_clientDiagnostics, Pipeline, _capacitiesRestClient.CreateResumeRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name).Request, response);
                if (waitForCompletion)
                    await operation.WaitForCompletionResponseAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        /// <param name="waitForCompletion"> Waits for the completion of the long running operations. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual DedicatedCapacityResumeOperation Resume(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("DedicatedCapacity.Resume");
            scope.Start();
            try
