...
namespace Azure.ResourceManager.PrivateDns.Tests.Mock
{
    ...
    public partial class PrivateDnsZoneCNAMECollectionMockTests : MockTestBase
    {
        public PrivateDnsZoneCNAMECollectionMockTests(bool isAsync) : base(isAsync, RecordedTestMode.Record)
        {
        ...
        public async Task CreateOrUpdate()
        {
            ...
            PrivateDns.Models.RecordType recordType = PrivateDns.Models.RecordType.A;
            ...
            var privateZoneId = PrivateDns.PrivateZone.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "resourceGroup1", "privatezone1.com");
            var collection = GetArmClient().GetPrivateZone(privateZoneId).GetPrivateDnsZoneCNAMEs();
        ...
        public async Task CreateOrUpdate2()
        {
            ...
            PrivateDns.Models.RecordType recordType = PrivateDns.Models.RecordType.Aaaa;
        ...
        public async Task CreateOrUpdate3()
        {
            ...
            PrivateDns.Models.RecordType recordType = PrivateDns.Models.RecordType.Cname;
            string relativeRecordSetName = "recordCNAME";
            PrivateDns.RecordSetData parameters = new PrivateDns.RecordSetData()
            {
                Ttl = 3600,
                CnameRecord = new PrivateDns.Models.CnameRecord()
                {
                    Cname = "contoso.com",
                },
            };
        ...
        public async Task CreateOrUpdate4()
        {
            ...
            PrivateDns.Models.RecordType recordType = PrivateDns.Models.RecordType.MX;
        ...
        public async Task CreateOrUpdate5()
        {
            ...
            PrivateDns.Models.RecordType recordType = PrivateDns.Models.RecordType.PTR;
            ...
            var privateZoneId = PrivateDns.PrivateZone.CreateResourceIdentifier("00000000-0000-0000-0000-000000000000", "resourceGroup1", "0.0.127.in-addr.arpa");
            var collection = GetArmClient().GetPrivateZone(privateZoneId).GetPrivateDnsZoneCNAMEs();
            await collection.CreateOrUpdateAsync(true, recordType, relativeRecordSetName, parameters, ifMatch, ifNoneMatch);
        }
        ...
        public async Task CreateOrUpdate6()
        {
            ...
            PrivateDns.Models.RecordType recordType = PrivateDns.Models.RecordType.SOA;
            string relativeRecordSetName = "@";
            PrivateDns.RecordSetData parameters = new PrivateDns.RecordSetData()
            {
                Ttl = 3600,
                SoaRecord = new PrivateDns.Models.SoaRecord()
                {
        ...
        public async Task CreateOrUpdate7()
        {
            ...
            PrivateDns.Models.RecordType recordType = PrivateDns.Models.RecordType.SRV;
        ...
        public async Task CreateOrUpdate8()
        {
            ...
            PrivateDns.Models.RecordType recordType = PrivateDns.Models.RecordType.TXT;
