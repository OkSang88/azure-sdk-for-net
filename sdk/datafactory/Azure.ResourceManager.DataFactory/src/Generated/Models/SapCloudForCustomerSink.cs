...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class SapCloudForCustomerSink : CopySink
    {
        ...
        internal SapCloudForCustomerSink(string type, object writeBatchSize, object writeBatchTimeout, object sinkRetryCount, object sinkRetryWait, object maxConcurrentConnections, object disableMetricsCollection, IDictionary<string, object> additionalProperties, SapCloudForCustomerSinkWriteBehavior? writeBehavior, object httpRequestTimeout) : base(type, writeBatchSize, writeBatchTimeout, sinkRetryCount, sinkRetryWait, maxConcurrentConnections, disableMetricsCollection, additionalProperties)
        {
