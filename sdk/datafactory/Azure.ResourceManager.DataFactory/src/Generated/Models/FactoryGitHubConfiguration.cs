...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class FactoryGitHubConfiguration : FactoryRepoConfiguration
    {
        ...
        internal FactoryGitHubConfiguration(string type, string accountName, string repositoryName, string collaborationBranch, string rootFolder, string lastCommitId, string hostName, string clientId, GitHubClientSecret clientSecret) : base(type, accountName, repositoryName, collaborationBranch, rootFolder, lastCommitId)
        {
            HostName = hostName;
            ClientId = clientId;
            ClientSecret = clientSecret;
            Type = type ?? "FactoryGitHubConfiguration";
        }
